...
The format is based on [Conventional Commits][238], and this project adheres to
[Semantic Versioning][239].

## [7.4.3][240] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][241])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][242])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][243])
...
- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][2])
- **package.json:** revert "test: peer dep install" ([4c174fe][3])
- **package.json:** test: peer dep install ([6c00005][4])
...
- **.github:** add codecov to externals; add flags to codecov ([e47160b][9])

# [7.3.0][10] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][11])

### Build System

- **package.json:** better lint output ([0dc7c4e][12])

### Features

- **.github:** backport env matrix hint ([c01b325][13])
- **readme.md:** add NPM7 warning ([24f0888][14])

## [7.2.3][15] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][16])

## [7.2.2][17] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][18])

## [7.2.1][19] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][20])

# [7.2.0][21] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][22])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][23])
- **workflows:** fix should-skip determination algo ([f7d1256][24])

# [7.1.0][25] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][26])
- **readme.md:** complete skip test ([67264ed][27])
- **workflows:** replace should-skip determination algo ([cd6236a][28])

# [7.0.0][29] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][30])
...
- **.changelogrc.js:** show reverts in changelog ([ec26302][32])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][33])

## [6.7.2][34] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][35])
- _"debug(readme.md): debug debug"_ ([aff005d][36])

## [6.7.1][37] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][38])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][39])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][40])

### Build System

- **package.json:** better build-changelog ([f2e971e][41])

# [6.7.0][42] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][43])

# [6.6.0][44] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][45])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][46])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][47])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][48])
- **release.config.js:** use imported releaseRules ([2fe163c][49])

## [6.5.1][50] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][51])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][52])

# [6.5.0][53] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][54])
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][57])
- **package.json:** remove deploy test script ([4fb641c][58])

## [6.4.2][59] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][60])

## [6.4.1][61] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support ([de7ef33][62])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][63])
...
- **package.json:** vercel deploy test ([ed73fc3][66])
...
- **.github/workflows/cleanup.yml:** fix metadata gathering step ([44dd462][70])

## [6.3.6][71] (2021-01-01)

### Build System

- **.github/workflows/cleanup.yml:** add metadata filtering step ([6667075][72])

## [6.3.5][73] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][74])

## [6.3.4][75] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][76])
- Update remark linting to exit 1 on error, quiet on success ([077abce][77])
- Update sort-package-json to contrib-env-expect ([6885a34][78])
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][82])

## [6.3.2][83] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][84])

## [6.3.1][85] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][86])

# [6.3.0][87] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][88])

### Features

- **src:** add div function ([636c353][89])
...
- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][91])
- **.husky:** remove verbose flag ([538c374][92])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][93])
- **package.json:** remove debug echo ([33a510d][94])
- **release.config.js:** fix to use gfm ([db4c284][95])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][96])

## [6.1.7][97] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][98])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][99])

## [6.1.6][100] (2020-12-30)
...
## [6.1.4][104] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][105])

## [6.1.3][106] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][107])
- **build-test-deploy.yml:** fix syntax error ([5448960][108])

## [6.1.2][109] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][110])
- **package.json:** remove high audit CI failure ([b2ea6f1][111])
- **package.json:** test high audit CI failure ([03825f0][112])

## [6.1.1][113] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][114])

# [6.1.0][115] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][116])

### Features

- **readme.md:** dummy feat ([f90dde3][117])

## [6.0.5][118] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][119])

## [6.0.4][120] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][121])

## [6.0.3][122] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][123])
- **.github:** fix cleanup ([7520e0f][124])

## [6.0.2][125] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][126])
- **release.config.js:** remove console.info ([b374296][127])

## [6.0.1][128] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][129])

# [6.0.0][130] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][131])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][132] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][134])

## [5.0.2][135] (2020-12-29)
...
## [5.0.1][137] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][138])
- **package.json:** add codecov package ([d73cac9][139])
- **package.json:** remove codecov package ([da477b7][140])

# [5.0.0][141] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][142])
...
- Update comment language ([5a2aef4][145])
...
## [3.0.1][146] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][147])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][148])

### Build System

- **package.json:** update deps ([a876517][149])

# [3.0.0][150] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][151])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][152])
- **package.json:** use @xunnamius/semantic-release ([0447d59][153])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][154])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][155])
- **package-lock.json:** fix syntax error ([4fd2952][156])
...
- Added mult function ([e537358][158])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][159])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][160])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][161])
...
## [2.3.4][162] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][163])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][164])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][165])
- Added .env.example and env-expect ([efb29c5][166])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][167])

## [2.3.3][168] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][170])

## [2.3.2][171] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][172])

## [2.3.1][173] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][174])
- **release:** fix changelogTitle bug ([0d181ea][175])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][176])

# [2.3.0][177] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][178])

### Performance Improvements

- Better faster spellchecking ([c44c310][179])

## [2.2.2][180] (2020-11-29)
...
## [2.2.1][182] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][183])

# [2.2.0][184] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][186])
- **config:** fix broken changelog.config.js structure ([bd10f44][187])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][188])
- **package.json:** install lint-staged dep and script ([f3800e4][189])
- **package.json:** install spellcheck dependencies ([9a7adb4][190])
- **spellcheck:** change "contains" to "includes" ([af76dbe][191])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][192])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][193])

### Build System

- Install @semantic-release/exec ([cc94940][194])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][195])
- **config:** fix husky pre-commit hook ([f0d0032][196])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][197])
- **config:** retire @semantic-release/changelog ([787a281][198])

### Features

- Add build-changelog to npm scripts ([8393a87][199])

## [2.1.4][200] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][201])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][202])

## [2.1.3][203] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][204])

## [2.1.2][205] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][206])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][207])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][208])

## [2.1.1][209] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][210])

# [2.1.0][211] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][212])
- **actions:** if statements now use | instead of > ([24e3739][213])
- **actions:** move comments out of multiline statements ([874f8d6][214])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][218])
- Add build commits to release rule ([3124ab0][219])

# [2.0.0][220] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][221])
- **actions:** deps caching done properly ([bbe0416][222])
- **actions:** ensure repo is always checked out first ([65e5d46][223])
- **actions:** removed signed pushes ([f621f76][224])
- **package.json:** do not guess error codes ([f5428c8][225])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][226])
...
- Added diff to take the difference ([5e40deb][229])

### Performance Improvements

- **actions:** better caching ([6da0a65][230])
- **actions:** made test-integration-chrome independent ([d489cfa][231])
- **actions:** only cache node_modules ([57775c9][232])

### Reverts

- _"debug: added debug step"_ ([1741cde][233])
- _"debug: debug cache miss"_ ([42af347][234])
...
- Version 1.0.15 ([57faa2c][235])

<!---->

- Version 1.0.7 ([5ced626][236])

- Version 1.0.0 ([df91d82][237])

[1]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.1...v7.4.2
[2]:
...
[5]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.0...v7.4.1
[6]:
...
[8]: https://github.com/Xunnamius/workflow-playground/compare/v7.3.0...v7.4.0
[9]:
  https://github.com/Xunnamius/workflow-playground/commit/e47160b09b956e69f0d9eb0cab01a3440bb66645
[10]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.3...v7.3.0
[11]:
...
[15]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.2...v7.2.3
[16]:
  https://github.com/Xunnamius/workflow-playground/commit/786942001834cb5337fabf921cbc14ea4cc04d2f
[17]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.1...v7.2.2
[18]:
  https://github.com/Xunnamius/workflow-playground/commit/a8cd37812dc9e304bf813c742b2d4d54c1c9c183
[19]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.0...v7.2.1
[20]:
  https://github.com/Xunnamius/workflow-playground/commit/73edb9a864bbc4b7d5a7eb1d03ca4ce3b8e02e95
[21]: https://github.com/Xunnamius/workflow-playground/compare/v7.1.0...v7.2.0
[22]:
...
[25]: https://github.com/Xunnamius/workflow-playground/compare/v7.0.0...v7.1.0
[26]:
...
[29]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.3...v7.0.0
[30]:
  https://github.com/Xunnamius/workflow-playground/commit/5765c024e82c3e7e0c77808e3860c85fb8c8d759
[31]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.2...v6.7.3
[32]:
...
[34]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.1...v6.7.2
[35]:
...
[37]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.0...v6.7.1
[38]:
...
[42]: https://github.com/Xunnamius/workflow-playground/compare/v6.6.0...v6.7.0
[43]:
  https://github.com/Xunnamius/workflow-playground/commit/1fdcb9c6c500f88fbc2b7b6ec7f427f0a4995080
[44]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.1...v6.6.0
[45]:
...
[50]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.0...v6.5.1
[51]:
...
[53]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.3...v6.5.0
[54]:
  https://github.com/Xunnamius/workflow-playground/commit/54488d92317360c2e358bca9238e60e2daca64dd
[55]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[56]:
...
[59]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[60]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[61]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[62]:
...
[80]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[81]:
...
[83]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[84]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[85]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[86]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[87]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[88]:
...
[90]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[91]:
...
[97]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[98]:
...
[100]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[101]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[102]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[103]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[104]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[105]:
  https://github.com/Xunnamius/workflow-playground/commit/44f5cd4c3c6adeb548ba89adba8e884336f41520
[106]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[107]:
...
[109]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[110]:
...
[113]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[114]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[115]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[116]:
...
[118]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[119]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[120]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[121]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[122]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[123]:
...
[125]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[126]:
...
[128]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.0...v6.0.1
[129]:
  https://github.com/Xunnamius/workflow-playground/commit/d40192bd13d9b301e09723cdca68be60b44b5d82
[130]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.3...v6.0.0
[131]:
  https://github.com/Xunnamius/workflow-playground/commit/95a13d21dd902a490d445d3c8aee89c59b2131f1
[132]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.2...v5.0.3
[133]:
...
[135]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.1...v5.0.2
[136]:
  https://github.com/Xunnamius/workflow-playground/commit/e62c5b42ca2b43326cc9eec8db248020b2d90ec8
[137]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.0...v5.0.1
[138]:
...
[141]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[142]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[143]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[144]:
...
[146]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[147]:
...
[150]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[151]:
...
[162]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[163]:
...
[168]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[169]:
...
[171]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[172]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[173]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[174]:
...
[177]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[178]:
...
[180]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[181]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[182]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[183]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[184]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[185]:
...
[200]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[201]:
...
[203]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[204]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[205]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[206]:
...
[209]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[210]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[211]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[212]:
...
[216]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[217]:
...
[220]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[221]:
...
[238]: https://conventionalcommits.org
[239]: https://semver.org
[240]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.2...v7.4.3
[241]:
