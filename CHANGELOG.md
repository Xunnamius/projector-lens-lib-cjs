...
The format is based on [Conventional Commits][285], and this project adheres to
[Semantic Versioning][286].

## [7.5.16][287] (2021-01-23)

### Build System

- **package.json:** nicer destructured vals in docs ([3b81944][288])

## [7.5.15][1] (2021-01-23)

### Build System

- Backport/normalize across packages ([85881f7][2])

## [7.5.14][3] (2021-01-22)

### Build System

- Update debug statement syntax ([107b953][4])
...
- Backport changes from gac ([172fa77][8])

## [7.5.11][9] (2021-01-12)

### Build System

- Rebuild lockfile ([fef7222][10])
- Update babel-plugin-transform-mjs-imports ([16a597d][11])

## [7.5.10][12] (2021-01-12)

### Build System

- Update -browser to -client everywhere ([597d6c5][13])

## [7.5.9][14] (2021-01-10)

### Bug Fixes

- **webpack.config.js:** better process.env support ([25db498][15])

## [7.5.8][16] (2021-01-06)

### Build System

- **webpack.config.js:** process.env shim ([3973279][17])
...
- **package.json:** backported updates ([8a051d1][27])

## [7.5.2][28] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][29])

## [7.5.1][30] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][31])
- **package.json:** return browser test ([6c1c4d4][32])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][33])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][34])
- **package.json:** backports from the wild ([eda277e][35])
- **webpack.config.js:** add env-expect ([0f401ff][36])

# [7.5.0][37] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][38])
...
- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][42])
...
- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][44])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][45])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][46])
...
- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][49])
- **package.json:** revert "test: peer dep install" ([4c174fe][50])
- **package.json:** test: peer dep install ([6c00005][51])
...
- **.github:** add codecov to externals; add flags to codecov ([e47160b][56])

# [7.3.0][57] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][58])

### Build System

- **package.json:** better lint output ([0dc7c4e][59])

### Features

- **.github:** backport env matrix hint ([c01b325][60])
- **readme.md:** add NPM7 warning ([24f0888][61])

## [7.2.3][62] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][63])

## [7.2.2][64] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][65])

## [7.2.1][66] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][67])

# [7.2.0][68] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][69])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][70])
- **workflows:** fix should-skip determination algo ([f7d1256][71])

# [7.1.0][72] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][73])
- **readme.md:** complete skip test ([67264ed][74])
- **workflows:** replace should-skip determination algo ([cd6236a][75])

# [7.0.0][76] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][77])
...
- **.changelogrc.js:** show reverts in changelog ([ec26302][79])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][80])

## [6.7.2][81] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][82])
- _"debug(readme.md): debug debug"_ ([aff005d][83])

## [6.7.1][84] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][85])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][86])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][87])

### Build System

- **package.json:** better build-changelog ([f2e971e][88])

# [6.7.0][89] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][90])

# [6.6.0][91] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][92])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][93])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][94])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][95])
- **release.config.js:** use imported releaseRules ([2fe163c][96])

## [6.5.1][97] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][98])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][99])

# [6.5.0][100] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][101])

## [6.4.3][102] (2021-01-02)
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][104])
- **package.json:** remove deploy test script ([4fb641c][105])

## [6.4.2][106] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][107])

## [6.4.1][108] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support
  ([de7ef33][109])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][110])
- **release.config.js:** fix deploy to run at success step; add debug output
  ([b9e8cc5][111])

# [6.4.0][112] (2021-01-02)

### Features

- **package.json:** vercel deploy test ([ed73fc3][113])

## [6.3.8][114] (2021-01-02)
...
## [6.3.5][120] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][121])

## [6.3.4][122] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][123])
- Update remark linting to exit 1 on error, quiet on success ([077abce][124])
- Update sort-package-json to contrib-env-expect ([6885a34][125])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][126])

## [6.3.3][127] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][129])

## [6.3.2][130] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][131])

## [6.3.1][132] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][133])

# [6.3.0][134] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][135])

### Features

- **src:** add div function ([636c353][136])

# [6.2.0][137] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][138])
- **.husky:** remove verbose flag ([538c374][139])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][140])
- **package.json:** remove debug echo ([33a510d][141])
- **release.config.js:** fix to use gfm ([db4c284][142])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][143])

## [6.1.7][144] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][145])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][146])

## [6.1.6][147] (2020-12-30)
...
## [6.1.4][151] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][152])

## [6.1.3][153] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][154])
- **build-test-deploy.yml:** fix syntax error ([5448960][155])

## [6.1.2][156] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][157])
- **package.json:** remove high audit CI failure ([b2ea6f1][158])
- **package.json:** test high audit CI failure ([03825f0][159])

## [6.1.1][160] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][161])

# [6.1.0][162] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][163])

### Features

- **readme.md:** dummy feat ([f90dde3][164])

## [6.0.5][165] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][166])

## [6.0.4][167] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][168])

## [6.0.3][169] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][170])
- **.github:** fix cleanup ([7520e0f][171])

## [6.0.2][172] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][173])
- **release.config.js:** remove console.info ([b374296][174])

## [6.0.1][175] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][176])

# [6.0.0][177] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][178])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][179] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][181])

## [5.0.2][182] (2020-12-29)
...
## [5.0.1][184] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][185])
- **package.json:** add codecov package ([d73cac9][186])
- **package.json:** remove codecov package ([da477b7][187])

# [5.0.0][188] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][189])
...
- Update comment language ([5a2aef4][192])
...
## [3.0.1][193] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][194])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][195])

### Build System

- **package.json:** update deps ([a876517][196])

# [3.0.0][197] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][198])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][199])
- **package.json:** use @xunnamius/semantic-release ([0447d59][200])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][201])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][202])
- **package-lock.json:** fix syntax error ([4fd2952][203])
...
- Added mult function ([e537358][205])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][206])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][207])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][208])
...
## [2.3.4][209] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][210])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][211])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][212])
- Added .env.example and env-expect ([efb29c5][213])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][214])

## [2.3.3][215] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][217])

## [2.3.2][218] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][219])

## [2.3.1][220] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][221])
- **release:** fix changelogTitle bug ([0d181ea][222])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][223])

# [2.3.0][224] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][225])

### Performance Improvements

- Better faster spellchecking ([c44c310][226])

## [2.2.2][227] (2020-11-29)
...
## [2.2.1][229] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][230])

# [2.2.0][231] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][233])
- **config:** fix broken changelog.config.js structure ([bd10f44][234])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][235])
- **package.json:** install lint-staged dep and script ([f3800e4][236])
- **package.json:** install spellcheck dependencies ([9a7adb4][237])
- **spellcheck:** change "contains" to "includes" ([af76dbe][238])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][239])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][240])

### Build System

- Install @semantic-release/exec ([cc94940][241])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][242])
- **config:** fix husky pre-commit hook ([f0d0032][243])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][244])
- **config:** retire @semantic-release/changelog ([787a281][245])

### Features

- Add build-changelog to npm scripts ([8393a87][246])

## [2.1.4][247] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][248])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][249])

## [2.1.3][250] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][251])

## [2.1.2][252] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][253])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][254])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][255])

## [2.1.1][256] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][257])

# [2.1.0][258] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][259])
- **actions:** if statements now use | instead of > ([24e3739][260])
- **actions:** move comments out of multiline statements ([874f8d6][261])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][265])
- Add build commits to release rule ([3124ab0][266])

# [2.0.0][267] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][268])
- **actions:** deps caching done properly ([bbe0416][269])
- **actions:** ensure repo is always checked out first ([65e5d46][270])
- **actions:** removed signed pushes ([f621f76][271])
- **package.json:** do not guess error codes ([f5428c8][272])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][273])
...
- Added diff to take the difference ([5e40deb][276])

### Performance Improvements

- **actions:** better caching ([6da0a65][277])
- **actions:** made test-integration-chrome independent ([d489cfa][278])
- **actions:** only cache node_modules ([57775c9][279])

### Reverts

- _"debug: added debug step"_ ([1741cde][280])
- _"debug: debug cache miss"_ ([42af347][281])
...
- Version 1.0.15 ([57faa2c][282])

<!---->

- Version 1.0.7 ([5ced626][283])

- Version 1.0.0 ([df91d82][284])

[1]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.14...v7.5.15
[2]:
  https://github.com/Xunnamius/workflow-playground/commit/85881f72411301a06791be63c76a67fbff45d3fd
[3]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.13...v7.5.14
[4]:
  https://github.com/Xunnamius/workflow-playground/commit/107b953b834fb54bb2ee1c418d5bb8119fabe3ac
[5]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.12...v7.5.13
[6]:
  https://github.com/Xunnamius/workflow-playground/commit/2dce9c47d069b05df41481678a967dccc4637ead
[7]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.11...v7.5.12
[8]:
  https://github.com/Xunnamius/workflow-playground/commit/172fa775e677fe977d2b8265460ec192818b1996
[9]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.10...v7.5.11
[10]:
...
[37]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.5...v7.5.0
[38]:
  https://github.com/Xunnamius/workflow-playground/commit/77c033ff143dff64455049b8314cd528bae4e198
[39]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.4...v7.4.5
[40]:
  https://github.com/Xunnamius/workflow-playground/commit/677b4cedff4d3e4541736e612035d909a0df6131
[41]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.3...v7.4.4
[42]:
  https://github.com/Xunnamius/workflow-playground/commit/5c8fefa330e31620fe2af848d42eb2c5ab881d02
[43]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.2...v7.4.3
[44]:
...
[48]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.1...v7.4.2
[49]:
...
[52]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.0...v7.4.1
[53]:
...
[55]: https://github.com/Xunnamius/workflow-playground/compare/v7.3.0...v7.4.0
[56]:
  https://github.com/Xunnamius/workflow-playground/commit/e47160b09b956e69f0d9eb0cab01a3440bb66645
[57]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.3...v7.3.0
[58]:
...
[62]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.2...v7.2.3
[63]:
  https://github.com/Xunnamius/workflow-playground/commit/786942001834cb5337fabf921cbc14ea4cc04d2f
[64]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.1...v7.2.2
[65]:
  https://github.com/Xunnamius/workflow-playground/commit/a8cd37812dc9e304bf813c742b2d4d54c1c9c183
[66]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.0...v7.2.1
[67]:
  https://github.com/Xunnamius/workflow-playground/commit/73edb9a864bbc4b7d5a7eb1d03ca4ce3b8e02e95
[68]: https://github.com/Xunnamius/workflow-playground/compare/v7.1.0...v7.2.0
[69]:
...
[72]: https://github.com/Xunnamius/workflow-playground/compare/v7.0.0...v7.1.0
[73]:
...
[76]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.3...v7.0.0
[77]:
  https://github.com/Xunnamius/workflow-playground/commit/5765c024e82c3e7e0c77808e3860c85fb8c8d759
[78]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.2...v6.7.3
[79]:
...
[81]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.1...v6.7.2
[82]:
...
[84]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.0...v6.7.1
[85]:
...
[89]: https://github.com/Xunnamius/workflow-playground/compare/v6.6.0...v6.7.0
[90]:
  https://github.com/Xunnamius/workflow-playground/commit/1fdcb9c6c500f88fbc2b7b6ec7f427f0a4995080
[91]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.1...v6.6.0
[92]:
...
[97]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.0...v6.5.1
[98]:
...
[100]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.3...v6.5.0
[101]:
  https://github.com/Xunnamius/workflow-playground/commit/54488d92317360c2e358bca9238e60e2daca64dd
[102]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[103]:
...
[106]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[107]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[108]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[109]:
...
[127]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[128]:
...
[130]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[131]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[132]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[133]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[134]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[135]:
...
[137]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[138]:
...
[144]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[145]:
...
[147]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[148]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[149]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[150]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[151]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[152]:
  https://github.com/Xunnamius/workflow-playground/commit/44f5cd4c3c6adeb548ba89adba8e884336f41520
[153]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[154]:
...
[156]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[157]:
...
[160]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[161]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[162]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[163]:
...
[165]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[166]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[167]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[168]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[169]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[170]:
...
[172]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[173]:
...
[175]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.0...v6.0.1
[176]:
  https://github.com/Xunnamius/workflow-playground/commit/d40192bd13d9b301e09723cdca68be60b44b5d82
[177]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.3...v6.0.0
[178]:
  https://github.com/Xunnamius/workflow-playground/commit/95a13d21dd902a490d445d3c8aee89c59b2131f1
[179]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.2...v5.0.3
[180]:
...
[182]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.1...v5.0.2
[183]:
  https://github.com/Xunnamius/workflow-playground/commit/e62c5b42ca2b43326cc9eec8db248020b2d90ec8
[184]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.0...v5.0.1
[185]:
...
[188]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[189]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[190]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[191]:
...
[193]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[194]:
...
[197]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[198]:
...
[209]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[210]:
...
[215]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[216]:
...
[218]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[219]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[220]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[221]:
...
[224]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[225]:
...
[227]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[228]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[229]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[230]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[231]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[232]:
...
[247]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[248]:
...
[250]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[251]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[252]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[253]:
...
[256]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[257]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[258]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[259]:
...
[263]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[264]:
...
[267]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[268]:
...
[285]: https://conventionalcommits.org
[286]: https://semver.org
[287]:
  https://github.com/Xunnamius/workflow-playground/compare/v7.5.15...v7.5.16
[288]:
