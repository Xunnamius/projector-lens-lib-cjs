...
- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][71])

## [6.1.3][72] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][73])
- **build-test-deploy.yml:** fix syntax error ([5448960][74])

## [6.1.2][75] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][76])
- **package.json:** remove high audit CI failure ([b2ea6f1][77])
- **package.json:** test high audit CI failure ([03825f0][78])

## [6.1.1][79] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][80])

# [6.1.0][81] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][82])

### Features

- **readme.md:** dummy feat ([f90dde3][83])

## [6.0.5][84] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][85])

## [6.0.4][86] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][87])

## [6.0.3][88] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][89])
- **.github:** fix cleanup ([7520e0f][90])

## [6.0.2][91] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][92])
- **release.config.js:** remove console.info ([b374296][93])

## [6.0.1][94] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][95])

# [6.0.0][96] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][97])
...
## [5.0.1][102] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][103])
- **package.json:** add codecov package ([d73cac9][104])
- **package.json:** remove codecov package ([da477b7][105])

# [5.0.0][106] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][107])
...
- Update comment language ([5a2aef4][110])
...
## [3.0.1][111] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][112])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][113])

### Build System

- **package.json:** update deps ([a876517][114])

# [3.0.0][115] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][116])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][117])
- **package.json:** use @xunnamius/semantic-release ([0447d59][118])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][119])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][120])
- **package-lock.json:** fix syntax error ([4fd2952][121])
...
- Added mult function ([e537358][123])
...
## [2.3.4][124] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][125])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][126])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][127])
- Added .env.example and env-expect ([efb29c5][128])

## [2.3.3][129] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][131])

## [2.3.2][132] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][133])

## [2.3.1][134] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][135])
- **release:** fix changelogTitle bug ([0d181ea][136])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][137])

# [2.3.0][138] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][139])

### Performance Improvements

- Better faster spellchecking ([c44c310][140])

## [2.2.2][141] (2020-11-29)
...
## [2.2.1][143] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][144])

# [2.2.0][145] (2020-11-29)
...
- Install @semantic-release/exec ([cc94940][155])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][156])
- **config:** fix husky pre-commit hook ([f0d0032][157])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][158])
- **config:** retire @semantic-release/changelog ([787a281][159])

### Features

- Add build-changelog to npm scripts ([8393a87][160])

## [2.1.4][161] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][162])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][163])

## [2.1.3][164] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][165])

## [2.1.2][166] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][167])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][168])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][169])

## [2.1.1][170] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][171])

# [2.1.0][172] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][173])
- **actions:** if statements now use | instead of > ([24e3739][174])
- **actions:** move comments out of multiline statements ([874f8d6][175])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][179])
- Add build commits to release rule ([3124ab0][180])

# [2.0.0][181] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][182])
- **actions:** deps caching done properly ([bbe0416][183])
- **actions:** ensure repo is always checked out first ([65e5d46][184])
- **actions:** removed signed pushes ([f621f76][185])
- **package.json:** do not guess error codes ([f5428c8][186])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][187])
...
- Added diff to take the difference ([5e40deb][190])

### Performance Improvements

- **actions:** better caching ([6da0a65][191])
- **actions:** made test-integration-chrome independent ([d489cfa][192])
- **actions:** only cache node_modules ([57775c9][193])
...
- Version 1.0.15 ([57faa2c][194])

<!---->

- Version 1.0.7 ([5ced626][195])

- Version 1.0.0 ([df91d82][196])

[1]: https://conventionalcommits.org
[2]: https://semver.org
[3]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.1...v6.7.2
...
[66]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[67]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[68]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[69]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[70]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[71]:
  https://github.com/Xunnamius/workflow-playground/commit/44f5cd4c3c6adeb548ba89adba8e884336f41520
[72]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[73]:
...
[75]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[76]:
...
[79]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[80]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[81]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[82]:
...
[84]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[85]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[86]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[87]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[88]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[89]:
...
[91]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[92]:
...
[106]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[107]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[108]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[109]:
...
[111]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[112]:
...
[115]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[116]:
...
[124]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[125]:
...
[129]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[130]:
...
[132]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[133]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[134]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[135]:
...
[138]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[139]:
...
[141]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[142]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[143]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[144]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[145]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[146]:
...
[161]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[162]:
...
[164]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[165]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[166]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[167]:
...
[170]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[171]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[172]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[173]:
...
[177]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[178]:
...
[181]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[182]:
