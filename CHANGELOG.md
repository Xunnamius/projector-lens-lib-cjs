...
- **.github/workflows/cleanup.yml:** add metadata filtering step ([6667075][4])

## [6.3.5][5] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][6])

## [6.3.4][7] (2021-01-01)

### Build System

- move npm lint step before lint-staged in husky hook ([e8bac90][8])
- update remark linting to exit 1 on error, quiet on success ([077abce][9])
- update sort-package-json to contrib-env-expect ([6885a34][10])
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][14])

## [6.3.2][15] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][16])

## [6.3.1][17] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][18])

# [6.3.0][19] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][20])

### Features

- **src:** add div function ([636c353][21])
...
- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][23])
- **.husky:** remove verbose flag ([538c374][24])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][25])
- **package.json:** remove debug echo ([33a510d][26])
- **release.config.js:** fix to use gfm ([db4c284][27])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][28])

## [6.1.7][29] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][30])
...
- **build-test-deploy.yml:** debug should warn ([55e1235][37])
- **build-test-deploy.yml:** fix syntax error ([5448960][38])

## [6.1.2][39] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][40])
- **package.json:** remove high audit CI failure ([b2ea6f1][41])
- **package.json:** test high audit CI failure ([03825f0][42])

## [6.1.1][43] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][44])
...
- **readme.md:** dummy feat ([f90dde3][46])

## 6.0.6-canary.1 (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][47])

## [6.0.5][48] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][49])

## [6.0.4][50] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][51])

## [6.0.3][52] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][53])
- **.github:** fix cleanup ([7520e0f][54])

## [6.0.2][55] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][56])
- **release.config.js:** remove console.info ([b374296][57])

## [6.0.1][58] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][59])

# [6.0.0][60] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][61])
...
- **.github:** add codecov-action to test-unit job ([2ef6297][67])
- **package.json:** add codecov package ([d73cac9][68])
- **package.json:** remove codecov package ([da477b7][69])

# [5.0.0][70] (2020-12-29)

### Chore

- fix capitalization of non-release commit types ([7391321][71])
...
- update comment language ([5a2aef4][74])
...
- **.github:** update ci committer name and email to xunn-bot ([b151491][76])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][77])

### Build System

- **package.json:** update deps ([a876517][78])
...
- **package-lock.json:** fix syntax error ([4fd2952][80])

# 3.0.0-canary.6 (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][81])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][82])
...
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][83])

# 3.0.0-canary.4 (2020-12-06)

### Build System

- **package.json:** add semver devdep ([4a50ecd][84])
...
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][86])
- **package.json:** use @xunnamius/semantic-release ([0447d59][87])
...
- added mult function ([e537358][88])
...
- **commitlint:** add debug type to type-enum ([10c71bf][90])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][91])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][92])
- added .env.example and env-expect ([efb29c5][93])
...
- **release:** fix changelogTitle skip title ([1dcdcc1][96])

## [2.3.2][97] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][98])

## [2.3.1][99] (2020-11-30)

### Build System

- install @semantic-release/changelog ([022603b][100])
- **release:** fix changelogTitle bug ([0d181ea][101])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][102])

# [2.3.0][103] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][104])

### Performance Improvements

- better faster spellchecking ([c44c310][105])

## [2.2.2][106] (2020-11-29)
...
## [2.2.1][108] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][109])

# [2.2.0][110] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][112])
- **config:** fix broken changelog.config.js structure ([bd10f44][113])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][114])
- **package.json:** install lint-staged dep and script ([f3800e4][115])
- **package.json:** install spellcheck dependencies ([9a7adb4][116])
- **spellcheck:** change "contains" to "includes" ([af76dbe][117])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][118])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][119])

### Build System

- install @semantic-release/exec ([cc94940][120])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][121])
- **config:** fix husky pre-commit hook ([f0d0032][122])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][123])
- **config:** retire @semantic-release/changelog ([787a281][124])

### Features

- add build-changelog to npm scripts ([8393a87][125])

## [2.1.4][126] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][127])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][128])

## [2.1.3][129] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][130])

## [2.1.2][131] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][132])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][133])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][134])

## [2.1.1][135] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][136])

# [2.1.0][137] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][138])
- **actions:** if statements now use | instead of > ([24e3739][139])
- **actions:** move comments out of multiline statements ([874f8d6][140])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][144])
- add build commits to release rule ([3124ab0][145])

# [2.0.0][146] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][147])
- **actions:** deps caching done properly ([bbe0416][148])
- **actions:** ensure repo is always checked out first ([65e5d46][149])
- **actions:** removed signed pushes ([f621f76][150])
- **package.json:** do not guess error codes ([f5428c8][151])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][152])
...
- added diff to take the difference ([5e40deb][155])

### Performance Improvements

- **actions:** better caching ([6da0a65][156])
- **actions:** made test-integration-chrome independent ([d489cfa][157])
- **actions:** only cache node_modules ([57775c9][158])
...
- Version 1.0.15 ([57faa2c][159])

<!---->

- Version 1.0.7 ([5ced626][160])

- Version 1.0.0 ([df91d82][161])

[1]: https://conventionalcommits.org
[2]: https://semver.org
[3]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.5...v6.3.6
[4]:
  https://github.com/Xunnamius/workflow-playground/commit/66670754987250b92806dfa7d94c1cb46349f07f
[5]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.4...v6.3.5
[6]:
  https://github.com/Xunnamius/workflow-playground/commit/a10bac3efbce2b4bd511420fd4d7466c288d9706
[7]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.3...v6.3.4
[8]:
...
[12]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[13]:
...
[15]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[16]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[17]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[18]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[19]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[20]:
...
[22]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[23]:
...
[29]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[30]:
  https://github.com/Xunnamius/workflow-playground/commit/8a7fc06df25ffa5381bb5d771eb6e5a619fcbf64
[31]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[32]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[33]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[34]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[35]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[36]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[37]:
...
[39]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[40]:
...
[43]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[44]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[45]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[46]:
...
[48]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[49]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[50]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[51]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[52]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[53]:
...
[55]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[56]:
...
[70]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[71]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[72]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[73]:
...
[75]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[76]:
...
[79]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[80]:
...
[89]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[90]:
...
[94]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[95]:
...
[97]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[98]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[99]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[100]:
...
[103]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[104]:
...
[106]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[107]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[108]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[109]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[110]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[111]:
...
[126]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[127]:
...
[129]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[130]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[131]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[132]:
...
[135]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[136]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[137]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[138]:
...
[142]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[143]:
...
[146]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[147]:
