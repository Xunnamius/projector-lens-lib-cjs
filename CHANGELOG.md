...
The format is based on [Conventional Commits][376], and this project adheres to
[Semantic Versioning][377].

## [7.8.18][378] (2021-02-22)

### Bug Fixes

- **.changelogrc.js:** fix dark magic ([6a3007d][379])

### Build System

- **package-lock.json:** remove shelljs ([92a2b23][380])
- Spellcheck-commit and .changelogrc no longer use shelljs ([b3633c3][381])
- **setup.ts:** update with new lib-pkg tools ([e77df0b][382])

## [7.8.17][1] (2021-02-22)

### Build System

- **externals:** update expected exit code to 2 ([fb22498][2])
...
- **setup.ts:** backport setup fix ([ee1aca2][10])

## [7.8.12][11] (2021-02-21)

### Build System

- **package.json:** chmod cli during build-dist step ([d6f8cc3][12])

## [7.8.11][13] (2021-02-21)

### Build System

- **expect-env.js:** rename from env-expect.js ([aa14ed9][14])

## [7.8.10][15] (2021-02-21)

### Bug Fixes

- **build-test-deploy.yml:** check real exit code ([4ff058e][16])

## [7.8.9][17] (2021-02-20)

### Build System

- **package-lock.json:** make consistent with package.json ([8a63ac7][18])
- **package.json:** remove extraneous module ([1012053][19])

## [7.8.8][20] (2021-02-20)

### Build System

- **deps:** bump object-path from 0.11.3 to 0.11.5 ([95c974a][21])

## [7.8.7][22] (2021-02-20)

### Bug Fixes

- Package.json & package-lock.json to reduce vulnerabilities ([41de5ce][23])

## [7.8.6][24] (2021-02-20)

### Bug Fixes

- **build-test-deploy.yml:** even more resilient error checking ([b050bba][25])

### Build System

- **deps:** bump object-path from 0.11.3 to 0.11.5 ([981229a][26])
...
- **build-test-deploy.yml:** better error handling and debug messaging for
  auto-merge job ([2dee6f6][28])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([1667e70][29])
...
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([e9e3ca1][32])
...
- **build-test-deploy.yml:** better error messages ([6d5573e][35])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([c493a8c][36])

## [7.8.2][37] (2021-02-20)

### Build System

- **deps:** bump object-path from 0.11.4 to 0.11.5 ([aaf7665][38])

## [7.8.1][39] (2021-02-20)

### Bug Fixes

- **build-test-deploy.yml:** store and use proper result ([09d35d7][40])

### Build System

- **deps:** bump object-path from 0.11.4 to 0.11.5 ([658f591][41])
- **package.json:** bump jest timeout to 1 minute ([cb59af2][42])
...
- **build-test-deploy.yml:** whitelist is again case-insensitive ([c034e86][46])

### Build System

- **build-test-deploy.yml:** also run on reopened PRs ([ece78e3][47])
- **build-test-deploy.yml:** codecov failures no longer fail the whole pipeline
  ([a111d7f][48])
- **build-test-deploy.yml:** restructure env w/ comments ([b980cbe][49])
- **build-test-deploy.yml:** update repo owner whitelist step ([b4f89cf][50])

# [7.7.0][51] (2021-02-19)

### Bug Fixes

- Account for node 12 ([4cdb325][52])
...
- **package.json:** external integration test runs w/ proper prefix
  ([5056c05][54])
- **package.json:** update deps ([4ef9c1b][55])

### Features

- **external-scripts:** reorganize externals; rename external to dummy
  ([efc916e][56])
- **test:** externalize jest helper proto-packages ([2dbfb8e][57])

## [7.6.5][58] (2021-02-15)

### Build System

- **package.json:** add private:false ([090cdfe][59])

## [7.6.4][60] (2021-02-14)

### Bug Fixes

- **webpack.config.js:** call dotenv properly ([22a8424][61])

## [7.6.3][62] (2021-02-14)

### Bug Fixes

- Incorrect package name ([bbbd58d][63])

### Build System

- **package.json:** update deps ([599b6c2][64])
...
- **package.json:** account for new ./dist organization ([99a01ea][67])

### Build System

- **test:** complete testing suite ([35da4c3][68])
- **webpack.config.js:** add externals ([7a8f54b][69])
- Move debug to deps, update dependencies ([6587184][70])
- **.eslintrc.js:** false env browser/webextensions ([71809e9][71])
- **integration-client.test.ts:** removed ([f080ad0][72])
- Normalize across repos ([2020d61][73])
- **webpack.config.js:** normalize webpack configuration across repos
  ([8a3bc81][74])
- **webpack.config.js:** remove ES6 syntax from JS file ([dd2b254][75])
...
- **babel.config.js:** add babel-plugin-transform-default-named-imports
  ([720dc20][77])
- **package.json:** update deps ([26a8371][78])
...
- **post-release-check.yml:** run executables as part of check ([31bdc0c][81])

## [7.5.18][82] (2021-01-29)

### Build System

- **build-test-deploy.yml:** drop support for webpack 4 ([e7f2bbb][83])
- **cleanup.yml:** fix bug for new package repos ([8d16630][84])

## [7.5.17][85] (2021-01-29)

### Build System

- **babel.config.js:** add plugin-rename-imports ([c59e45c][86])
- **build-test-deploy.yml:** remove externals exception ([3addf11][87])
- **test:** drop support for 10.x ([fb18856][88])
- **test:** standardize imports ([4f23d4e][89])

## [7.5.16][90] (2021-01-23)

### Build System

- **package.json:** nicer destructured vals in docs ([3b81944][91])

## [7.5.15][92] (2021-01-23)

### Build System

- Backport/normalize across packages ([85881f7][93])

## [7.5.14][94] (2021-01-22)

### Build System

- Update debug statement syntax ([107b953][95])

## [7.5.13][96] (2021-01-21)
...
## [7.5.12][98] (2021-01-17)

### Build System

- Backport changes from gac ([172fa77][99])

## [7.5.11][100] (2021-01-12)

### Build System

- Rebuild lockfile ([fef7222][101])
- Update babel-plugin-transform-mjs-imports ([16a597d][102])

## [7.5.10][103] (2021-01-12)

### Build System

- Update -browser to -client everywhere ([597d6c5][104])

## [7.5.9][105] (2021-01-10)

### Bug Fixes

- **webpack.config.js:** better process.env support ([25db498][106])

## [7.5.8][107] (2021-01-06)

### Build System

- **webpack.config.js:** process.env shim ([3973279][108])

## [7.5.7][109] (2021-01-06)
...
## [7.5.3][117] (2021-01-05)

### Build System

- **package.json:** backported updates ([8a051d1][118])

## [7.5.2][119] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][120])

## [7.5.1][121] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][122])
- **package.json:** return browser test ([6c1c4d4][123])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][124])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][125])
- **package.json:** backports from the wild ([eda277e][126])
- **webpack.config.js:** add env-expect ([0f401ff][127])

# [7.5.0][128] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][129])

## [7.4.5][130] (2021-01-05)
...
## [7.4.4][132] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][133])

## [7.4.3][134] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][135])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][136])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][137])
- **.github/workflows/build-test-deploy.yml:** fix debug output (normalize node
  support) ([0528db6][138])

## [7.4.2][139] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][140])
- **package.json:** revert "test: peer dep install" ([4c174fe][141])
- **package.json:** test: peer dep install ([6c00005][142])

## [7.4.1][143] (2021-01-04)
...
# [7.4.0][146] (2021-01-04)

### Features

- **.github:** add codecov to externals; add flags to codecov ([e47160b][147])

# [7.3.0][148] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][149])

### Build System

- **package.json:** better lint output ([0dc7c4e][150])

### Features

- **.github:** backport env matrix hint ([c01b325][151])
- **readme.md:** add NPM7 warning ([24f0888][152])

## [7.2.3][153] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][154])

## [7.2.2][155] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][156])

## [7.2.1][157] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][158])

# [7.2.0][159] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][160])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][161])
- **workflows:** fix should-skip determination algo ([f7d1256][162])

# [7.1.0][163] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][164])
- **readme.md:** complete skip test ([67264ed][165])
- **workflows:** replace should-skip determination algo ([cd6236a][166])

# [7.0.0][167] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][168])

### BREAKING CHANGES

- **changelog.md:** **skip github/github skip options were removed**

## [6.7.3][169] (2021-01-03)

### Bug Fixes

- **.changelogrc.js:** show reverts in changelog ([ec26302][170])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][171])

## [6.7.2][172] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][173])
- _"debug(readme.md): debug debug"_ ([aff005d][174])

## [6.7.1][175] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][176])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][177])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][178])

### Build System

- **package.json:** better build-changelog ([f2e971e][179])

# [6.7.0][180] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][181])

# [6.6.0][182] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][183])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][184])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][185])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][186])
- **release.config.js:** use imported releaseRules ([2fe163c][187])

## [6.5.1][188] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][189])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][190])

# [6.5.0][191] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][192])

## [6.4.3][193] (2021-01-02)
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][195])
- **package.json:** remove deploy test script ([4fb641c][196])

## [6.4.2][197] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][198])

## [6.4.1][199] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support
  ([de7ef33][200])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][201])
- **release.config.js:** fix deploy to run at success step; add debug output
  ([b9e8cc5][202])

# [6.4.0][203] (2021-01-02)

### Features

- **package.json:** vercel deploy test ([ed73fc3][204])

## [6.3.8][205] (2021-01-02)
...
## [6.3.5][211] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][212])

## [6.3.4][213] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][214])
- Update remark linting to exit 1 on error, quiet on success ([077abce][215])
- Update sort-package-json to contrib-env-expect ([6885a34][216])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][217])

## [6.3.3][218] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][220])

## [6.3.2][221] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][222])

## [6.3.1][223] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][224])

# [6.3.0][225] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][226])

### Features

- **src:** add div function ([636c353][227])

# [6.2.0][228] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][229])
- **.husky:** remove verbose flag ([538c374][230])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][231])
- **package.json:** remove debug echo ([33a510d][232])
- **release.config.js:** fix to use gfm ([db4c284][233])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][234])

## [6.1.7][235] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][236])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][237])

## [6.1.6][238] (2020-12-30)
...
## [6.1.4][242] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][243])

## [6.1.3][244] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][245])
- **build-test-deploy.yml:** fix syntax error ([5448960][246])

## [6.1.2][247] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][248])
- **package.json:** remove high audit CI failure ([b2ea6f1][249])
- **package.json:** test high audit CI failure ([03825f0][250])

## [6.1.1][251] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][252])

# [6.1.0][253] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][254])

### Features

- **readme.md:** dummy feat ([f90dde3][255])

## [6.0.5][256] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][257])

## [6.0.4][258] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][259])

## [6.0.3][260] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][261])
- **.github:** fix cleanup ([7520e0f][262])

## [6.0.2][263] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][264])
- **release.config.js:** remove console.info ([b374296][265])

## [6.0.1][266] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][267])

# [6.0.0][268] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][269])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][270] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][272])

## [5.0.2][273] (2020-12-29)
...
## [5.0.1][275] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][276])
- **package.json:** add codecov package ([d73cac9][277])
- **package.json:** remove codecov package ([da477b7][278])

# [5.0.0][279] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][280])
...
- Update comment language ([5a2aef4][283])
...
## [3.0.1][284] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][285])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][286])

### Build System

- **package.json:** update deps ([a876517][287])

# [3.0.0][288] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][289])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][290])
- **package.json:** use @xunnamius/semantic-release ([0447d59][291])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][292])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][293])
- **package-lock.json:** fix syntax error ([4fd2952][294])
...
- Added mult function ([e537358][296])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][297])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][298])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][299])
...
## [2.3.4][300] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][301])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][302])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][303])
- Added .env.example and env-expect ([efb29c5][304])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][305])

## [2.3.3][306] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][308])

## [2.3.2][309] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][310])

## [2.3.1][311] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][312])
- **release:** fix changelogTitle bug ([0d181ea][313])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][314])

# [2.3.0][315] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][316])

### Performance Improvements

- Better faster spellchecking ([c44c310][317])

## [2.2.2][318] (2020-11-29)
...
## [2.2.1][320] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][321])

# [2.2.0][322] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][324])
- **config:** fix broken changelog.config.js structure ([bd10f44][325])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][326])
- **package.json:** install lint-staged dep and script ([f3800e4][327])
- **package.json:** install spellcheck dependencies ([9a7adb4][328])
- **spellcheck:** change "contains" to "includes" ([af76dbe][329])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][330])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][331])

### Build System

- Install @semantic-release/exec ([cc94940][332])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][333])
- **config:** fix husky pre-commit hook ([f0d0032][334])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][335])
- **config:** retire @semantic-release/changelog ([787a281][336])

### Features

- Add build-changelog to npm scripts ([8393a87][337])

## [2.1.4][338] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][339])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][340])

## [2.1.3][341] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][342])

## [2.1.2][343] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][344])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][345])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][346])

## [2.1.1][347] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][348])

# [2.1.0][349] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][350])
- **actions:** if statements now use | instead of > ([24e3739][351])
- **actions:** move comments out of multiline statements ([874f8d6][352])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][356])
- Add build commits to release rule ([3124ab0][357])

# [2.0.0][358] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][359])
- **actions:** deps caching done properly ([bbe0416][360])
- **actions:** ensure repo is always checked out first ([65e5d46][361])
- **actions:** removed signed pushes ([f621f76][362])
- **package.json:** do not guess error codes ([f5428c8][363])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][364])
...
- Added diff to take the difference ([5e40deb][367])

### Performance Improvements

- **actions:** better caching ([6da0a65][368])
- **actions:** made test-integration-chrome independent ([d489cfa][369])
- **actions:** only cache node_modules ([57775c9][370])

### Reverts

- _"debug: added debug step"_ ([1741cde][371])
- _"debug: debug cache miss"_ ([42af347][372])
...
- Version 1.0.15 ([57faa2c][373])

<!---->

- Version 1.0.7 ([5ced626][374])

- Version 1.0.0 ([df91d82][375])
...
[376]: https://conventionalcommits.org
[377]: https://semver.org
[378]:
