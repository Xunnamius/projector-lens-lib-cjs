...
- **.changelogrc.js:** add debug to all javascript ([54488d9][4])
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][7])
- **package.json:** remove deploy test script ([4fb641c][8])

## [6.4.2][9] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][10])

## [6.4.1][11] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support ([de7ef33][12])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][13])
...
- **package.json:** vercel deploy test ([ed73fc3][16])
...
- **.github/workflows/cleanup.yml:** fix metadata gathering step ([44dd462][20])

## [6.3.6][21] (2021-01-01)

### Build System

- **.github/workflows/cleanup.yml:** add metadata filtering step ([6667075][22])

## [6.3.5][23] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][24])

## [6.3.4][25] (2021-01-01)

### Build System

- move npm lint step before lint-staged in husky hook ([e8bac90][26])
- update remark linting to exit 1 on error, quiet on success ([077abce][27])
- update sort-package-json to contrib-env-expect ([6885a34][28])
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][32])

## [6.3.2][33] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][34])

## [6.3.1][35] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][36])

# [6.3.0][37] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][38])

### Features

- **src:** add div function ([636c353][39])
...
- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][41])
- **.husky:** remove verbose flag ([538c374][42])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][43])
- **package.json:** remove debug echo ([33a510d][44])
- **release.config.js:** fix to use gfm ([db4c284][45])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][46])

## [6.1.7][47] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][48])
...
- **build-test-deploy.yml:** debug should warn ([55e1235][55])
- **build-test-deploy.yml:** fix syntax error ([5448960][56])

## [6.1.2][57] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][58])
- **package.json:** remove high audit CI failure ([b2ea6f1][59])
- **package.json:** test high audit CI failure ([03825f0][60])

## [6.1.1][61] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][62])
...
- **readme.md:** dummy feat ([f90dde3][64])

## 6.0.6-canary.1 (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][65])

## [6.0.5][66] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][67])

## [6.0.4][68] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][69])

## [6.0.3][70] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][71])
- **.github:** fix cleanup ([7520e0f][72])

## [6.0.2][73] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][74])
- **release.config.js:** remove console.info ([b374296][75])

## [6.0.1][76] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][77])

# [6.0.0][78] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][79])
...
- **.github:** add codecov-action to test-unit job ([2ef6297][85])
- **package.json:** add codecov package ([d73cac9][86])
- **package.json:** remove codecov package ([da477b7][87])

# [5.0.0][88] (2020-12-29)

### Chore

- fix capitalization of non-release commit types ([7391321][89])
...
- update comment language ([5a2aef4][92])
...
- **.github:** update ci committer name and email to xunn-bot ([b151491][94])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][95])

### Build System

- **package.json:** update deps ([a876517][96])
...
- **package-lock.json:** fix syntax error ([4fd2952][98])

# 3.0.0-canary.6 (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][99])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][100])
...
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][101])

# 3.0.0-canary.4 (2020-12-06)

### Build System

- **package.json:** add semver devdep ([4a50ecd][102])
...
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][104])
- **package.json:** use @xunnamius/semantic-release ([0447d59][105])
...
- added mult function ([e537358][106])
...
## [2.3.4][107] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][108])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][109])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][110])
- added .env.example and env-expect ([efb29c5][111])

## [2.3.3][112] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][114])

## [2.3.2][115] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][116])

## [2.3.1][117] (2020-11-30)

### Build System

- install @semantic-release/changelog ([022603b][118])
- **release:** fix changelogTitle bug ([0d181ea][119])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][120])

# [2.3.0][121] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][122])

### Performance Improvements

- better faster spellchecking ([c44c310][123])

## [2.2.2][124] (2020-11-29)
...
## [2.2.1][126] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][127])

# [2.2.0][128] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][130])
- **config:** fix broken changelog.config.js structure ([bd10f44][131])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][132])
- **package.json:** install lint-staged dep and script ([f3800e4][133])
- **package.json:** install spellcheck dependencies ([9a7adb4][134])
- **spellcheck:** change "contains" to "includes" ([af76dbe][135])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][136])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][137])

### Build System

- install @semantic-release/exec ([cc94940][138])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][139])
- **config:** fix husky pre-commit hook ([f0d0032][140])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][141])
- **config:** retire @semantic-release/changelog ([787a281][142])

### Features

- add build-changelog to npm scripts ([8393a87][143])

## [2.1.4][144] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][145])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][146])

## [2.1.3][147] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][148])

## [2.1.2][149] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][150])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][151])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][152])

## [2.1.1][153] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][154])

# [2.1.0][155] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][156])
- **actions:** if statements now use | instead of > ([24e3739][157])
- **actions:** move comments out of multiline statements ([874f8d6][158])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][162])
- add build commits to release rule ([3124ab0][163])

# [2.0.0][164] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][165])
- **actions:** deps caching done properly ([bbe0416][166])
- **actions:** ensure repo is always checked out first ([65e5d46][167])
- **actions:** removed signed pushes ([f621f76][168])
- **package.json:** do not guess error codes ([f5428c8][169])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][170])
...
- added diff to take the difference ([5e40deb][173])

### Performance Improvements

- **actions:** better caching ([6da0a65][174])
- **actions:** made test-integration-chrome independent ([d489cfa][175])
- **actions:** only cache node_modules ([57775c9][176])
...
- Version 1.0.15 ([57faa2c][177])

<!---->

- Version 1.0.7 ([5ced626][178])

- Version 1.0.0 ([df91d82][179])

[1]: https://conventionalcommits.org
[2]: https://semver.org
[3]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.3...v6.5.0
[4]:
  https://github.com/Xunnamius/workflow-playground/commit/54488d92317360c2e358bca9238e60e2daca64dd
[5]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[6]:
...
[9]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[10]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[11]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[12]:
...
[30]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[31]:
...
[33]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[34]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[35]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[36]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[37]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[38]:
...
[40]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[41]:
...
[47]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[48]:
  https://github.com/Xunnamius/workflow-playground/commit/8a7fc06df25ffa5381bb5d771eb6e5a619fcbf64
[49]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[50]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[51]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[52]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[53]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[54]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[55]:
...
[57]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[58]:
...
[61]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[62]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[63]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[64]:
...
[66]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[67]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[68]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[69]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[70]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[71]:
...
[73]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[74]:
...
[88]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[89]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[90]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[91]:
...
[93]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[94]:
...
[97]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[98]:
...
[107]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[108]:
...
[112]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[113]:
...
[115]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[116]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[117]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[118]:
...
[121]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[122]:
...
[124]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[125]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[126]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[127]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[128]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[129]:
...
[144]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[145]:
...
[147]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[148]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[149]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[150]:
...
[153]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[154]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[155]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[156]:
...
[160]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[161]:
...
[164]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[165]:
