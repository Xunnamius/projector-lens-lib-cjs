...
The format is based on [Conventional Commits][362], and this project adheres to
[Semantic Versioning][363].

## [7.8.11][364] (2021-02-21)

### Build System

- **expect-env.js:** rename from env-expect.js ([aa14ed9][365])

## [7.8.10][1] (2021-02-21)

### Bug Fixes

- **build-test-deploy.yml:** check real exit code ([4ff058e][2])

## [7.8.9][3] (2021-02-20)

### Build System

- **package-lock.json:** make consistent with package.json ([8a63ac7][4])
- **package.json:** remove extraneous module ([1012053][5])

## [7.8.8][6] (2021-02-20)

### Build System

- **deps:** bump object-path from 0.11.3 to 0.11.5 ([95c974a][7])

## [7.8.7][8] (2021-02-20)

### Bug Fixes

- Package.json & package-lock.json to reduce vulnerabilities ([41de5ce][9])

## [7.8.6][10] (2021-02-20)

### Bug Fixes

- **build-test-deploy.yml:** even more resilient error checking ([b050bba][11])

### Build System

- **deps:** bump object-path from 0.11.3 to 0.11.5 ([981229a][12])
...
- **build-test-deploy.yml:** better error handling and debug messaging for
  auto-merge job ([2dee6f6][14])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([1667e70][15])
...
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([e9e3ca1][18])
...
- **build-test-deploy.yml:** better error messages ([6d5573e][21])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([c493a8c][22])

## [7.8.2][23] (2021-02-20)

### Build System

- **deps:** bump object-path from 0.11.4 to 0.11.5 ([aaf7665][24])

## [7.8.1][25] (2021-02-20)

### Bug Fixes

- **build-test-deploy.yml:** store and use proper result ([09d35d7][26])

### Build System

- **deps:** bump object-path from 0.11.4 to 0.11.5 ([658f591][27])
- **package.json:** bump jest timeout to 1 minute ([cb59af2][28])
...
- **build-test-deploy.yml:** whitelist is again case-insensitive ([c034e86][32])

### Build System

- **build-test-deploy.yml:** also run on reopened PRs ([ece78e3][33])
- **build-test-deploy.yml:** codecov failures no longer fail the whole pipeline
  ([a111d7f][34])
- **build-test-deploy.yml:** restructure env w/ comments ([b980cbe][35])
- **build-test-deploy.yml:** update repo owner whitelist step ([b4f89cf][36])

# [7.7.0][37] (2021-02-19)

### Bug Fixes

- Account for node 12 ([4cdb325][38])
...
- **package.json:** external integration test runs w/ proper prefix
  ([5056c05][40])
- **package.json:** update deps ([4ef9c1b][41])

### Features

- **external-scripts:** reorganize externals; rename external to dummy
  ([efc916e][42])
- **test:** externalize jest helper proto-packages ([2dbfb8e][43])

## [7.6.5][44] (2021-02-15)

### Build System

- **package.json:** add private:false ([090cdfe][45])

## [7.6.4][46] (2021-02-14)

### Bug Fixes

- **webpack.config.js:** call dotenv properly ([22a8424][47])

## [7.6.3][48] (2021-02-14)

### Bug Fixes

- Incorrect package name ([bbbd58d][49])

### Build System

- **package.json:** update deps ([599b6c2][50])
...
- **package.json:** account for new ./dist organization ([99a01ea][53])

### Build System

- **test:** complete testing suite ([35da4c3][54])
- **webpack.config.js:** add externals ([7a8f54b][55])
- Move debug to deps, update dependencies ([6587184][56])
- **.eslintrc.js:** false env browser/webextensions ([71809e9][57])
- **integration-client.test.ts:** removed ([f080ad0][58])
- Normalize across repos ([2020d61][59])
- **webpack.config.js:** normalize webpack configuration across repos
  ([8a3bc81][60])
- **webpack.config.js:** remove ES6 syntax from JS file ([dd2b254][61])
...
- **babel.config.js:** add babel-plugin-transform-default-named-imports
  ([720dc20][63])
- **package.json:** update deps ([26a8371][64])
...
- **post-release-check.yml:** run executables as part of check ([31bdc0c][67])

## [7.5.18][68] (2021-01-29)

### Build System

- **build-test-deploy.yml:** drop support for webpack 4 ([e7f2bbb][69])
- **cleanup.yml:** fix bug for new package repos ([8d16630][70])

## [7.5.17][71] (2021-01-29)

### Build System

- **babel.config.js:** add plugin-rename-imports ([c59e45c][72])
- **build-test-deploy.yml:** remove externals exception ([3addf11][73])
- **test:** drop support for 10.x ([fb18856][74])
- **test:** standardize imports ([4f23d4e][75])

## [7.5.16][76] (2021-01-23)

### Build System

- **package.json:** nicer destructured vals in docs ([3b81944][77])

## [7.5.15][78] (2021-01-23)

### Build System

- Backport/normalize across packages ([85881f7][79])

## [7.5.14][80] (2021-01-22)

### Build System

- Update debug statement syntax ([107b953][81])

## [7.5.13][82] (2021-01-21)
...
## [7.5.12][84] (2021-01-17)

### Build System

- Backport changes from gac ([172fa77][85])

## [7.5.11][86] (2021-01-12)

### Build System

- Rebuild lockfile ([fef7222][87])
- Update babel-plugin-transform-mjs-imports ([16a597d][88])

## [7.5.10][89] (2021-01-12)

### Build System

- Update -browser to -client everywhere ([597d6c5][90])

## [7.5.9][91] (2021-01-10)

### Bug Fixes

- **webpack.config.js:** better process.env support ([25db498][92])

## [7.5.8][93] (2021-01-06)

### Build System

- **webpack.config.js:** process.env shim ([3973279][94])
...
## [7.5.3][103] (2021-01-05)

### Build System

- **package.json:** backported updates ([8a051d1][104])

## [7.5.2][105] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][106])

## [7.5.1][107] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][108])
- **package.json:** return browser test ([6c1c4d4][109])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][110])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][111])
- **package.json:** backports from the wild ([eda277e][112])
- **webpack.config.js:** add env-expect ([0f401ff][113])

# [7.5.0][114] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][115])

## [7.4.5][116] (2021-01-05)
...
## [7.4.4][118] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][119])

## [7.4.3][120] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][121])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][122])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][123])
- **.github/workflows/build-test-deploy.yml:** fix debug output (normalize node
  support) ([0528db6][124])

## [7.4.2][125] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][126])
- **package.json:** revert "test: peer dep install" ([4c174fe][127])
- **package.json:** test: peer dep install ([6c00005][128])

## [7.4.1][129] (2021-01-04)
...
# [7.4.0][132] (2021-01-04)

### Features

- **.github:** add codecov to externals; add flags to codecov ([e47160b][133])

# [7.3.0][134] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][135])

### Build System

- **package.json:** better lint output ([0dc7c4e][136])

### Features

- **.github:** backport env matrix hint ([c01b325][137])
- **readme.md:** add NPM7 warning ([24f0888][138])

## [7.2.3][139] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][140])

## [7.2.2][141] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][142])

## [7.2.1][143] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][144])

# [7.2.0][145] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][146])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][147])
- **workflows:** fix should-skip determination algo ([f7d1256][148])

# [7.1.0][149] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][150])
- **readme.md:** complete skip test ([67264ed][151])
- **workflows:** replace should-skip determination algo ([cd6236a][152])

# [7.0.0][153] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][154])

### BREAKING CHANGES

- **changelog.md:** **skip github/github skip options were removed**

## [6.7.3][155] (2021-01-03)

### Bug Fixes

- **.changelogrc.js:** show reverts in changelog ([ec26302][156])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][157])

## [6.7.2][158] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][159])
- _"debug(readme.md): debug debug"_ ([aff005d][160])

## [6.7.1][161] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][162])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][163])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][164])

### Build System

- **package.json:** better build-changelog ([f2e971e][165])

# [6.7.0][166] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][167])

# [6.6.0][168] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][169])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][170])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][171])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][172])
- **release.config.js:** use imported releaseRules ([2fe163c][173])

## [6.5.1][174] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][175])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][176])

# [6.5.0][177] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][178])

## [6.4.3][179] (2021-01-02)
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][181])
- **package.json:** remove deploy test script ([4fb641c][182])

## [6.4.2][183] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][184])

## [6.4.1][185] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support
  ([de7ef33][186])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][187])
- **release.config.js:** fix deploy to run at success step; add debug output
  ([b9e8cc5][188])

# [6.4.0][189] (2021-01-02)

### Features

- **package.json:** vercel deploy test ([ed73fc3][190])

## [6.3.8][191] (2021-01-02)
...
## [6.3.5][197] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][198])

## [6.3.4][199] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][200])
- Update remark linting to exit 1 on error, quiet on success ([077abce][201])
- Update sort-package-json to contrib-env-expect ([6885a34][202])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][203])

## [6.3.3][204] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][206])

## [6.3.2][207] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][208])

## [6.3.1][209] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][210])

# [6.3.0][211] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][212])

### Features

- **src:** add div function ([636c353][213])

# [6.2.0][214] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][215])
- **.husky:** remove verbose flag ([538c374][216])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][217])
- **package.json:** remove debug echo ([33a510d][218])
- **release.config.js:** fix to use gfm ([db4c284][219])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][220])

## [6.1.7][221] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][222])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][223])

## [6.1.6][224] (2020-12-30)
...
## [6.1.4][228] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][229])

## [6.1.3][230] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][231])
- **build-test-deploy.yml:** fix syntax error ([5448960][232])

## [6.1.2][233] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][234])
- **package.json:** remove high audit CI failure ([b2ea6f1][235])
- **package.json:** test high audit CI failure ([03825f0][236])

## [6.1.1][237] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][238])

# [6.1.0][239] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][240])

### Features

- **readme.md:** dummy feat ([f90dde3][241])

## [6.0.5][242] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][243])

## [6.0.4][244] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][245])

## [6.0.3][246] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][247])
- **.github:** fix cleanup ([7520e0f][248])

## [6.0.2][249] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][250])
- **release.config.js:** remove console.info ([b374296][251])

## [6.0.1][252] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][253])

# [6.0.0][254] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][255])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][256] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][258])

## [5.0.2][259] (2020-12-29)
...
## [5.0.1][261] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][262])
- **package.json:** add codecov package ([d73cac9][263])
- **package.json:** remove codecov package ([da477b7][264])

# [5.0.0][265] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][266])
...
- Update comment language ([5a2aef4][269])
...
## [3.0.1][270] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][271])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][272])

### Build System

- **package.json:** update deps ([a876517][273])

# [3.0.0][274] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][275])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][276])
- **package.json:** use @xunnamius/semantic-release ([0447d59][277])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][278])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][279])
- **package-lock.json:** fix syntax error ([4fd2952][280])
...
- Added mult function ([e537358][282])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][283])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][284])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][285])
...
## [2.3.4][286] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][287])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][288])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][289])
- Added .env.example and env-expect ([efb29c5][290])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][291])

## [2.3.3][292] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][294])

## [2.3.2][295] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][296])

## [2.3.1][297] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][298])
- **release:** fix changelogTitle bug ([0d181ea][299])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][300])

# [2.3.0][301] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][302])

### Performance Improvements

- Better faster spellchecking ([c44c310][303])

## [2.2.2][304] (2020-11-29)
...
## [2.2.1][306] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][307])

# [2.2.0][308] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][310])
- **config:** fix broken changelog.config.js structure ([bd10f44][311])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][312])
- **package.json:** install lint-staged dep and script ([f3800e4][313])
- **package.json:** install spellcheck dependencies ([9a7adb4][314])
- **spellcheck:** change "contains" to "includes" ([af76dbe][315])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][316])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][317])

### Build System

- Install @semantic-release/exec ([cc94940][318])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][319])
- **config:** fix husky pre-commit hook ([f0d0032][320])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][321])
- **config:** retire @semantic-release/changelog ([787a281][322])

### Features

- Add build-changelog to npm scripts ([8393a87][323])

## [2.1.4][324] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][325])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][326])

## [2.1.3][327] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][328])

## [2.1.2][329] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][330])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][331])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][332])

## [2.1.1][333] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][334])

# [2.1.0][335] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][336])
- **actions:** if statements now use | instead of > ([24e3739][337])
- **actions:** move comments out of multiline statements ([874f8d6][338])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][342])
- Add build commits to release rule ([3124ab0][343])

# [2.0.0][344] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][345])
- **actions:** deps caching done properly ([bbe0416][346])
- **actions:** ensure repo is always checked out first ([65e5d46][347])
- **actions:** removed signed pushes ([f621f76][348])
- **package.json:** do not guess error codes ([f5428c8][349])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][350])
...
- Added diff to take the difference ([5e40deb][353])

### Performance Improvements

- **actions:** better caching ([6da0a65][354])
- **actions:** made test-integration-chrome independent ([d489cfa][355])
- **actions:** only cache node_modules ([57775c9][356])

### Reverts

- _"debug: added debug step"_ ([1741cde][357])
- _"debug: debug cache miss"_ ([42af347][358])
...
- Version 1.0.15 ([57faa2c][359])

<!---->

- Version 1.0.7 ([5ced626][360])

- Version 1.0.0 ([df91d82][361])
...
[3]: https://github.com/Xunnamius/projector-lens-lib-cjs/compare/v7.8.8...v7.8.9
[4]:
...
[6]: https://github.com/Xunnamius/projector-lens-lib-cjs/compare/v7.8.7...v7.8.8
[7]:
  https://github.com/Xunnamius/projector-lens-lib-cjs/commit/95c974a66a381da546dc9e810d04f22f565a557c
[8]: https://github.com/Xunnamius/projector-lens-lib-cjs/compare/v7.8.6...v7.8.7
[9]:
...
[362]: https://conventionalcommits.org
[363]: https://semver.org
[364]:
