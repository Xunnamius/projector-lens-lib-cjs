...
The format is based on [Conventional Commits][260], and this project adheres to
[Semantic Versioning][261].

## [7.5.4][262] (2021-01-06)
...
- **package.json:** backported updates ([8a051d1][2])

## [7.5.2][3] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][4])

## [7.5.1][5] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][6])
- **package.json:** return browser test ([6c1c4d4][7])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][8])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][9])
- **package.json:** backports from the wild ([eda277e][10])
- **webpack.config.js:** add env-expect ([0f401ff][11])

# [7.5.0][12] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][13])
...
- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][17])
...
- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][19])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][20])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][21])
...
- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][24])
- **package.json:** revert "test: peer dep install" ([4c174fe][25])
- **package.json:** test: peer dep install ([6c00005][26])
...
- **.github:** add codecov to externals; add flags to codecov ([e47160b][31])

# [7.3.0][32] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][33])

### Build System

- **package.json:** better lint output ([0dc7c4e][34])

### Features

- **.github:** backport env matrix hint ([c01b325][35])
- **readme.md:** add NPM7 warning ([24f0888][36])

## [7.2.3][37] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][38])

## [7.2.2][39] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][40])

## [7.2.1][41] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][42])

# [7.2.0][43] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][44])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][45])
- **workflows:** fix should-skip determination algo ([f7d1256][46])

# [7.1.0][47] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][48])
- **readme.md:** complete skip test ([67264ed][49])
- **workflows:** replace should-skip determination algo ([cd6236a][50])

# [7.0.0][51] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][52])
...
- **.changelogrc.js:** show reverts in changelog ([ec26302][54])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][55])

## [6.7.2][56] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][57])
- _"debug(readme.md): debug debug"_ ([aff005d][58])

## [6.7.1][59] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][60])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][61])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][62])

### Build System

- **package.json:** better build-changelog ([f2e971e][63])

# [6.7.0][64] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][65])

# [6.6.0][66] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][67])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][68])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][69])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][70])
- **release.config.js:** use imported releaseRules ([2fe163c][71])

## [6.5.1][72] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][73])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][74])

# [6.5.0][75] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][76])
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][79])
- **package.json:** remove deploy test script ([4fb641c][80])

## [6.4.2][81] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][82])

## [6.4.1][83] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support ([de7ef33][84])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][85])
...
- **package.json:** vercel deploy test ([ed73fc3][88])
...
- **.github/workflows/cleanup.yml:** fix metadata gathering step ([44dd462][92])

## [6.3.6][93] (2021-01-01)

### Build System

- **.github/workflows/cleanup.yml:** add metadata filtering step ([6667075][94])

## [6.3.5][95] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][96])

## [6.3.4][97] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][98])
- Update remark linting to exit 1 on error, quiet on success ([077abce][99])
- Update sort-package-json to contrib-env-expect ([6885a34][100])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][101])

## [6.3.3][102] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][104])

## [6.3.2][105] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][106])

## [6.3.1][107] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][108])

# [6.3.0][109] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][110])

### Features

- **src:** add div function ([636c353][111])

# [6.2.0][112] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][113])
- **.husky:** remove verbose flag ([538c374][114])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][115])
- **package.json:** remove debug echo ([33a510d][116])
- **release.config.js:** fix to use gfm ([db4c284][117])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][118])

## [6.1.7][119] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][120])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][121])

## [6.1.6][122] (2020-12-30)
...
## [6.1.4][126] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][127])

## [6.1.3][128] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][129])
- **build-test-deploy.yml:** fix syntax error ([5448960][130])

## [6.1.2][131] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][132])
- **package.json:** remove high audit CI failure ([b2ea6f1][133])
- **package.json:** test high audit CI failure ([03825f0][134])

## [6.1.1][135] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][136])

# [6.1.0][137] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][138])

### Features

- **readme.md:** dummy feat ([f90dde3][139])

## [6.0.5][140] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][141])

## [6.0.4][142] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][143])

## [6.0.3][144] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][145])
- **.github:** fix cleanup ([7520e0f][146])

## [6.0.2][147] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][148])
- **release.config.js:** remove console.info ([b374296][149])

## [6.0.1][150] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][151])

# [6.0.0][152] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][153])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][154] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][156])

## [5.0.2][157] (2020-12-29)
...
## [5.0.1][159] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][160])
- **package.json:** add codecov package ([d73cac9][161])
- **package.json:** remove codecov package ([da477b7][162])

# [5.0.0][163] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][164])
...
- Update comment language ([5a2aef4][167])
...
## [3.0.1][168] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][169])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][170])

### Build System

- **package.json:** update deps ([a876517][171])

# [3.0.0][172] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][173])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][174])
- **package.json:** use @xunnamius/semantic-release ([0447d59][175])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][176])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][177])
- **package-lock.json:** fix syntax error ([4fd2952][178])
...
- Added mult function ([e537358][180])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][181])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][182])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][183])
...
## [2.3.4][184] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][185])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][186])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][187])
- Added .env.example and env-expect ([efb29c5][188])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][189])

## [2.3.3][190] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][192])

## [2.3.2][193] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][194])

## [2.3.1][195] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][196])
- **release:** fix changelogTitle bug ([0d181ea][197])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][198])

# [2.3.0][199] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][200])

### Performance Improvements

- Better faster spellchecking ([c44c310][201])

## [2.2.2][202] (2020-11-29)
...
## [2.2.1][204] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][205])

# [2.2.0][206] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][208])
- **config:** fix broken changelog.config.js structure ([bd10f44][209])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][210])
- **package.json:** install lint-staged dep and script ([f3800e4][211])
- **package.json:** install spellcheck dependencies ([9a7adb4][212])
- **spellcheck:** change "contains" to "includes" ([af76dbe][213])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][214])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][215])

### Build System

- Install @semantic-release/exec ([cc94940][216])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][217])
- **config:** fix husky pre-commit hook ([f0d0032][218])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][219])
- **config:** retire @semantic-release/changelog ([787a281][220])

### Features

- Add build-changelog to npm scripts ([8393a87][221])

## [2.1.4][222] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][223])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][224])

## [2.1.3][225] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][226])

## [2.1.2][227] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][228])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][229])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][230])

## [2.1.1][231] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][232])

# [2.1.0][233] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][234])
- **actions:** if statements now use | instead of > ([24e3739][235])
- **actions:** move comments out of multiline statements ([874f8d6][236])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][240])
- Add build commits to release rule ([3124ab0][241])

# [2.0.0][242] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][243])
- **actions:** deps caching done properly ([bbe0416][244])
- **actions:** ensure repo is always checked out first ([65e5d46][245])
- **actions:** removed signed pushes ([f621f76][246])
- **package.json:** do not guess error codes ([f5428c8][247])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][248])
...
- Added diff to take the difference ([5e40deb][251])

### Performance Improvements

- **actions:** better caching ([6da0a65][252])
- **actions:** made test-integration-chrome independent ([d489cfa][253])
- **actions:** only cache node_modules ([57775c9][254])

### Reverts

- _"debug: added debug step"_ ([1741cde][255])
- _"debug: debug cache miss"_ ([42af347][256])
...
- Version 1.0.15 ([57faa2c][257])

<!---->

- Version 1.0.7 ([5ced626][258])

- Version 1.0.0 ([df91d82][259])

[1]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.2...v7.5.3
[2]:
  https://github.com/Xunnamius/workflow-playground/commit/8a051d1222ed6df2d1c9e1f2e2eb890d763a6333
[3]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.1...v7.5.2
[4]:
  https://github.com/Xunnamius/workflow-playground/commit/2cf6e46a6fe59b8a47123f2215ba8caf7976ad87
[5]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.0...v7.5.1
[6]:
...
[12]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.5...v7.5.0
[13]:
  https://github.com/Xunnamius/workflow-playground/commit/77c033ff143dff64455049b8314cd528bae4e198
[14]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.4...v7.4.5
[15]:
  https://github.com/Xunnamius/workflow-playground/commit/677b4cedff4d3e4541736e612035d909a0df6131
[16]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.3...v7.4.4
[17]:
  https://github.com/Xunnamius/workflow-playground/commit/5c8fefa330e31620fe2af848d42eb2c5ab881d02
[18]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.2...v7.4.3
[19]:
...
[23]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.1...v7.4.2
[24]:
...
[27]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.0...v7.4.1
[28]:
...
[30]: https://github.com/Xunnamius/workflow-playground/compare/v7.3.0...v7.4.0
[31]:
  https://github.com/Xunnamius/workflow-playground/commit/e47160b09b956e69f0d9eb0cab01a3440bb66645
[32]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.3...v7.3.0
[33]:
...
[37]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.2...v7.2.3
[38]:
  https://github.com/Xunnamius/workflow-playground/commit/786942001834cb5337fabf921cbc14ea4cc04d2f
[39]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.1...v7.2.2
[40]:
  https://github.com/Xunnamius/workflow-playground/commit/a8cd37812dc9e304bf813c742b2d4d54c1c9c183
[41]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.0...v7.2.1
[42]:
  https://github.com/Xunnamius/workflow-playground/commit/73edb9a864bbc4b7d5a7eb1d03ca4ce3b8e02e95
[43]: https://github.com/Xunnamius/workflow-playground/compare/v7.1.0...v7.2.0
[44]:
...
[47]: https://github.com/Xunnamius/workflow-playground/compare/v7.0.0...v7.1.0
[48]:
...
[51]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.3...v7.0.0
[52]:
  https://github.com/Xunnamius/workflow-playground/commit/5765c024e82c3e7e0c77808e3860c85fb8c8d759
[53]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.2...v6.7.3
[54]:
...
[56]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.1...v6.7.2
[57]:
...
[59]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.0...v6.7.1
[60]:
...
[64]: https://github.com/Xunnamius/workflow-playground/compare/v6.6.0...v6.7.0
[65]:
  https://github.com/Xunnamius/workflow-playground/commit/1fdcb9c6c500f88fbc2b7b6ec7f427f0a4995080
[66]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.1...v6.6.0
[67]:
...
[72]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.0...v6.5.1
[73]:
...
[75]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.3...v6.5.0
[76]:
  https://github.com/Xunnamius/workflow-playground/commit/54488d92317360c2e358bca9238e60e2daca64dd
[77]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[78]:
...
[81]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[82]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[83]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[84]:
...
[102]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[103]:
...
[105]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[106]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[107]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[108]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[109]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[110]:
...
[112]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[113]:
...
[119]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[120]:
...
[122]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[123]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[124]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[125]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[126]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[127]:
  https://github.com/Xunnamius/workflow-playground/commit/44f5cd4c3c6adeb548ba89adba8e884336f41520
[128]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[129]:
...
[131]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[132]:
...
[135]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[136]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[137]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[138]:
...
[140]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[141]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[142]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[143]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[144]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[145]:
...
[147]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[148]:
...
[150]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.0...v6.0.1
[151]:
  https://github.com/Xunnamius/workflow-playground/commit/d40192bd13d9b301e09723cdca68be60b44b5d82
[152]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.3...v6.0.0
[153]:
  https://github.com/Xunnamius/workflow-playground/commit/95a13d21dd902a490d445d3c8aee89c59b2131f1
[154]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.2...v5.0.3
[155]:
...
[157]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.1...v5.0.2
[158]:
  https://github.com/Xunnamius/workflow-playground/commit/e62c5b42ca2b43326cc9eec8db248020b2d90ec8
[159]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.0...v5.0.1
[160]:
...
[163]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[164]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[165]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[166]:
...
[168]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[169]:
...
[172]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[173]:
...
[184]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[185]:
...
[190]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[191]:
...
[193]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[194]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[195]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[196]:
...
[199]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[200]:
...
[202]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[203]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[204]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[205]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[206]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[207]:
...
[222]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[223]:
...
[225]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[226]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[227]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[228]:
...
[231]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[232]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[233]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[234]:
...
[238]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[239]:
...
[242]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[243]:
...
[260]: https://conventionalcommits.org
[261]: https://semver.org
[262]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.3...v7.5.4
[263]:
