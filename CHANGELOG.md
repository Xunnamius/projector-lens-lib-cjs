...
- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][10])

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][11])
...
- **readme.md:** dummy feat ([f90dde3][74])

## 6.0.6-canary.1 (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][75])
...
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][113])
- **package.json:** use @xunnamius/semantic-release ([0447d59][114])
...
- revert "debug: switch actions ci to install" ([f9a3e23][121])

## [2.3.3][122] (2020-11-30)
...
## [2.3.2][125] (2020-11-30)

- **release:** fix changelogTitle spread bug ([598a396][126])

## [2.3.1][127] (2020-11-30)

- install @semantic-release/changelog ([022603b][128])
- **release:** fix changelogTitle bug ([0d181ea][129])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][130])

# [2.3.0][131] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][132])

### Performance Improvements

- better faster spellchecking ([c44c310][133])

## [2.2.2][134] (2020-11-29)

- **changelog:** changelog now includes relevant build-type commits
  ([d630264][135])

## [2.2.1][136] (2020-11-29)

- **changelog:** changelog now includes relevant reverts ([d4ccacb][137])

# [2.2.0][138] (2020-11-29)

- install @semantic-release/exec ([cc94940][139])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][140])
- **config:** fix husky pre-commit hook ([f0d0032][141])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][142])
- **config:** retire @semantic-release/changelog ([787a281][143])
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][145])
- **config:** fix broken changelog.config.js structure ([bd10f44][146])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][147])
- **package.json:** install lint-staged dep and script ([f3800e4][148])
- **package.json:** install spellcheck dependencies ([9a7adb4][149])
- **spellcheck:** change "contains" to "includes" ([af76dbe][150])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][151])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][152])

### Features

- add build-changelog to npm scripts ([8393a87][153])

## [2.1.4][154] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][155])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][156])

## [2.1.3][157] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][158])

## [2.1.2][159] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][160])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][161])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][162])

## [2.1.1][163] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][164])

# [2.1.0][165] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][166])
- **actions:** if statements now use | instead of > ([24e3739][167])
- **actions:** move comments out of multiline statements ([874f8d6][168])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][172])
- add build commits to release rule ([3124ab0][173])

# [2.0.0][174] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][175])
- **actions:** deps caching done properly ([bbe0416][176])
- **actions:** ensure repo is always checked out first ([65e5d46][177])
- **actions:** removed signed pushes ([f621f76][178])
- **package.json:** do not guess error codes ([f5428c8][179])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][180])
...
- added diff to take the difference ([5e40deb][183])

### Performance Improvements

- **actions:** better caching ([6da0a65][184])
- **actions:** made test-integration-chrome independent ([d489cfa][185])
- **actions:** only cache node_modules ([57775c9][186])
...
- Version 1.0.15 ([57faa2c][187])

<!---->

- Version 1.0.7 ([5ced626][188])

- Version 1.0.0 ([df91d82][189])
...
[122]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[123]:
...
[125]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[126]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[127]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[128]:
...
[131]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[132]:
...
[134]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[135]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[136]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[137]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[138]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[139]:
...
[154]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[155]:
...
[157]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[158]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[159]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[160]:
...
[163]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[164]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[165]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[166]:
...
[170]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[171]:
...
[174]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[175]:
