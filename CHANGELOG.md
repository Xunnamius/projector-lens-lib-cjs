...
The format is based on [Conventional Commits][224], and this project adheres to
[Semantic Versioning][225].

# [7.3.0][226] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][227])

### Build System

- **package.json:** better lint output ([0dc7c4e][228])

### Features

- **.github:** backport env matrix hint ([c01b325][229])
- **readme.md:** add NPM7 warning ([24f0888][230])

## [7.2.3][1] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][2])

## [7.2.2][3] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][4])

## [7.2.1][5] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][6])

# [7.2.0][7] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][8])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][9])
- **workflows:** fix should-skip determination algo ([f7d1256][10])

# [7.1.0][11] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][12])
- **readme.md:** complete skip test ([67264ed][13])
- **workflows:** replace should-skip determination algo ([cd6236a][14])

# [7.0.0][15] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][16])
...
- **.changelogrc.js:** show reverts in changelog ([ec26302][18])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][19])

## [6.7.2][20] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][21])
- _"debug(readme.md): debug debug"_ ([aff005d][22])

## [6.7.1][23] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][24])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][25])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][26])

### Build System

- **package.json:** better build-changelog ([f2e971e][27])

# [6.7.0][28] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][29])

# [6.6.0][30] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][31])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][32])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][33])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][34])
- **release.config.js:** use imported releaseRules ([2fe163c][35])

## [6.5.1][36] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][37])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][38])

# [6.5.0][39] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][40])
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][43])
- **package.json:** remove deploy test script ([4fb641c][44])

## [6.4.2][45] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][46])

## [6.4.1][47] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support ([de7ef33][48])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][49])
...
- **package.json:** vercel deploy test ([ed73fc3][52])
...
- **.github/workflows/cleanup.yml:** fix metadata gathering step ([44dd462][56])

## [6.3.6][57] (2021-01-01)

### Build System

- **.github/workflows/cleanup.yml:** add metadata filtering step ([6667075][58])

## [6.3.5][59] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][60])

## [6.3.4][61] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][62])
- Update remark linting to exit 1 on error, quiet on success ([077abce][63])
- Update sort-package-json to contrib-env-expect ([6885a34][64])
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][68])

## [6.3.2][69] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][70])

## [6.3.1][71] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][72])

# [6.3.0][73] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][74])

### Features

- **src:** add div function ([636c353][75])
...
- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][77])
- **.husky:** remove verbose flag ([538c374][78])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][79])
- **package.json:** remove debug echo ([33a510d][80])
- **release.config.js:** fix to use gfm ([db4c284][81])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][82])

## [6.1.7][83] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][84])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][85])
...
- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][91])

## [6.1.3][92] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][93])
- **build-test-deploy.yml:** fix syntax error ([5448960][94])

## [6.1.2][95] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][96])
- **package.json:** remove high audit CI failure ([b2ea6f1][97])
- **package.json:** test high audit CI failure ([03825f0][98])

## [6.1.1][99] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][100])

# [6.1.0][101] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][102])

### Features

- **readme.md:** dummy feat ([f90dde3][103])

## [6.0.5][104] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][105])

## [6.0.4][106] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][107])

## [6.0.3][108] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][109])
- **.github:** fix cleanup ([7520e0f][110])

## [6.0.2][111] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][112])
- **release.config.js:** remove console.info ([b374296][113])

## [6.0.1][114] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][115])

# [6.0.0][116] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][117])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][118] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][120])

## [5.0.2][121] (2020-12-29)
...
## [5.0.1][123] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][124])
- **package.json:** add codecov package ([d73cac9][125])
- **package.json:** remove codecov package ([da477b7][126])

# [5.0.0][127] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][128])
...
- Update comment language ([5a2aef4][131])
...
## [3.0.1][132] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][133])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][134])

### Build System

- **package.json:** update deps ([a876517][135])

# [3.0.0][136] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][137])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][138])
- **package.json:** use @xunnamius/semantic-release ([0447d59][139])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][140])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][141])
- **package-lock.json:** fix syntax error ([4fd2952][142])
...
- Added mult function ([e537358][144])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][145])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][146])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][147])
...
## [2.3.4][148] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][149])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][150])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][151])
- Added .env.example and env-expect ([efb29c5][152])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][153])

## [2.3.3][154] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][156])

## [2.3.2][157] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][158])

## [2.3.1][159] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][160])
- **release:** fix changelogTitle bug ([0d181ea][161])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][162])

# [2.3.0][163] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][164])

### Performance Improvements

- Better faster spellchecking ([c44c310][165])

## [2.2.2][166] (2020-11-29)
...
## [2.2.1][168] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][169])

# [2.2.0][170] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][172])
- **config:** fix broken changelog.config.js structure ([bd10f44][173])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][174])
- **package.json:** install lint-staged dep and script ([f3800e4][175])
- **package.json:** install spellcheck dependencies ([9a7adb4][176])
- **spellcheck:** change "contains" to "includes" ([af76dbe][177])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][178])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][179])

### Build System

- Install @semantic-release/exec ([cc94940][180])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][181])
- **config:** fix husky pre-commit hook ([f0d0032][182])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][183])
- **config:** retire @semantic-release/changelog ([787a281][184])

### Features

- Add build-changelog to npm scripts ([8393a87][185])

## [2.1.4][186] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][187])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][188])

## [2.1.3][189] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][190])

## [2.1.2][191] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][192])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][193])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][194])

## [2.1.1][195] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][196])

# [2.1.0][197] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][198])
- **actions:** if statements now use | instead of > ([24e3739][199])
- **actions:** move comments out of multiline statements ([874f8d6][200])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][204])
- Add build commits to release rule ([3124ab0][205])

# [2.0.0][206] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][207])
- **actions:** deps caching done properly ([bbe0416][208])
- **actions:** ensure repo is always checked out first ([65e5d46][209])
- **actions:** removed signed pushes ([f621f76][210])
- **package.json:** do not guess error codes ([f5428c8][211])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][212])
...
- Added diff to take the difference ([5e40deb][215])

### Performance Improvements

- **actions:** better caching ([6da0a65][216])
- **actions:** made test-integration-chrome independent ([d489cfa][217])
- **actions:** only cache node_modules ([57775c9][218])

### Reverts

- _"debug: added debug step"_ ([1741cde][219])
- _"debug: debug cache miss"_ ([42af347][220])
...
- Version 1.0.15 ([57faa2c][221])

<!---->

- Version 1.0.7 ([5ced626][222])

- Version 1.0.0 ([df91d82][223])

[1]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.2...v7.2.3
[2]:
  https://github.com/Xunnamius/workflow-playground/commit/786942001834cb5337fabf921cbc14ea4cc04d2f
[3]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.1...v7.2.2
[4]:
  https://github.com/Xunnamius/workflow-playground/commit/a8cd37812dc9e304bf813c742b2d4d54c1c9c183
[5]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.0...v7.2.1
[6]:
  https://github.com/Xunnamius/workflow-playground/commit/73edb9a864bbc4b7d5a7eb1d03ca4ce3b8e02e95
[7]: https://github.com/Xunnamius/workflow-playground/compare/v7.1.0...v7.2.0
[8]:
...
[11]: https://github.com/Xunnamius/workflow-playground/compare/v7.0.0...v7.1.0
[12]:
...
[15]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.3...v7.0.0
[16]:
  https://github.com/Xunnamius/workflow-playground/commit/5765c024e82c3e7e0c77808e3860c85fb8c8d759
[17]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.2...v6.7.3
[18]:
...
[20]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.1...v6.7.2
[21]:
...
[23]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.0...v6.7.1
[24]:
...
[28]: https://github.com/Xunnamius/workflow-playground/compare/v6.6.0...v6.7.0
[29]:
  https://github.com/Xunnamius/workflow-playground/commit/1fdcb9c6c500f88fbc2b7b6ec7f427f0a4995080
[30]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.1...v6.6.0
[31]:
...
[36]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.0...v6.5.1
[37]:
...
[39]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.3...v6.5.0
[40]:
  https://github.com/Xunnamius/workflow-playground/commit/54488d92317360c2e358bca9238e60e2daca64dd
[41]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[42]:
...
[45]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[46]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[47]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[48]:
...
[66]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[67]:
...
[69]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[70]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[71]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[72]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[73]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[74]:
...
[76]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[77]:
...
[83]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[84]:
...
[86]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[87]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[88]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[89]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[90]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[91]:
  https://github.com/Xunnamius/workflow-playground/commit/44f5cd4c3c6adeb548ba89adba8e884336f41520
[92]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[93]:
...
[95]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[96]:
...
[99]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[100]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[101]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[102]:
...
[104]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[105]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[106]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[107]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[108]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[109]:
...
[111]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[112]:
...
[114]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.0...v6.0.1
[115]:
  https://github.com/Xunnamius/workflow-playground/commit/d40192bd13d9b301e09723cdca68be60b44b5d82
[116]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.3...v6.0.0
[117]:
  https://github.com/Xunnamius/workflow-playground/commit/95a13d21dd902a490d445d3c8aee89c59b2131f1
[118]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.2...v5.0.3
[119]:
...
[121]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.1...v5.0.2
[122]:
  https://github.com/Xunnamius/workflow-playground/commit/e62c5b42ca2b43326cc9eec8db248020b2d90ec8
[123]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.0...v5.0.1
[124]:
...
[127]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[128]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[129]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[130]:
...
[132]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[133]:
...
[136]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[137]:
...
[148]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[149]:
...
[154]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[155]:
...
[157]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[158]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[159]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[160]:
...
[163]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[164]:
...
[166]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[167]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[168]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[169]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[170]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[171]:
...
[186]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[187]:
...
[189]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[190]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[191]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[192]:
...
[195]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[196]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[197]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[198]:
...
[202]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[203]:
...
[206]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[207]:
...
[224]: https://conventionalcommits.org
[225]: https://semver.org
[226]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.3...v7.3.0
[227]:
