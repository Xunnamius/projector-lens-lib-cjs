...
The format is based on [Conventional Commits][264], and this project adheres to
[Semantic Versioning][265].

## [7.5.6][266] (2021-01-06)
...
- **package.json:** backported updates ([8a051d1][6])

## [7.5.2][7] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][8])

## [7.5.1][9] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][10])
- **package.json:** return browser test ([6c1c4d4][11])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][12])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][13])
- **package.json:** backports from the wild ([eda277e][14])
- **webpack.config.js:** add env-expect ([0f401ff][15])

# [7.5.0][16] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][17])
...
- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][21])
...
- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][23])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][24])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][25])
...
- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][28])
- **package.json:** revert "test: peer dep install" ([4c174fe][29])
- **package.json:** test: peer dep install ([6c00005][30])
...
- **.github:** add codecov to externals; add flags to codecov ([e47160b][35])

# [7.3.0][36] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][37])

### Build System

- **package.json:** better lint output ([0dc7c4e][38])

### Features

- **.github:** backport env matrix hint ([c01b325][39])
- **readme.md:** add NPM7 warning ([24f0888][40])

## [7.2.3][41] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][42])

## [7.2.2][43] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][44])

## [7.2.1][45] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][46])

# [7.2.0][47] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][48])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][49])
- **workflows:** fix should-skip determination algo ([f7d1256][50])

# [7.1.0][51] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][52])
- **readme.md:** complete skip test ([67264ed][53])
- **workflows:** replace should-skip determination algo ([cd6236a][54])

# [7.0.0][55] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][56])
...
- **.changelogrc.js:** show reverts in changelog ([ec26302][58])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][59])

## [6.7.2][60] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][61])
- _"debug(readme.md): debug debug"_ ([aff005d][62])

## [6.7.1][63] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][64])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][65])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][66])

### Build System

- **package.json:** better build-changelog ([f2e971e][67])

# [6.7.0][68] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][69])

# [6.6.0][70] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][71])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][72])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][73])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][74])
- **release.config.js:** use imported releaseRules ([2fe163c][75])

## [6.5.1][76] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][77])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][78])

# [6.5.0][79] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][80])
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][83])
- **package.json:** remove deploy test script ([4fb641c][84])

## [6.4.2][85] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][86])

## [6.4.1][87] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support ([de7ef33][88])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][89])
...
- **package.json:** vercel deploy test ([ed73fc3][92])
...
- **.github/workflows/cleanup.yml:** fix metadata gathering step ([44dd462][96])

## [6.3.6][97] (2021-01-01)

### Build System

- **.github/workflows/cleanup.yml:** add metadata filtering step ([6667075][98])

## [6.3.5][99] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][100])

## [6.3.4][101] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][102])
- Update remark linting to exit 1 on error, quiet on success ([077abce][103])
- Update sort-package-json to contrib-env-expect ([6885a34][104])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][105])

## [6.3.3][106] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][108])

## [6.3.2][109] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][110])

## [6.3.1][111] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][112])

# [6.3.0][113] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][114])

### Features

- **src:** add div function ([636c353][115])

# [6.2.0][116] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][117])
- **.husky:** remove verbose flag ([538c374][118])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][119])
- **package.json:** remove debug echo ([33a510d][120])
- **release.config.js:** fix to use gfm ([db4c284][121])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][122])

## [6.1.7][123] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][124])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][125])

## [6.1.6][126] (2020-12-30)
...
## [6.1.4][130] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][131])

## [6.1.3][132] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][133])
- **build-test-deploy.yml:** fix syntax error ([5448960][134])

## [6.1.2][135] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][136])
- **package.json:** remove high audit CI failure ([b2ea6f1][137])
- **package.json:** test high audit CI failure ([03825f0][138])

## [6.1.1][139] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][140])

# [6.1.0][141] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][142])

### Features

- **readme.md:** dummy feat ([f90dde3][143])

## [6.0.5][144] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][145])

## [6.0.4][146] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][147])

## [6.0.3][148] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][149])
- **.github:** fix cleanup ([7520e0f][150])

## [6.0.2][151] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][152])
- **release.config.js:** remove console.info ([b374296][153])

## [6.0.1][154] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][155])

# [6.0.0][156] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][157])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][158] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][160])

## [5.0.2][161] (2020-12-29)
...
## [5.0.1][163] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][164])
- **package.json:** add codecov package ([d73cac9][165])
- **package.json:** remove codecov package ([da477b7][166])

# [5.0.0][167] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][168])
...
- Update comment language ([5a2aef4][171])
...
## [3.0.1][172] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][173])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][174])

### Build System

- **package.json:** update deps ([a876517][175])

# [3.0.0][176] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][177])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][178])
- **package.json:** use @xunnamius/semantic-release ([0447d59][179])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][180])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][181])
- **package-lock.json:** fix syntax error ([4fd2952][182])
...
- Added mult function ([e537358][184])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][185])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][186])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][187])
...
## [2.3.4][188] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][189])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][190])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][191])
- Added .env.example and env-expect ([efb29c5][192])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][193])

## [2.3.3][194] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][196])

## [2.3.2][197] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][198])

## [2.3.1][199] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][200])
- **release:** fix changelogTitle bug ([0d181ea][201])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][202])

# [2.3.0][203] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][204])

### Performance Improvements

- Better faster spellchecking ([c44c310][205])

## [2.2.2][206] (2020-11-29)
...
## [2.2.1][208] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][209])

# [2.2.0][210] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][212])
- **config:** fix broken changelog.config.js structure ([bd10f44][213])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][214])
- **package.json:** install lint-staged dep and script ([f3800e4][215])
- **package.json:** install spellcheck dependencies ([9a7adb4][216])
- **spellcheck:** change "contains" to "includes" ([af76dbe][217])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][218])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][219])

### Build System

- Install @semantic-release/exec ([cc94940][220])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][221])
- **config:** fix husky pre-commit hook ([f0d0032][222])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][223])
- **config:** retire @semantic-release/changelog ([787a281][224])

### Features

- Add build-changelog to npm scripts ([8393a87][225])

## [2.1.4][226] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][227])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][228])

## [2.1.3][229] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][230])

## [2.1.2][231] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][232])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][233])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][234])

## [2.1.1][235] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][236])

# [2.1.0][237] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][238])
- **actions:** if statements now use | instead of > ([24e3739][239])
- **actions:** move comments out of multiline statements ([874f8d6][240])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][244])
- Add build commits to release rule ([3124ab0][245])

# [2.0.0][246] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][247])
- **actions:** deps caching done properly ([bbe0416][248])
- **actions:** ensure repo is always checked out first ([65e5d46][249])
- **actions:** removed signed pushes ([f621f76][250])
- **package.json:** do not guess error codes ([f5428c8][251])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][252])
...
- Added diff to take the difference ([5e40deb][255])

### Performance Improvements

- **actions:** better caching ([6da0a65][256])
- **actions:** made test-integration-chrome independent ([d489cfa][257])
- **actions:** only cache node_modules ([57775c9][258])

### Reverts

- _"debug: added debug step"_ ([1741cde][259])
- _"debug: debug cache miss"_ ([42af347][260])
...
- Version 1.0.15 ([57faa2c][261])

<!---->

- Version 1.0.7 ([5ced626][262])

- Version 1.0.0 ([df91d82][263])

[1]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.4...v7.5.5
[2]:
  https://github.com/Xunnamius/workflow-playground/commit/7212561b4cf094f47169b7b38e9ae4a9550e569b
[3]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.3...v7.5.4
[4]:
  https://github.com/Xunnamius/workflow-playground/commit/ed31f79e0ebe97823e2a62b9e6aa7b3e2355ff7c
[5]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.2...v7.5.3
[6]:
  https://github.com/Xunnamius/workflow-playground/commit/8a051d1222ed6df2d1c9e1f2e2eb890d763a6333
[7]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.1...v7.5.2
[8]:
  https://github.com/Xunnamius/workflow-playground/commit/2cf6e46a6fe59b8a47123f2215ba8caf7976ad87
[9]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.0...v7.5.1
[10]:
...
[16]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.5...v7.5.0
[17]:
  https://github.com/Xunnamius/workflow-playground/commit/77c033ff143dff64455049b8314cd528bae4e198
[18]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.4...v7.4.5
[19]:
  https://github.com/Xunnamius/workflow-playground/commit/677b4cedff4d3e4541736e612035d909a0df6131
[20]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.3...v7.4.4
[21]:
  https://github.com/Xunnamius/workflow-playground/commit/5c8fefa330e31620fe2af848d42eb2c5ab881d02
[22]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.2...v7.4.3
[23]:
...
[27]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.1...v7.4.2
[28]:
...
[31]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.0...v7.4.1
[32]:
...
[34]: https://github.com/Xunnamius/workflow-playground/compare/v7.3.0...v7.4.0
[35]:
  https://github.com/Xunnamius/workflow-playground/commit/e47160b09b956e69f0d9eb0cab01a3440bb66645
[36]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.3...v7.3.0
[37]:
...
[41]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.2...v7.2.3
[42]:
  https://github.com/Xunnamius/workflow-playground/commit/786942001834cb5337fabf921cbc14ea4cc04d2f
[43]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.1...v7.2.2
[44]:
  https://github.com/Xunnamius/workflow-playground/commit/a8cd37812dc9e304bf813c742b2d4d54c1c9c183
[45]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.0...v7.2.1
[46]:
  https://github.com/Xunnamius/workflow-playground/commit/73edb9a864bbc4b7d5a7eb1d03ca4ce3b8e02e95
[47]: https://github.com/Xunnamius/workflow-playground/compare/v7.1.0...v7.2.0
[48]:
...
[51]: https://github.com/Xunnamius/workflow-playground/compare/v7.0.0...v7.1.0
[52]:
...
[55]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.3...v7.0.0
[56]:
  https://github.com/Xunnamius/workflow-playground/commit/5765c024e82c3e7e0c77808e3860c85fb8c8d759
[57]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.2...v6.7.3
[58]:
...
[60]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.1...v6.7.2
[61]:
...
[63]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.0...v6.7.1
[64]:
...
[68]: https://github.com/Xunnamius/workflow-playground/compare/v6.6.0...v6.7.0
[69]:
  https://github.com/Xunnamius/workflow-playground/commit/1fdcb9c6c500f88fbc2b7b6ec7f427f0a4995080
[70]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.1...v6.6.0
[71]:
...
[76]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.0...v6.5.1
[77]:
...
[79]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.3...v6.5.0
[80]:
  https://github.com/Xunnamius/workflow-playground/commit/54488d92317360c2e358bca9238e60e2daca64dd
[81]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[82]:
...
[85]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[86]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[87]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[88]:
...
[106]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[107]:
...
[109]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[110]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[111]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[112]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[113]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[114]:
...
[116]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[117]:
...
[123]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[124]:
...
[126]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[127]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[128]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[129]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[130]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[131]:
  https://github.com/Xunnamius/workflow-playground/commit/44f5cd4c3c6adeb548ba89adba8e884336f41520
[132]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[133]:
...
[135]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[136]:
...
[139]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[140]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[141]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[142]:
...
[144]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[145]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[146]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[147]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[148]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[149]:
...
[151]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[152]:
...
[154]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.0...v6.0.1
[155]:
  https://github.com/Xunnamius/workflow-playground/commit/d40192bd13d9b301e09723cdca68be60b44b5d82
[156]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.3...v6.0.0
[157]:
  https://github.com/Xunnamius/workflow-playground/commit/95a13d21dd902a490d445d3c8aee89c59b2131f1
[158]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.2...v5.0.3
[159]:
...
[161]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.1...v5.0.2
[162]:
  https://github.com/Xunnamius/workflow-playground/commit/e62c5b42ca2b43326cc9eec8db248020b2d90ec8
[163]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.0...v5.0.1
[164]:
...
[167]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[168]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[169]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[170]:
...
[172]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[173]:
...
[176]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[177]:
...
[188]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[189]:
...
[194]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[195]:
...
[197]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[198]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[199]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[200]:
...
[203]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[204]:
...
[206]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[207]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[208]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[209]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[210]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[211]:
...
[226]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[227]:
...
[229]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[230]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[231]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[232]:
...
[235]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[236]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[237]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[238]:
...
[242]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[243]:
...
[246]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[247]:
...
[264]: https://conventionalcommits.org
[265]: https://semver.org
[266]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.5...v7.5.6
[267]:
