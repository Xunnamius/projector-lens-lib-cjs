...
The format is based on [Conventional Commits][283], and this project adheres to
[Semantic Versioning][284].

## [7.5.15][285] (2021-01-23)

### Build System

- Backport/normalize across packages ([85881f7][286])

## [7.5.14][1] (2021-01-22)

### Build System

- Update debug statement syntax ([107b953][2])
...
- Backport changes from gac ([172fa77][6])

## [7.5.11][7] (2021-01-12)

### Build System

- Rebuild lockfile ([fef7222][8])
- Update babel-plugin-transform-mjs-imports ([16a597d][9])

## [7.5.10][10] (2021-01-12)

### Build System

- Update -browser to -client everywhere ([597d6c5][11])

## [7.5.9][12] (2021-01-10)

### Bug Fixes

- **webpack.config.js:** better process.env support ([25db498][13])

## [7.5.8][14] (2021-01-06)

### Build System

- **webpack.config.js:** process.env shim ([3973279][15])
...
- **package.json:** backported updates ([8a051d1][25])

## [7.5.2][26] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][27])

## [7.5.1][28] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][29])
- **package.json:** return browser test ([6c1c4d4][30])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][31])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][32])
- **package.json:** backports from the wild ([eda277e][33])
- **webpack.config.js:** add env-expect ([0f401ff][34])

# [7.5.0][35] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][36])
...
- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][40])
...
- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][42])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][43])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][44])
...
- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][47])
- **package.json:** revert "test: peer dep install" ([4c174fe][48])
- **package.json:** test: peer dep install ([6c00005][49])
...
- **.github:** add codecov to externals; add flags to codecov ([e47160b][54])

# [7.3.0][55] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][56])

### Build System

- **package.json:** better lint output ([0dc7c4e][57])

### Features

- **.github:** backport env matrix hint ([c01b325][58])
- **readme.md:** add NPM7 warning ([24f0888][59])

## [7.2.3][60] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][61])

## [7.2.2][62] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][63])

## [7.2.1][64] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][65])

# [7.2.0][66] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][67])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][68])
- **workflows:** fix should-skip determination algo ([f7d1256][69])

# [7.1.0][70] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][71])
- **readme.md:** complete skip test ([67264ed][72])
- **workflows:** replace should-skip determination algo ([cd6236a][73])

# [7.0.0][74] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][75])
...
- **.changelogrc.js:** show reverts in changelog ([ec26302][77])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][78])

## [6.7.2][79] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][80])
- _"debug(readme.md): debug debug"_ ([aff005d][81])

## [6.7.1][82] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][83])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][84])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][85])

### Build System

- **package.json:** better build-changelog ([f2e971e][86])

# [6.7.0][87] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][88])

# [6.6.0][89] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][90])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][91])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][92])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][93])
- **release.config.js:** use imported releaseRules ([2fe163c][94])

## [6.5.1][95] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][96])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][97])

# [6.5.0][98] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][99])

## [6.4.3][100] (2021-01-02)
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][102])
- **package.json:** remove deploy test script ([4fb641c][103])

## [6.4.2][104] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][105])

## [6.4.1][106] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support
  ([de7ef33][107])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][108])
- **release.config.js:** fix deploy to run at success step; add debug output
  ([b9e8cc5][109])

# [6.4.0][110] (2021-01-02)

### Features

- **package.json:** vercel deploy test ([ed73fc3][111])

## [6.3.8][112] (2021-01-02)
...
## [6.3.5][118] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][119])

## [6.3.4][120] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][121])
- Update remark linting to exit 1 on error, quiet on success ([077abce][122])
- Update sort-package-json to contrib-env-expect ([6885a34][123])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][124])

## [6.3.3][125] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][127])

## [6.3.2][128] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][129])

## [6.3.1][130] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][131])

# [6.3.0][132] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][133])

### Features

- **src:** add div function ([636c353][134])

# [6.2.0][135] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][136])
- **.husky:** remove verbose flag ([538c374][137])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][138])
- **package.json:** remove debug echo ([33a510d][139])
- **release.config.js:** fix to use gfm ([db4c284][140])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][141])

## [6.1.7][142] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][143])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][144])

## [6.1.6][145] (2020-12-30)
...
## [6.1.4][149] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][150])

## [6.1.3][151] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][152])
- **build-test-deploy.yml:** fix syntax error ([5448960][153])

## [6.1.2][154] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][155])
- **package.json:** remove high audit CI failure ([b2ea6f1][156])
- **package.json:** test high audit CI failure ([03825f0][157])

## [6.1.1][158] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][159])

# [6.1.0][160] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][161])

### Features

- **readme.md:** dummy feat ([f90dde3][162])

## [6.0.5][163] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][164])

## [6.0.4][165] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][166])

## [6.0.3][167] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][168])
- **.github:** fix cleanup ([7520e0f][169])

## [6.0.2][170] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][171])
- **release.config.js:** remove console.info ([b374296][172])

## [6.0.1][173] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][174])

# [6.0.0][175] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][176])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][177] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][179])

## [5.0.2][180] (2020-12-29)
...
## [5.0.1][182] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][183])
- **package.json:** add codecov package ([d73cac9][184])
- **package.json:** remove codecov package ([da477b7][185])

# [5.0.0][186] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][187])
...
- Update comment language ([5a2aef4][190])
...
## [3.0.1][191] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][192])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][193])

### Build System

- **package.json:** update deps ([a876517][194])

# [3.0.0][195] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][196])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][197])
- **package.json:** use @xunnamius/semantic-release ([0447d59][198])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][199])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][200])
- **package-lock.json:** fix syntax error ([4fd2952][201])
...
- Added mult function ([e537358][203])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][204])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][205])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][206])
...
## [2.3.4][207] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][208])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][209])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][210])
- Added .env.example and env-expect ([efb29c5][211])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][212])

## [2.3.3][213] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][215])

## [2.3.2][216] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][217])

## [2.3.1][218] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][219])
- **release:** fix changelogTitle bug ([0d181ea][220])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][221])

# [2.3.0][222] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][223])

### Performance Improvements

- Better faster spellchecking ([c44c310][224])

## [2.2.2][225] (2020-11-29)
...
## [2.2.1][227] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][228])

# [2.2.0][229] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][231])
- **config:** fix broken changelog.config.js structure ([bd10f44][232])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][233])
- **package.json:** install lint-staged dep and script ([f3800e4][234])
- **package.json:** install spellcheck dependencies ([9a7adb4][235])
- **spellcheck:** change "contains" to "includes" ([af76dbe][236])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][237])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][238])

### Build System

- Install @semantic-release/exec ([cc94940][239])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][240])
- **config:** fix husky pre-commit hook ([f0d0032][241])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][242])
- **config:** retire @semantic-release/changelog ([787a281][243])

### Features

- Add build-changelog to npm scripts ([8393a87][244])

## [2.1.4][245] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][246])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][247])

## [2.1.3][248] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][249])

## [2.1.2][250] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][251])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][252])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][253])

## [2.1.1][254] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][255])

# [2.1.0][256] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][257])
- **actions:** if statements now use | instead of > ([24e3739][258])
- **actions:** move comments out of multiline statements ([874f8d6][259])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][263])
- Add build commits to release rule ([3124ab0][264])

# [2.0.0][265] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][266])
- **actions:** deps caching done properly ([bbe0416][267])
- **actions:** ensure repo is always checked out first ([65e5d46][268])
- **actions:** removed signed pushes ([f621f76][269])
- **package.json:** do not guess error codes ([f5428c8][270])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][271])
...
- Added diff to take the difference ([5e40deb][274])

### Performance Improvements

- **actions:** better caching ([6da0a65][275])
- **actions:** made test-integration-chrome independent ([d489cfa][276])
- **actions:** only cache node_modules ([57775c9][277])

### Reverts

- _"debug: added debug step"_ ([1741cde][278])
- _"debug: debug cache miss"_ ([42af347][279])
...
- Version 1.0.15 ([57faa2c][280])

<!---->

- Version 1.0.7 ([5ced626][281])

- Version 1.0.0 ([df91d82][282])

[1]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.13...v7.5.14
[2]:
  https://github.com/Xunnamius/workflow-playground/commit/107b953b834fb54bb2ee1c418d5bb8119fabe3ac
[3]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.12...v7.5.13
[4]:
  https://github.com/Xunnamius/workflow-playground/commit/2dce9c47d069b05df41481678a967dccc4637ead
[5]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.11...v7.5.12
[6]:
  https://github.com/Xunnamius/workflow-playground/commit/172fa775e677fe977d2b8265460ec192818b1996
[7]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.10...v7.5.11
[8]:
...
[35]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.5...v7.5.0
[36]:
  https://github.com/Xunnamius/workflow-playground/commit/77c033ff143dff64455049b8314cd528bae4e198
[37]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.4...v7.4.5
[38]:
  https://github.com/Xunnamius/workflow-playground/commit/677b4cedff4d3e4541736e612035d909a0df6131
[39]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.3...v7.4.4
[40]:
  https://github.com/Xunnamius/workflow-playground/commit/5c8fefa330e31620fe2af848d42eb2c5ab881d02
[41]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.2...v7.4.3
[42]:
...
[46]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.1...v7.4.2
[47]:
...
[50]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.0...v7.4.1
[51]:
...
[53]: https://github.com/Xunnamius/workflow-playground/compare/v7.3.0...v7.4.0
[54]:
  https://github.com/Xunnamius/workflow-playground/commit/e47160b09b956e69f0d9eb0cab01a3440bb66645
[55]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.3...v7.3.0
[56]:
...
[60]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.2...v7.2.3
[61]:
  https://github.com/Xunnamius/workflow-playground/commit/786942001834cb5337fabf921cbc14ea4cc04d2f
[62]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.1...v7.2.2
[63]:
  https://github.com/Xunnamius/workflow-playground/commit/a8cd37812dc9e304bf813c742b2d4d54c1c9c183
[64]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.0...v7.2.1
[65]:
  https://github.com/Xunnamius/workflow-playground/commit/73edb9a864bbc4b7d5a7eb1d03ca4ce3b8e02e95
[66]: https://github.com/Xunnamius/workflow-playground/compare/v7.1.0...v7.2.0
[67]:
...
[70]: https://github.com/Xunnamius/workflow-playground/compare/v7.0.0...v7.1.0
[71]:
...
[74]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.3...v7.0.0
[75]:
  https://github.com/Xunnamius/workflow-playground/commit/5765c024e82c3e7e0c77808e3860c85fb8c8d759
[76]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.2...v6.7.3
[77]:
...
[79]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.1...v6.7.2
[80]:
...
[82]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.0...v6.7.1
[83]:
...
[87]: https://github.com/Xunnamius/workflow-playground/compare/v6.6.0...v6.7.0
[88]:
  https://github.com/Xunnamius/workflow-playground/commit/1fdcb9c6c500f88fbc2b7b6ec7f427f0a4995080
[89]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.1...v6.6.0
[90]:
...
[95]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.0...v6.5.1
[96]:
...
[98]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.3...v6.5.0
[99]:
  https://github.com/Xunnamius/workflow-playground/commit/54488d92317360c2e358bca9238e60e2daca64dd
[100]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[101]:
...
[104]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[105]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[106]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[107]:
...
[125]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[126]:
...
[128]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[129]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[130]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[131]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[132]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[133]:
...
[135]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[136]:
...
[142]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[143]:
...
[145]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[146]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[147]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[148]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[149]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[150]:
  https://github.com/Xunnamius/workflow-playground/commit/44f5cd4c3c6adeb548ba89adba8e884336f41520
[151]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[152]:
...
[154]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[155]:
...
[158]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[159]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[160]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[161]:
...
[163]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[164]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[165]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[166]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[167]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[168]:
...
[170]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[171]:
...
[173]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.0...v6.0.1
[174]:
  https://github.com/Xunnamius/workflow-playground/commit/d40192bd13d9b301e09723cdca68be60b44b5d82
[175]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.3...v6.0.0
[176]:
  https://github.com/Xunnamius/workflow-playground/commit/95a13d21dd902a490d445d3c8aee89c59b2131f1
[177]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.2...v5.0.3
[178]:
...
[180]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.1...v5.0.2
[181]:
  https://github.com/Xunnamius/workflow-playground/commit/e62c5b42ca2b43326cc9eec8db248020b2d90ec8
[182]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.0...v5.0.1
[183]:
...
[186]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[187]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[188]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[189]:
...
[191]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[192]:
...
[195]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[196]:
...
[207]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[208]:
...
[213]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[214]:
...
[216]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[217]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[218]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[219]:
...
[222]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[223]:
...
[225]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[226]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[227]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[228]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[229]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[230]:
...
[245]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[246]:
...
[248]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[249]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[250]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[251]:
...
[254]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[255]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[256]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[257]:
...
[261]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[262]:
...
[265]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[266]:
...
[283]: https://conventionalcommits.org
[284]: https://semver.org
[285]:
  https://github.com/Xunnamius/workflow-playground/compare/v7.5.14...v7.5.15
[286]:
