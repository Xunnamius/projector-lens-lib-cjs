...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][5])
- **package.json:** remove deploy test script ([4fb641c][6])

## [6.4.2][7] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][8])

## [6.4.1][9] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support ([de7ef33][10])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][11])
...
- **package.json:** vercel deploy test ([ed73fc3][14])
...
- **.github/workflows/cleanup.yml:** fix metadata gathering step ([44dd462][18])

## [6.3.6][19] (2021-01-01)

### Build System

- **.github/workflows/cleanup.yml:** add metadata filtering step ([6667075][20])

## [6.3.5][21] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][22])

## [6.3.4][23] (2021-01-01)

### Build System

- move npm lint step before lint-staged in husky hook ([e8bac90][24])
- update remark linting to exit 1 on error, quiet on success ([077abce][25])
- update sort-package-json to contrib-env-expect ([6885a34][26])
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][30])

## [6.3.2][31] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][32])

## [6.3.1][33] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][34])

# [6.3.0][35] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][36])

### Features

- **src:** add div function ([636c353][37])
...
- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][39])
- **.husky:** remove verbose flag ([538c374][40])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][41])
- **package.json:** remove debug echo ([33a510d][42])
- **release.config.js:** fix to use gfm ([db4c284][43])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][44])

## [6.1.7][45] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][46])
...
- **build-test-deploy.yml:** debug should warn ([55e1235][53])
- **build-test-deploy.yml:** fix syntax error ([5448960][54])

## [6.1.2][55] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][56])
- **package.json:** remove high audit CI failure ([b2ea6f1][57])
- **package.json:** test high audit CI failure ([03825f0][58])

## [6.1.1][59] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][60])
...
- **readme.md:** dummy feat ([f90dde3][62])

## 6.0.6-canary.1 (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][63])

## [6.0.5][64] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][65])

## [6.0.4][66] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][67])

## [6.0.3][68] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][69])
- **.github:** fix cleanup ([7520e0f][70])

## [6.0.2][71] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][72])
- **release.config.js:** remove console.info ([b374296][73])

## [6.0.1][74] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][75])

# [6.0.0][76] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][77])
...
- **.github:** add codecov-action to test-unit job ([2ef6297][83])
- **package.json:** add codecov package ([d73cac9][84])
- **package.json:** remove codecov package ([da477b7][85])

# [5.0.0][86] (2020-12-29)

### Chore

- fix capitalization of non-release commit types ([7391321][87])
...
- update comment language ([5a2aef4][90])
...
- **.github:** update ci committer name and email to xunn-bot ([b151491][92])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][93])

### Build System

- **package.json:** update deps ([a876517][94])
...
- **package-lock.json:** fix syntax error ([4fd2952][96])

# 3.0.0-canary.6 (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][97])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][98])
...
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][99])

# 3.0.0-canary.4 (2020-12-06)

### Build System

- **package.json:** add semver devdep ([4a50ecd][100])
...
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][102])
- **package.json:** use @xunnamius/semantic-release ([0447d59][103])
...
- added mult function ([e537358][104])
...
## [2.3.4][105] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][106])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][107])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][108])
- added .env.example and env-expect ([efb29c5][109])

## [2.3.3][110] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][112])

## [2.3.2][113] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][114])

## [2.3.1][115] (2020-11-30)

### Build System

- install @semantic-release/changelog ([022603b][116])
- **release:** fix changelogTitle bug ([0d181ea][117])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][118])

# [2.3.0][119] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][120])

### Performance Improvements

- better faster spellchecking ([c44c310][121])

## [2.2.2][122] (2020-11-29)
...
## [2.2.1][124] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][125])

# [2.2.0][126] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][128])
- **config:** fix broken changelog.config.js structure ([bd10f44][129])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][130])
- **package.json:** install lint-staged dep and script ([f3800e4][131])
- **package.json:** install spellcheck dependencies ([9a7adb4][132])
- **spellcheck:** change "contains" to "includes" ([af76dbe][133])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][134])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][135])

### Build System

- install @semantic-release/exec ([cc94940][136])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][137])
- **config:** fix husky pre-commit hook ([f0d0032][138])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][139])
- **config:** retire @semantic-release/changelog ([787a281][140])

### Features

- add build-changelog to npm scripts ([8393a87][141])

## [2.1.4][142] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][143])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][144])

## [2.1.3][145] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][146])

## [2.1.2][147] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][148])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][149])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][150])

## [2.1.1][151] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][152])

# [2.1.0][153] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][154])
- **actions:** if statements now use | instead of > ([24e3739][155])
- **actions:** move comments out of multiline statements ([874f8d6][156])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][160])
- add build commits to release rule ([3124ab0][161])

# [2.0.0][162] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][163])
- **actions:** deps caching done properly ([bbe0416][164])
- **actions:** ensure repo is always checked out first ([65e5d46][165])
- **actions:** removed signed pushes ([f621f76][166])
- **package.json:** do not guess error codes ([f5428c8][167])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][168])
...
- added diff to take the difference ([5e40deb][171])

### Performance Improvements

- **actions:** better caching ([6da0a65][172])
- **actions:** made test-integration-chrome independent ([d489cfa][173])
- **actions:** only cache node_modules ([57775c9][174])
...
- Version 1.0.15 ([57faa2c][175])

<!---->

- Version 1.0.7 ([5ced626][176])

- Version 1.0.0 ([df91d82][177])

[1]: https://conventionalcommits.org
[2]: https://semver.org
[3]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[4]:
...
[7]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[8]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[9]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[10]:
...
[28]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[29]:
...
[31]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[32]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[33]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[34]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[35]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[36]:
...
[38]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[39]:
...
[45]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[46]:
  https://github.com/Xunnamius/workflow-playground/commit/8a7fc06df25ffa5381bb5d771eb6e5a619fcbf64
[47]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[48]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[49]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[50]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[51]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[52]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[53]:
...
[55]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[56]:
...
[59]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[60]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[61]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[62]:
...
[64]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[65]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[66]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[67]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[68]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[69]:
...
[71]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[72]:
...
[86]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[87]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[88]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[89]:
...
[91]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[92]:
...
[95]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[96]:
...
[105]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[106]:
...
[110]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[111]:
...
[113]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[114]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[115]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[116]:
...
[119]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[120]:
...
[122]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[123]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[124]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[125]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[126]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[127]:
...
[142]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[143]:
...
[145]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[146]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[147]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[148]:
...
[151]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[152]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[153]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[154]:
...
[158]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[159]:
...
[162]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[163]:
