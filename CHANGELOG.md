...
- move npm lint step before lint-staged in husky hook ([e8bac90][4])
- update remark linting to exit 1 on error, quiet on success ([077abce][5])
- update sort-package-json to contrib-env-expect ([6885a34][6])
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][10])

## [6.3.2][11] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][12])

## [6.3.1][13] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][14])

# [6.3.0][15] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][16])

### Features

- **src:** add div function ([636c353][17])
...
- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][19])
- **.husky:** remove verbose flag ([538c374][20])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][21])
- **package.json:** remove debug echo ([33a510d][22])
- **release.config.js:** fix to use gfm ([db4c284][23])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][24])

## [6.1.7][25] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][26])
...
- **build-test-deploy.yml:** debug should warn ([55e1235][33])
- **build-test-deploy.yml:** fix syntax error ([5448960][34])

## [6.1.2][35] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][36])
- **package.json:** remove high audit CI failure ([b2ea6f1][37])
- **package.json:** test high audit CI failure ([03825f0][38])

## [6.1.1][39] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][40])
...
- **readme.md:** dummy feat ([f90dde3][42])

## 6.0.6-canary.1 (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][43])

## [6.0.5][44] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][45])

## [6.0.4][46] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][47])

## [6.0.3][48] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][49])
- **.github:** fix cleanup ([7520e0f][50])

## [6.0.2][51] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][52])
- **release.config.js:** remove console.info ([b374296][53])

## [6.0.1][54] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][55])

# [6.0.0][56] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][57])
...
- **.github:** add codecov-action to test-unit job ([2ef6297][63])
- **package.json:** add codecov package ([d73cac9][64])
- **package.json:** remove codecov package ([da477b7][65])

# [5.0.0][66] (2020-12-29)

### Chore

- fix capitalization of non-release commit types ([7391321][67])
...
- update comment language ([5a2aef4][70])
...
- **.github:** update ci committer name and email to xunn-bot ([b151491][72])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][73])

### Build System

- **package.json:** update deps ([a876517][74])
...
- **package-lock.json:** fix syntax error ([4fd2952][76])

# 3.0.0-canary.6 (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][77])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][78])
...
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][79])

# 3.0.0-canary.4 (2020-12-06)

### Build System

- **package.json:** add semver devdep ([4a50ecd][80])
...
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][82])
- **package.json:** use @xunnamius/semantic-release ([0447d59][83])
...
- added mult function ([e537358][84])
...
- **commitlint:** add debug type to type-enum ([10c71bf][86])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][87])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][88])
- added .env.example and env-expect ([efb29c5][89])
...
- **release:** fix changelogTitle skip title ([1dcdcc1][92])

## [2.3.2][93] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][94])

## [2.3.1][95] (2020-11-30)

### Build System

- install @semantic-release/changelog ([022603b][96])
- **release:** fix changelogTitle bug ([0d181ea][97])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][98])

# [2.3.0][99] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][100])

### Performance Improvements

- better faster spellchecking ([c44c310][101])

## [2.2.2][102] (2020-11-29)
...
## [2.2.1][104] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][105])

# [2.2.0][106] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][108])
- **config:** fix broken changelog.config.js structure ([bd10f44][109])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][110])
- **package.json:** install lint-staged dep and script ([f3800e4][111])
- **package.json:** install spellcheck dependencies ([9a7adb4][112])
- **spellcheck:** change "contains" to "includes" ([af76dbe][113])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][114])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][115])

### Build System

- install @semantic-release/exec ([cc94940][116])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][117])
- **config:** fix husky pre-commit hook ([f0d0032][118])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][119])
- **config:** retire @semantic-release/changelog ([787a281][120])

### Features

- add build-changelog to npm scripts ([8393a87][121])

## [2.1.4][122] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][123])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][124])

## [2.1.3][125] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][126])

## [2.1.2][127] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][128])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][129])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][130])

## [2.1.1][131] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][132])

# [2.1.0][133] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][134])
- **actions:** if statements now use | instead of > ([24e3739][135])
- **actions:** move comments out of multiline statements ([874f8d6][136])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][140])
- add build commits to release rule ([3124ab0][141])

# [2.0.0][142] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][143])
- **actions:** deps caching done properly ([bbe0416][144])
- **actions:** ensure repo is always checked out first ([65e5d46][145])
- **actions:** removed signed pushes ([f621f76][146])
- **package.json:** do not guess error codes ([f5428c8][147])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][148])
...
- added diff to take the difference ([5e40deb][151])

### Performance Improvements

- **actions:** better caching ([6da0a65][152])
- **actions:** made test-integration-chrome independent ([d489cfa][153])
- **actions:** only cache node_modules ([57775c9][154])
...
- Version 1.0.15 ([57faa2c][155])

<!---->

- Version 1.0.7 ([5ced626][156])

- Version 1.0.0 ([df91d82][157])

[1]: https://conventionalcommits.org
[2]: https://semver.org
[3]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.3...v6.3.4
[4]:
...
[8]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[9]:
...
[11]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[12]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[13]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[14]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[15]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[16]:
...
[18]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[19]:
...
[25]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[26]:
  https://github.com/Xunnamius/workflow-playground/commit/8a7fc06df25ffa5381bb5d771eb6e5a619fcbf64
[27]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[28]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[29]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[30]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[31]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[32]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[33]:
...
[35]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[36]:
...
[39]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[40]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[41]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[42]:
...
[44]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[45]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[46]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[47]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[48]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[49]:
...
[51]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[52]:
...
[66]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[67]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[68]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[69]:
...
[71]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[72]:
...
[75]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[76]:
...
[85]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[86]:
...
[90]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[91]:
...
[93]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[94]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[95]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[96]:
...
[99]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[100]:
...
[102]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[103]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[104]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[105]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[106]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[107]:
...
[122]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[123]:
...
[125]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[126]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[127]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[128]:
...
[131]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[132]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[133]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[134]:
...
[138]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[139]:
...
[142]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[143]:
