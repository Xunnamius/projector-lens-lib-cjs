...
The format is based on [Conventional Commits][274], and this project adheres to
[Semantic Versioning][275].

## [7.5.11][276] (2021-01-12)

### Build System

- Rebuild lockfile ([fef7222][277])
- Update babel-plugin-transform-mjs-imports ([16a597d][278])

## [7.5.10][1] (2021-01-12)

### Build System

- Update -browser to -client everywhere ([597d6c5][2])

## [7.5.9][3] (2021-01-10)

### Bug Fixes

- **webpack.config.js:** better process.env support ([25db498][4])

## [7.5.8][5] (2021-01-06)

### Build System

- **webpack.config.js:** process.env shim ([3973279][6])
...
- **package.json:** backported updates ([8a051d1][16])

## [7.5.2][17] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][18])

## [7.5.1][19] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][20])
- **package.json:** return browser test ([6c1c4d4][21])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][22])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][23])
- **package.json:** backports from the wild ([eda277e][24])
- **webpack.config.js:** add env-expect ([0f401ff][25])

# [7.5.0][26] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][27])
...
- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][31])
...
- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][33])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][34])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][35])
...
- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][38])
- **package.json:** revert "test: peer dep install" ([4c174fe][39])
- **package.json:** test: peer dep install ([6c00005][40])
...
- **.github:** add codecov to externals; add flags to codecov ([e47160b][45])

# [7.3.0][46] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][47])

### Build System

- **package.json:** better lint output ([0dc7c4e][48])

### Features

- **.github:** backport env matrix hint ([c01b325][49])
- **readme.md:** add NPM7 warning ([24f0888][50])

## [7.2.3][51] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][52])

## [7.2.2][53] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][54])

## [7.2.1][55] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][56])

# [7.2.0][57] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][58])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][59])
- **workflows:** fix should-skip determination algo ([f7d1256][60])

# [7.1.0][61] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][62])
- **readme.md:** complete skip test ([67264ed][63])
- **workflows:** replace should-skip determination algo ([cd6236a][64])

# [7.0.0][65] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][66])
...
- **.changelogrc.js:** show reverts in changelog ([ec26302][68])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][69])

## [6.7.2][70] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][71])
- _"debug(readme.md): debug debug"_ ([aff005d][72])

## [6.7.1][73] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][74])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][75])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][76])

### Build System

- **package.json:** better build-changelog ([f2e971e][77])

# [6.7.0][78] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][79])

# [6.6.0][80] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][81])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][82])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][83])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][84])
- **release.config.js:** use imported releaseRules ([2fe163c][85])

## [6.5.1][86] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][87])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][88])

# [6.5.0][89] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][90])
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][93])
- **package.json:** remove deploy test script ([4fb641c][94])

## [6.4.2][95] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][96])

## [6.4.1][97] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support ([de7ef33][98])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][99])
- **release.config.js:** fix deploy to run at success step; add debug output
  ([b9e8cc5][100])

# [6.4.0][101] (2021-01-02)

### Features

- **package.json:** vercel deploy test ([ed73fc3][102])

## [6.3.8][103] (2021-01-02)
...
## [6.3.5][109] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][110])

## [6.3.4][111] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][112])
- Update remark linting to exit 1 on error, quiet on success ([077abce][113])
- Update sort-package-json to contrib-env-expect ([6885a34][114])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][115])

## [6.3.3][116] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][118])

## [6.3.2][119] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][120])

## [6.3.1][121] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][122])

# [6.3.0][123] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][124])

### Features

- **src:** add div function ([636c353][125])

# [6.2.0][126] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][127])
- **.husky:** remove verbose flag ([538c374][128])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][129])
- **package.json:** remove debug echo ([33a510d][130])
- **release.config.js:** fix to use gfm ([db4c284][131])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][132])

## [6.1.7][133] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][134])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][135])

## [6.1.6][136] (2020-12-30)
...
## [6.1.4][140] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][141])

## [6.1.3][142] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][143])
- **build-test-deploy.yml:** fix syntax error ([5448960][144])

## [6.1.2][145] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][146])
- **package.json:** remove high audit CI failure ([b2ea6f1][147])
- **package.json:** test high audit CI failure ([03825f0][148])

## [6.1.1][149] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][150])

# [6.1.0][151] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][152])

### Features

- **readme.md:** dummy feat ([f90dde3][153])

## [6.0.5][154] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][155])

## [6.0.4][156] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][157])

## [6.0.3][158] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][159])
- **.github:** fix cleanup ([7520e0f][160])

## [6.0.2][161] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][162])
- **release.config.js:** remove console.info ([b374296][163])

## [6.0.1][164] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][165])

# [6.0.0][166] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][167])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][168] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][170])

## [5.0.2][171] (2020-12-29)
...
## [5.0.1][173] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][174])
- **package.json:** add codecov package ([d73cac9][175])
- **package.json:** remove codecov package ([da477b7][176])

# [5.0.0][177] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][178])
...
- Update comment language ([5a2aef4][181])
...
## [3.0.1][182] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][183])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][184])

### Build System

- **package.json:** update deps ([a876517][185])

# [3.0.0][186] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][187])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][188])
- **package.json:** use @xunnamius/semantic-release ([0447d59][189])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][190])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][191])
- **package-lock.json:** fix syntax error ([4fd2952][192])
...
- Added mult function ([e537358][194])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][195])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][196])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][197])
...
## [2.3.4][198] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][199])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][200])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][201])
- Added .env.example and env-expect ([efb29c5][202])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][203])

## [2.3.3][204] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][206])

## [2.3.2][207] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][208])

## [2.3.1][209] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][210])
- **release:** fix changelogTitle bug ([0d181ea][211])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][212])

# [2.3.0][213] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][214])

### Performance Improvements

- Better faster spellchecking ([c44c310][215])

## [2.2.2][216] (2020-11-29)
...
## [2.2.1][218] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][219])

# [2.2.0][220] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][222])
- **config:** fix broken changelog.config.js structure ([bd10f44][223])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][224])
- **package.json:** install lint-staged dep and script ([f3800e4][225])
- **package.json:** install spellcheck dependencies ([9a7adb4][226])
- **spellcheck:** change "contains" to "includes" ([af76dbe][227])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][228])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][229])

### Build System

- Install @semantic-release/exec ([cc94940][230])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][231])
- **config:** fix husky pre-commit hook ([f0d0032][232])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][233])
- **config:** retire @semantic-release/changelog ([787a281][234])

### Features

- Add build-changelog to npm scripts ([8393a87][235])

## [2.1.4][236] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][237])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][238])

## [2.1.3][239] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][240])

## [2.1.2][241] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][242])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][243])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][244])

## [2.1.1][245] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][246])

# [2.1.0][247] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][248])
- **actions:** if statements now use | instead of > ([24e3739][249])
- **actions:** move comments out of multiline statements ([874f8d6][250])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][254])
- Add build commits to release rule ([3124ab0][255])

# [2.0.0][256] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][257])
- **actions:** deps caching done properly ([bbe0416][258])
- **actions:** ensure repo is always checked out first ([65e5d46][259])
- **actions:** removed signed pushes ([f621f76][260])
- **package.json:** do not guess error codes ([f5428c8][261])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][262])
...
- Added diff to take the difference ([5e40deb][265])

### Performance Improvements

- **actions:** better caching ([6da0a65][266])
- **actions:** made test-integration-chrome independent ([d489cfa][267])
- **actions:** only cache node_modules ([57775c9][268])

### Reverts

- _"debug: added debug step"_ ([1741cde][269])
- _"debug: debug cache miss"_ ([42af347][270])
...
[26]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.5...v7.5.0
[27]:
  https://github.com/Xunnamius/workflow-playground/commit/77c033ff143dff64455049b8314cd528bae4e198
[28]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.4...v7.4.5
[29]:
  https://github.com/Xunnamius/workflow-playground/commit/677b4cedff4d3e4541736e612035d909a0df6131
[30]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.3...v7.4.4
[31]:
  https://github.com/Xunnamius/workflow-playground/commit/5c8fefa330e31620fe2af848d42eb2c5ab881d02
[32]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.2...v7.4.3
[33]:
...
[37]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.1...v7.4.2
[38]:
...
[41]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.0...v7.4.1
[42]:
...
[44]: https://github.com/Xunnamius/workflow-playground/compare/v7.3.0...v7.4.0
[45]:
  https://github.com/Xunnamius/workflow-playground/commit/e47160b09b956e69f0d9eb0cab01a3440bb66645
[46]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.3...v7.3.0
[47]:
...
[51]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.2...v7.2.3
[52]:
  https://github.com/Xunnamius/workflow-playground/commit/786942001834cb5337fabf921cbc14ea4cc04d2f
[53]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.1...v7.2.2
[54]:
  https://github.com/Xunnamius/workflow-playground/commit/a8cd37812dc9e304bf813c742b2d4d54c1c9c183
[55]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.0...v7.2.1
[56]:
  https://github.com/Xunnamius/workflow-playground/commit/73edb9a864bbc4b7d5a7eb1d03ca4ce3b8e02e95
[57]: https://github.com/Xunnamius/workflow-playground/compare/v7.1.0...v7.2.0
[58]:
...
[61]: https://github.com/Xunnamius/workflow-playground/compare/v7.0.0...v7.1.0
[62]:
...
[65]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.3...v7.0.0
[66]:
  https://github.com/Xunnamius/workflow-playground/commit/5765c024e82c3e7e0c77808e3860c85fb8c8d759
[67]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.2...v6.7.3
[68]:
...
[70]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.1...v6.7.2
[71]:
...
[73]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.0...v6.7.1
[74]:
...
[78]: https://github.com/Xunnamius/workflow-playground/compare/v6.6.0...v6.7.0
[79]:
  https://github.com/Xunnamius/workflow-playground/commit/1fdcb9c6c500f88fbc2b7b6ec7f427f0a4995080
[80]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.1...v6.6.0
[81]:
...
[86]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.0...v6.5.1
[87]:
...
[89]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.3...v6.5.0
[90]:
  https://github.com/Xunnamius/workflow-playground/commit/54488d92317360c2e358bca9238e60e2daca64dd
[91]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[92]:
...
[95]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[96]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[97]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[98]:
...
[116]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[117]:
...
[119]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[120]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[121]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[122]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[123]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[124]:
...
[126]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[127]:
...
[133]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[134]:
...
[136]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[137]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[138]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[139]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[140]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[141]:
  https://github.com/Xunnamius/workflow-playground/commit/44f5cd4c3c6adeb548ba89adba8e884336f41520
[142]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[143]:
...
[145]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[146]:
...
[149]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[150]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[151]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[152]:
...
[154]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[155]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[156]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[157]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[158]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[159]:
...
[161]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[162]:
...
[164]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.0...v6.0.1
[165]:
  https://github.com/Xunnamius/workflow-playground/commit/d40192bd13d9b301e09723cdca68be60b44b5d82
[166]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.3...v6.0.0
[167]:
  https://github.com/Xunnamius/workflow-playground/commit/95a13d21dd902a490d445d3c8aee89c59b2131f1
[168]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.2...v5.0.3
[169]:
...
[171]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.1...v5.0.2
[172]:
  https://github.com/Xunnamius/workflow-playground/commit/e62c5b42ca2b43326cc9eec8db248020b2d90ec8
[173]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.0...v5.0.1
[174]:
...
[177]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[178]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[179]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[180]:
...
[182]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[183]:
...
[186]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[187]:
...
[198]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[199]:
...
[204]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[205]:
...
[207]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[208]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[209]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[210]:
...
[213]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[214]:
...
[216]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[217]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[218]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[219]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[220]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[221]:
...
[236]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[237]:
...
[239]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[240]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[241]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[242]:
...
[245]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[246]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[247]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[248]:
...
[252]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[253]:
...
[256]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[257]:
...
[274]: https://conventionalcommits.org
[275]: https://semver.org
[276]:
  https://github.com/Xunnamius/workflow-playground/compare/v7.5.10...v7.5.11
[277]:
