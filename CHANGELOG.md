...
- **.github:** fix hardcoded package name ([a10bac3][4])

## [6.3.4][5] (2021-01-01)

### Build System

- move npm lint step before lint-staged in husky hook ([e8bac90][6])
- update remark linting to exit 1 on error, quiet on success ([077abce][7])
- update sort-package-json to contrib-env-expect ([6885a34][8])
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][12])

## [6.3.2][13] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][14])

## [6.3.1][15] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][16])

# [6.3.0][17] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][18])

### Features

- **src:** add div function ([636c353][19])
...
- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][21])
- **.husky:** remove verbose flag ([538c374][22])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][23])
- **package.json:** remove debug echo ([33a510d][24])
- **release.config.js:** fix to use gfm ([db4c284][25])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][26])

## [6.1.7][27] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][28])
...
- **build-test-deploy.yml:** debug should warn ([55e1235][35])
- **build-test-deploy.yml:** fix syntax error ([5448960][36])

## [6.1.2][37] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][38])
- **package.json:** remove high audit CI failure ([b2ea6f1][39])
- **package.json:** test high audit CI failure ([03825f0][40])

## [6.1.1][41] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][42])
...
- **readme.md:** dummy feat ([f90dde3][44])

## 6.0.6-canary.1 (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][45])

## [6.0.5][46] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][47])

## [6.0.4][48] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][49])

## [6.0.3][50] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][51])
- **.github:** fix cleanup ([7520e0f][52])

## [6.0.2][53] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][54])
- **release.config.js:** remove console.info ([b374296][55])

## [6.0.1][56] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][57])

# [6.0.0][58] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][59])
...
- **.github:** add codecov-action to test-unit job ([2ef6297][65])
- **package.json:** add codecov package ([d73cac9][66])
- **package.json:** remove codecov package ([da477b7][67])

# [5.0.0][68] (2020-12-29)

### Chore

- fix capitalization of non-release commit types ([7391321][69])
...
- update comment language ([5a2aef4][72])
...
- **.github:** update ci committer name and email to xunn-bot ([b151491][74])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][75])

### Build System

- **package.json:** update deps ([a876517][76])
...
- **package-lock.json:** fix syntax error ([4fd2952][78])

# 3.0.0-canary.6 (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][79])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][80])
...
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][81])

# 3.0.0-canary.4 (2020-12-06)

### Build System

- **package.json:** add semver devdep ([4a50ecd][82])
...
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][84])
- **package.json:** use @xunnamius/semantic-release ([0447d59][85])
...
- added mult function ([e537358][86])
...
- **commitlint:** add debug type to type-enum ([10c71bf][88])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][89])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][90])
- added .env.example and env-expect ([efb29c5][91])
...
- **release:** fix changelogTitle skip title ([1dcdcc1][94])

## [2.3.2][95] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][96])

## [2.3.1][97] (2020-11-30)

### Build System

- install @semantic-release/changelog ([022603b][98])
- **release:** fix changelogTitle bug ([0d181ea][99])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][100])

# [2.3.0][101] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][102])

### Performance Improvements

- better faster spellchecking ([c44c310][103])

## [2.2.2][104] (2020-11-29)
...
## [2.2.1][106] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][107])

# [2.2.0][108] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][110])
- **config:** fix broken changelog.config.js structure ([bd10f44][111])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][112])
- **package.json:** install lint-staged dep and script ([f3800e4][113])
- **package.json:** install spellcheck dependencies ([9a7adb4][114])
- **spellcheck:** change "contains" to "includes" ([af76dbe][115])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][116])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][117])

### Build System

- install @semantic-release/exec ([cc94940][118])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][119])
- **config:** fix husky pre-commit hook ([f0d0032][120])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][121])
- **config:** retire @semantic-release/changelog ([787a281][122])

### Features

- add build-changelog to npm scripts ([8393a87][123])

## [2.1.4][124] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][125])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][126])

## [2.1.3][127] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][128])

## [2.1.2][129] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][130])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][131])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][132])

## [2.1.1][133] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][134])

# [2.1.0][135] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][136])
- **actions:** if statements now use | instead of > ([24e3739][137])
- **actions:** move comments out of multiline statements ([874f8d6][138])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][142])
- add build commits to release rule ([3124ab0][143])

# [2.0.0][144] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][145])
- **actions:** deps caching done properly ([bbe0416][146])
- **actions:** ensure repo is always checked out first ([65e5d46][147])
- **actions:** removed signed pushes ([f621f76][148])
- **package.json:** do not guess error codes ([f5428c8][149])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][150])
...
- added diff to take the difference ([5e40deb][153])

### Performance Improvements

- **actions:** better caching ([6da0a65][154])
- **actions:** made test-integration-chrome independent ([d489cfa][155])
- **actions:** only cache node_modules ([57775c9][156])
...
- Version 1.0.15 ([57faa2c][157])

<!---->

- Version 1.0.7 ([5ced626][158])

- Version 1.0.0 ([df91d82][159])

[1]: https://conventionalcommits.org
[2]: https://semver.org
[3]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.4...v6.3.5
[4]:
  https://github.com/Xunnamius/workflow-playground/commit/a10bac3efbce2b4bd511420fd4d7466c288d9706
[5]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.3...v6.3.4
[6]:
...
[10]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[11]:
...
[13]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[14]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[15]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[16]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[17]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[18]:
...
[20]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[21]:
...
[27]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[28]:
  https://github.com/Xunnamius/workflow-playground/commit/8a7fc06df25ffa5381bb5d771eb6e5a619fcbf64
[29]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[30]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[31]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[32]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[33]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[34]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[35]:
...
[37]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[38]:
...
[41]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[42]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[43]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[44]:
...
[46]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[47]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[48]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[49]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[50]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[51]:
...
[53]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[54]:
...
[68]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[69]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[70]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[71]:
...
[73]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[74]:
...
[77]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[78]:
...
[87]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[88]:
...
[92]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[93]:
...
[95]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[96]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[97]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[98]:
...
[101]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[102]:
...
[104]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[105]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[106]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[107]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[108]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[109]:
...
[124]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[125]:
...
[127]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[128]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[129]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[130]:
...
[133]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[134]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[135]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[136]:
...
[140]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[141]:
...
[144]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[145]:
