...
The format is based on [Conventional Commits][258], and this project adheres to
[Semantic Versioning][259].

## [7.5.3][260] (2021-01-05)

### Build System

- **package.json:** backported updates ([8a051d1][261])

## [7.5.2][1] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][2])

## [7.5.1][3] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][4])
- **package.json:** return browser test ([6c1c4d4][5])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][6])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][7])
- **package.json:** backports from the wild ([eda277e][8])
- **webpack.config.js:** add env-expect ([0f401ff][9])

# [7.5.0][10] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][11])
...
- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][15])
...
- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][17])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][18])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][19])
...
- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][22])
- **package.json:** revert "test: peer dep install" ([4c174fe][23])
- **package.json:** test: peer dep install ([6c00005][24])
...
- **.github:** add codecov to externals; add flags to codecov ([e47160b][29])

# [7.3.0][30] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][31])

### Build System

- **package.json:** better lint output ([0dc7c4e][32])

### Features

- **.github:** backport env matrix hint ([c01b325][33])
- **readme.md:** add NPM7 warning ([24f0888][34])

## [7.2.3][35] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][36])

## [7.2.2][37] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][38])

## [7.2.1][39] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][40])

# [7.2.0][41] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][42])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][43])
- **workflows:** fix should-skip determination algo ([f7d1256][44])

# [7.1.0][45] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][46])
- **readme.md:** complete skip test ([67264ed][47])
- **workflows:** replace should-skip determination algo ([cd6236a][48])

# [7.0.0][49] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][50])
...
- **.changelogrc.js:** show reverts in changelog ([ec26302][52])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][53])

## [6.7.2][54] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][55])
- _"debug(readme.md): debug debug"_ ([aff005d][56])

## [6.7.1][57] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][58])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][59])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][60])

### Build System

- **package.json:** better build-changelog ([f2e971e][61])

# [6.7.0][62] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][63])

# [6.6.0][64] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][65])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][66])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][67])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][68])
- **release.config.js:** use imported releaseRules ([2fe163c][69])

## [6.5.1][70] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][71])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][72])

# [6.5.0][73] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][74])
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][77])
- **package.json:** remove deploy test script ([4fb641c][78])

## [6.4.2][79] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][80])

## [6.4.1][81] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support ([de7ef33][82])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][83])
...
- **package.json:** vercel deploy test ([ed73fc3][86])
...
- **.github/workflows/cleanup.yml:** fix metadata gathering step ([44dd462][90])

## [6.3.6][91] (2021-01-01)

### Build System

- **.github/workflows/cleanup.yml:** add metadata filtering step ([6667075][92])

## [6.3.5][93] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][94])

## [6.3.4][95] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][96])
- Update remark linting to exit 1 on error, quiet on success ([077abce][97])
- Update sort-package-json to contrib-env-expect ([6885a34][98])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][99])

## [6.3.3][100] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][102])

## [6.3.2][103] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][104])

## [6.3.1][105] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][106])

# [6.3.0][107] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][108])

### Features

- **src:** add div function ([636c353][109])

# [6.2.0][110] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][111])
- **.husky:** remove verbose flag ([538c374][112])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][113])
- **package.json:** remove debug echo ([33a510d][114])
- **release.config.js:** fix to use gfm ([db4c284][115])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][116])

## [6.1.7][117] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][118])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][119])

## [6.1.6][120] (2020-12-30)
...
## [6.1.4][124] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][125])

## [6.1.3][126] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][127])
- **build-test-deploy.yml:** fix syntax error ([5448960][128])

## [6.1.2][129] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][130])
- **package.json:** remove high audit CI failure ([b2ea6f1][131])
- **package.json:** test high audit CI failure ([03825f0][132])

## [6.1.1][133] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][134])

# [6.1.0][135] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][136])

### Features

- **readme.md:** dummy feat ([f90dde3][137])

## [6.0.5][138] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][139])

## [6.0.4][140] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][141])

## [6.0.3][142] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][143])
- **.github:** fix cleanup ([7520e0f][144])

## [6.0.2][145] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][146])
- **release.config.js:** remove console.info ([b374296][147])

## [6.0.1][148] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][149])

# [6.0.0][150] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][151])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][152] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][154])

## [5.0.2][155] (2020-12-29)
...
## [5.0.1][157] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][158])
- **package.json:** add codecov package ([d73cac9][159])
- **package.json:** remove codecov package ([da477b7][160])

# [5.0.0][161] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][162])
...
- Update comment language ([5a2aef4][165])
...
## [3.0.1][166] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][167])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][168])

### Build System

- **package.json:** update deps ([a876517][169])

# [3.0.0][170] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][171])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][172])
- **package.json:** use @xunnamius/semantic-release ([0447d59][173])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][174])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][175])
- **package-lock.json:** fix syntax error ([4fd2952][176])
...
- Added mult function ([e537358][178])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][179])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][180])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][181])
...
## [2.3.4][182] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][183])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][184])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][185])
- Added .env.example and env-expect ([efb29c5][186])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][187])

## [2.3.3][188] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][190])

## [2.3.2][191] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][192])

## [2.3.1][193] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][194])
- **release:** fix changelogTitle bug ([0d181ea][195])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][196])

# [2.3.0][197] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][198])

### Performance Improvements

- Better faster spellchecking ([c44c310][199])

## [2.2.2][200] (2020-11-29)
...
## [2.2.1][202] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][203])

# [2.2.0][204] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][206])
- **config:** fix broken changelog.config.js structure ([bd10f44][207])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][208])
- **package.json:** install lint-staged dep and script ([f3800e4][209])
- **package.json:** install spellcheck dependencies ([9a7adb4][210])
- **spellcheck:** change "contains" to "includes" ([af76dbe][211])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][212])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][213])

### Build System

- Install @semantic-release/exec ([cc94940][214])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][215])
- **config:** fix husky pre-commit hook ([f0d0032][216])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][217])
- **config:** retire @semantic-release/changelog ([787a281][218])

### Features

- Add build-changelog to npm scripts ([8393a87][219])

## [2.1.4][220] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][221])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][222])

## [2.1.3][223] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][224])

## [2.1.2][225] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][226])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][227])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][228])

## [2.1.1][229] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][230])

# [2.1.0][231] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][232])
- **actions:** if statements now use | instead of > ([24e3739][233])
- **actions:** move comments out of multiline statements ([874f8d6][234])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][238])
- Add build commits to release rule ([3124ab0][239])

# [2.0.0][240] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][241])
- **actions:** deps caching done properly ([bbe0416][242])
- **actions:** ensure repo is always checked out first ([65e5d46][243])
- **actions:** removed signed pushes ([f621f76][244])
- **package.json:** do not guess error codes ([f5428c8][245])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][246])
...
- Added diff to take the difference ([5e40deb][249])

### Performance Improvements

- **actions:** better caching ([6da0a65][250])
- **actions:** made test-integration-chrome independent ([d489cfa][251])
- **actions:** only cache node_modules ([57775c9][252])

### Reverts

- _"debug: added debug step"_ ([1741cde][253])
- _"debug: debug cache miss"_ ([42af347][254])
...
- Version 1.0.15 ([57faa2c][255])

<!---->

- Version 1.0.7 ([5ced626][256])

- Version 1.0.0 ([df91d82][257])

[1]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.1...v7.5.2
[2]:
  https://github.com/Xunnamius/workflow-playground/commit/2cf6e46a6fe59b8a47123f2215ba8caf7976ad87
[3]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.0...v7.5.1
[4]:
...
[10]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.5...v7.5.0
[11]:
  https://github.com/Xunnamius/workflow-playground/commit/77c033ff143dff64455049b8314cd528bae4e198
[12]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.4...v7.4.5
[13]:
  https://github.com/Xunnamius/workflow-playground/commit/677b4cedff4d3e4541736e612035d909a0df6131
[14]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.3...v7.4.4
[15]:
  https://github.com/Xunnamius/workflow-playground/commit/5c8fefa330e31620fe2af848d42eb2c5ab881d02
[16]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.2...v7.4.3
[17]:
...
[21]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.1...v7.4.2
[22]:
...
[25]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.0...v7.4.1
[26]:
...
[28]: https://github.com/Xunnamius/workflow-playground/compare/v7.3.0...v7.4.0
[29]:
  https://github.com/Xunnamius/workflow-playground/commit/e47160b09b956e69f0d9eb0cab01a3440bb66645
[30]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.3...v7.3.0
[31]:
...
[35]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.2...v7.2.3
[36]:
  https://github.com/Xunnamius/workflow-playground/commit/786942001834cb5337fabf921cbc14ea4cc04d2f
[37]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.1...v7.2.2
[38]:
  https://github.com/Xunnamius/workflow-playground/commit/a8cd37812dc9e304bf813c742b2d4d54c1c9c183
[39]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.0...v7.2.1
[40]:
  https://github.com/Xunnamius/workflow-playground/commit/73edb9a864bbc4b7d5a7eb1d03ca4ce3b8e02e95
[41]: https://github.com/Xunnamius/workflow-playground/compare/v7.1.0...v7.2.0
[42]:
...
[45]: https://github.com/Xunnamius/workflow-playground/compare/v7.0.0...v7.1.0
[46]:
...
[49]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.3...v7.0.0
[50]:
  https://github.com/Xunnamius/workflow-playground/commit/5765c024e82c3e7e0c77808e3860c85fb8c8d759
[51]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.2...v6.7.3
[52]:
...
[54]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.1...v6.7.2
[55]:
...
[57]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.0...v6.7.1
[58]:
...
[62]: https://github.com/Xunnamius/workflow-playground/compare/v6.6.0...v6.7.0
[63]:
  https://github.com/Xunnamius/workflow-playground/commit/1fdcb9c6c500f88fbc2b7b6ec7f427f0a4995080
[64]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.1...v6.6.0
[65]:
...
[70]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.0...v6.5.1
[71]:
...
[73]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.3...v6.5.0
[74]:
  https://github.com/Xunnamius/workflow-playground/commit/54488d92317360c2e358bca9238e60e2daca64dd
[75]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[76]:
...
[79]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[80]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[81]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[82]:
...
[100]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[101]:
...
[103]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[104]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[105]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[106]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[107]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[108]:
...
[110]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[111]:
...
[117]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[118]:
...
[120]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[121]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[122]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[123]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[124]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[125]:
  https://github.com/Xunnamius/workflow-playground/commit/44f5cd4c3c6adeb548ba89adba8e884336f41520
[126]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[127]:
...
[129]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[130]:
...
[133]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[134]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[135]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[136]:
...
[138]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[139]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[140]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[141]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[142]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[143]:
...
[145]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[146]:
...
[148]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.0...v6.0.1
[149]:
  https://github.com/Xunnamius/workflow-playground/commit/d40192bd13d9b301e09723cdca68be60b44b5d82
[150]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.3...v6.0.0
[151]:
  https://github.com/Xunnamius/workflow-playground/commit/95a13d21dd902a490d445d3c8aee89c59b2131f1
[152]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.2...v5.0.3
[153]:
...
[155]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.1...v5.0.2
[156]:
  https://github.com/Xunnamius/workflow-playground/commit/e62c5b42ca2b43326cc9eec8db248020b2d90ec8
[157]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.0...v5.0.1
[158]:
...
[161]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[162]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[163]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[164]:
...
[166]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[167]:
...
[170]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[171]:
...
[182]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[183]:
...
[188]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[189]:
...
[191]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[192]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[193]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[194]:
...
[197]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[198]:
...
[200]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[201]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[202]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[203]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[204]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[205]:
...
[220]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[221]:
...
[223]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[224]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[225]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[226]:
...
[229]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[230]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[231]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[232]:
...
[236]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[237]:
...
[240]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[241]:
...
[258]: https://conventionalcommits.org
[259]: https://semver.org
[260]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.2...v7.5.3
[261]:
