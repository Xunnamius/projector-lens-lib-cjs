...
The format is based on [Conventional Commits][262], and this project adheres to
[Semantic Versioning][263].

## [7.5.5][264] (2021-01-06)
...
- **package.json:** backported updates ([8a051d1][4])

## [7.5.2][5] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][6])

## [7.5.1][7] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][8])
- **package.json:** return browser test ([6c1c4d4][9])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][10])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][11])
- **package.json:** backports from the wild ([eda277e][12])
- **webpack.config.js:** add env-expect ([0f401ff][13])

# [7.5.0][14] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][15])
...
- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][19])
...
- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][21])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][22])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][23])
...
- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][26])
- **package.json:** revert "test: peer dep install" ([4c174fe][27])
- **package.json:** test: peer dep install ([6c00005][28])
...
- **.github:** add codecov to externals; add flags to codecov ([e47160b][33])

# [7.3.0][34] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][35])

### Build System

- **package.json:** better lint output ([0dc7c4e][36])

### Features

- **.github:** backport env matrix hint ([c01b325][37])
- **readme.md:** add NPM7 warning ([24f0888][38])

## [7.2.3][39] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][40])

## [7.2.2][41] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][42])

## [7.2.1][43] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][44])

# [7.2.0][45] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][46])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][47])
- **workflows:** fix should-skip determination algo ([f7d1256][48])

# [7.1.0][49] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][50])
- **readme.md:** complete skip test ([67264ed][51])
- **workflows:** replace should-skip determination algo ([cd6236a][52])

# [7.0.0][53] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][54])
...
- **.changelogrc.js:** show reverts in changelog ([ec26302][56])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][57])

## [6.7.2][58] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][59])
- _"debug(readme.md): debug debug"_ ([aff005d][60])

## [6.7.1][61] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][62])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][63])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][64])

### Build System

- **package.json:** better build-changelog ([f2e971e][65])

# [6.7.0][66] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][67])

# [6.6.0][68] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][69])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][70])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][71])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][72])
- **release.config.js:** use imported releaseRules ([2fe163c][73])

## [6.5.1][74] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][75])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][76])

# [6.5.0][77] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][78])
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][81])
- **package.json:** remove deploy test script ([4fb641c][82])

## [6.4.2][83] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][84])

## [6.4.1][85] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support ([de7ef33][86])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][87])
...
- **package.json:** vercel deploy test ([ed73fc3][90])
...
- **.github/workflows/cleanup.yml:** fix metadata gathering step ([44dd462][94])

## [6.3.6][95] (2021-01-01)

### Build System

- **.github/workflows/cleanup.yml:** add metadata filtering step ([6667075][96])

## [6.3.5][97] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][98])

## [6.3.4][99] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][100])
- Update remark linting to exit 1 on error, quiet on success ([077abce][101])
- Update sort-package-json to contrib-env-expect ([6885a34][102])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][103])

## [6.3.3][104] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][106])

## [6.3.2][107] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][108])

## [6.3.1][109] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][110])

# [6.3.0][111] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][112])

### Features

- **src:** add div function ([636c353][113])

# [6.2.0][114] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][115])
- **.husky:** remove verbose flag ([538c374][116])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][117])
- **package.json:** remove debug echo ([33a510d][118])
- **release.config.js:** fix to use gfm ([db4c284][119])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][120])

## [6.1.7][121] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][122])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][123])

## [6.1.6][124] (2020-12-30)
...
## [6.1.4][128] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][129])

## [6.1.3][130] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][131])
- **build-test-deploy.yml:** fix syntax error ([5448960][132])

## [6.1.2][133] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][134])
- **package.json:** remove high audit CI failure ([b2ea6f1][135])
- **package.json:** test high audit CI failure ([03825f0][136])

## [6.1.1][137] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][138])

# [6.1.0][139] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][140])

### Features

- **readme.md:** dummy feat ([f90dde3][141])

## [6.0.5][142] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][143])

## [6.0.4][144] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][145])

## [6.0.3][146] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][147])
- **.github:** fix cleanup ([7520e0f][148])

## [6.0.2][149] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][150])
- **release.config.js:** remove console.info ([b374296][151])

## [6.0.1][152] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][153])

# [6.0.0][154] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][155])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][156] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][158])

## [5.0.2][159] (2020-12-29)
...
## [5.0.1][161] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][162])
- **package.json:** add codecov package ([d73cac9][163])
- **package.json:** remove codecov package ([da477b7][164])

# [5.0.0][165] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][166])
...
- Update comment language ([5a2aef4][169])
...
## [3.0.1][170] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][171])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][172])

### Build System

- **package.json:** update deps ([a876517][173])

# [3.0.0][174] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][175])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][176])
- **package.json:** use @xunnamius/semantic-release ([0447d59][177])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][178])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][179])
- **package-lock.json:** fix syntax error ([4fd2952][180])
...
- Added mult function ([e537358][182])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][183])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][184])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][185])
...
## [2.3.4][186] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][187])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][188])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][189])
- Added .env.example and env-expect ([efb29c5][190])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][191])

## [2.3.3][192] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][194])

## [2.3.2][195] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][196])

## [2.3.1][197] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][198])
- **release:** fix changelogTitle bug ([0d181ea][199])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][200])

# [2.3.0][201] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][202])

### Performance Improvements

- Better faster spellchecking ([c44c310][203])

## [2.2.2][204] (2020-11-29)
...
## [2.2.1][206] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][207])

# [2.2.0][208] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][210])
- **config:** fix broken changelog.config.js structure ([bd10f44][211])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][212])
- **package.json:** install lint-staged dep and script ([f3800e4][213])
- **package.json:** install spellcheck dependencies ([9a7adb4][214])
- **spellcheck:** change "contains" to "includes" ([af76dbe][215])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][216])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][217])

### Build System

- Install @semantic-release/exec ([cc94940][218])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][219])
- **config:** fix husky pre-commit hook ([f0d0032][220])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][221])
- **config:** retire @semantic-release/changelog ([787a281][222])

### Features

- Add build-changelog to npm scripts ([8393a87][223])

## [2.1.4][224] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][225])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][226])

## [2.1.3][227] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][228])

## [2.1.2][229] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][230])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][231])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][232])

## [2.1.1][233] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][234])

# [2.1.0][235] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][236])
- **actions:** if statements now use | instead of > ([24e3739][237])
- **actions:** move comments out of multiline statements ([874f8d6][238])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][242])
- Add build commits to release rule ([3124ab0][243])

# [2.0.0][244] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][245])
- **actions:** deps caching done properly ([bbe0416][246])
- **actions:** ensure repo is always checked out first ([65e5d46][247])
- **actions:** removed signed pushes ([f621f76][248])
- **package.json:** do not guess error codes ([f5428c8][249])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][250])
...
- Added diff to take the difference ([5e40deb][253])

### Performance Improvements

- **actions:** better caching ([6da0a65][254])
- **actions:** made test-integration-chrome independent ([d489cfa][255])
- **actions:** only cache node_modules ([57775c9][256])

### Reverts

- _"debug: added debug step"_ ([1741cde][257])
- _"debug: debug cache miss"_ ([42af347][258])
...
- Version 1.0.15 ([57faa2c][259])

<!---->

- Version 1.0.7 ([5ced626][260])

- Version 1.0.0 ([df91d82][261])

[1]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.3...v7.5.4
[2]:
  https://github.com/Xunnamius/workflow-playground/commit/ed31f79e0ebe97823e2a62b9e6aa7b3e2355ff7c
[3]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.2...v7.5.3
[4]:
  https://github.com/Xunnamius/workflow-playground/commit/8a051d1222ed6df2d1c9e1f2e2eb890d763a6333
[5]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.1...v7.5.2
[6]:
  https://github.com/Xunnamius/workflow-playground/commit/2cf6e46a6fe59b8a47123f2215ba8caf7976ad87
[7]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.0...v7.5.1
[8]:
...
[14]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.5...v7.5.0
[15]:
  https://github.com/Xunnamius/workflow-playground/commit/77c033ff143dff64455049b8314cd528bae4e198
[16]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.4...v7.4.5
[17]:
  https://github.com/Xunnamius/workflow-playground/commit/677b4cedff4d3e4541736e612035d909a0df6131
[18]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.3...v7.4.4
[19]:
  https://github.com/Xunnamius/workflow-playground/commit/5c8fefa330e31620fe2af848d42eb2c5ab881d02
[20]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.2...v7.4.3
[21]:
...
[25]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.1...v7.4.2
[26]:
...
[29]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.0...v7.4.1
[30]:
...
[32]: https://github.com/Xunnamius/workflow-playground/compare/v7.3.0...v7.4.0
[33]:
  https://github.com/Xunnamius/workflow-playground/commit/e47160b09b956e69f0d9eb0cab01a3440bb66645
[34]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.3...v7.3.0
[35]:
...
[39]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.2...v7.2.3
[40]:
  https://github.com/Xunnamius/workflow-playground/commit/786942001834cb5337fabf921cbc14ea4cc04d2f
[41]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.1...v7.2.2
[42]:
  https://github.com/Xunnamius/workflow-playground/commit/a8cd37812dc9e304bf813c742b2d4d54c1c9c183
[43]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.0...v7.2.1
[44]:
  https://github.com/Xunnamius/workflow-playground/commit/73edb9a864bbc4b7d5a7eb1d03ca4ce3b8e02e95
[45]: https://github.com/Xunnamius/workflow-playground/compare/v7.1.0...v7.2.0
[46]:
...
[49]: https://github.com/Xunnamius/workflow-playground/compare/v7.0.0...v7.1.0
[50]:
...
[53]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.3...v7.0.0
[54]:
  https://github.com/Xunnamius/workflow-playground/commit/5765c024e82c3e7e0c77808e3860c85fb8c8d759
[55]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.2...v6.7.3
[56]:
...
[58]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.1...v6.7.2
[59]:
...
[61]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.0...v6.7.1
[62]:
...
[66]: https://github.com/Xunnamius/workflow-playground/compare/v6.6.0...v6.7.0
[67]:
  https://github.com/Xunnamius/workflow-playground/commit/1fdcb9c6c500f88fbc2b7b6ec7f427f0a4995080
[68]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.1...v6.6.0
[69]:
...
[74]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.0...v6.5.1
[75]:
...
[77]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.3...v6.5.0
[78]:
  https://github.com/Xunnamius/workflow-playground/commit/54488d92317360c2e358bca9238e60e2daca64dd
[79]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[80]:
...
[83]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[84]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[85]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[86]:
...
[104]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[105]:
...
[107]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[108]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[109]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[110]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[111]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[112]:
...
[114]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[115]:
...
[121]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[122]:
...
[124]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[125]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[126]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[127]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[128]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[129]:
  https://github.com/Xunnamius/workflow-playground/commit/44f5cd4c3c6adeb548ba89adba8e884336f41520
[130]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[131]:
...
[133]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[134]:
...
[137]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[138]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[139]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[140]:
...
[142]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[143]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[144]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[145]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[146]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[147]:
...
[149]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[150]:
...
[152]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.0...v6.0.1
[153]:
  https://github.com/Xunnamius/workflow-playground/commit/d40192bd13d9b301e09723cdca68be60b44b5d82
[154]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.3...v6.0.0
[155]:
  https://github.com/Xunnamius/workflow-playground/commit/95a13d21dd902a490d445d3c8aee89c59b2131f1
[156]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.2...v5.0.3
[157]:
...
[159]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.1...v5.0.2
[160]:
  https://github.com/Xunnamius/workflow-playground/commit/e62c5b42ca2b43326cc9eec8db248020b2d90ec8
[161]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.0...v5.0.1
[162]:
...
[165]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[166]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[167]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[168]:
...
[170]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[171]:
...
[174]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[175]:
...
[186]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[187]:
...
[192]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[193]:
...
[195]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[196]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[197]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[198]:
...
[201]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[202]:
...
[204]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[205]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[206]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[207]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[208]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[209]:
...
[224]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[225]:
...
[227]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[228]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[229]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[230]:
...
[233]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[234]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[235]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[236]:
...
[240]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[241]:
...
[244]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[245]:
...
[262]: https://conventionalcommits.org
[263]: https://semver.org
[264]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.4...v7.5.5
[265]:
