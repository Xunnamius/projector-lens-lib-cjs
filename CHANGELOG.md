...
The format is based on [Conventional Commits][381], and this project adheres to
[Semantic Versioning][382].

## [7.8.19][383] (2021-02-22)

### Bug Fixes

- **integration-external-dummy.test.ts:** ensure proper cwd is used for
  executing externals ([99d175e][384])

## [7.8.18][1] (2021-02-22)

### Bug Fixes

- **.changelogrc.js:** fix dark magic ([6a3007d][2])

### Build System

- **package-lock.json:** remove shelljs ([92a2b23][3])
- Spellcheck-commit and .changelogrc no longer use shelljs ([b3633c3][4])
- **setup.ts:** update with new lib-pkg tools ([e77df0b][5])

## [7.8.17][6] (2021-02-22)

### Build System

- **externals:** update expected exit code to 2 ([fb22498][7])
...
## [7.8.13][14] (2021-02-21)

### Bug Fixes

- **setup.ts:** backport setup fix ([ee1aca2][15])

## [7.8.12][16] (2021-02-21)

### Build System

- **package.json:** chmod cli during build-dist step ([d6f8cc3][17])

## [7.8.11][18] (2021-02-21)

### Build System

- **expect-env.js:** rename from env-expect.js ([aa14ed9][19])

## [7.8.10][20] (2021-02-21)

### Bug Fixes

- **build-test-deploy.yml:** check real exit code ([4ff058e][21])

## [7.8.9][22] (2021-02-20)

### Build System

- **package-lock.json:** make consistent with package.json ([8a63ac7][23])
- **package.json:** remove extraneous module ([1012053][24])

## [7.8.8][25] (2021-02-20)

### Build System

- **deps:** bump object-path from 0.11.3 to 0.11.5 ([95c974a][26])

## [7.8.7][27] (2021-02-20)

### Bug Fixes

- Package.json & package-lock.json to reduce vulnerabilities ([41de5ce][28])

## [7.8.6][29] (2021-02-20)

### Bug Fixes

- **build-test-deploy.yml:** even more resilient error checking ([b050bba][30])

### Build System

- **deps:** bump object-path from 0.11.3 to 0.11.5 ([981229a][31])
...
- **build-test-deploy.yml:** better error handling and debug messaging for
  auto-merge job ([2dee6f6][33])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([1667e70][34])
...
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([e9e3ca1][37])
...
- **build-test-deploy.yml:** better error messages ([6d5573e][40])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([c493a8c][41])

## [7.8.2][42] (2021-02-20)

### Build System

- **deps:** bump object-path from 0.11.4 to 0.11.5 ([aaf7665][43])

## [7.8.1][44] (2021-02-20)

### Bug Fixes

- **build-test-deploy.yml:** store and use proper result ([09d35d7][45])

### Build System

- **deps:** bump object-path from 0.11.4 to 0.11.5 ([658f591][46])
- **package.json:** bump jest timeout to 1 minute ([cb59af2][47])
...
- **build-test-deploy.yml:** whitelist is again case-insensitive ([c034e86][51])

### Build System

- **build-test-deploy.yml:** also run on reopened PRs ([ece78e3][52])
- **build-test-deploy.yml:** codecov failures no longer fail the whole pipeline
  ([a111d7f][53])
- **build-test-deploy.yml:** restructure env w/ comments ([b980cbe][54])
- **build-test-deploy.yml:** update repo owner whitelist step ([b4f89cf][55])

# [7.7.0][56] (2021-02-19)

### Bug Fixes

- Account for node 12 ([4cdb325][57])
...
- **package.json:** external integration test runs w/ proper prefix
  ([5056c05][59])
- **package.json:** update deps ([4ef9c1b][60])

### Features

- **external-scripts:** reorganize externals; rename external to dummy
  ([efc916e][61])
- **test:** externalize jest helper proto-packages ([2dbfb8e][62])

## [7.6.5][63] (2021-02-15)

### Build System

- **package.json:** add private:false ([090cdfe][64])

## [7.6.4][65] (2021-02-14)

### Bug Fixes

- **webpack.config.js:** call dotenv properly ([22a8424][66])

## [7.6.3][67] (2021-02-14)

### Bug Fixes

- Incorrect package name ([bbbd58d][68])

### Build System

- **package.json:** update deps ([599b6c2][69])
...
- **package.json:** account for new ./dist organization ([99a01ea][72])

### Build System

- **test:** complete testing suite ([35da4c3][73])
- **webpack.config.js:** add externals ([7a8f54b][74])
- Move debug to deps, update dependencies ([6587184][75])
- **.eslintrc.js:** false env browser/webextensions ([71809e9][76])
- **integration-client.test.ts:** removed ([f080ad0][77])
- Normalize across repos ([2020d61][78])
- **webpack.config.js:** normalize webpack configuration across repos
  ([8a3bc81][79])
- **webpack.config.js:** remove ES6 syntax from JS file ([dd2b254][80])
...
- **babel.config.js:** add babel-plugin-transform-default-named-imports
  ([720dc20][82])
- **package.json:** update deps ([26a8371][83])
...
- **post-release-check.yml:** run executables as part of check ([31bdc0c][86])

## [7.5.18][87] (2021-01-29)

### Build System

- **build-test-deploy.yml:** drop support for webpack 4 ([e7f2bbb][88])
- **cleanup.yml:** fix bug for new package repos ([8d16630][89])

## [7.5.17][90] (2021-01-29)

### Build System

- **babel.config.js:** add plugin-rename-imports ([c59e45c][91])
- **build-test-deploy.yml:** remove externals exception ([3addf11][92])
- **test:** drop support for 10.x ([fb18856][93])
- **test:** standardize imports ([4f23d4e][94])

## [7.5.16][95] (2021-01-23)

### Build System

- **package.json:** nicer destructured vals in docs ([3b81944][96])

## [7.5.15][97] (2021-01-23)

### Build System

- Backport/normalize across packages ([85881f7][98])

## [7.5.14][99] (2021-01-22)

### Build System

- Update debug statement syntax ([107b953][100])

## [7.5.13][101] (2021-01-21)
...
## [7.5.12][103] (2021-01-17)

### Build System

- Backport changes from gac ([172fa77][104])

## [7.5.11][105] (2021-01-12)

### Build System

- Rebuild lockfile ([fef7222][106])
- Update babel-plugin-transform-mjs-imports ([16a597d][107])

## [7.5.10][108] (2021-01-12)

### Build System

- Update -browser to -client everywhere ([597d6c5][109])

## [7.5.9][110] (2021-01-10)

### Bug Fixes

- **webpack.config.js:** better process.env support ([25db498][111])

## [7.5.8][112] (2021-01-06)

### Build System

- **webpack.config.js:** process.env shim ([3973279][113])

## [7.5.7][114] (2021-01-06)
...
## [7.5.3][122] (2021-01-05)

### Build System

- **package.json:** backported updates ([8a051d1][123])

## [7.5.2][124] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][125])

## [7.5.1][126] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][127])
- **package.json:** return browser test ([6c1c4d4][128])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][129])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][130])
- **package.json:** backports from the wild ([eda277e][131])
- **webpack.config.js:** add env-expect ([0f401ff][132])

# [7.5.0][133] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][134])

## [7.4.5][135] (2021-01-05)
...
## [7.4.4][137] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][138])

## [7.4.3][139] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][140])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][141])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][142])
- **.github/workflows/build-test-deploy.yml:** fix debug output (normalize node
  support) ([0528db6][143])

## [7.4.2][144] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][145])
- **package.json:** revert "test: peer dep install" ([4c174fe][146])
- **package.json:** test: peer dep install ([6c00005][147])

## [7.4.1][148] (2021-01-04)
...
# [7.4.0][151] (2021-01-04)

### Features

- **.github:** add codecov to externals; add flags to codecov ([e47160b][152])

# [7.3.0][153] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][154])

### Build System

- **package.json:** better lint output ([0dc7c4e][155])

### Features

- **.github:** backport env matrix hint ([c01b325][156])
- **readme.md:** add NPM7 warning ([24f0888][157])

## [7.2.3][158] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][159])

## [7.2.2][160] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][161])

## [7.2.1][162] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][163])

# [7.2.0][164] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][165])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][166])
- **workflows:** fix should-skip determination algo ([f7d1256][167])

# [7.1.0][168] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][169])
- **readme.md:** complete skip test ([67264ed][170])
- **workflows:** replace should-skip determination algo ([cd6236a][171])

# [7.0.0][172] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][173])

### BREAKING CHANGES

- **changelog.md:** **skip github/github skip options were removed**

## [6.7.3][174] (2021-01-03)

### Bug Fixes

- **.changelogrc.js:** show reverts in changelog ([ec26302][175])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][176])

## [6.7.2][177] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][178])
- _"debug(readme.md): debug debug"_ ([aff005d][179])

## [6.7.1][180] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][181])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][182])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][183])

### Build System

- **package.json:** better build-changelog ([f2e971e][184])

# [6.7.0][185] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][186])

# [6.6.0][187] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][188])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][189])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][190])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][191])
- **release.config.js:** use imported releaseRules ([2fe163c][192])

## [6.5.1][193] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][194])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][195])

# [6.5.0][196] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][197])

## [6.4.3][198] (2021-01-02)
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][200])
- **package.json:** remove deploy test script ([4fb641c][201])

## [6.4.2][202] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][203])

## [6.4.1][204] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support
  ([de7ef33][205])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][206])
- **release.config.js:** fix deploy to run at success step; add debug output
  ([b9e8cc5][207])

# [6.4.0][208] (2021-01-02)

### Features

- **package.json:** vercel deploy test ([ed73fc3][209])

## [6.3.8][210] (2021-01-02)
...
## [6.3.5][216] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][217])

## [6.3.4][218] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][219])
- Update remark linting to exit 1 on error, quiet on success ([077abce][220])
- Update sort-package-json to contrib-env-expect ([6885a34][221])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][222])

## [6.3.3][223] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][225])

## [6.3.2][226] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][227])

## [6.3.1][228] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][229])

# [6.3.0][230] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][231])

### Features

- **src:** add div function ([636c353][232])

# [6.2.0][233] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][234])
- **.husky:** remove verbose flag ([538c374][235])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][236])
- **package.json:** remove debug echo ([33a510d][237])
- **release.config.js:** fix to use gfm ([db4c284][238])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][239])

## [6.1.7][240] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][241])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][242])

## [6.1.6][243] (2020-12-30)
...
## [6.1.4][247] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][248])

## [6.1.3][249] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][250])
- **build-test-deploy.yml:** fix syntax error ([5448960][251])

## [6.1.2][252] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][253])
- **package.json:** remove high audit CI failure ([b2ea6f1][254])
- **package.json:** test high audit CI failure ([03825f0][255])

## [6.1.1][256] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][257])

# [6.1.0][258] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][259])

### Features

- **readme.md:** dummy feat ([f90dde3][260])

## [6.0.5][261] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][262])

## [6.0.4][263] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][264])

## [6.0.3][265] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][266])
- **.github:** fix cleanup ([7520e0f][267])

## [6.0.2][268] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][269])
- **release.config.js:** remove console.info ([b374296][270])

## [6.0.1][271] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][272])

# [6.0.0][273] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][274])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][275] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][277])

## [5.0.2][278] (2020-12-29)
...
## [5.0.1][280] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][281])
- **package.json:** add codecov package ([d73cac9][282])
- **package.json:** remove codecov package ([da477b7][283])

# [5.0.0][284] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][285])
...
- Update comment language ([5a2aef4][288])
...
## [3.0.1][289] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][290])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][291])

### Build System

- **package.json:** update deps ([a876517][292])

# [3.0.0][293] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][294])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][295])
- **package.json:** use @xunnamius/semantic-release ([0447d59][296])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][297])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][298])
- **package-lock.json:** fix syntax error ([4fd2952][299])
...
- Added mult function ([e537358][301])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][302])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][303])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][304])
...
## [2.3.4][305] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][306])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][307])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][308])
- Added .env.example and env-expect ([efb29c5][309])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][310])

## [2.3.3][311] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][313])

## [2.3.2][314] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][315])

## [2.3.1][316] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][317])
- **release:** fix changelogTitle bug ([0d181ea][318])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][319])

# [2.3.0][320] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][321])

### Performance Improvements

- Better faster spellchecking ([c44c310][322])

## [2.2.2][323] (2020-11-29)
...
## [2.2.1][325] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][326])

# [2.2.0][327] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][329])
- **config:** fix broken changelog.config.js structure ([bd10f44][330])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][331])
- **package.json:** install lint-staged dep and script ([f3800e4][332])
- **package.json:** install spellcheck dependencies ([9a7adb4][333])
- **spellcheck:** change "contains" to "includes" ([af76dbe][334])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][335])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][336])

### Build System

- Install @semantic-release/exec ([cc94940][337])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][338])
- **config:** fix husky pre-commit hook ([f0d0032][339])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][340])
- **config:** retire @semantic-release/changelog ([787a281][341])

### Features

- Add build-changelog to npm scripts ([8393a87][342])

## [2.1.4][343] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][344])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][345])

## [2.1.3][346] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][347])

## [2.1.2][348] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][349])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][350])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][351])

## [2.1.1][352] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][353])

# [2.1.0][354] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][355])
- **actions:** if statements now use | instead of > ([24e3739][356])
- **actions:** move comments out of multiline statements ([874f8d6][357])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][361])
- Add build commits to release rule ([3124ab0][362])

# [2.0.0][363] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][364])
- **actions:** deps caching done properly ([bbe0416][365])
- **actions:** ensure repo is always checked out first ([65e5d46][366])
- **actions:** removed signed pushes ([f621f76][367])
- **package.json:** do not guess error codes ([f5428c8][368])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][369])
...
- Added diff to take the difference ([5e40deb][372])

### Performance Improvements

- **actions:** better caching ([6da0a65][373])
- **actions:** made test-integration-chrome independent ([d489cfa][374])
- **actions:** only cache node_modules ([57775c9][375])

### Reverts

- _"debug: added debug step"_ ([1741cde][376])
- _"debug: debug cache miss"_ ([42af347][377])
...
- Version 1.0.15 ([57faa2c][378])

<!---->

- Version 1.0.7 ([5ced626][379])

- Version 1.0.0 ([df91d82][380])
...
[381]: https://conventionalcommits.org
[382]: https://semver.org
[383]:
