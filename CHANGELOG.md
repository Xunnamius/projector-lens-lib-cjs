...
The format is based on [Conventional Commits][295], and this project adheres to
[Semantic Versioning][296].

# [7.6.0][297] (2021-01-29)

### Features

- **post-release-check.yml:** run executables as part of check ([31bdc0c][298])

## [7.5.18][1] (2021-01-29)

### Build System

- **build-test-deploy.yml:** drop support for webpack 4 ([e7f2bbb][2])
- **cleanup.yml:** fix bug for new package repos ([8d16630][3])

## [7.5.17][4] (2021-01-29)

### Build System

- **babel.config.js:** add plugin-rename-imports ([c59e45c][5])
- **build-test-deploy.yml:** remove externals exception ([3addf11][6])
- **test:** drop support for 10.x ([fb18856][7])
- **test:** standardize imports ([4f23d4e][8])

## [7.5.16][9] (2021-01-23)

### Build System

- **package.json:** nicer destructured vals in docs ([3b81944][10])

## [7.5.15][11] (2021-01-23)

### Build System

- Backport/normalize across packages ([85881f7][12])

## [7.5.14][13] (2021-01-22)

### Build System

- Update debug statement syntax ([107b953][14])

## [7.5.13][15] (2021-01-21)
...
## [7.5.12][17] (2021-01-17)

### Build System

- Backport changes from gac ([172fa77][18])

## [7.5.11][19] (2021-01-12)

### Build System

- Rebuild lockfile ([fef7222][20])
- Update babel-plugin-transform-mjs-imports ([16a597d][21])

## [7.5.10][22] (2021-01-12)

### Build System

- Update -browser to -client everywhere ([597d6c5][23])

## [7.5.9][24] (2021-01-10)

### Bug Fixes

- **webpack.config.js:** better process.env support ([25db498][25])

## [7.5.8][26] (2021-01-06)

### Build System

- **webpack.config.js:** process.env shim ([3973279][27])
...
- **package.json:** backported updates ([8a051d1][37])

## [7.5.2][38] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][39])

## [7.5.1][40] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][41])
- **package.json:** return browser test ([6c1c4d4][42])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][43])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][44])
- **package.json:** backports from the wild ([eda277e][45])
- **webpack.config.js:** add env-expect ([0f401ff][46])

# [7.5.0][47] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][48])
...
- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][52])
...
- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][54])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][55])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][56])
...
- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][59])
- **package.json:** revert "test: peer dep install" ([4c174fe][60])
- **package.json:** test: peer dep install ([6c00005][61])
...
- **.github:** add codecov to externals; add flags to codecov ([e47160b][66])

# [7.3.0][67] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][68])

### Build System

- **package.json:** better lint output ([0dc7c4e][69])

### Features

- **.github:** backport env matrix hint ([c01b325][70])
- **readme.md:** add NPM7 warning ([24f0888][71])

## [7.2.3][72] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][73])

## [7.2.2][74] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][75])

## [7.2.1][76] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][77])

# [7.2.0][78] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][79])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][80])
- **workflows:** fix should-skip determination algo ([f7d1256][81])

# [7.1.0][82] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][83])
- **readme.md:** complete skip test ([67264ed][84])
- **workflows:** replace should-skip determination algo ([cd6236a][85])

# [7.0.0][86] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][87])
...
- **.changelogrc.js:** show reverts in changelog ([ec26302][89])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][90])

## [6.7.2][91] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][92])
- _"debug(readme.md): debug debug"_ ([aff005d][93])

## [6.7.1][94] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][95])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][96])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][97])

### Build System

- **package.json:** better build-changelog ([f2e971e][98])

# [6.7.0][99] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][100])

# [6.6.0][101] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][102])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][103])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][104])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][105])
- **release.config.js:** use imported releaseRules ([2fe163c][106])

## [6.5.1][107] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][108])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][109])

# [6.5.0][110] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][111])

## [6.4.3][112] (2021-01-02)
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][114])
- **package.json:** remove deploy test script ([4fb641c][115])

## [6.4.2][116] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][117])

## [6.4.1][118] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support
  ([de7ef33][119])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][120])
- **release.config.js:** fix deploy to run at success step; add debug output
  ([b9e8cc5][121])

# [6.4.0][122] (2021-01-02)

### Features

- **package.json:** vercel deploy test ([ed73fc3][123])

## [6.3.8][124] (2021-01-02)
...
## [6.3.5][130] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][131])

## [6.3.4][132] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][133])
- Update remark linting to exit 1 on error, quiet on success ([077abce][134])
- Update sort-package-json to contrib-env-expect ([6885a34][135])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][136])

## [6.3.3][137] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][139])

## [6.3.2][140] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][141])

## [6.3.1][142] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][143])

# [6.3.0][144] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][145])

### Features

- **src:** add div function ([636c353][146])

# [6.2.0][147] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][148])
- **.husky:** remove verbose flag ([538c374][149])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][150])
- **package.json:** remove debug echo ([33a510d][151])
- **release.config.js:** fix to use gfm ([db4c284][152])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][153])

## [6.1.7][154] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][155])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][156])

## [6.1.6][157] (2020-12-30)
...
## [6.1.4][161] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][162])

## [6.1.3][163] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][164])
- **build-test-deploy.yml:** fix syntax error ([5448960][165])

## [6.1.2][166] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][167])
- **package.json:** remove high audit CI failure ([b2ea6f1][168])
- **package.json:** test high audit CI failure ([03825f0][169])

## [6.1.1][170] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][171])

# [6.1.0][172] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][173])

### Features

- **readme.md:** dummy feat ([f90dde3][174])

## [6.0.5][175] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][176])

## [6.0.4][177] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][178])

## [6.0.3][179] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][180])
- **.github:** fix cleanup ([7520e0f][181])

## [6.0.2][182] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][183])
- **release.config.js:** remove console.info ([b374296][184])

## [6.0.1][185] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][186])

# [6.0.0][187] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][188])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][189] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][191])

## [5.0.2][192] (2020-12-29)
...
## [5.0.1][194] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][195])
- **package.json:** add codecov package ([d73cac9][196])
- **package.json:** remove codecov package ([da477b7][197])

# [5.0.0][198] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][199])
...
- Update comment language ([5a2aef4][202])
...
## [3.0.1][203] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][204])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][205])

### Build System

- **package.json:** update deps ([a876517][206])

# [3.0.0][207] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][208])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][209])
- **package.json:** use @xunnamius/semantic-release ([0447d59][210])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][211])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][212])
- **package-lock.json:** fix syntax error ([4fd2952][213])
...
- Added mult function ([e537358][215])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][216])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][217])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][218])
...
## [2.3.4][219] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][220])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][221])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][222])
- Added .env.example and env-expect ([efb29c5][223])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][224])

## [2.3.3][225] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][227])

## [2.3.2][228] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][229])

## [2.3.1][230] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][231])
- **release:** fix changelogTitle bug ([0d181ea][232])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][233])

# [2.3.0][234] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][235])

### Performance Improvements

- Better faster spellchecking ([c44c310][236])

## [2.2.2][237] (2020-11-29)
...
## [2.2.1][239] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][240])

# [2.2.0][241] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][243])
- **config:** fix broken changelog.config.js structure ([bd10f44][244])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][245])
- **package.json:** install lint-staged dep and script ([f3800e4][246])
- **package.json:** install spellcheck dependencies ([9a7adb4][247])
- **spellcheck:** change "contains" to "includes" ([af76dbe][248])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][249])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][250])

### Build System

- Install @semantic-release/exec ([cc94940][251])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][252])
- **config:** fix husky pre-commit hook ([f0d0032][253])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][254])
- **config:** retire @semantic-release/changelog ([787a281][255])

### Features

- Add build-changelog to npm scripts ([8393a87][256])

## [2.1.4][257] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][258])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][259])

## [2.1.3][260] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][261])

## [2.1.2][262] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][263])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][264])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][265])

## [2.1.1][266] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][267])

# [2.1.0][268] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][269])
- **actions:** if statements now use | instead of > ([24e3739][270])
- **actions:** move comments out of multiline statements ([874f8d6][271])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][275])
- Add build commits to release rule ([3124ab0][276])

# [2.0.0][277] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][278])
- **actions:** deps caching done properly ([bbe0416][279])
- **actions:** ensure repo is always checked out first ([65e5d46][280])
- **actions:** removed signed pushes ([f621f76][281])
- **package.json:** do not guess error codes ([f5428c8][282])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][283])
...
- Added diff to take the difference ([5e40deb][286])

### Performance Improvements

- **actions:** better caching ([6da0a65][287])
- **actions:** made test-integration-chrome independent ([d489cfa][288])
- **actions:** only cache node_modules ([57775c9][289])

### Reverts

- _"debug: added debug step"_ ([1741cde][290])
- _"debug: debug cache miss"_ ([42af347][291])
...
- Version 1.0.15 ([57faa2c][292])

<!---->

- Version 1.0.7 ([5ced626][293])

- Version 1.0.0 ([df91d82][294])

[1]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.17...v7.5.18
[2]:
...
[4]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.16...v7.5.17
[5]:
...
[47]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.5...v7.5.0
[48]:
  https://github.com/Xunnamius/workflow-playground/commit/77c033ff143dff64455049b8314cd528bae4e198
[49]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.4...v7.4.5
[50]:
  https://github.com/Xunnamius/workflow-playground/commit/677b4cedff4d3e4541736e612035d909a0df6131
[51]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.3...v7.4.4
[52]:
  https://github.com/Xunnamius/workflow-playground/commit/5c8fefa330e31620fe2af848d42eb2c5ab881d02
[53]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.2...v7.4.3
[54]:
...
[58]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.1...v7.4.2
[59]:
...
[62]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.0...v7.4.1
[63]:
...
[65]: https://github.com/Xunnamius/workflow-playground/compare/v7.3.0...v7.4.0
[66]:
  https://github.com/Xunnamius/workflow-playground/commit/e47160b09b956e69f0d9eb0cab01a3440bb66645
[67]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.3...v7.3.0
[68]:
...
[72]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.2...v7.2.3
[73]:
  https://github.com/Xunnamius/workflow-playground/commit/786942001834cb5337fabf921cbc14ea4cc04d2f
[74]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.1...v7.2.2
[75]:
  https://github.com/Xunnamius/workflow-playground/commit/a8cd37812dc9e304bf813c742b2d4d54c1c9c183
[76]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.0...v7.2.1
[77]:
  https://github.com/Xunnamius/workflow-playground/commit/73edb9a864bbc4b7d5a7eb1d03ca4ce3b8e02e95
[78]: https://github.com/Xunnamius/workflow-playground/compare/v7.1.0...v7.2.0
[79]:
...
[82]: https://github.com/Xunnamius/workflow-playground/compare/v7.0.0...v7.1.0
[83]:
...
[86]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.3...v7.0.0
[87]:
  https://github.com/Xunnamius/workflow-playground/commit/5765c024e82c3e7e0c77808e3860c85fb8c8d759
[88]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.2...v6.7.3
[89]:
...
[91]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.1...v6.7.2
[92]:
...
[94]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.0...v6.7.1
[95]:
...
[99]: https://github.com/Xunnamius/workflow-playground/compare/v6.6.0...v6.7.0
[100]:
  https://github.com/Xunnamius/workflow-playground/commit/1fdcb9c6c500f88fbc2b7b6ec7f427f0a4995080
[101]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.1...v6.6.0
[102]:
...
[107]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.0...v6.5.1
[108]:
...
[110]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.3...v6.5.0
[111]:
  https://github.com/Xunnamius/workflow-playground/commit/54488d92317360c2e358bca9238e60e2daca64dd
[112]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[113]:
...
[116]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[117]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[118]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[119]:
...
[137]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[138]:
...
[140]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[141]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[142]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[143]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[144]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[145]:
...
[147]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[148]:
...
[154]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[155]:
...
[157]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[158]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[159]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[160]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[161]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[162]:
  https://github.com/Xunnamius/workflow-playground/commit/44f5cd4c3c6adeb548ba89adba8e884336f41520
[163]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[164]:
...
[166]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[167]:
...
[170]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[171]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[172]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[173]:
...
[175]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[176]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[177]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[178]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[179]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[180]:
...
[182]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[183]:
...
[185]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.0...v6.0.1
[186]:
  https://github.com/Xunnamius/workflow-playground/commit/d40192bd13d9b301e09723cdca68be60b44b5d82
[187]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.3...v6.0.0
[188]:
  https://github.com/Xunnamius/workflow-playground/commit/95a13d21dd902a490d445d3c8aee89c59b2131f1
[189]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.2...v5.0.3
[190]:
...
[192]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.1...v5.0.2
[193]:
  https://github.com/Xunnamius/workflow-playground/commit/e62c5b42ca2b43326cc9eec8db248020b2d90ec8
[194]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.0...v5.0.1
[195]:
...
[198]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[199]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[200]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[201]:
...
[203]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[204]:
...
[207]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[208]:
...
[219]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[220]:
...
[225]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[226]:
...
[228]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[229]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[230]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[231]:
...
[234]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[235]:
...
[237]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[238]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[239]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[240]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[241]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[242]:
...
[257]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[258]:
...
[260]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[261]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[262]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[263]:
...
[266]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[267]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[268]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[269]:
...
[273]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[274]:
...
[277]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[278]:
...
[295]: https://conventionalcommits.org
[296]: https://semver.org
[297]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.18...v7.6.0
[298]:
