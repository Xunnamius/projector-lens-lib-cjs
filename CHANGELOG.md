...
The format is based on [Conventional Commits][210], and this project adheres to
[Semantic Versioning][211].

# [7.1.0][212] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][213])
...
- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][2])
...
- **.changelogrc.js:** show reverts in changelog ([ec26302][4])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][5])

## [6.7.2][6] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][7])
- _"debug(readme.md): debug debug"_ ([aff005d][8])

## [6.7.1][9] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][10])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][11])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][12])

### Build System

- **package.json:** better build-changelog ([f2e971e][13])

# [6.7.0][14] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][15])

# [6.6.0][16] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][17])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][18])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][19])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][20])
- **release.config.js:** use imported releaseRules ([2fe163c][21])

## [6.5.1][22] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][23])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][24])

# [6.5.0][25] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][26])
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][29])
- **package.json:** remove deploy test script ([4fb641c][30])

## [6.4.2][31] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][32])

## [6.4.1][33] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support ([de7ef33][34])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][35])
...
- **package.json:** vercel deploy test ([ed73fc3][38])
...
- **.github/workflows/cleanup.yml:** fix metadata gathering step ([44dd462][42])

## [6.3.6][43] (2021-01-01)

### Build System

- **.github/workflows/cleanup.yml:** add metadata filtering step ([6667075][44])

## [6.3.5][45] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][46])

## [6.3.4][47] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][48])
- Update remark linting to exit 1 on error, quiet on success ([077abce][49])
- Update sort-package-json to contrib-env-expect ([6885a34][50])
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][54])

## [6.3.2][55] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][56])

## [6.3.1][57] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][58])

# [6.3.0][59] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][60])

### Features

- **src:** add div function ([636c353][61])
...
- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][63])
- **.husky:** remove verbose flag ([538c374][64])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][65])
- **package.json:** remove debug echo ([33a510d][66])
- **release.config.js:** fix to use gfm ([db4c284][67])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][68])

## [6.1.7][69] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][70])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][71])
...
- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][77])

## [6.1.3][78] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][79])
- **build-test-deploy.yml:** fix syntax error ([5448960][80])

## [6.1.2][81] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][82])
- **package.json:** remove high audit CI failure ([b2ea6f1][83])
- **package.json:** test high audit CI failure ([03825f0][84])

## [6.1.1][85] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][86])

# [6.1.0][87] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][88])

### Features

- **readme.md:** dummy feat ([f90dde3][89])

## [6.0.5][90] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][91])

## [6.0.4][92] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][93])

## [6.0.3][94] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][95])
- **.github:** fix cleanup ([7520e0f][96])

## [6.0.2][97] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][98])
- **release.config.js:** remove console.info ([b374296][99])

## [6.0.1][100] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][101])

# [6.0.0][102] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][103])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][104] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][106])

## [5.0.2][107] (2020-12-29)
...
## [5.0.1][109] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][110])
- **package.json:** add codecov package ([d73cac9][111])
- **package.json:** remove codecov package ([da477b7][112])

# [5.0.0][113] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][114])
...
- Update comment language ([5a2aef4][117])
...
## [3.0.1][118] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][119])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][120])

### Build System

- **package.json:** update deps ([a876517][121])

# [3.0.0][122] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][123])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][124])
- **package.json:** use @xunnamius/semantic-release ([0447d59][125])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][126])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][127])
- **package-lock.json:** fix syntax error ([4fd2952][128])
...
- Added mult function ([e537358][130])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][131])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][132])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][133])
...
## [2.3.4][134] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][135])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][136])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][137])
- Added .env.example and env-expect ([efb29c5][138])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][139])

## [2.3.3][140] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][142])

## [2.3.2][143] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][144])

## [2.3.1][145] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][146])
- **release:** fix changelogTitle bug ([0d181ea][147])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][148])

# [2.3.0][149] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][150])

### Performance Improvements

- Better faster spellchecking ([c44c310][151])

## [2.2.2][152] (2020-11-29)
...
## [2.2.1][154] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][155])

# [2.2.0][156] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][158])
- **config:** fix broken changelog.config.js structure ([bd10f44][159])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][160])
- **package.json:** install lint-staged dep and script ([f3800e4][161])
- **package.json:** install spellcheck dependencies ([9a7adb4][162])
- **spellcheck:** change "contains" to "includes" ([af76dbe][163])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][164])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][165])

### Build System

- Install @semantic-release/exec ([cc94940][166])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][167])
- **config:** fix husky pre-commit hook ([f0d0032][168])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][169])
- **config:** retire @semantic-release/changelog ([787a281][170])

### Features

- Add build-changelog to npm scripts ([8393a87][171])

## [2.1.4][172] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][173])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][174])

## [2.1.3][175] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][176])

## [2.1.2][177] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][178])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][179])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][180])

## [2.1.1][181] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][182])

# [2.1.0][183] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][184])
- **actions:** if statements now use | instead of > ([24e3739][185])
- **actions:** move comments out of multiline statements ([874f8d6][186])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][190])
- Add build commits to release rule ([3124ab0][191])

# [2.0.0][192] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][193])
- **actions:** deps caching done properly ([bbe0416][194])
- **actions:** ensure repo is always checked out first ([65e5d46][195])
- **actions:** removed signed pushes ([f621f76][196])
- **package.json:** do not guess error codes ([f5428c8][197])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][198])
...
- Added diff to take the difference ([5e40deb][201])

### Performance Improvements

- **actions:** better caching ([6da0a65][202])
- **actions:** made test-integration-chrome independent ([d489cfa][203])
- **actions:** only cache node_modules ([57775c9][204])

### Reverts

- _"debug: added debug step"_ ([1741cde][205])
- _"debug: debug cache miss"_ ([42af347][206])
...
- Version 1.0.15 ([57faa2c][207])

<!---->

- Version 1.0.7 ([5ced626][208])

- Version 1.0.0 ([df91d82][209])

[1]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.3...v7.0.0
[2]:
  https://github.com/Xunnamius/workflow-playground/commit/5765c024e82c3e7e0c77808e3860c85fb8c8d759
[3]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.2...v6.7.3
[4]:
...
[6]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.1...v6.7.2
[7]:
...
[9]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.0...v6.7.1
[10]:
...
[14]: https://github.com/Xunnamius/workflow-playground/compare/v6.6.0...v6.7.0
[15]:
  https://github.com/Xunnamius/workflow-playground/commit/1fdcb9c6c500f88fbc2b7b6ec7f427f0a4995080
[16]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.1...v6.6.0
[17]:
...
[22]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.0...v6.5.1
[23]:
...
[25]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.3...v6.5.0
[26]:
  https://github.com/Xunnamius/workflow-playground/commit/54488d92317360c2e358bca9238e60e2daca64dd
[27]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[28]:
...
[31]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[32]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[33]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[34]:
...
[52]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[53]:
...
[55]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[56]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[57]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[58]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[59]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[60]:
...
[62]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[63]:
...
[69]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[70]:
...
[72]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[73]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[74]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[75]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[76]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[77]:
  https://github.com/Xunnamius/workflow-playground/commit/44f5cd4c3c6adeb548ba89adba8e884336f41520
[78]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[79]:
...
[81]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[82]:
...
[85]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[86]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[87]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[88]:
...
[90]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[91]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[92]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[93]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[94]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[95]:
...
[97]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[98]:
...
[100]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.0...v6.0.1
[101]:
  https://github.com/Xunnamius/workflow-playground/commit/d40192bd13d9b301e09723cdca68be60b44b5d82
[102]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.3...v6.0.0
[103]:
  https://github.com/Xunnamius/workflow-playground/commit/95a13d21dd902a490d445d3c8aee89c59b2131f1
[104]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.2...v5.0.3
[105]:
...
[107]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.1...v5.0.2
[108]:
  https://github.com/Xunnamius/workflow-playground/commit/e62c5b42ca2b43326cc9eec8db248020b2d90ec8
[109]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.0...v5.0.1
[110]:
...
[113]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[114]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[115]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[116]:
...
[118]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[119]:
...
[122]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[123]:
...
[134]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[135]:
...
[140]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[141]:
...
[143]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[144]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[145]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[146]:
...
[149]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[150]:
...
[152]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[153]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[154]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[155]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[156]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[157]:
...
[172]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[173]:
...
[175]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[176]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[177]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[178]:
...
[181]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[182]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[183]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[184]:
...
[188]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[189]:
...
[192]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[193]:
...
[212]: https://github.com/Xunnamius/workflow-playground/compare/v7.0.0...v7.1.0
[213]:
