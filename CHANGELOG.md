...
The format is based on [Conventional Commits][366], and this project adheres to
[Semantic Versioning][367].

## [7.8.13][368] (2021-02-21)

### Bug Fixes

- **setup.ts:** backport setup fix ([ee1aca2][369])

## [7.8.12][1] (2021-02-21)

### Build System

- **package.json:** chmod cli during build-dist step ([d6f8cc3][2])

## [7.8.11][3] (2021-02-21)

### Build System

- **expect-env.js:** rename from env-expect.js ([aa14ed9][4])

## [7.8.10][5] (2021-02-21)

### Bug Fixes

- **build-test-deploy.yml:** check real exit code ([4ff058e][6])

## [7.8.9][7] (2021-02-20)

### Build System

- **package-lock.json:** make consistent with package.json ([8a63ac7][8])
- **package.json:** remove extraneous module ([1012053][9])

## [7.8.8][10] (2021-02-20)

### Build System

- **deps:** bump object-path from 0.11.3 to 0.11.5 ([95c974a][11])

## [7.8.7][12] (2021-02-20)

### Bug Fixes

- Package.json & package-lock.json to reduce vulnerabilities ([41de5ce][13])

## [7.8.6][14] (2021-02-20)

### Bug Fixes

- **build-test-deploy.yml:** even more resilient error checking ([b050bba][15])

### Build System

- **deps:** bump object-path from 0.11.3 to 0.11.5 ([981229a][16])
...
- **build-test-deploy.yml:** better error handling and debug messaging for
  auto-merge job ([2dee6f6][18])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([1667e70][19])
...
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([e9e3ca1][22])
...
- **build-test-deploy.yml:** better error messages ([6d5573e][25])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([c493a8c][26])

## [7.8.2][27] (2021-02-20)

### Build System

- **deps:** bump object-path from 0.11.4 to 0.11.5 ([aaf7665][28])

## [7.8.1][29] (2021-02-20)

### Bug Fixes

- **build-test-deploy.yml:** store and use proper result ([09d35d7][30])

### Build System

- **deps:** bump object-path from 0.11.4 to 0.11.5 ([658f591][31])
- **package.json:** bump jest timeout to 1 minute ([cb59af2][32])
...
- **build-test-deploy.yml:** whitelist is again case-insensitive ([c034e86][36])

### Build System

- **build-test-deploy.yml:** also run on reopened PRs ([ece78e3][37])
- **build-test-deploy.yml:** codecov failures no longer fail the whole pipeline
  ([a111d7f][38])
- **build-test-deploy.yml:** restructure env w/ comments ([b980cbe][39])
- **build-test-deploy.yml:** update repo owner whitelist step ([b4f89cf][40])

# [7.7.0][41] (2021-02-19)

### Bug Fixes

- Account for node 12 ([4cdb325][42])
...
- **package.json:** external integration test runs w/ proper prefix
  ([5056c05][44])
- **package.json:** update deps ([4ef9c1b][45])

### Features

- **external-scripts:** reorganize externals; rename external to dummy
  ([efc916e][46])
- **test:** externalize jest helper proto-packages ([2dbfb8e][47])

## [7.6.5][48] (2021-02-15)

### Build System

- **package.json:** add private:false ([090cdfe][49])

## [7.6.4][50] (2021-02-14)

### Bug Fixes

- **webpack.config.js:** call dotenv properly ([22a8424][51])

## [7.6.3][52] (2021-02-14)

### Bug Fixes

- Incorrect package name ([bbbd58d][53])

### Build System

- **package.json:** update deps ([599b6c2][54])
...
- **package.json:** account for new ./dist organization ([99a01ea][57])

### Build System

- **test:** complete testing suite ([35da4c3][58])
- **webpack.config.js:** add externals ([7a8f54b][59])
- Move debug to deps, update dependencies ([6587184][60])
- **.eslintrc.js:** false env browser/webextensions ([71809e9][61])
- **integration-client.test.ts:** removed ([f080ad0][62])
- Normalize across repos ([2020d61][63])
- **webpack.config.js:** normalize webpack configuration across repos
  ([8a3bc81][64])
- **webpack.config.js:** remove ES6 syntax from JS file ([dd2b254][65])
...
- **babel.config.js:** add babel-plugin-transform-default-named-imports
  ([720dc20][67])
- **package.json:** update deps ([26a8371][68])
...
- **post-release-check.yml:** run executables as part of check ([31bdc0c][71])

## [7.5.18][72] (2021-01-29)

### Build System

- **build-test-deploy.yml:** drop support for webpack 4 ([e7f2bbb][73])
- **cleanup.yml:** fix bug for new package repos ([8d16630][74])

## [7.5.17][75] (2021-01-29)

### Build System

- **babel.config.js:** add plugin-rename-imports ([c59e45c][76])
- **build-test-deploy.yml:** remove externals exception ([3addf11][77])
- **test:** drop support for 10.x ([fb18856][78])
- **test:** standardize imports ([4f23d4e][79])

## [7.5.16][80] (2021-01-23)

### Build System

- **package.json:** nicer destructured vals in docs ([3b81944][81])

## [7.5.15][82] (2021-01-23)

### Build System

- Backport/normalize across packages ([85881f7][83])

## [7.5.14][84] (2021-01-22)

### Build System

- Update debug statement syntax ([107b953][85])

## [7.5.13][86] (2021-01-21)
...
## [7.5.12][88] (2021-01-17)

### Build System

- Backport changes from gac ([172fa77][89])

## [7.5.11][90] (2021-01-12)

### Build System

- Rebuild lockfile ([fef7222][91])
- Update babel-plugin-transform-mjs-imports ([16a597d][92])

## [7.5.10][93] (2021-01-12)

### Build System

- Update -browser to -client everywhere ([597d6c5][94])

## [7.5.9][95] (2021-01-10)

### Bug Fixes

- **webpack.config.js:** better process.env support ([25db498][96])

## [7.5.8][97] (2021-01-06)

### Build System

- **webpack.config.js:** process.env shim ([3973279][98])
...
## [7.5.3][107] (2021-01-05)

### Build System

- **package.json:** backported updates ([8a051d1][108])

## [7.5.2][109] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][110])

## [7.5.1][111] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][112])
- **package.json:** return browser test ([6c1c4d4][113])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][114])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][115])
- **package.json:** backports from the wild ([eda277e][116])
- **webpack.config.js:** add env-expect ([0f401ff][117])

# [7.5.0][118] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][119])

## [7.4.5][120] (2021-01-05)
...
## [7.4.4][122] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][123])

## [7.4.3][124] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][125])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][126])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][127])
- **.github/workflows/build-test-deploy.yml:** fix debug output (normalize node
  support) ([0528db6][128])

## [7.4.2][129] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][130])
- **package.json:** revert "test: peer dep install" ([4c174fe][131])
- **package.json:** test: peer dep install ([6c00005][132])

## [7.4.1][133] (2021-01-04)
...
# [7.4.0][136] (2021-01-04)

### Features

- **.github:** add codecov to externals; add flags to codecov ([e47160b][137])

# [7.3.0][138] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][139])

### Build System

- **package.json:** better lint output ([0dc7c4e][140])

### Features

- **.github:** backport env matrix hint ([c01b325][141])
- **readme.md:** add NPM7 warning ([24f0888][142])

## [7.2.3][143] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][144])

## [7.2.2][145] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][146])

## [7.2.1][147] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][148])

# [7.2.0][149] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][150])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][151])
- **workflows:** fix should-skip determination algo ([f7d1256][152])

# [7.1.0][153] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][154])
- **readme.md:** complete skip test ([67264ed][155])
- **workflows:** replace should-skip determination algo ([cd6236a][156])

# [7.0.0][157] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][158])

### BREAKING CHANGES

- **changelog.md:** **skip github/github skip options were removed**

## [6.7.3][159] (2021-01-03)

### Bug Fixes

- **.changelogrc.js:** show reverts in changelog ([ec26302][160])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][161])

## [6.7.2][162] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][163])
- _"debug(readme.md): debug debug"_ ([aff005d][164])

## [6.7.1][165] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][166])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][167])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][168])

### Build System

- **package.json:** better build-changelog ([f2e971e][169])

# [6.7.0][170] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][171])

# [6.6.0][172] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][173])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][174])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][175])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][176])
- **release.config.js:** use imported releaseRules ([2fe163c][177])

## [6.5.1][178] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][179])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][180])

# [6.5.0][181] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][182])

## [6.4.3][183] (2021-01-02)
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][185])
- **package.json:** remove deploy test script ([4fb641c][186])

## [6.4.2][187] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][188])

## [6.4.1][189] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support
  ([de7ef33][190])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][191])
- **release.config.js:** fix deploy to run at success step; add debug output
  ([b9e8cc5][192])

# [6.4.0][193] (2021-01-02)

### Features

- **package.json:** vercel deploy test ([ed73fc3][194])

## [6.3.8][195] (2021-01-02)
...
## [6.3.5][201] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][202])

## [6.3.4][203] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][204])
- Update remark linting to exit 1 on error, quiet on success ([077abce][205])
- Update sort-package-json to contrib-env-expect ([6885a34][206])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][207])

## [6.3.3][208] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][210])

## [6.3.2][211] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][212])

## [6.3.1][213] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][214])

# [6.3.0][215] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][216])

### Features

- **src:** add div function ([636c353][217])

# [6.2.0][218] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][219])
- **.husky:** remove verbose flag ([538c374][220])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][221])
- **package.json:** remove debug echo ([33a510d][222])
- **release.config.js:** fix to use gfm ([db4c284][223])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][224])

## [6.1.7][225] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][226])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][227])

## [6.1.6][228] (2020-12-30)
...
## [6.1.4][232] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][233])

## [6.1.3][234] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][235])
- **build-test-deploy.yml:** fix syntax error ([5448960][236])

## [6.1.2][237] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][238])
- **package.json:** remove high audit CI failure ([b2ea6f1][239])
- **package.json:** test high audit CI failure ([03825f0][240])

## [6.1.1][241] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][242])

# [6.1.0][243] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][244])

### Features

- **readme.md:** dummy feat ([f90dde3][245])

## [6.0.5][246] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][247])

## [6.0.4][248] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][249])

## [6.0.3][250] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][251])
- **.github:** fix cleanup ([7520e0f][252])

## [6.0.2][253] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][254])
- **release.config.js:** remove console.info ([b374296][255])

## [6.0.1][256] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][257])

# [6.0.0][258] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][259])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][260] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][262])

## [5.0.2][263] (2020-12-29)
...
## [5.0.1][265] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][266])
- **package.json:** add codecov package ([d73cac9][267])
- **package.json:** remove codecov package ([da477b7][268])

# [5.0.0][269] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][270])
...
- Update comment language ([5a2aef4][273])
...
## [3.0.1][274] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][275])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][276])

### Build System

- **package.json:** update deps ([a876517][277])

# [3.0.0][278] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][279])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][280])
- **package.json:** use @xunnamius/semantic-release ([0447d59][281])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][282])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][283])
- **package-lock.json:** fix syntax error ([4fd2952][284])
...
- Added mult function ([e537358][286])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][287])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][288])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][289])
...
## [2.3.4][290] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][291])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][292])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][293])
- Added .env.example and env-expect ([efb29c5][294])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][295])

## [2.3.3][296] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][298])

## [2.3.2][299] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][300])

## [2.3.1][301] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][302])
- **release:** fix changelogTitle bug ([0d181ea][303])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][304])

# [2.3.0][305] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][306])

### Performance Improvements

- Better faster spellchecking ([c44c310][307])

## [2.2.2][308] (2020-11-29)
...
## [2.2.1][310] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][311])

# [2.2.0][312] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][314])
- **config:** fix broken changelog.config.js structure ([bd10f44][315])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][316])
- **package.json:** install lint-staged dep and script ([f3800e4][317])
- **package.json:** install spellcheck dependencies ([9a7adb4][318])
- **spellcheck:** change "contains" to "includes" ([af76dbe][319])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][320])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][321])

### Build System

- Install @semantic-release/exec ([cc94940][322])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][323])
- **config:** fix husky pre-commit hook ([f0d0032][324])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][325])
- **config:** retire @semantic-release/changelog ([787a281][326])

### Features

- Add build-changelog to npm scripts ([8393a87][327])

## [2.1.4][328] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][329])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][330])

## [2.1.3][331] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][332])

## [2.1.2][333] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][334])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][335])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][336])

## [2.1.1][337] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][338])

# [2.1.0][339] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][340])
- **actions:** if statements now use | instead of > ([24e3739][341])
- **actions:** move comments out of multiline statements ([874f8d6][342])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][346])
- Add build commits to release rule ([3124ab0][347])

# [2.0.0][348] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][349])
- **actions:** deps caching done properly ([bbe0416][350])
- **actions:** ensure repo is always checked out first ([65e5d46][351])
- **actions:** removed signed pushes ([f621f76][352])
- **package.json:** do not guess error codes ([f5428c8][353])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][354])
...
- Added diff to take the difference ([5e40deb][357])

### Performance Improvements

- **actions:** better caching ([6da0a65][358])
- **actions:** made test-integration-chrome independent ([d489cfa][359])
- **actions:** only cache node_modules ([57775c9][360])

### Reverts

- _"debug: added debug step"_ ([1741cde][361])
- _"debug: debug cache miss"_ ([42af347][362])
...
- Version 1.0.15 ([57faa2c][363])

<!---->

- Version 1.0.7 ([5ced626][364])

- Version 1.0.0 ([df91d82][365])
...
[7]: https://github.com/Xunnamius/projector-lens-lib-cjs/compare/v7.8.8...v7.8.9
[8]:
...
[366]: https://conventionalcommits.org
[367]: https://semver.org
[368]:
