...
The format is based on [Conventional Commits][277], and this project adheres to
[Semantic Versioning][278].

## [7.5.12][279] (2021-01-17)

### Build System

- Backport changes from gac ([172fa77][280])

## [7.5.11][1] (2021-01-12)

### Build System

- Rebuild lockfile ([fef7222][2])
- Update babel-plugin-transform-mjs-imports ([16a597d][3])

## [7.5.10][4] (2021-01-12)

### Build System

- Update -browser to -client everywhere ([597d6c5][5])

## [7.5.9][6] (2021-01-10)

### Bug Fixes

- **webpack.config.js:** better process.env support ([25db498][7])

## [7.5.8][8] (2021-01-06)

### Build System

- **webpack.config.js:** process.env shim ([3973279][9])
...
- **package.json:** backported updates ([8a051d1][19])

## [7.5.2][20] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][21])

## [7.5.1][22] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][23])
- **package.json:** return browser test ([6c1c4d4][24])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][25])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][26])
- **package.json:** backports from the wild ([eda277e][27])
- **webpack.config.js:** add env-expect ([0f401ff][28])

# [7.5.0][29] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][30])
...
- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][34])
...
- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][36])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][37])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][38])
...
- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][41])
- **package.json:** revert "test: peer dep install" ([4c174fe][42])
- **package.json:** test: peer dep install ([6c00005][43])
...
- **.github:** add codecov to externals; add flags to codecov ([e47160b][48])

# [7.3.0][49] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][50])

### Build System

- **package.json:** better lint output ([0dc7c4e][51])

### Features

- **.github:** backport env matrix hint ([c01b325][52])
- **readme.md:** add NPM7 warning ([24f0888][53])

## [7.2.3][54] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][55])

## [7.2.2][56] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][57])

## [7.2.1][58] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][59])

# [7.2.0][60] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][61])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][62])
- **workflows:** fix should-skip determination algo ([f7d1256][63])

# [7.1.0][64] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][65])
- **readme.md:** complete skip test ([67264ed][66])
- **workflows:** replace should-skip determination algo ([cd6236a][67])

# [7.0.0][68] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][69])
...
- **.changelogrc.js:** show reverts in changelog ([ec26302][71])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][72])

## [6.7.2][73] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][74])
- _"debug(readme.md): debug debug"_ ([aff005d][75])

## [6.7.1][76] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][77])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][78])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][79])

### Build System

- **package.json:** better build-changelog ([f2e971e][80])

# [6.7.0][81] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][82])

# [6.6.0][83] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][84])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][85])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][86])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][87])
- **release.config.js:** use imported releaseRules ([2fe163c][88])

## [6.5.1][89] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][90])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][91])

# [6.5.0][92] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][93])
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][96])
- **package.json:** remove deploy test script ([4fb641c][97])

## [6.4.2][98] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][99])

## [6.4.1][100] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support
  ([de7ef33][101])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][102])
- **release.config.js:** fix deploy to run at success step; add debug output
  ([b9e8cc5][103])

# [6.4.0][104] (2021-01-02)

### Features

- **package.json:** vercel deploy test ([ed73fc3][105])

## [6.3.8][106] (2021-01-02)
...
## [6.3.5][112] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][113])

## [6.3.4][114] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][115])
- Update remark linting to exit 1 on error, quiet on success ([077abce][116])
- Update sort-package-json to contrib-env-expect ([6885a34][117])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][118])

## [6.3.3][119] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][121])

## [6.3.2][122] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][123])

## [6.3.1][124] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][125])

# [6.3.0][126] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][127])

### Features

- **src:** add div function ([636c353][128])

# [6.2.0][129] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][130])
- **.husky:** remove verbose flag ([538c374][131])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][132])
- **package.json:** remove debug echo ([33a510d][133])
- **release.config.js:** fix to use gfm ([db4c284][134])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][135])

## [6.1.7][136] (2020-12-31)
...
- _"chore(readme.md): format husky test"_ ([9675eeb][138])

## [6.1.6][139] (2020-12-30)
...
## [6.1.4][143] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][144])

## [6.1.3][145] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][146])
- **build-test-deploy.yml:** fix syntax error ([5448960][147])

## [6.1.2][148] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][149])
- **package.json:** remove high audit CI failure ([b2ea6f1][150])
- **package.json:** test high audit CI failure ([03825f0][151])

## [6.1.1][152] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][153])

# [6.1.0][154] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][155])

### Features

- **readme.md:** dummy feat ([f90dde3][156])

## [6.0.5][157] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][158])

## [6.0.4][159] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][160])

## [6.0.3][161] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][162])
- **.github:** fix cleanup ([7520e0f][163])

## [6.0.2][164] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][165])
- **release.config.js:** remove console.info ([b374296][166])

## [6.0.1][167] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][168])

# [6.0.0][169] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][170])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][171] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][173])

## [5.0.2][174] (2020-12-29)
...
## [5.0.1][176] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][177])
- **package.json:** add codecov package ([d73cac9][178])
- **package.json:** remove codecov package ([da477b7][179])

# [5.0.0][180] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][181])
...
- Update comment language ([5a2aef4][184])
...
## [3.0.1][185] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][186])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][187])

### Build System

- **package.json:** update deps ([a876517][188])

# [3.0.0][189] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][190])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][191])
- **package.json:** use @xunnamius/semantic-release ([0447d59][192])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][193])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][194])
- **package-lock.json:** fix syntax error ([4fd2952][195])
...
- Added mult function ([e537358][197])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][198])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][199])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][200])
...
## [2.3.4][201] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][202])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][203])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][204])
- Added .env.example and env-expect ([efb29c5][205])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][206])

## [2.3.3][207] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][209])

## [2.3.2][210] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][211])

## [2.3.1][212] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][213])
- **release:** fix changelogTitle bug ([0d181ea][214])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][215])

# [2.3.0][216] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][217])

### Performance Improvements

- Better faster spellchecking ([c44c310][218])

## [2.2.2][219] (2020-11-29)
...
## [2.2.1][221] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][222])

# [2.2.0][223] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][225])
- **config:** fix broken changelog.config.js structure ([bd10f44][226])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][227])
- **package.json:** install lint-staged dep and script ([f3800e4][228])
- **package.json:** install spellcheck dependencies ([9a7adb4][229])
- **spellcheck:** change "contains" to "includes" ([af76dbe][230])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][231])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][232])

### Build System

- Install @semantic-release/exec ([cc94940][233])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][234])
- **config:** fix husky pre-commit hook ([f0d0032][235])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][236])
- **config:** retire @semantic-release/changelog ([787a281][237])

### Features

- Add build-changelog to npm scripts ([8393a87][238])

## [2.1.4][239] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][240])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][241])

## [2.1.3][242] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][243])

## [2.1.2][244] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][245])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][246])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][247])

## [2.1.1][248] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][249])

# [2.1.0][250] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][251])
- **actions:** if statements now use | instead of > ([24e3739][252])
- **actions:** move comments out of multiline statements ([874f8d6][253])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][257])
- Add build commits to release rule ([3124ab0][258])

# [2.0.0][259] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][260])
- **actions:** deps caching done properly ([bbe0416][261])
- **actions:** ensure repo is always checked out first ([65e5d46][262])
- **actions:** removed signed pushes ([f621f76][263])
- **package.json:** do not guess error codes ([f5428c8][264])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][265])
...
- Added diff to take the difference ([5e40deb][268])

### Performance Improvements

- **actions:** better caching ([6da0a65][269])
- **actions:** made test-integration-chrome independent ([d489cfa][270])
- **actions:** only cache node_modules ([57775c9][271])

### Reverts

- _"debug: added debug step"_ ([1741cde][272])
- _"debug: debug cache miss"_ ([42af347][273])
...
- Version 1.0.15 ([57faa2c][274])

<!---->

- Version 1.0.7 ([5ced626][275])

- Version 1.0.0 ([df91d82][276])

[1]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.10...v7.5.11
[2]:
...
[29]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.5...v7.5.0
[30]:
  https://github.com/Xunnamius/workflow-playground/commit/77c033ff143dff64455049b8314cd528bae4e198
[31]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.4...v7.4.5
[32]:
  https://github.com/Xunnamius/workflow-playground/commit/677b4cedff4d3e4541736e612035d909a0df6131
[33]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.3...v7.4.4
[34]:
  https://github.com/Xunnamius/workflow-playground/commit/5c8fefa330e31620fe2af848d42eb2c5ab881d02
[35]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.2...v7.4.3
[36]:
...
[40]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.1...v7.4.2
[41]:
...
[44]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.0...v7.4.1
[45]:
...
[47]: https://github.com/Xunnamius/workflow-playground/compare/v7.3.0...v7.4.0
[48]:
  https://github.com/Xunnamius/workflow-playground/commit/e47160b09b956e69f0d9eb0cab01a3440bb66645
[49]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.3...v7.3.0
[50]:
...
[54]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.2...v7.2.3
[55]:
  https://github.com/Xunnamius/workflow-playground/commit/786942001834cb5337fabf921cbc14ea4cc04d2f
[56]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.1...v7.2.2
[57]:
  https://github.com/Xunnamius/workflow-playground/commit/a8cd37812dc9e304bf813c742b2d4d54c1c9c183
[58]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.0...v7.2.1
[59]:
  https://github.com/Xunnamius/workflow-playground/commit/73edb9a864bbc4b7d5a7eb1d03ca4ce3b8e02e95
[60]: https://github.com/Xunnamius/workflow-playground/compare/v7.1.0...v7.2.0
[61]:
...
[64]: https://github.com/Xunnamius/workflow-playground/compare/v7.0.0...v7.1.0
[65]:
...
[68]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.3...v7.0.0
[69]:
  https://github.com/Xunnamius/workflow-playground/commit/5765c024e82c3e7e0c77808e3860c85fb8c8d759
[70]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.2...v6.7.3
[71]:
...
[73]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.1...v6.7.2
[74]:
...
[76]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.0...v6.7.1
[77]:
...
[81]: https://github.com/Xunnamius/workflow-playground/compare/v6.6.0...v6.7.0
[82]:
  https://github.com/Xunnamius/workflow-playground/commit/1fdcb9c6c500f88fbc2b7b6ec7f427f0a4995080
[83]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.1...v6.6.0
[84]:
...
[89]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.0...v6.5.1
[90]:
...
[92]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.3...v6.5.0
[93]:
  https://github.com/Xunnamius/workflow-playground/commit/54488d92317360c2e358bca9238e60e2daca64dd
[94]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[95]:
...
[98]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[99]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[100]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[101]:
...
[119]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[120]:
...
[122]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[123]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[124]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[125]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[126]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[127]:
...
[129]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[130]:
...
[136]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[137]:
...
[139]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[140]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[141]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[142]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[143]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[144]:
  https://github.com/Xunnamius/workflow-playground/commit/44f5cd4c3c6adeb548ba89adba8e884336f41520
[145]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[146]:
...
[148]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[149]:
...
[152]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[153]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[154]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[155]:
...
[157]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[158]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[159]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[160]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[161]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[162]:
...
[164]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[165]:
...
[167]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.0...v6.0.1
[168]:
  https://github.com/Xunnamius/workflow-playground/commit/d40192bd13d9b301e09723cdca68be60b44b5d82
[169]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.3...v6.0.0
[170]:
  https://github.com/Xunnamius/workflow-playground/commit/95a13d21dd902a490d445d3c8aee89c59b2131f1
[171]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.2...v5.0.3
[172]:
...
[174]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.1...v5.0.2
[175]:
  https://github.com/Xunnamius/workflow-playground/commit/e62c5b42ca2b43326cc9eec8db248020b2d90ec8
[176]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.0...v5.0.1
[177]:
...
[180]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[181]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[182]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[183]:
...
[185]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[186]:
...
[189]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[190]:
...
[201]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[202]:
...
[207]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[208]:
...
[210]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[211]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[212]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[213]:
...
[216]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[217]:
...
[219]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[220]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[221]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[222]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[223]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[224]:
...
[239]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[240]:
...
[242]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[243]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[244]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[245]:
...
[248]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[249]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[250]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[251]:
...
[255]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[256]:
...
[259]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[260]:
...
[277]: https://conventionalcommits.org
[278]: https://semver.org
[279]:
  https://github.com/Xunnamius/workflow-playground/compare/v7.5.11...v7.5.12
[280]:
