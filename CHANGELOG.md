...
The format is based on [Conventional Commits][245], and this project adheres to
[Semantic Versioning][246].

## [7.4.5][247] (2021-01-05)
...
- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][2])
...
- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][4])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][5])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][6])
...
- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][9])
- **package.json:** revert "test: peer dep install" ([4c174fe][10])
- **package.json:** test: peer dep install ([6c00005][11])
...
- **.github:** add codecov to externals; add flags to codecov ([e47160b][16])

# [7.3.0][17] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][18])

### Build System

- **package.json:** better lint output ([0dc7c4e][19])

### Features

- **.github:** backport env matrix hint ([c01b325][20])
- **readme.md:** add NPM7 warning ([24f0888][21])

## [7.2.3][22] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][23])

## [7.2.2][24] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][25])

## [7.2.1][26] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][27])

# [7.2.0][28] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][29])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][30])
- **workflows:** fix should-skip determination algo ([f7d1256][31])

# [7.1.0][32] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][33])
- **readme.md:** complete skip test ([67264ed][34])
- **workflows:** replace should-skip determination algo ([cd6236a][35])

# [7.0.0][36] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][37])
...
- **.changelogrc.js:** show reverts in changelog ([ec26302][39])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][40])

## [6.7.2][41] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][42])
- _"debug(readme.md): debug debug"_ ([aff005d][43])

## [6.7.1][44] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][45])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][46])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][47])

### Build System

- **package.json:** better build-changelog ([f2e971e][48])

# [6.7.0][49] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][50])

# [6.6.0][51] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][52])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][53])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][54])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][55])
- **release.config.js:** use imported releaseRules ([2fe163c][56])

## [6.5.1][57] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][58])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][59])

# [6.5.0][60] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][61])
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][64])
- **package.json:** remove deploy test script ([4fb641c][65])

## [6.4.2][66] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][67])

## [6.4.1][68] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support ([de7ef33][69])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][70])
...
- **package.json:** vercel deploy test ([ed73fc3][73])
...
- **.github/workflows/cleanup.yml:** fix metadata gathering step ([44dd462][77])

## [6.3.6][78] (2021-01-01)

### Build System

- **.github/workflows/cleanup.yml:** add metadata filtering step ([6667075][79])

## [6.3.5][80] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][81])

## [6.3.4][82] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][83])
- Update remark linting to exit 1 on error, quiet on success ([077abce][84])
- Update sort-package-json to contrib-env-expect ([6885a34][85])
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][89])

## [6.3.2][90] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][91])

## [6.3.1][92] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][93])

# [6.3.0][94] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][95])

### Features

- **src:** add div function ([636c353][96])
...
- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][98])
- **.husky:** remove verbose flag ([538c374][99])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][100])
- **package.json:** remove debug echo ([33a510d][101])
- **release.config.js:** fix to use gfm ([db4c284][102])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][103])

## [6.1.7][104] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][105])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][106])

## [6.1.6][107] (2020-12-30)
...
## [6.1.4][111] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][112])

## [6.1.3][113] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][114])
- **build-test-deploy.yml:** fix syntax error ([5448960][115])

## [6.1.2][116] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][117])
- **package.json:** remove high audit CI failure ([b2ea6f1][118])
- **package.json:** test high audit CI failure ([03825f0][119])

## [6.1.1][120] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][121])

# [6.1.0][122] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][123])

### Features

- **readme.md:** dummy feat ([f90dde3][124])

## [6.0.5][125] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][126])

## [6.0.4][127] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][128])

## [6.0.3][129] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][130])
- **.github:** fix cleanup ([7520e0f][131])

## [6.0.2][132] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][133])
- **release.config.js:** remove console.info ([b374296][134])

## [6.0.1][135] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][136])

# [6.0.0][137] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][138])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][139] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][141])

## [5.0.2][142] (2020-12-29)
...
## [5.0.1][144] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][145])
- **package.json:** add codecov package ([d73cac9][146])
- **package.json:** remove codecov package ([da477b7][147])

# [5.0.0][148] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][149])
...
- Update comment language ([5a2aef4][152])
...
## [3.0.1][153] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][154])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][155])

### Build System

- **package.json:** update deps ([a876517][156])

# [3.0.0][157] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][158])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][159])
- **package.json:** use @xunnamius/semantic-release ([0447d59][160])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][161])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][162])
- **package-lock.json:** fix syntax error ([4fd2952][163])
...
- Added mult function ([e537358][165])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][166])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][167])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][168])
...
## [2.3.4][169] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][170])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][171])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][172])
- Added .env.example and env-expect ([efb29c5][173])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][174])

## [2.3.3][175] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][177])

## [2.3.2][178] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][179])

## [2.3.1][180] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][181])
- **release:** fix changelogTitle bug ([0d181ea][182])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][183])

# [2.3.0][184] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][185])

### Performance Improvements

- Better faster spellchecking ([c44c310][186])

## [2.2.2][187] (2020-11-29)
...
## [2.2.1][189] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][190])

# [2.2.0][191] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][193])
- **config:** fix broken changelog.config.js structure ([bd10f44][194])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][195])
- **package.json:** install lint-staged dep and script ([f3800e4][196])
- **package.json:** install spellcheck dependencies ([9a7adb4][197])
- **spellcheck:** change "contains" to "includes" ([af76dbe][198])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][199])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][200])

### Build System

- Install @semantic-release/exec ([cc94940][201])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][202])
- **config:** fix husky pre-commit hook ([f0d0032][203])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][204])
- **config:** retire @semantic-release/changelog ([787a281][205])

### Features

- Add build-changelog to npm scripts ([8393a87][206])

## [2.1.4][207] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][208])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][209])

## [2.1.3][210] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][211])

## [2.1.2][212] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][213])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][214])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][215])

## [2.1.1][216] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][217])

# [2.1.0][218] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][219])
- **actions:** if statements now use | instead of > ([24e3739][220])
- **actions:** move comments out of multiline statements ([874f8d6][221])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][225])
- Add build commits to release rule ([3124ab0][226])

# [2.0.0][227] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][228])
- **actions:** deps caching done properly ([bbe0416][229])
- **actions:** ensure repo is always checked out first ([65e5d46][230])
- **actions:** removed signed pushes ([f621f76][231])
- **package.json:** do not guess error codes ([f5428c8][232])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][233])
...
- Added diff to take the difference ([5e40deb][236])

### Performance Improvements

- **actions:** better caching ([6da0a65][237])
- **actions:** made test-integration-chrome independent ([d489cfa][238])
- **actions:** only cache node_modules ([57775c9][239])

### Reverts

- _"debug: added debug step"_ ([1741cde][240])
- _"debug: debug cache miss"_ ([42af347][241])
...
- Version 1.0.15 ([57faa2c][242])

<!---->

- Version 1.0.7 ([5ced626][243])

- Version 1.0.0 ([df91d82][244])

[1]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.3...v7.4.4
[2]:
  https://github.com/Xunnamius/workflow-playground/commit/5c8fefa330e31620fe2af848d42eb2c5ab881d02
[3]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.2...v7.4.3
[4]:
...
[8]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.1...v7.4.2
[9]:
...
[12]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.0...v7.4.1
[13]:
...
[15]: https://github.com/Xunnamius/workflow-playground/compare/v7.3.0...v7.4.0
[16]:
  https://github.com/Xunnamius/workflow-playground/commit/e47160b09b956e69f0d9eb0cab01a3440bb66645
[17]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.3...v7.3.0
[18]:
...
[22]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.2...v7.2.3
[23]:
  https://github.com/Xunnamius/workflow-playground/commit/786942001834cb5337fabf921cbc14ea4cc04d2f
[24]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.1...v7.2.2
[25]:
  https://github.com/Xunnamius/workflow-playground/commit/a8cd37812dc9e304bf813c742b2d4d54c1c9c183
[26]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.0...v7.2.1
[27]:
  https://github.com/Xunnamius/workflow-playground/commit/73edb9a864bbc4b7d5a7eb1d03ca4ce3b8e02e95
[28]: https://github.com/Xunnamius/workflow-playground/compare/v7.1.0...v7.2.0
[29]:
...
[32]: https://github.com/Xunnamius/workflow-playground/compare/v7.0.0...v7.1.0
[33]:
...
[36]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.3...v7.0.0
[37]:
  https://github.com/Xunnamius/workflow-playground/commit/5765c024e82c3e7e0c77808e3860c85fb8c8d759
[38]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.2...v6.7.3
[39]:
...
[41]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.1...v6.7.2
[42]:
...
[44]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.0...v6.7.1
[45]:
...
[49]: https://github.com/Xunnamius/workflow-playground/compare/v6.6.0...v6.7.0
[50]:
  https://github.com/Xunnamius/workflow-playground/commit/1fdcb9c6c500f88fbc2b7b6ec7f427f0a4995080
[51]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.1...v6.6.0
[52]:
...
[57]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.0...v6.5.1
[58]:
...
[60]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.3...v6.5.0
[61]:
  https://github.com/Xunnamius/workflow-playground/commit/54488d92317360c2e358bca9238e60e2daca64dd
[62]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[63]:
...
[66]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[67]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[68]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[69]:
...
[87]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[88]:
...
[90]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[91]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[92]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[93]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[94]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[95]:
...
[97]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[98]:
...
[104]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[105]:
...
[107]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[108]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[109]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[110]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[111]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[112]:
  https://github.com/Xunnamius/workflow-playground/commit/44f5cd4c3c6adeb548ba89adba8e884336f41520
[113]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[114]:
...
[116]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[117]:
...
[120]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[121]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[122]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[123]:
...
[125]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[126]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[127]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[128]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[129]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[130]:
...
[132]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[133]:
...
[135]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.0...v6.0.1
[136]:
  https://github.com/Xunnamius/workflow-playground/commit/d40192bd13d9b301e09723cdca68be60b44b5d82
[137]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.3...v6.0.0
[138]:
  https://github.com/Xunnamius/workflow-playground/commit/95a13d21dd902a490d445d3c8aee89c59b2131f1
[139]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.2...v5.0.3
[140]:
...
[142]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.1...v5.0.2
[143]:
  https://github.com/Xunnamius/workflow-playground/commit/e62c5b42ca2b43326cc9eec8db248020b2d90ec8
[144]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.0...v5.0.1
[145]:
...
[148]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[149]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[150]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[151]:
...
[153]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[154]:
...
[157]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[158]:
...
[169]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[170]:
...
[175]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[176]:
...
[178]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[179]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[180]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[181]:
...
[184]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[185]:
...
[187]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[188]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[189]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[190]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[191]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[192]:
...
[207]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[208]:
...
[210]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[211]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[212]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[213]:
...
[216]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[217]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[218]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[219]:
...
[223]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[224]:
...
[227]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[228]:
...
[245]: https://conventionalcommits.org
[246]: https://semver.org
[247]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.4...v7.4.5
[248]:
