...
The format is based on [Conventional Commits][385], and this project adheres to
[Semantic Versioning][386].

## [7.8.21][387] (2021-03-14)

### Build System

- **package.json:** better documentation ([4db4c96][388])

## [7.8.20][1] (2021-02-22)

### Build System

- Update sort-package-json ([9d52947][2])
...
- **integration-external-dummy.test.ts:** ensure proper cwd is used for
  executing externals ([99d175e][4])

## [7.8.18][5] (2021-02-22)

### Bug Fixes

- **.changelogrc.js:** fix dark magic ([6a3007d][6])

### Build System

- **package-lock.json:** remove shelljs ([92a2b23][7])
- Spellcheck-commit and .changelogrc no longer use shelljs ([b3633c3][8])
- **setup.ts:** update with new lib-pkg tools ([e77df0b][9])

## [7.8.17][10] (2021-02-22)

### Build System

- **externals:** update expected exit code to 2 ([fb22498][11])

## [7.8.16][12] (2021-02-21)
...
## [7.8.13][18] (2021-02-21)

### Bug Fixes

- **setup.ts:** backport setup fix ([ee1aca2][19])

## [7.8.12][20] (2021-02-21)

### Build System

- **package.json:** chmod cli during build-dist step ([d6f8cc3][21])

## [7.8.11][22] (2021-02-21)

### Build System

- **expect-env.js:** rename from env-expect.js ([aa14ed9][23])

## [7.8.10][24] (2021-02-21)

### Bug Fixes

- **build-test-deploy.yml:** check real exit code ([4ff058e][25])

## [7.8.9][26] (2021-02-20)

### Build System

- **package-lock.json:** make consistent with package.json ([8a63ac7][27])
- **package.json:** remove extraneous module ([1012053][28])

## [7.8.8][29] (2021-02-20)

### Build System

- **deps:** bump object-path from 0.11.3 to 0.11.5 ([95c974a][30])

## [7.8.7][31] (2021-02-20)

### Bug Fixes

- Package.json & package-lock.json to reduce vulnerabilities ([41de5ce][32])

## [7.8.6][33] (2021-02-20)

### Bug Fixes

- **build-test-deploy.yml:** even more resilient error checking ([b050bba][34])

### Build System

- **deps:** bump object-path from 0.11.3 to 0.11.5 ([981229a][35])
...
- **build-test-deploy.yml:** better error handling and debug messaging for
  auto-merge job ([2dee6f6][37])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([1667e70][38])
...
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([e9e3ca1][41])
...
- **build-test-deploy.yml:** better error messages ([6d5573e][44])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([c493a8c][45])

## [7.8.2][46] (2021-02-20)

### Build System

- **deps:** bump object-path from 0.11.4 to 0.11.5 ([aaf7665][47])

## [7.8.1][48] (2021-02-20)

### Bug Fixes

- **build-test-deploy.yml:** store and use proper result ([09d35d7][49])

### Build System

- **deps:** bump object-path from 0.11.4 to 0.11.5 ([658f591][50])
- **package.json:** bump jest timeout to 1 minute ([cb59af2][51])
...
- **build-test-deploy.yml:** whitelist is again case-insensitive ([c034e86][55])

### Build System

- **build-test-deploy.yml:** also run on reopened PRs ([ece78e3][56])
- **build-test-deploy.yml:** codecov failures no longer fail the whole pipeline
  ([a111d7f][57])
- **build-test-deploy.yml:** restructure env w/ comments ([b980cbe][58])
- **build-test-deploy.yml:** update repo owner whitelist step ([b4f89cf][59])

# [7.7.0][60] (2021-02-19)

### Bug Fixes

- Account for node 12 ([4cdb325][61])
...
- **package.json:** external integration test runs w/ proper prefix
  ([5056c05][63])
- **package.json:** update deps ([4ef9c1b][64])

### Features

- **external-scripts:** reorganize externals; rename external to dummy
  ([efc916e][65])
- **test:** externalize jest helper proto-packages ([2dbfb8e][66])

## [7.6.5][67] (2021-02-15)

### Build System

- **package.json:** add private:false ([090cdfe][68])

## [7.6.4][69] (2021-02-14)

### Bug Fixes

- **webpack.config.js:** call dotenv properly ([22a8424][70])

## [7.6.3][71] (2021-02-14)

### Bug Fixes

- Incorrect package name ([bbbd58d][72])

### Build System

- **package.json:** update deps ([599b6c2][73])
...
- **package.json:** account for new ./dist organization ([99a01ea][76])

### Build System

- **test:** complete testing suite ([35da4c3][77])
- **webpack.config.js:** add externals ([7a8f54b][78])
- Move debug to deps, update dependencies ([6587184][79])
- **.eslintrc.js:** false env browser/webextensions ([71809e9][80])
- **integration-client.test.ts:** removed ([f080ad0][81])
- Normalize across repos ([2020d61][82])
- **webpack.config.js:** normalize webpack configuration across repos
  ([8a3bc81][83])
- **webpack.config.js:** remove ES6 syntax from JS file ([dd2b254][84])
...
- **babel.config.js:** add babel-plugin-transform-default-named-imports
  ([720dc20][86])
- **package.json:** update deps ([26a8371][87])
...
- **post-release-check.yml:** run executables as part of check ([31bdc0c][90])

## [7.5.18][91] (2021-01-29)

### Build System

- **build-test-deploy.yml:** drop support for webpack 4 ([e7f2bbb][92])
- **cleanup.yml:** fix bug for new package repos ([8d16630][93])

## [7.5.17][94] (2021-01-29)

### Build System

- **babel.config.js:** add plugin-rename-imports ([c59e45c][95])
- **build-test-deploy.yml:** remove externals exception ([3addf11][96])
- **test:** drop support for 10.x ([fb18856][97])
- **test:** standardize imports ([4f23d4e][98])

## [7.5.16][99] (2021-01-23)

### Build System

- **package.json:** nicer destructured vals in docs ([3b81944][100])

## [7.5.15][101] (2021-01-23)

### Build System

- Backport/normalize across packages ([85881f7][102])

## [7.5.14][103] (2021-01-22)

### Build System

- Update debug statement syntax ([107b953][104])

## [7.5.13][105] (2021-01-21)
...
## [7.5.12][107] (2021-01-17)

### Build System

- Backport changes from gac ([172fa77][108])

## [7.5.11][109] (2021-01-12)

### Build System

- Rebuild lockfile ([fef7222][110])
- Update babel-plugin-transform-mjs-imports ([16a597d][111])

## [7.5.10][112] (2021-01-12)

### Build System

- Update -browser to -client everywhere ([597d6c5][113])

## [7.5.9][114] (2021-01-10)

### Bug Fixes

- **webpack.config.js:** better process.env support ([25db498][115])

## [7.5.8][116] (2021-01-06)

### Build System

- **webpack.config.js:** process.env shim ([3973279][117])

## [7.5.7][118] (2021-01-06)
...
## [7.5.3][126] (2021-01-05)

### Build System

- **package.json:** backported updates ([8a051d1][127])

## [7.5.2][128] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][129])

## [7.5.1][130] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][131])
- **package.json:** return browser test ([6c1c4d4][132])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][133])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][134])
- **package.json:** backports from the wild ([eda277e][135])
- **webpack.config.js:** add env-expect ([0f401ff][136])

# [7.5.0][137] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][138])

## [7.4.5][139] (2021-01-05)
...
## [7.4.4][141] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][142])

## [7.4.3][143] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][144])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][145])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][146])
- **.github/workflows/build-test-deploy.yml:** fix debug output (normalize node
  support) ([0528db6][147])

## [7.4.2][148] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][149])
- **package.json:** revert "test: peer dep install" ([4c174fe][150])
- **package.json:** test: peer dep install ([6c00005][151])

## [7.4.1][152] (2021-01-04)
...
# [7.4.0][155] (2021-01-04)

### Features

- **.github:** add codecov to externals; add flags to codecov ([e47160b][156])

# [7.3.0][157] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][158])

### Build System

- **package.json:** better lint output ([0dc7c4e][159])

### Features

- **.github:** backport env matrix hint ([c01b325][160])
- **readme.md:** add NPM7 warning ([24f0888][161])

## [7.2.3][162] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][163])

## [7.2.2][164] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][165])

## [7.2.1][166] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][167])

# [7.2.0][168] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][169])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][170])
- **workflows:** fix should-skip determination algo ([f7d1256][171])

# [7.1.0][172] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][173])
- **readme.md:** complete skip test ([67264ed][174])
- **workflows:** replace should-skip determination algo ([cd6236a][175])

# [7.0.0][176] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][177])

### BREAKING CHANGES

- **changelog.md:** **skip github/github skip options were removed**

## [6.7.3][178] (2021-01-03)

### Bug Fixes

- **.changelogrc.js:** show reverts in changelog ([ec26302][179])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][180])

## [6.7.2][181] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][182])
- _"debug(readme.md): debug debug"_ ([aff005d][183])

## [6.7.1][184] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][185])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][186])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][187])

### Build System

- **package.json:** better build-changelog ([f2e971e][188])

# [6.7.0][189] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][190])

# [6.6.0][191] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][192])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][193])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][194])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][195])
- **release.config.js:** use imported releaseRules ([2fe163c][196])

## [6.5.1][197] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][198])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][199])

# [6.5.0][200] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][201])

## [6.4.3][202] (2021-01-02)
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][204])
- **package.json:** remove deploy test script ([4fb641c][205])

## [6.4.2][206] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][207])

## [6.4.1][208] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support
  ([de7ef33][209])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][210])
- **release.config.js:** fix deploy to run at success step; add debug output
  ([b9e8cc5][211])

# [6.4.0][212] (2021-01-02)

### Features

- **package.json:** vercel deploy test ([ed73fc3][213])

## [6.3.8][214] (2021-01-02)
...
## [6.3.5][220] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][221])

## [6.3.4][222] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][223])
- Update remark linting to exit 1 on error, quiet on success ([077abce][224])
- Update sort-package-json to contrib-env-expect ([6885a34][225])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][226])

## [6.3.3][227] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][229])

## [6.3.2][230] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][231])

## [6.3.1][232] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][233])

# [6.3.0][234] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][235])

### Features

- **src:** add div function ([636c353][236])

# [6.2.0][237] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][238])
- **.husky:** remove verbose flag ([538c374][239])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][240])
- **package.json:** remove debug echo ([33a510d][241])
- **release.config.js:** fix to use gfm ([db4c284][242])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][243])

## [6.1.7][244] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][245])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][246])

## [6.1.6][247] (2020-12-30)
...
## [6.1.4][251] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][252])

## [6.1.3][253] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][254])
- **build-test-deploy.yml:** fix syntax error ([5448960][255])

## [6.1.2][256] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][257])
- **package.json:** remove high audit CI failure ([b2ea6f1][258])
- **package.json:** test high audit CI failure ([03825f0][259])

## [6.1.1][260] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][261])

# [6.1.0][262] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][263])

### Features

- **readme.md:** dummy feat ([f90dde3][264])

## [6.0.5][265] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][266])

## [6.0.4][267] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][268])

## [6.0.3][269] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][270])
- **.github:** fix cleanup ([7520e0f][271])

## [6.0.2][272] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][273])
- **release.config.js:** remove console.info ([b374296][274])

## [6.0.1][275] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][276])

# [6.0.0][277] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][278])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][279] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][281])

## [5.0.2][282] (2020-12-29)
...
## [5.0.1][284] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][285])
- **package.json:** add codecov package ([d73cac9][286])
- **package.json:** remove codecov package ([da477b7][287])

# [5.0.0][288] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][289])
...
- Update comment language ([5a2aef4][292])
...
## [3.0.1][293] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][294])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][295])

### Build System

- **package.json:** update deps ([a876517][296])

# [3.0.0][297] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][298])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][299])
- **package.json:** use @xunnamius/semantic-release ([0447d59][300])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][301])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][302])
- **package-lock.json:** fix syntax error ([4fd2952][303])
...
- Added mult function ([e537358][305])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][306])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][307])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][308])
...
## [2.3.4][309] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][310])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][311])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][312])
- Added .env.example and env-expect ([efb29c5][313])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][314])

## [2.3.3][315] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][317])

## [2.3.2][318] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][319])

## [2.3.1][320] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][321])
- **release:** fix changelogTitle bug ([0d181ea][322])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][323])

# [2.3.0][324] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][325])

### Performance Improvements

- Better faster spellchecking ([c44c310][326])

## [2.2.2][327] (2020-11-29)
...
## [2.2.1][329] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][330])

# [2.2.0][331] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][333])
- **config:** fix broken changelog.config.js structure ([bd10f44][334])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][335])
- **package.json:** install lint-staged dep and script ([f3800e4][336])
- **package.json:** install spellcheck dependencies ([9a7adb4][337])
- **spellcheck:** change "contains" to "includes" ([af76dbe][338])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][339])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][340])

### Build System

- Install @semantic-release/exec ([cc94940][341])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][342])
- **config:** fix husky pre-commit hook ([f0d0032][343])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][344])
- **config:** retire @semantic-release/changelog ([787a281][345])

### Features

- Add build-changelog to npm scripts ([8393a87][346])

## [2.1.4][347] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][348])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][349])

## [2.1.3][350] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][351])

## [2.1.2][352] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][353])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][354])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][355])

## [2.1.1][356] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][357])

# [2.1.0][358] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][359])
- **actions:** if statements now use | instead of > ([24e3739][360])
- **actions:** move comments out of multiline statements ([874f8d6][361])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][365])
- Add build commits to release rule ([3124ab0][366])

# [2.0.0][367] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][368])
- **actions:** deps caching done properly ([bbe0416][369])
- **actions:** ensure repo is always checked out first ([65e5d46][370])
- **actions:** removed signed pushes ([f621f76][371])
- **package.json:** do not guess error codes ([f5428c8][372])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][373])
...
- Added diff to take the difference ([5e40deb][376])

### Performance Improvements

- **actions:** better caching ([6da0a65][377])
- **actions:** made test-integration-chrome independent ([d489cfa][378])
- **actions:** only cache node_modules ([57775c9][379])

### Reverts

- _"debug: added debug step"_ ([1741cde][380])
- _"debug: debug cache miss"_ ([42af347][381])
...
- Version 1.0.15 ([57faa2c][382])

<!---->

- Version 1.0.7 ([5ced626][383])

- Version 1.0.0 ([df91d82][384])
...
[385]: https://conventionalcommits.org
[386]: https://semver.org
[387]:
  https://github.com/Xunnamius/projector-lens-lib-cjs/compare/v7.8.20...v7.8.21
[388]:
  https://github.com/Xunnamius/projector-lens-lib-cjs/commit/4db4c966b25a18df6e268bd0b51cb78bf0023096
