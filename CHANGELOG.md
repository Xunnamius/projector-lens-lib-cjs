...
The format is based on [Conventional Commits][370], and this project adheres to
[Semantic Versioning][371].

## [7.8.15][372] (2021-02-21)
...
- **setup.ts:** backport setup fix ([ee1aca2][4])

## [7.8.12][5] (2021-02-21)

### Build System

- **package.json:** chmod cli during build-dist step ([d6f8cc3][6])

## [7.8.11][7] (2021-02-21)

### Build System

- **expect-env.js:** rename from env-expect.js ([aa14ed9][8])

## [7.8.10][9] (2021-02-21)

### Bug Fixes

- **build-test-deploy.yml:** check real exit code ([4ff058e][10])

## [7.8.9][11] (2021-02-20)

### Build System

- **package-lock.json:** make consistent with package.json ([8a63ac7][12])
- **package.json:** remove extraneous module ([1012053][13])

## [7.8.8][14] (2021-02-20)

### Build System

- **deps:** bump object-path from 0.11.3 to 0.11.5 ([95c974a][15])

## [7.8.7][16] (2021-02-20)

### Bug Fixes

- Package.json & package-lock.json to reduce vulnerabilities ([41de5ce][17])

## [7.8.6][18] (2021-02-20)

### Bug Fixes

- **build-test-deploy.yml:** even more resilient error checking ([b050bba][19])

### Build System

- **deps:** bump object-path from 0.11.3 to 0.11.5 ([981229a][20])
...
- **build-test-deploy.yml:** better error handling and debug messaging for
  auto-merge job ([2dee6f6][22])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([1667e70][23])
...
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([e9e3ca1][26])
...
- **build-test-deploy.yml:** better error messages ([6d5573e][29])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([c493a8c][30])

## [7.8.2][31] (2021-02-20)

### Build System

- **deps:** bump object-path from 0.11.4 to 0.11.5 ([aaf7665][32])

## [7.8.1][33] (2021-02-20)

### Bug Fixes

- **build-test-deploy.yml:** store and use proper result ([09d35d7][34])

### Build System

- **deps:** bump object-path from 0.11.4 to 0.11.5 ([658f591][35])
- **package.json:** bump jest timeout to 1 minute ([cb59af2][36])
...
- **build-test-deploy.yml:** whitelist is again case-insensitive ([c034e86][40])

### Build System

- **build-test-deploy.yml:** also run on reopened PRs ([ece78e3][41])
- **build-test-deploy.yml:** codecov failures no longer fail the whole pipeline
  ([a111d7f][42])
- **build-test-deploy.yml:** restructure env w/ comments ([b980cbe][43])
- **build-test-deploy.yml:** update repo owner whitelist step ([b4f89cf][44])

# [7.7.0][45] (2021-02-19)

### Bug Fixes

- Account for node 12 ([4cdb325][46])
...
- **package.json:** external integration test runs w/ proper prefix
  ([5056c05][48])
- **package.json:** update deps ([4ef9c1b][49])

### Features

- **external-scripts:** reorganize externals; rename external to dummy
  ([efc916e][50])
- **test:** externalize jest helper proto-packages ([2dbfb8e][51])

## [7.6.5][52] (2021-02-15)

### Build System

- **package.json:** add private:false ([090cdfe][53])

## [7.6.4][54] (2021-02-14)

### Bug Fixes

- **webpack.config.js:** call dotenv properly ([22a8424][55])

## [7.6.3][56] (2021-02-14)

### Bug Fixes

- Incorrect package name ([bbbd58d][57])

### Build System

- **package.json:** update deps ([599b6c2][58])
...
- **package.json:** account for new ./dist organization ([99a01ea][61])

### Build System

- **test:** complete testing suite ([35da4c3][62])
- **webpack.config.js:** add externals ([7a8f54b][63])
- Move debug to deps, update dependencies ([6587184][64])
- **.eslintrc.js:** false env browser/webextensions ([71809e9][65])
- **integration-client.test.ts:** removed ([f080ad0][66])
- Normalize across repos ([2020d61][67])
- **webpack.config.js:** normalize webpack configuration across repos
  ([8a3bc81][68])
- **webpack.config.js:** remove ES6 syntax from JS file ([dd2b254][69])
...
- **babel.config.js:** add babel-plugin-transform-default-named-imports
  ([720dc20][71])
- **package.json:** update deps ([26a8371][72])
...
- **post-release-check.yml:** run executables as part of check ([31bdc0c][75])

## [7.5.18][76] (2021-01-29)

### Build System

- **build-test-deploy.yml:** drop support for webpack 4 ([e7f2bbb][77])
- **cleanup.yml:** fix bug for new package repos ([8d16630][78])

## [7.5.17][79] (2021-01-29)

### Build System

- **babel.config.js:** add plugin-rename-imports ([c59e45c][80])
- **build-test-deploy.yml:** remove externals exception ([3addf11][81])
- **test:** drop support for 10.x ([fb18856][82])
- **test:** standardize imports ([4f23d4e][83])

## [7.5.16][84] (2021-01-23)

### Build System

- **package.json:** nicer destructured vals in docs ([3b81944][85])

## [7.5.15][86] (2021-01-23)

### Build System

- Backport/normalize across packages ([85881f7][87])

## [7.5.14][88] (2021-01-22)

### Build System

- Update debug statement syntax ([107b953][89])

## [7.5.13][90] (2021-01-21)
...
## [7.5.12][92] (2021-01-17)

### Build System

- Backport changes from gac ([172fa77][93])

## [7.5.11][94] (2021-01-12)

### Build System

- Rebuild lockfile ([fef7222][95])
- Update babel-plugin-transform-mjs-imports ([16a597d][96])

## [7.5.10][97] (2021-01-12)

### Build System

- Update -browser to -client everywhere ([597d6c5][98])

## [7.5.9][99] (2021-01-10)

### Bug Fixes

- **webpack.config.js:** better process.env support ([25db498][100])

## [7.5.8][101] (2021-01-06)

### Build System

- **webpack.config.js:** process.env shim ([3973279][102])

## [7.5.7][103] (2021-01-06)
...
## [7.5.3][111] (2021-01-05)

### Build System

- **package.json:** backported updates ([8a051d1][112])

## [7.5.2][113] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][114])

## [7.5.1][115] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][116])
- **package.json:** return browser test ([6c1c4d4][117])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][118])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][119])
- **package.json:** backports from the wild ([eda277e][120])
- **webpack.config.js:** add env-expect ([0f401ff][121])

# [7.5.0][122] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][123])

## [7.4.5][124] (2021-01-05)
...
## [7.4.4][126] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][127])

## [7.4.3][128] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][129])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][130])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][131])
- **.github/workflows/build-test-deploy.yml:** fix debug output (normalize node
  support) ([0528db6][132])

## [7.4.2][133] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][134])
- **package.json:** revert "test: peer dep install" ([4c174fe][135])
- **package.json:** test: peer dep install ([6c00005][136])

## [7.4.1][137] (2021-01-04)
...
# [7.4.0][140] (2021-01-04)

### Features

- **.github:** add codecov to externals; add flags to codecov ([e47160b][141])

# [7.3.0][142] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][143])

### Build System

- **package.json:** better lint output ([0dc7c4e][144])

### Features

- **.github:** backport env matrix hint ([c01b325][145])
- **readme.md:** add NPM7 warning ([24f0888][146])

## [7.2.3][147] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][148])

## [7.2.2][149] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][150])

## [7.2.1][151] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][152])

# [7.2.0][153] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][154])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][155])
- **workflows:** fix should-skip determination algo ([f7d1256][156])

# [7.1.0][157] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][158])
- **readme.md:** complete skip test ([67264ed][159])
- **workflows:** replace should-skip determination algo ([cd6236a][160])

# [7.0.0][161] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][162])

### BREAKING CHANGES

- **changelog.md:** **skip github/github skip options were removed**

## [6.7.3][163] (2021-01-03)

### Bug Fixes

- **.changelogrc.js:** show reverts in changelog ([ec26302][164])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][165])

## [6.7.2][166] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][167])
- _"debug(readme.md): debug debug"_ ([aff005d][168])

## [6.7.1][169] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][170])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][171])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][172])

### Build System

- **package.json:** better build-changelog ([f2e971e][173])

# [6.7.0][174] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][175])

# [6.6.0][176] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][177])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][178])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][179])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][180])
- **release.config.js:** use imported releaseRules ([2fe163c][181])

## [6.5.1][182] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][183])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][184])

# [6.5.0][185] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][186])

## [6.4.3][187] (2021-01-02)
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][189])
- **package.json:** remove deploy test script ([4fb641c][190])

## [6.4.2][191] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][192])

## [6.4.1][193] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support
  ([de7ef33][194])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][195])
- **release.config.js:** fix deploy to run at success step; add debug output
  ([b9e8cc5][196])

# [6.4.0][197] (2021-01-02)

### Features

- **package.json:** vercel deploy test ([ed73fc3][198])

## [6.3.8][199] (2021-01-02)
...
## [6.3.5][205] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][206])

## [6.3.4][207] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][208])
- Update remark linting to exit 1 on error, quiet on success ([077abce][209])
- Update sort-package-json to contrib-env-expect ([6885a34][210])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][211])

## [6.3.3][212] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][214])

## [6.3.2][215] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][216])

## [6.3.1][217] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][218])

# [6.3.0][219] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][220])

### Features

- **src:** add div function ([636c353][221])

# [6.2.0][222] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][223])
- **.husky:** remove verbose flag ([538c374][224])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][225])
- **package.json:** remove debug echo ([33a510d][226])
- **release.config.js:** fix to use gfm ([db4c284][227])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][228])

## [6.1.7][229] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][230])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][231])

## [6.1.6][232] (2020-12-30)
...
## [6.1.4][236] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][237])

## [6.1.3][238] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][239])
- **build-test-deploy.yml:** fix syntax error ([5448960][240])

## [6.1.2][241] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][242])
- **package.json:** remove high audit CI failure ([b2ea6f1][243])
- **package.json:** test high audit CI failure ([03825f0][244])

## [6.1.1][245] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][246])

# [6.1.0][247] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][248])

### Features

- **readme.md:** dummy feat ([f90dde3][249])

## [6.0.5][250] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][251])

## [6.0.4][252] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][253])

## [6.0.3][254] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][255])
- **.github:** fix cleanup ([7520e0f][256])

## [6.0.2][257] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][258])
- **release.config.js:** remove console.info ([b374296][259])

## [6.0.1][260] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][261])

# [6.0.0][262] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][263])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][264] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][266])

## [5.0.2][267] (2020-12-29)
...
## [5.0.1][269] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][270])
- **package.json:** add codecov package ([d73cac9][271])
- **package.json:** remove codecov package ([da477b7][272])

# [5.0.0][273] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][274])
...
- Update comment language ([5a2aef4][277])
...
## [3.0.1][278] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][279])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][280])

### Build System

- **package.json:** update deps ([a876517][281])

# [3.0.0][282] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][283])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][284])
- **package.json:** use @xunnamius/semantic-release ([0447d59][285])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][286])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][287])
- **package-lock.json:** fix syntax error ([4fd2952][288])
...
- Added mult function ([e537358][290])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][291])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][292])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][293])
...
## [2.3.4][294] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][295])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][296])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][297])
- Added .env.example and env-expect ([efb29c5][298])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][299])

## [2.3.3][300] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][302])

## [2.3.2][303] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][304])

## [2.3.1][305] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][306])
- **release:** fix changelogTitle bug ([0d181ea][307])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][308])

# [2.3.0][309] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][310])

### Performance Improvements

- Better faster spellchecking ([c44c310][311])

## [2.2.2][312] (2020-11-29)
...
## [2.2.1][314] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][315])

# [2.2.0][316] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][318])
- **config:** fix broken changelog.config.js structure ([bd10f44][319])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][320])
- **package.json:** install lint-staged dep and script ([f3800e4][321])
- **package.json:** install spellcheck dependencies ([9a7adb4][322])
- **spellcheck:** change "contains" to "includes" ([af76dbe][323])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][324])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][325])

### Build System

- Install @semantic-release/exec ([cc94940][326])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][327])
- **config:** fix husky pre-commit hook ([f0d0032][328])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][329])
- **config:** retire @semantic-release/changelog ([787a281][330])

### Features

- Add build-changelog to npm scripts ([8393a87][331])

## [2.1.4][332] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][333])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][334])

## [2.1.3][335] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][336])

## [2.1.2][337] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][338])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][339])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][340])

## [2.1.1][341] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][342])

# [2.1.0][343] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][344])
- **actions:** if statements now use | instead of > ([24e3739][345])
- **actions:** move comments out of multiline statements ([874f8d6][346])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][350])
- Add build commits to release rule ([3124ab0][351])

# [2.0.0][352] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][353])
- **actions:** deps caching done properly ([bbe0416][354])
- **actions:** ensure repo is always checked out first ([65e5d46][355])
- **actions:** removed signed pushes ([f621f76][356])
- **package.json:** do not guess error codes ([f5428c8][357])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][358])
...
- Added diff to take the difference ([5e40deb][361])

### Performance Improvements

- **actions:** better caching ([6da0a65][362])
- **actions:** made test-integration-chrome independent ([d489cfa][363])
- **actions:** only cache node_modules ([57775c9][364])

### Reverts

- _"debug: added debug step"_ ([1741cde][365])
- _"debug: debug cache miss"_ ([42af347][366])
...
- Version 1.0.15 ([57faa2c][367])

<!---->

- Version 1.0.7 ([5ced626][368])

- Version 1.0.0 ([df91d82][369])
...
[370]: https://conventionalcommits.org
