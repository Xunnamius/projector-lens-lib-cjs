...
The format is based on [Conventional Commits][218], and this project adheres to
[Semantic Versioning][219].

## [7.2.1][220] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][221])

# [7.2.0][1] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][2])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][3])
- **workflows:** fix should-skip determination algo ([f7d1256][4])

# [7.1.0][5] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][6])
- **readme.md:** complete skip test ([67264ed][7])
- **workflows:** replace should-skip determination algo ([cd6236a][8])

# [7.0.0][9] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][10])
...
- **.changelogrc.js:** show reverts in changelog ([ec26302][12])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][13])

## [6.7.2][14] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][15])
- _"debug(readme.md): debug debug"_ ([aff005d][16])

## [6.7.1][17] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][18])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][19])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][20])

### Build System

- **package.json:** better build-changelog ([f2e971e][21])

# [6.7.0][22] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][23])

# [6.6.0][24] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][25])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][26])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][27])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][28])
- **release.config.js:** use imported releaseRules ([2fe163c][29])

## [6.5.1][30] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][31])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][32])

# [6.5.0][33] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][34])
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][37])
- **package.json:** remove deploy test script ([4fb641c][38])

## [6.4.2][39] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][40])

## [6.4.1][41] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support ([de7ef33][42])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][43])
...
- **package.json:** vercel deploy test ([ed73fc3][46])
...
- **.github/workflows/cleanup.yml:** fix metadata gathering step ([44dd462][50])

## [6.3.6][51] (2021-01-01)

### Build System

- **.github/workflows/cleanup.yml:** add metadata filtering step ([6667075][52])

## [6.3.5][53] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][54])

## [6.3.4][55] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][56])
- Update remark linting to exit 1 on error, quiet on success ([077abce][57])
- Update sort-package-json to contrib-env-expect ([6885a34][58])
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][62])

## [6.3.2][63] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][64])

## [6.3.1][65] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][66])

# [6.3.0][67] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][68])

### Features

- **src:** add div function ([636c353][69])
...
- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][71])
- **.husky:** remove verbose flag ([538c374][72])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][73])
- **package.json:** remove debug echo ([33a510d][74])
- **release.config.js:** fix to use gfm ([db4c284][75])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][76])

## [6.1.7][77] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][78])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][79])
...
- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][85])

## [6.1.3][86] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][87])
- **build-test-deploy.yml:** fix syntax error ([5448960][88])

## [6.1.2][89] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][90])
- **package.json:** remove high audit CI failure ([b2ea6f1][91])
- **package.json:** test high audit CI failure ([03825f0][92])

## [6.1.1][93] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][94])

# [6.1.0][95] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][96])

### Features

- **readme.md:** dummy feat ([f90dde3][97])

## [6.0.5][98] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][99])

## [6.0.4][100] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][101])

## [6.0.3][102] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][103])
- **.github:** fix cleanup ([7520e0f][104])

## [6.0.2][105] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][106])
- **release.config.js:** remove console.info ([b374296][107])

## [6.0.1][108] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][109])

# [6.0.0][110] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][111])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][112] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][114])

## [5.0.2][115] (2020-12-29)
...
## [5.0.1][117] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][118])
- **package.json:** add codecov package ([d73cac9][119])
- **package.json:** remove codecov package ([da477b7][120])

# [5.0.0][121] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][122])
...
- Update comment language ([5a2aef4][125])
...
## [3.0.1][126] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][127])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][128])

### Build System

- **package.json:** update deps ([a876517][129])

# [3.0.0][130] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][131])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][132])
- **package.json:** use @xunnamius/semantic-release ([0447d59][133])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][134])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][135])
- **package-lock.json:** fix syntax error ([4fd2952][136])
...
- Added mult function ([e537358][138])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][139])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][140])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][141])
...
## [2.3.4][142] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][143])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][144])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][145])
- Added .env.example and env-expect ([efb29c5][146])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][147])

## [2.3.3][148] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][150])

## [2.3.2][151] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][152])

## [2.3.1][153] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][154])
- **release:** fix changelogTitle bug ([0d181ea][155])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][156])

# [2.3.0][157] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][158])

### Performance Improvements

- Better faster spellchecking ([c44c310][159])

## [2.2.2][160] (2020-11-29)
...
## [2.2.1][162] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][163])

# [2.2.0][164] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][166])
- **config:** fix broken changelog.config.js structure ([bd10f44][167])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][168])
- **package.json:** install lint-staged dep and script ([f3800e4][169])
- **package.json:** install spellcheck dependencies ([9a7adb4][170])
- **spellcheck:** change "contains" to "includes" ([af76dbe][171])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][172])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][173])

### Build System

- Install @semantic-release/exec ([cc94940][174])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][175])
- **config:** fix husky pre-commit hook ([f0d0032][176])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][177])
- **config:** retire @semantic-release/changelog ([787a281][178])

### Features

- Add build-changelog to npm scripts ([8393a87][179])

## [2.1.4][180] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][181])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][182])

## [2.1.3][183] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][184])

## [2.1.2][185] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][186])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][187])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][188])

## [2.1.1][189] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][190])

# [2.1.0][191] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][192])
- **actions:** if statements now use | instead of > ([24e3739][193])
- **actions:** move comments out of multiline statements ([874f8d6][194])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][198])
- Add build commits to release rule ([3124ab0][199])

# [2.0.0][200] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][201])
- **actions:** deps caching done properly ([bbe0416][202])
- **actions:** ensure repo is always checked out first ([65e5d46][203])
- **actions:** removed signed pushes ([f621f76][204])
- **package.json:** do not guess error codes ([f5428c8][205])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][206])
...
- Added diff to take the difference ([5e40deb][209])

### Performance Improvements

- **actions:** better caching ([6da0a65][210])
- **actions:** made test-integration-chrome independent ([d489cfa][211])
- **actions:** only cache node_modules ([57775c9][212])

### Reverts

- _"debug: added debug step"_ ([1741cde][213])
- _"debug: debug cache miss"_ ([42af347][214])
...
- Version 1.0.15 ([57faa2c][215])

<!---->

- Version 1.0.7 ([5ced626][216])

- Version 1.0.0 ([df91d82][217])

[1]: https://github.com/Xunnamius/workflow-playground/compare/v7.1.0...v7.2.0
[2]:
...
[5]: https://github.com/Xunnamius/workflow-playground/compare/v7.0.0...v7.1.0
[6]:
...
[9]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.3...v7.0.0
[10]:
  https://github.com/Xunnamius/workflow-playground/commit/5765c024e82c3e7e0c77808e3860c85fb8c8d759
[11]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.2...v6.7.3
[12]:
...
[14]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.1...v6.7.2
[15]:
...
[17]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.0...v6.7.1
[18]:
...
[22]: https://github.com/Xunnamius/workflow-playground/compare/v6.6.0...v6.7.0
[23]:
  https://github.com/Xunnamius/workflow-playground/commit/1fdcb9c6c500f88fbc2b7b6ec7f427f0a4995080
[24]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.1...v6.6.0
[25]:
...
[30]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.0...v6.5.1
[31]:
...
[33]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.3...v6.5.0
[34]:
  https://github.com/Xunnamius/workflow-playground/commit/54488d92317360c2e358bca9238e60e2daca64dd
[35]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[36]:
...
[39]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[40]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[41]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[42]:
...
[60]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[61]:
...
[63]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[64]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[65]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[66]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[67]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[68]:
...
[70]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[71]:
...
[77]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[78]:
...
[80]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[81]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[82]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[83]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[84]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[85]:
  https://github.com/Xunnamius/workflow-playground/commit/44f5cd4c3c6adeb548ba89adba8e884336f41520
[86]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[87]:
...
[89]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[90]:
...
[93]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[94]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[95]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[96]:
...
[98]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[99]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[100]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[101]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[102]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[103]:
...
[105]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[106]:
...
[108]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.0...v6.0.1
[109]:
  https://github.com/Xunnamius/workflow-playground/commit/d40192bd13d9b301e09723cdca68be60b44b5d82
[110]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.3...v6.0.0
[111]:
  https://github.com/Xunnamius/workflow-playground/commit/95a13d21dd902a490d445d3c8aee89c59b2131f1
[112]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.2...v5.0.3
[113]:
...
[115]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.1...v5.0.2
[116]:
  https://github.com/Xunnamius/workflow-playground/commit/e62c5b42ca2b43326cc9eec8db248020b2d90ec8
[117]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.0...v5.0.1
[118]:
...
[121]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[122]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[123]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[124]:
...
[126]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[127]:
...
[130]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[131]:
...
[142]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[143]:
...
[148]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[149]:
...
[151]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[152]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[153]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[154]:
...
[157]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[158]:
...
[160]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[161]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[162]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[163]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[164]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[165]:
...
[180]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[181]:
...
[183]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[184]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[185]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[186]:
...
[189]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[190]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[191]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[192]:
...
[196]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[197]:
...
[200]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[201]:
...
[218]: https://conventionalcommits.org
[219]: https://semver.org
[220]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.0...v7.2.1
[221]:
