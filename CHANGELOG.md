...
The format is based on [Conventional Commits][272], and this project adheres to
[Semantic Versioning][273].

## [7.5.10][274] (2021-01-12)

### Build System

- Update -browser to -client everywhere ([597d6c5][275])

## [7.5.9][1] (2021-01-10)

### Bug Fixes

- **webpack.config.js:** better process.env support ([25db498][2])

## [7.5.8][3] (2021-01-06)

### Build System

- **webpack.config.js:** process.env shim ([3973279][4])
...
- **package.json:** backported updates ([8a051d1][14])

## [7.5.2][15] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][16])

## [7.5.1][17] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][18])
- **package.json:** return browser test ([6c1c4d4][19])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][20])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][21])
- **package.json:** backports from the wild ([eda277e][22])
- **webpack.config.js:** add env-expect ([0f401ff][23])

# [7.5.0][24] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][25])
...
- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][29])
...
- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][31])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][32])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][33])
...
- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][36])
- **package.json:** revert "test: peer dep install" ([4c174fe][37])
- **package.json:** test: peer dep install ([6c00005][38])
...
- **.github:** add codecov to externals; add flags to codecov ([e47160b][43])

# [7.3.0][44] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][45])

### Build System

- **package.json:** better lint output ([0dc7c4e][46])

### Features

- **.github:** backport env matrix hint ([c01b325][47])
- **readme.md:** add NPM7 warning ([24f0888][48])

## [7.2.3][49] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][50])

## [7.2.2][51] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][52])

## [7.2.1][53] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][54])

# [7.2.0][55] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][56])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][57])
- **workflows:** fix should-skip determination algo ([f7d1256][58])

# [7.1.0][59] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][60])
- **readme.md:** complete skip test ([67264ed][61])
- **workflows:** replace should-skip determination algo ([cd6236a][62])

# [7.0.0][63] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][64])
...
- **.changelogrc.js:** show reverts in changelog ([ec26302][66])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][67])

## [6.7.2][68] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][69])
- _"debug(readme.md): debug debug"_ ([aff005d][70])

## [6.7.1][71] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][72])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][73])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][74])

### Build System

- **package.json:** better build-changelog ([f2e971e][75])

# [6.7.0][76] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][77])

# [6.6.0][78] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][79])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][80])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][81])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][82])
- **release.config.js:** use imported releaseRules ([2fe163c][83])

## [6.5.1][84] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][85])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][86])

# [6.5.0][87] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][88])
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][91])
- **package.json:** remove deploy test script ([4fb641c][92])

## [6.4.2][93] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][94])

## [6.4.1][95] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support ([de7ef33][96])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][97])
...
- **package.json:** vercel deploy test ([ed73fc3][100])

## [6.3.8][101] (2021-01-02)
...
## [6.3.5][107] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][108])

## [6.3.4][109] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][110])
- Update remark linting to exit 1 on error, quiet on success ([077abce][111])
- Update sort-package-json to contrib-env-expect ([6885a34][112])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][113])

## [6.3.3][114] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][116])

## [6.3.2][117] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][118])

## [6.3.1][119] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][120])

# [6.3.0][121] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][122])

### Features

- **src:** add div function ([636c353][123])

# [6.2.0][124] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][125])
- **.husky:** remove verbose flag ([538c374][126])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][127])
- **package.json:** remove debug echo ([33a510d][128])
- **release.config.js:** fix to use gfm ([db4c284][129])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][130])

## [6.1.7][131] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][132])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][133])

## [6.1.6][134] (2020-12-30)
...
## [6.1.4][138] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][139])

## [6.1.3][140] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][141])
- **build-test-deploy.yml:** fix syntax error ([5448960][142])

## [6.1.2][143] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][144])
- **package.json:** remove high audit CI failure ([b2ea6f1][145])
- **package.json:** test high audit CI failure ([03825f0][146])

## [6.1.1][147] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][148])

# [6.1.0][149] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][150])

### Features

- **readme.md:** dummy feat ([f90dde3][151])

## [6.0.5][152] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][153])

## [6.0.4][154] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][155])

## [6.0.3][156] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][157])
- **.github:** fix cleanup ([7520e0f][158])

## [6.0.2][159] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][160])
- **release.config.js:** remove console.info ([b374296][161])

## [6.0.1][162] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][163])

# [6.0.0][164] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][165])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][166] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][168])

## [5.0.2][169] (2020-12-29)
...
## [5.0.1][171] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][172])
- **package.json:** add codecov package ([d73cac9][173])
- **package.json:** remove codecov package ([da477b7][174])

# [5.0.0][175] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][176])
...
- Update comment language ([5a2aef4][179])
...
## [3.0.1][180] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][181])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][182])

### Build System

- **package.json:** update deps ([a876517][183])

# [3.0.0][184] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][185])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][186])
- **package.json:** use @xunnamius/semantic-release ([0447d59][187])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][188])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][189])
- **package-lock.json:** fix syntax error ([4fd2952][190])
...
- Added mult function ([e537358][192])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][193])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][194])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][195])
...
## [2.3.4][196] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][197])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][198])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][199])
- Added .env.example and env-expect ([efb29c5][200])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][201])

## [2.3.3][202] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][204])

## [2.3.2][205] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][206])

## [2.3.1][207] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][208])
- **release:** fix changelogTitle bug ([0d181ea][209])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][210])

# [2.3.0][211] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][212])

### Performance Improvements

- Better faster spellchecking ([c44c310][213])

## [2.2.2][214] (2020-11-29)
...
## [2.2.1][216] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][217])

# [2.2.0][218] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][220])
- **config:** fix broken changelog.config.js structure ([bd10f44][221])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][222])
- **package.json:** install lint-staged dep and script ([f3800e4][223])
- **package.json:** install spellcheck dependencies ([9a7adb4][224])
- **spellcheck:** change "contains" to "includes" ([af76dbe][225])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][226])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][227])

### Build System

- Install @semantic-release/exec ([cc94940][228])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][229])
- **config:** fix husky pre-commit hook ([f0d0032][230])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][231])
- **config:** retire @semantic-release/changelog ([787a281][232])

### Features

- Add build-changelog to npm scripts ([8393a87][233])

## [2.1.4][234] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][235])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][236])

## [2.1.3][237] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][238])

## [2.1.2][239] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][240])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][241])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][242])

## [2.1.1][243] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][244])

# [2.1.0][245] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][246])
- **actions:** if statements now use | instead of > ([24e3739][247])
- **actions:** move comments out of multiline statements ([874f8d6][248])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][252])
- Add build commits to release rule ([3124ab0][253])

# [2.0.0][254] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][255])
- **actions:** deps caching done properly ([bbe0416][256])
- **actions:** ensure repo is always checked out first ([65e5d46][257])
- **actions:** removed signed pushes ([f621f76][258])
- **package.json:** do not guess error codes ([f5428c8][259])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][260])
...
- Added diff to take the difference ([5e40deb][263])

### Performance Improvements

- **actions:** better caching ([6da0a65][264])
- **actions:** made test-integration-chrome independent ([d489cfa][265])
- **actions:** only cache node_modules ([57775c9][266])

### Reverts

- _"debug: added debug step"_ ([1741cde][267])
- _"debug: debug cache miss"_ ([42af347][268])
...
[24]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.5...v7.5.0
[25]:
  https://github.com/Xunnamius/workflow-playground/commit/77c033ff143dff64455049b8314cd528bae4e198
[26]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.4...v7.4.5
[27]:
  https://github.com/Xunnamius/workflow-playground/commit/677b4cedff4d3e4541736e612035d909a0df6131
[28]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.3...v7.4.4
[29]:
  https://github.com/Xunnamius/workflow-playground/commit/5c8fefa330e31620fe2af848d42eb2c5ab881d02
[30]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.2...v7.4.3
[31]:
...
[35]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.1...v7.4.2
[36]:
...
[39]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.0...v7.4.1
[40]:
...
[42]: https://github.com/Xunnamius/workflow-playground/compare/v7.3.0...v7.4.0
[43]:
  https://github.com/Xunnamius/workflow-playground/commit/e47160b09b956e69f0d9eb0cab01a3440bb66645
[44]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.3...v7.3.0
[45]:
...
[49]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.2...v7.2.3
[50]:
  https://github.com/Xunnamius/workflow-playground/commit/786942001834cb5337fabf921cbc14ea4cc04d2f
[51]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.1...v7.2.2
[52]:
  https://github.com/Xunnamius/workflow-playground/commit/a8cd37812dc9e304bf813c742b2d4d54c1c9c183
[53]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.0...v7.2.1
[54]:
  https://github.com/Xunnamius/workflow-playground/commit/73edb9a864bbc4b7d5a7eb1d03ca4ce3b8e02e95
[55]: https://github.com/Xunnamius/workflow-playground/compare/v7.1.0...v7.2.0
[56]:
...
[59]: https://github.com/Xunnamius/workflow-playground/compare/v7.0.0...v7.1.0
[60]:
...
[63]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.3...v7.0.0
[64]:
  https://github.com/Xunnamius/workflow-playground/commit/5765c024e82c3e7e0c77808e3860c85fb8c8d759
[65]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.2...v6.7.3
[66]:
...
[68]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.1...v6.7.2
[69]:
...
[71]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.0...v6.7.1
[72]:
...
[76]: https://github.com/Xunnamius/workflow-playground/compare/v6.6.0...v6.7.0
[77]:
  https://github.com/Xunnamius/workflow-playground/commit/1fdcb9c6c500f88fbc2b7b6ec7f427f0a4995080
[78]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.1...v6.6.0
[79]:
...
[84]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.0...v6.5.1
[85]:
...
[87]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.3...v6.5.0
[88]:
  https://github.com/Xunnamius/workflow-playground/commit/54488d92317360c2e358bca9238e60e2daca64dd
[89]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[90]:
...
[93]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[94]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[95]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[96]:
...
[114]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[115]:
...
[117]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[118]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[119]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[120]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[121]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[122]:
...
[124]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[125]:
...
[131]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[132]:
...
[134]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[135]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[136]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[137]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[138]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[139]:
  https://github.com/Xunnamius/workflow-playground/commit/44f5cd4c3c6adeb548ba89adba8e884336f41520
[140]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[141]:
...
[143]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[144]:
...
[147]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[148]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[149]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[150]:
...
[152]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[153]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[154]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[155]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[156]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[157]:
...
[159]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[160]:
...
[162]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.0...v6.0.1
[163]:
  https://github.com/Xunnamius/workflow-playground/commit/d40192bd13d9b301e09723cdca68be60b44b5d82
[164]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.3...v6.0.0
[165]:
  https://github.com/Xunnamius/workflow-playground/commit/95a13d21dd902a490d445d3c8aee89c59b2131f1
[166]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.2...v5.0.3
[167]:
...
[169]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.1...v5.0.2
[170]:
  https://github.com/Xunnamius/workflow-playground/commit/e62c5b42ca2b43326cc9eec8db248020b2d90ec8
[171]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.0...v5.0.1
[172]:
...
[175]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[176]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[177]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[178]:
...
[180]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[181]:
...
[184]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[185]:
...
[196]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[197]:
...
[202]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[203]:
...
[205]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[206]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[207]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[208]:
...
[211]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[212]:
...
[214]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[215]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[216]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[217]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[218]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[219]:
...
[234]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[235]:
...
[237]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[238]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[239]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[240]:
...
[243]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[244]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[245]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[246]:
...
[250]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[251]:
...
[254]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[255]:
...
[272]: https://conventionalcommits.org
[273]: https://semver.org
[274]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.9...v7.5.10
[275]:
