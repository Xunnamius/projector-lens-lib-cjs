...
The format is based on [Conventional Commits][360], and this project adheres to
[Semantic Versioning][361].

## [7.8.10][362] (2021-02-21)

### Bug Fixes

- **build-test-deploy.yml:** check real exit code ([4ff058e][363])

## [7.8.9][1] (2021-02-20)

### Build System

- **package-lock.json:** make consistent with package.json ([8a63ac7][2])
- **package.json:** remove extraneous module ([1012053][3])

## [7.8.8][4] (2021-02-20)

### Build System

- **deps:** bump object-path from 0.11.3 to 0.11.5 ([95c974a][5])

## [7.8.7][6] (2021-02-20)

### Bug Fixes

- Package.json & package-lock.json to reduce vulnerabilities ([41de5ce][7])

## [7.8.6][8] (2021-02-20)

### Bug Fixes

- **build-test-deploy.yml:** even more resilient error checking ([b050bba][9])

### Build System

- **deps:** bump object-path from 0.11.3 to 0.11.5 ([981229a][10])
...
- **build-test-deploy.yml:** better error handling and debug messaging for
  auto-merge job ([2dee6f6][12])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([1667e70][13])
...
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([e9e3ca1][16])
...
- **build-test-deploy.yml:** better error messages ([6d5573e][19])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([c493a8c][20])

## [7.8.2][21] (2021-02-20)

### Build System

- **deps:** bump object-path from 0.11.4 to 0.11.5 ([aaf7665][22])

## [7.8.1][23] (2021-02-20)

### Bug Fixes

- **build-test-deploy.yml:** store and use proper result ([09d35d7][24])

### Build System

- **deps:** bump object-path from 0.11.4 to 0.11.5 ([658f591][25])
- **package.json:** bump jest timeout to 1 minute ([cb59af2][26])
...
- **build-test-deploy.yml:** whitelist is again case-insensitive ([c034e86][30])

### Build System

- **build-test-deploy.yml:** also run on reopened PRs ([ece78e3][31])
- **build-test-deploy.yml:** codecov failures no longer fail the whole pipeline
  ([a111d7f][32])
- **build-test-deploy.yml:** restructure env w/ comments ([b980cbe][33])
- **build-test-deploy.yml:** update repo owner whitelist step ([b4f89cf][34])

# [7.7.0][35] (2021-02-19)

### Bug Fixes

- Account for node 12 ([4cdb325][36])
...
- **package.json:** external integration test runs w/ proper prefix
  ([5056c05][38])
- **package.json:** update deps ([4ef9c1b][39])

### Features

- **external-scripts:** reorganize externals; rename external to dummy
  ([efc916e][40])
- **test:** externalize jest helper proto-packages ([2dbfb8e][41])

## [7.6.5][42] (2021-02-15)

### Build System

- **package.json:** add private:false ([090cdfe][43])

## [7.6.4][44] (2021-02-14)

### Bug Fixes

- **webpack.config.js:** call dotenv properly ([22a8424][45])

## [7.6.3][46] (2021-02-14)

### Bug Fixes

- Incorrect package name ([bbbd58d][47])

### Build System

- **package.json:** update deps ([599b6c2][48])
...
- **package.json:** account for new ./dist organization ([99a01ea][51])

### Build System

- **test:** complete testing suite ([35da4c3][52])
- **webpack.config.js:** add externals ([7a8f54b][53])
- Move debug to deps, update dependencies ([6587184][54])
- **.eslintrc.js:** false env browser/webextensions ([71809e9][55])
- **integration-client.test.ts:** removed ([f080ad0][56])
- Normalize across repos ([2020d61][57])
- **webpack.config.js:** normalize webpack configuration across repos
  ([8a3bc81][58])
- **webpack.config.js:** remove ES6 syntax from JS file ([dd2b254][59])
...
- **babel.config.js:** add babel-plugin-transform-default-named-imports
  ([720dc20][61])
- **package.json:** update deps ([26a8371][62])
...
- **post-release-check.yml:** run executables as part of check ([31bdc0c][65])

## [7.5.18][66] (2021-01-29)

### Build System

- **build-test-deploy.yml:** drop support for webpack 4 ([e7f2bbb][67])
- **cleanup.yml:** fix bug for new package repos ([8d16630][68])

## [7.5.17][69] (2021-01-29)

### Build System

- **babel.config.js:** add plugin-rename-imports ([c59e45c][70])
- **build-test-deploy.yml:** remove externals exception ([3addf11][71])
- **test:** drop support for 10.x ([fb18856][72])
- **test:** standardize imports ([4f23d4e][73])

## [7.5.16][74] (2021-01-23)

### Build System

- **package.json:** nicer destructured vals in docs ([3b81944][75])

## [7.5.15][76] (2021-01-23)

### Build System

- Backport/normalize across packages ([85881f7][77])

## [7.5.14][78] (2021-01-22)

### Build System

- Update debug statement syntax ([107b953][79])

## [7.5.13][80] (2021-01-21)
...
## [7.5.12][82] (2021-01-17)

### Build System

- Backport changes from gac ([172fa77][83])

## [7.5.11][84] (2021-01-12)

### Build System

- Rebuild lockfile ([fef7222][85])
- Update babel-plugin-transform-mjs-imports ([16a597d][86])

## [7.5.10][87] (2021-01-12)

### Build System

- Update -browser to -client everywhere ([597d6c5][88])

## [7.5.9][89] (2021-01-10)

### Bug Fixes

- **webpack.config.js:** better process.env support ([25db498][90])

## [7.5.8][91] (2021-01-06)

### Build System

- **webpack.config.js:** process.env shim ([3973279][92])
...
## [7.5.3][101] (2021-01-05)

### Build System

- **package.json:** backported updates ([8a051d1][102])

## [7.5.2][103] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][104])

## [7.5.1][105] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][106])
- **package.json:** return browser test ([6c1c4d4][107])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][108])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][109])
- **package.json:** backports from the wild ([eda277e][110])
- **webpack.config.js:** add env-expect ([0f401ff][111])

# [7.5.0][112] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][113])

## [7.4.5][114] (2021-01-05)
...
## [7.4.4][116] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][117])

## [7.4.3][118] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][119])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][120])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][121])
- **.github/workflows/build-test-deploy.yml:** fix debug output (normalize node
  support) ([0528db6][122])

## [7.4.2][123] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][124])
- **package.json:** revert "test: peer dep install" ([4c174fe][125])
- **package.json:** test: peer dep install ([6c00005][126])

## [7.4.1][127] (2021-01-04)
...
# [7.4.0][130] (2021-01-04)

### Features

- **.github:** add codecov to externals; add flags to codecov ([e47160b][131])

# [7.3.0][132] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][133])

### Build System

- **package.json:** better lint output ([0dc7c4e][134])

### Features

- **.github:** backport env matrix hint ([c01b325][135])
- **readme.md:** add NPM7 warning ([24f0888][136])

## [7.2.3][137] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][138])

## [7.2.2][139] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][140])

## [7.2.1][141] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][142])

# [7.2.0][143] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][144])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][145])
- **workflows:** fix should-skip determination algo ([f7d1256][146])

# [7.1.0][147] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][148])
- **readme.md:** complete skip test ([67264ed][149])
- **workflows:** replace should-skip determination algo ([cd6236a][150])

# [7.0.0][151] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][152])

### BREAKING CHANGES

- **changelog.md:** **skip github/github skip options were removed**

## [6.7.3][153] (2021-01-03)

### Bug Fixes

- **.changelogrc.js:** show reverts in changelog ([ec26302][154])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][155])

## [6.7.2][156] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][157])
- _"debug(readme.md): debug debug"_ ([aff005d][158])

## [6.7.1][159] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][160])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][161])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][162])

### Build System

- **package.json:** better build-changelog ([f2e971e][163])

# [6.7.0][164] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][165])

# [6.6.0][166] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][167])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][168])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][169])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][170])
- **release.config.js:** use imported releaseRules ([2fe163c][171])

## [6.5.1][172] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][173])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][174])

# [6.5.0][175] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][176])

## [6.4.3][177] (2021-01-02)
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][179])
- **package.json:** remove deploy test script ([4fb641c][180])

## [6.4.2][181] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][182])

## [6.4.1][183] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support
  ([de7ef33][184])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][185])
- **release.config.js:** fix deploy to run at success step; add debug output
  ([b9e8cc5][186])

# [6.4.0][187] (2021-01-02)

### Features

- **package.json:** vercel deploy test ([ed73fc3][188])

## [6.3.8][189] (2021-01-02)
...
## [6.3.5][195] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][196])

## [6.3.4][197] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][198])
- Update remark linting to exit 1 on error, quiet on success ([077abce][199])
- Update sort-package-json to contrib-env-expect ([6885a34][200])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][201])

## [6.3.3][202] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][204])

## [6.3.2][205] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][206])

## [6.3.1][207] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][208])

# [6.3.0][209] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][210])

### Features

- **src:** add div function ([636c353][211])

# [6.2.0][212] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][213])
- **.husky:** remove verbose flag ([538c374][214])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][215])
- **package.json:** remove debug echo ([33a510d][216])
- **release.config.js:** fix to use gfm ([db4c284][217])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][218])

## [6.1.7][219] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][220])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][221])

## [6.1.6][222] (2020-12-30)
...
## [6.1.4][226] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][227])

## [6.1.3][228] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][229])
- **build-test-deploy.yml:** fix syntax error ([5448960][230])

## [6.1.2][231] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][232])
- **package.json:** remove high audit CI failure ([b2ea6f1][233])
- **package.json:** test high audit CI failure ([03825f0][234])

## [6.1.1][235] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][236])

# [6.1.0][237] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][238])

### Features

- **readme.md:** dummy feat ([f90dde3][239])

## [6.0.5][240] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][241])

## [6.0.4][242] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][243])

## [6.0.3][244] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][245])
- **.github:** fix cleanup ([7520e0f][246])

## [6.0.2][247] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][248])
- **release.config.js:** remove console.info ([b374296][249])

## [6.0.1][250] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][251])

# [6.0.0][252] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][253])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][254] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][256])

## [5.0.2][257] (2020-12-29)
...
## [5.0.1][259] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][260])
- **package.json:** add codecov package ([d73cac9][261])
- **package.json:** remove codecov package ([da477b7][262])

# [5.0.0][263] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][264])
...
- Update comment language ([5a2aef4][267])
...
## [3.0.1][268] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][269])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][270])

### Build System

- **package.json:** update deps ([a876517][271])

# [3.0.0][272] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][273])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][274])
- **package.json:** use @xunnamius/semantic-release ([0447d59][275])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][276])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][277])
- **package-lock.json:** fix syntax error ([4fd2952][278])
...
- Added mult function ([e537358][280])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][281])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][282])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][283])
...
## [2.3.4][284] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][285])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][286])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][287])
- Added .env.example and env-expect ([efb29c5][288])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][289])

## [2.3.3][290] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][292])

## [2.3.2][293] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][294])

## [2.3.1][295] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][296])
- **release:** fix changelogTitle bug ([0d181ea][297])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][298])

# [2.3.0][299] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][300])

### Performance Improvements

- Better faster spellchecking ([c44c310][301])

## [2.2.2][302] (2020-11-29)
...
## [2.2.1][304] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][305])

# [2.2.0][306] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][308])
- **config:** fix broken changelog.config.js structure ([bd10f44][309])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][310])
- **package.json:** install lint-staged dep and script ([f3800e4][311])
- **package.json:** install spellcheck dependencies ([9a7adb4][312])
- **spellcheck:** change "contains" to "includes" ([af76dbe][313])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][314])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][315])

### Build System

- Install @semantic-release/exec ([cc94940][316])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][317])
- **config:** fix husky pre-commit hook ([f0d0032][318])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][319])
- **config:** retire @semantic-release/changelog ([787a281][320])

### Features

- Add build-changelog to npm scripts ([8393a87][321])

## [2.1.4][322] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][323])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][324])

## [2.1.3][325] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][326])

## [2.1.2][327] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][328])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][329])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][330])

## [2.1.1][331] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][332])

# [2.1.0][333] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][334])
- **actions:** if statements now use | instead of > ([24e3739][335])
- **actions:** move comments out of multiline statements ([874f8d6][336])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][340])
- Add build commits to release rule ([3124ab0][341])

# [2.0.0][342] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][343])
- **actions:** deps caching done properly ([bbe0416][344])
- **actions:** ensure repo is always checked out first ([65e5d46][345])
- **actions:** removed signed pushes ([f621f76][346])
- **package.json:** do not guess error codes ([f5428c8][347])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][348])
...
- Added diff to take the difference ([5e40deb][351])

### Performance Improvements

- **actions:** better caching ([6da0a65][352])
- **actions:** made test-integration-chrome independent ([d489cfa][353])
- **actions:** only cache node_modules ([57775c9][354])

### Reverts

- _"debug: added debug step"_ ([1741cde][355])
- _"debug: debug cache miss"_ ([42af347][356])
...
- Version 1.0.15 ([57faa2c][357])

<!---->

- Version 1.0.7 ([5ced626][358])

- Version 1.0.0 ([df91d82][359])

[1]: https://github.com/Xunnamius/projector-lens-lib-cjs/compare/v7.8.8...v7.8.9
[2]:
...
[4]: https://github.com/Xunnamius/projector-lens-lib-cjs/compare/v7.8.7...v7.8.8
[5]:
  https://github.com/Xunnamius/projector-lens-lib-cjs/commit/95c974a66a381da546dc9e810d04f22f565a557c
[6]: https://github.com/Xunnamius/projector-lens-lib-cjs/compare/v7.8.6...v7.8.7
[7]:
  https://github.com/Xunnamius/projector-lens-lib-cjs/commit/41de5cee6a6e5c56366a62d556f0c7f14b4bfc39
[8]: https://github.com/Xunnamius/projector-lens-lib-cjs/compare/v7.8.5...v7.8.6
[9]:
...
[360]: https://conventionalcommits.org
[361]: https://semver.org
[362]:
