...
The format is based on [Conventional Commits][287], and this project adheres to
[Semantic Versioning][288].

## [7.5.17][289] (2021-01-29)

### Build System

- **babel.config.js:** add plugin-rename-imports ([c59e45c][290])
- **build-test-deploy.yml:** remove externals exception ([3addf11][291])
- **test:** drop support for 10.x ([fb18856][292])
- **test:** standardize imports ([4f23d4e][293])

## [7.5.16][1] (2021-01-23)

### Build System

- **package.json:** nicer destructured vals in docs ([3b81944][2])

## [7.5.15][3] (2021-01-23)

### Build System

- Backport/normalize across packages ([85881f7][4])

## [7.5.14][5] (2021-01-22)

### Build System

- Update debug statement syntax ([107b953][6])
...
- Backport changes from gac ([172fa77][10])

## [7.5.11][11] (2021-01-12)

### Build System

- Rebuild lockfile ([fef7222][12])
- Update babel-plugin-transform-mjs-imports ([16a597d][13])

## [7.5.10][14] (2021-01-12)

### Build System

- Update -browser to -client everywhere ([597d6c5][15])

## [7.5.9][16] (2021-01-10)

### Bug Fixes

- **webpack.config.js:** better process.env support ([25db498][17])

## [7.5.8][18] (2021-01-06)

### Build System

- **webpack.config.js:** process.env shim ([3973279][19])
...
- **package.json:** backported updates ([8a051d1][29])

## [7.5.2][30] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][31])

## [7.5.1][32] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][33])
- **package.json:** return browser test ([6c1c4d4][34])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][35])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][36])
- **package.json:** backports from the wild ([eda277e][37])
- **webpack.config.js:** add env-expect ([0f401ff][38])

# [7.5.0][39] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][40])
...
- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][44])
...
- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][46])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][47])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][48])
...
- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][51])
- **package.json:** revert "test: peer dep install" ([4c174fe][52])
- **package.json:** test: peer dep install ([6c00005][53])
...
- **.github:** add codecov to externals; add flags to codecov ([e47160b][58])

# [7.3.0][59] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][60])

### Build System

- **package.json:** better lint output ([0dc7c4e][61])

### Features

- **.github:** backport env matrix hint ([c01b325][62])
- **readme.md:** add NPM7 warning ([24f0888][63])

## [7.2.3][64] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][65])

## [7.2.2][66] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][67])

## [7.2.1][68] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][69])

# [7.2.0][70] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][71])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][72])
- **workflows:** fix should-skip determination algo ([f7d1256][73])

# [7.1.0][74] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][75])
- **readme.md:** complete skip test ([67264ed][76])
- **workflows:** replace should-skip determination algo ([cd6236a][77])

# [7.0.0][78] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][79])
...
- **.changelogrc.js:** show reverts in changelog ([ec26302][81])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][82])

## [6.7.2][83] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][84])
- _"debug(readme.md): debug debug"_ ([aff005d][85])

## [6.7.1][86] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][87])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][88])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][89])

### Build System

- **package.json:** better build-changelog ([f2e971e][90])

# [6.7.0][91] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][92])

# [6.6.0][93] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][94])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][95])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][96])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][97])
- **release.config.js:** use imported releaseRules ([2fe163c][98])

## [6.5.1][99] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][100])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][101])

# [6.5.0][102] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][103])

## [6.4.3][104] (2021-01-02)
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][106])
- **package.json:** remove deploy test script ([4fb641c][107])

## [6.4.2][108] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][109])

## [6.4.1][110] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support
  ([de7ef33][111])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][112])
- **release.config.js:** fix deploy to run at success step; add debug output
  ([b9e8cc5][113])

# [6.4.0][114] (2021-01-02)

### Features

- **package.json:** vercel deploy test ([ed73fc3][115])

## [6.3.8][116] (2021-01-02)
...
## [6.3.5][122] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][123])

## [6.3.4][124] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][125])
- Update remark linting to exit 1 on error, quiet on success ([077abce][126])
- Update sort-package-json to contrib-env-expect ([6885a34][127])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][128])

## [6.3.3][129] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][131])

## [6.3.2][132] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][133])

## [6.3.1][134] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][135])

# [6.3.0][136] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][137])

### Features

- **src:** add div function ([636c353][138])

# [6.2.0][139] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][140])
- **.husky:** remove verbose flag ([538c374][141])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][142])
- **package.json:** remove debug echo ([33a510d][143])
- **release.config.js:** fix to use gfm ([db4c284][144])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][145])

## [6.1.7][146] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][147])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][148])

## [6.1.6][149] (2020-12-30)
...
## [6.1.4][153] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][154])

## [6.1.3][155] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][156])
- **build-test-deploy.yml:** fix syntax error ([5448960][157])

## [6.1.2][158] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][159])
- **package.json:** remove high audit CI failure ([b2ea6f1][160])
- **package.json:** test high audit CI failure ([03825f0][161])

## [6.1.1][162] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][163])

# [6.1.0][164] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][165])

### Features

- **readme.md:** dummy feat ([f90dde3][166])

## [6.0.5][167] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][168])

## [6.0.4][169] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][170])

## [6.0.3][171] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][172])
- **.github:** fix cleanup ([7520e0f][173])

## [6.0.2][174] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][175])
- **release.config.js:** remove console.info ([b374296][176])

## [6.0.1][177] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][178])

# [6.0.0][179] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][180])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][181] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][183])

## [5.0.2][184] (2020-12-29)
...
## [5.0.1][186] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][187])
- **package.json:** add codecov package ([d73cac9][188])
- **package.json:** remove codecov package ([da477b7][189])

# [5.0.0][190] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][191])
...
- Update comment language ([5a2aef4][194])
...
## [3.0.1][195] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][196])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][197])

### Build System

- **package.json:** update deps ([a876517][198])

# [3.0.0][199] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][200])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][201])
- **package.json:** use @xunnamius/semantic-release ([0447d59][202])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][203])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][204])
- **package-lock.json:** fix syntax error ([4fd2952][205])
...
- Added mult function ([e537358][207])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][208])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][209])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][210])
...
## [2.3.4][211] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][212])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][213])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][214])
- Added .env.example and env-expect ([efb29c5][215])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][216])

## [2.3.3][217] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][219])

## [2.3.2][220] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][221])

## [2.3.1][222] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][223])
- **release:** fix changelogTitle bug ([0d181ea][224])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][225])

# [2.3.0][226] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][227])

### Performance Improvements

- Better faster spellchecking ([c44c310][228])

## [2.2.2][229] (2020-11-29)
...
## [2.2.1][231] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][232])

# [2.2.0][233] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][235])
- **config:** fix broken changelog.config.js structure ([bd10f44][236])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][237])
- **package.json:** install lint-staged dep and script ([f3800e4][238])
- **package.json:** install spellcheck dependencies ([9a7adb4][239])
- **spellcheck:** change "contains" to "includes" ([af76dbe][240])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][241])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][242])

### Build System

- Install @semantic-release/exec ([cc94940][243])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][244])
- **config:** fix husky pre-commit hook ([f0d0032][245])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][246])
- **config:** retire @semantic-release/changelog ([787a281][247])

### Features

- Add build-changelog to npm scripts ([8393a87][248])

## [2.1.4][249] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][250])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][251])

## [2.1.3][252] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][253])

## [2.1.2][254] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][255])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][256])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][257])

## [2.1.1][258] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][259])

# [2.1.0][260] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][261])
- **actions:** if statements now use | instead of > ([24e3739][262])
- **actions:** move comments out of multiline statements ([874f8d6][263])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][267])
- Add build commits to release rule ([3124ab0][268])

# [2.0.0][269] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][270])
- **actions:** deps caching done properly ([bbe0416][271])
- **actions:** ensure repo is always checked out first ([65e5d46][272])
- **actions:** removed signed pushes ([f621f76][273])
- **package.json:** do not guess error codes ([f5428c8][274])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][275])
...
- Added diff to take the difference ([5e40deb][278])

### Performance Improvements

- **actions:** better caching ([6da0a65][279])
- **actions:** made test-integration-chrome independent ([d489cfa][280])
- **actions:** only cache node_modules ([57775c9][281])

### Reverts

- _"debug: added debug step"_ ([1741cde][282])
- _"debug: debug cache miss"_ ([42af347][283])
...
- Version 1.0.15 ([57faa2c][284])

<!---->

- Version 1.0.7 ([5ced626][285])

- Version 1.0.0 ([df91d82][286])

[1]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.15...v7.5.16
[2]:
  https://github.com/Xunnamius/workflow-playground/commit/3b81944504da09657d3232b437c4d04ba9fa95a4
[3]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.14...v7.5.15
[4]:
  https://github.com/Xunnamius/workflow-playground/commit/85881f72411301a06791be63c76a67fbff45d3fd
[5]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.13...v7.5.14
[6]:
  https://github.com/Xunnamius/workflow-playground/commit/107b953b834fb54bb2ee1c418d5bb8119fabe3ac
[7]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.12...v7.5.13
[8]:
  https://github.com/Xunnamius/workflow-playground/commit/2dce9c47d069b05df41481678a967dccc4637ead
[9]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.11...v7.5.12
[10]:
  https://github.com/Xunnamius/workflow-playground/commit/172fa775e677fe977d2b8265460ec192818b1996
[11]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.10...v7.5.11
[12]:
...
[39]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.5...v7.5.0
[40]:
  https://github.com/Xunnamius/workflow-playground/commit/77c033ff143dff64455049b8314cd528bae4e198
[41]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.4...v7.4.5
[42]:
  https://github.com/Xunnamius/workflow-playground/commit/677b4cedff4d3e4541736e612035d909a0df6131
[43]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.3...v7.4.4
[44]:
  https://github.com/Xunnamius/workflow-playground/commit/5c8fefa330e31620fe2af848d42eb2c5ab881d02
[45]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.2...v7.4.3
[46]:
...
[50]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.1...v7.4.2
[51]:
...
[54]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.0...v7.4.1
[55]:
...
[57]: https://github.com/Xunnamius/workflow-playground/compare/v7.3.0...v7.4.0
[58]:
  https://github.com/Xunnamius/workflow-playground/commit/e47160b09b956e69f0d9eb0cab01a3440bb66645
[59]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.3...v7.3.0
[60]:
...
[64]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.2...v7.2.3
[65]:
  https://github.com/Xunnamius/workflow-playground/commit/786942001834cb5337fabf921cbc14ea4cc04d2f
[66]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.1...v7.2.2
[67]:
  https://github.com/Xunnamius/workflow-playground/commit/a8cd37812dc9e304bf813c742b2d4d54c1c9c183
[68]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.0...v7.2.1
[69]:
  https://github.com/Xunnamius/workflow-playground/commit/73edb9a864bbc4b7d5a7eb1d03ca4ce3b8e02e95
[70]: https://github.com/Xunnamius/workflow-playground/compare/v7.1.0...v7.2.0
[71]:
...
[74]: https://github.com/Xunnamius/workflow-playground/compare/v7.0.0...v7.1.0
[75]:
...
[78]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.3...v7.0.0
[79]:
  https://github.com/Xunnamius/workflow-playground/commit/5765c024e82c3e7e0c77808e3860c85fb8c8d759
[80]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.2...v6.7.3
[81]:
...
[83]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.1...v6.7.2
[84]:
...
[86]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.0...v6.7.1
[87]:
...
[91]: https://github.com/Xunnamius/workflow-playground/compare/v6.6.0...v6.7.0
[92]:
  https://github.com/Xunnamius/workflow-playground/commit/1fdcb9c6c500f88fbc2b7b6ec7f427f0a4995080
[93]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.1...v6.6.0
[94]:
...
[99]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.0...v6.5.1
[100]:
...
[102]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.3...v6.5.0
[103]:
  https://github.com/Xunnamius/workflow-playground/commit/54488d92317360c2e358bca9238e60e2daca64dd
[104]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[105]:
...
[108]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[109]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[110]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[111]:
...
[129]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[130]:
...
[132]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[133]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[134]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[135]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[136]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[137]:
...
[139]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[140]:
...
[146]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[147]:
...
[149]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[150]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[151]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[152]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[153]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[154]:
  https://github.com/Xunnamius/workflow-playground/commit/44f5cd4c3c6adeb548ba89adba8e884336f41520
[155]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[156]:
...
[158]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[159]:
...
[162]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[163]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[164]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[165]:
...
[167]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[168]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[169]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[170]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[171]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[172]:
...
[174]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[175]:
...
[177]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.0...v6.0.1
[178]:
  https://github.com/Xunnamius/workflow-playground/commit/d40192bd13d9b301e09723cdca68be60b44b5d82
[179]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.3...v6.0.0
[180]:
  https://github.com/Xunnamius/workflow-playground/commit/95a13d21dd902a490d445d3c8aee89c59b2131f1
[181]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.2...v5.0.3
[182]:
...
[184]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.1...v5.0.2
[185]:
  https://github.com/Xunnamius/workflow-playground/commit/e62c5b42ca2b43326cc9eec8db248020b2d90ec8
[186]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.0...v5.0.1
[187]:
...
[190]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[191]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[192]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[193]:
...
[195]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[196]:
...
[199]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[200]:
...
[211]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[212]:
...
[217]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[218]:
...
[220]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[221]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[222]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[223]:
...
[226]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[227]:
...
[229]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[230]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[231]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[232]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[233]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[234]:
...
[249]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[250]:
...
[252]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[253]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[254]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[255]:
...
[258]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[259]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[260]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[261]:
...
[265]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[266]:
...
[269]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[270]:
...
[287]: https://conventionalcommits.org
[288]: https://semver.org
[289]:
  https://github.com/Xunnamius/workflow-playground/compare/v7.5.16...v7.5.17
[290]:
