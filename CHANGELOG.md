...
The format is based on [Conventional Commits][247], and this project adheres to
[Semantic Versioning][248].

# [7.5.0][249] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][250])
...
- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][4])
...
- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][6])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][7])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][8])
...
- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][11])
- **package.json:** revert "test: peer dep install" ([4c174fe][12])
- **package.json:** test: peer dep install ([6c00005][13])
...
- **.github:** add codecov to externals; add flags to codecov ([e47160b][18])

# [7.3.0][19] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][20])

### Build System

- **package.json:** better lint output ([0dc7c4e][21])

### Features

- **.github:** backport env matrix hint ([c01b325][22])
- **readme.md:** add NPM7 warning ([24f0888][23])

## [7.2.3][24] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][25])

## [7.2.2][26] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][27])

## [7.2.1][28] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][29])

# [7.2.0][30] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][31])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][32])
- **workflows:** fix should-skip determination algo ([f7d1256][33])

# [7.1.0][34] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][35])
- **readme.md:** complete skip test ([67264ed][36])
- **workflows:** replace should-skip determination algo ([cd6236a][37])

# [7.0.0][38] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][39])
...
- **.changelogrc.js:** show reverts in changelog ([ec26302][41])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][42])

## [6.7.2][43] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][44])
- _"debug(readme.md): debug debug"_ ([aff005d][45])

## [6.7.1][46] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][47])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][48])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][49])

### Build System

- **package.json:** better build-changelog ([f2e971e][50])

# [6.7.0][51] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][52])

# [6.6.0][53] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][54])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][55])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][56])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][57])
- **release.config.js:** use imported releaseRules ([2fe163c][58])

## [6.5.1][59] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][60])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][61])

# [6.5.0][62] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][63])
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][66])
- **package.json:** remove deploy test script ([4fb641c][67])

## [6.4.2][68] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][69])

## [6.4.1][70] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support ([de7ef33][71])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][72])
...
- **package.json:** vercel deploy test ([ed73fc3][75])
...
- **.github/workflows/cleanup.yml:** fix metadata gathering step ([44dd462][79])

## [6.3.6][80] (2021-01-01)

### Build System

- **.github/workflows/cleanup.yml:** add metadata filtering step ([6667075][81])

## [6.3.5][82] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][83])

## [6.3.4][84] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][85])
- Update remark linting to exit 1 on error, quiet on success ([077abce][86])
- Update sort-package-json to contrib-env-expect ([6885a34][87])
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][91])

## [6.3.2][92] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][93])

## [6.3.1][94] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][95])

# [6.3.0][96] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][97])

### Features

- **src:** add div function ([636c353][98])
...
- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][100])
- **.husky:** remove verbose flag ([538c374][101])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][102])
- **package.json:** remove debug echo ([33a510d][103])
- **release.config.js:** fix to use gfm ([db4c284][104])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][105])

## [6.1.7][106] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][107])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][108])

## [6.1.6][109] (2020-12-30)
...
## [6.1.4][113] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][114])

## [6.1.3][115] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][116])
- **build-test-deploy.yml:** fix syntax error ([5448960][117])

## [6.1.2][118] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][119])
- **package.json:** remove high audit CI failure ([b2ea6f1][120])
- **package.json:** test high audit CI failure ([03825f0][121])

## [6.1.1][122] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][123])

# [6.1.0][124] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][125])

### Features

- **readme.md:** dummy feat ([f90dde3][126])

## [6.0.5][127] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][128])

## [6.0.4][129] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][130])

## [6.0.3][131] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][132])
- **.github:** fix cleanup ([7520e0f][133])

## [6.0.2][134] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][135])
- **release.config.js:** remove console.info ([b374296][136])

## [6.0.1][137] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][138])

# [6.0.0][139] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][140])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][141] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][143])

## [5.0.2][144] (2020-12-29)
...
## [5.0.1][146] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][147])
- **package.json:** add codecov package ([d73cac9][148])
- **package.json:** remove codecov package ([da477b7][149])

# [5.0.0][150] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][151])
...
- Update comment language ([5a2aef4][154])
...
## [3.0.1][155] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][156])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][157])

### Build System

- **package.json:** update deps ([a876517][158])

# [3.0.0][159] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][160])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][161])
- **package.json:** use @xunnamius/semantic-release ([0447d59][162])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][163])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][164])
- **package-lock.json:** fix syntax error ([4fd2952][165])
...
- Added mult function ([e537358][167])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][168])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][169])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][170])
...
## [2.3.4][171] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][172])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][173])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][174])
- Added .env.example and env-expect ([efb29c5][175])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][176])

## [2.3.3][177] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][179])

## [2.3.2][180] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][181])

## [2.3.1][182] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][183])
- **release:** fix changelogTitle bug ([0d181ea][184])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][185])

# [2.3.0][186] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][187])

### Performance Improvements

- Better faster spellchecking ([c44c310][188])

## [2.2.2][189] (2020-11-29)
...
## [2.2.1][191] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][192])

# [2.2.0][193] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][195])
- **config:** fix broken changelog.config.js structure ([bd10f44][196])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][197])
- **package.json:** install lint-staged dep and script ([f3800e4][198])
- **package.json:** install spellcheck dependencies ([9a7adb4][199])
- **spellcheck:** change "contains" to "includes" ([af76dbe][200])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][201])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][202])

### Build System

- Install @semantic-release/exec ([cc94940][203])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][204])
- **config:** fix husky pre-commit hook ([f0d0032][205])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][206])
- **config:** retire @semantic-release/changelog ([787a281][207])

### Features

- Add build-changelog to npm scripts ([8393a87][208])

## [2.1.4][209] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][210])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][211])

## [2.1.3][212] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][213])

## [2.1.2][214] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][215])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][216])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][217])

## [2.1.1][218] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][219])

# [2.1.0][220] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][221])
- **actions:** if statements now use | instead of > ([24e3739][222])
- **actions:** move comments out of multiline statements ([874f8d6][223])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][227])
- Add build commits to release rule ([3124ab0][228])

# [2.0.0][229] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][230])
- **actions:** deps caching done properly ([bbe0416][231])
- **actions:** ensure repo is always checked out first ([65e5d46][232])
- **actions:** removed signed pushes ([f621f76][233])
- **package.json:** do not guess error codes ([f5428c8][234])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][235])
...
- Added diff to take the difference ([5e40deb][238])

### Performance Improvements

- **actions:** better caching ([6da0a65][239])
- **actions:** made test-integration-chrome independent ([d489cfa][240])
- **actions:** only cache node_modules ([57775c9][241])

### Reverts

- _"debug: added debug step"_ ([1741cde][242])
- _"debug: debug cache miss"_ ([42af347][243])
...
- Version 1.0.15 ([57faa2c][244])

<!---->

- Version 1.0.7 ([5ced626][245])

- Version 1.0.0 ([df91d82][246])

[1]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.4...v7.4.5
[2]:
  https://github.com/Xunnamius/workflow-playground/commit/677b4cedff4d3e4541736e612035d909a0df6131
[3]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.3...v7.4.4
[4]:
  https://github.com/Xunnamius/workflow-playground/commit/5c8fefa330e31620fe2af848d42eb2c5ab881d02
[5]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.2...v7.4.3
[6]:
...
[10]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.1...v7.4.2
[11]:
...
[14]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.0...v7.4.1
[15]:
...
[17]: https://github.com/Xunnamius/workflow-playground/compare/v7.3.0...v7.4.0
[18]:
  https://github.com/Xunnamius/workflow-playground/commit/e47160b09b956e69f0d9eb0cab01a3440bb66645
[19]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.3...v7.3.0
[20]:
...
[24]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.2...v7.2.3
[25]:
  https://github.com/Xunnamius/workflow-playground/commit/786942001834cb5337fabf921cbc14ea4cc04d2f
[26]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.1...v7.2.2
[27]:
  https://github.com/Xunnamius/workflow-playground/commit/a8cd37812dc9e304bf813c742b2d4d54c1c9c183
[28]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.0...v7.2.1
[29]:
  https://github.com/Xunnamius/workflow-playground/commit/73edb9a864bbc4b7d5a7eb1d03ca4ce3b8e02e95
[30]: https://github.com/Xunnamius/workflow-playground/compare/v7.1.0...v7.2.0
[31]:
...
[34]: https://github.com/Xunnamius/workflow-playground/compare/v7.0.0...v7.1.0
[35]:
...
[38]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.3...v7.0.0
[39]:
  https://github.com/Xunnamius/workflow-playground/commit/5765c024e82c3e7e0c77808e3860c85fb8c8d759
[40]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.2...v6.7.3
[41]:
...
[43]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.1...v6.7.2
[44]:
...
[46]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.0...v6.7.1
[47]:
...
[51]: https://github.com/Xunnamius/workflow-playground/compare/v6.6.0...v6.7.0
[52]:
  https://github.com/Xunnamius/workflow-playground/commit/1fdcb9c6c500f88fbc2b7b6ec7f427f0a4995080
[53]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.1...v6.6.0
[54]:
...
[59]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.0...v6.5.1
[60]:
...
[62]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.3...v6.5.0
[63]:
  https://github.com/Xunnamius/workflow-playground/commit/54488d92317360c2e358bca9238e60e2daca64dd
[64]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[65]:
...
[68]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[69]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[70]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[71]:
...
[89]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[90]:
...
[92]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[93]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[94]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[95]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[96]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[97]:
...
[99]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[100]:
...
[106]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[107]:
...
[109]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[110]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[111]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[112]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[113]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[114]:
  https://github.com/Xunnamius/workflow-playground/commit/44f5cd4c3c6adeb548ba89adba8e884336f41520
[115]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[116]:
...
[118]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[119]:
...
[122]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[123]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[124]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[125]:
...
[127]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[128]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[129]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[130]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[131]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[132]:
...
[134]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[135]:
...
[137]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.0...v6.0.1
[138]:
  https://github.com/Xunnamius/workflow-playground/commit/d40192bd13d9b301e09723cdca68be60b44b5d82
[139]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.3...v6.0.0
[140]:
  https://github.com/Xunnamius/workflow-playground/commit/95a13d21dd902a490d445d3c8aee89c59b2131f1
[141]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.2...v5.0.3
[142]:
...
[144]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.1...v5.0.2
[145]:
  https://github.com/Xunnamius/workflow-playground/commit/e62c5b42ca2b43326cc9eec8db248020b2d90ec8
[146]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.0...v5.0.1
[147]:
...
[150]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[151]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[152]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[153]:
...
[155]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[156]:
...
[159]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[160]:
...
[171]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[172]:
...
[177]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[178]:
...
[180]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[181]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[182]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[183]:
...
[186]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[187]:
...
[189]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[190]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[191]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[192]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[193]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[194]:
...
[209]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[210]:
...
[212]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[213]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[214]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[215]:
...
[218]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[219]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[220]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[221]:
...
[225]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[226]:
...
[229]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[230]:
...
[247]: https://conventionalcommits.org
[248]: https://semver.org
[249]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.5...v7.5.0
[250]:
