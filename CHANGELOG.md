...
The format is based on [Conventional Commits][374], and this project adheres to
[Semantic Versioning][375].

## [7.8.17][376] (2021-02-22)

### Build System

- **externals:** update expected exit code to 2 ([fb22498][377])
...
- **setup.ts:** backport setup fix ([ee1aca2][8])

## [7.8.12][9] (2021-02-21)

### Build System

- **package.json:** chmod cli during build-dist step ([d6f8cc3][10])

## [7.8.11][11] (2021-02-21)

### Build System

- **expect-env.js:** rename from env-expect.js ([aa14ed9][12])

## [7.8.10][13] (2021-02-21)

### Bug Fixes

- **build-test-deploy.yml:** check real exit code ([4ff058e][14])

## [7.8.9][15] (2021-02-20)

### Build System

- **package-lock.json:** make consistent with package.json ([8a63ac7][16])
- **package.json:** remove extraneous module ([1012053][17])

## [7.8.8][18] (2021-02-20)

### Build System

- **deps:** bump object-path from 0.11.3 to 0.11.5 ([95c974a][19])

## [7.8.7][20] (2021-02-20)

### Bug Fixes

- Package.json & package-lock.json to reduce vulnerabilities ([41de5ce][21])

## [7.8.6][22] (2021-02-20)

### Bug Fixes

- **build-test-deploy.yml:** even more resilient error checking ([b050bba][23])

### Build System

- **deps:** bump object-path from 0.11.3 to 0.11.5 ([981229a][24])
...
- **build-test-deploy.yml:** better error handling and debug messaging for
  auto-merge job ([2dee6f6][26])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([1667e70][27])
...
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([e9e3ca1][30])
...
- **build-test-deploy.yml:** better error messages ([6d5573e][33])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([c493a8c][34])

## [7.8.2][35] (2021-02-20)

### Build System

- **deps:** bump object-path from 0.11.4 to 0.11.5 ([aaf7665][36])

## [7.8.1][37] (2021-02-20)

### Bug Fixes

- **build-test-deploy.yml:** store and use proper result ([09d35d7][38])

### Build System

- **deps:** bump object-path from 0.11.4 to 0.11.5 ([658f591][39])
- **package.json:** bump jest timeout to 1 minute ([cb59af2][40])
...
- **build-test-deploy.yml:** whitelist is again case-insensitive ([c034e86][44])

### Build System

- **build-test-deploy.yml:** also run on reopened PRs ([ece78e3][45])
- **build-test-deploy.yml:** codecov failures no longer fail the whole pipeline
  ([a111d7f][46])
- **build-test-deploy.yml:** restructure env w/ comments ([b980cbe][47])
- **build-test-deploy.yml:** update repo owner whitelist step ([b4f89cf][48])

# [7.7.0][49] (2021-02-19)

### Bug Fixes

- Account for node 12 ([4cdb325][50])
...
- **package.json:** external integration test runs w/ proper prefix
  ([5056c05][52])
- **package.json:** update deps ([4ef9c1b][53])

### Features

- **external-scripts:** reorganize externals; rename external to dummy
  ([efc916e][54])
- **test:** externalize jest helper proto-packages ([2dbfb8e][55])

## [7.6.5][56] (2021-02-15)

### Build System

- **package.json:** add private:false ([090cdfe][57])

## [7.6.4][58] (2021-02-14)

### Bug Fixes

- **webpack.config.js:** call dotenv properly ([22a8424][59])

## [7.6.3][60] (2021-02-14)

### Bug Fixes

- Incorrect package name ([bbbd58d][61])

### Build System

- **package.json:** update deps ([599b6c2][62])
...
- **package.json:** account for new ./dist organization ([99a01ea][65])

### Build System

- **test:** complete testing suite ([35da4c3][66])
- **webpack.config.js:** add externals ([7a8f54b][67])
- Move debug to deps, update dependencies ([6587184][68])
- **.eslintrc.js:** false env browser/webextensions ([71809e9][69])
- **integration-client.test.ts:** removed ([f080ad0][70])
- Normalize across repos ([2020d61][71])
- **webpack.config.js:** normalize webpack configuration across repos
  ([8a3bc81][72])
- **webpack.config.js:** remove ES6 syntax from JS file ([dd2b254][73])
...
- **babel.config.js:** add babel-plugin-transform-default-named-imports
  ([720dc20][75])
- **package.json:** update deps ([26a8371][76])
...
- **post-release-check.yml:** run executables as part of check ([31bdc0c][79])

## [7.5.18][80] (2021-01-29)

### Build System

- **build-test-deploy.yml:** drop support for webpack 4 ([e7f2bbb][81])
- **cleanup.yml:** fix bug for new package repos ([8d16630][82])

## [7.5.17][83] (2021-01-29)

### Build System

- **babel.config.js:** add plugin-rename-imports ([c59e45c][84])
- **build-test-deploy.yml:** remove externals exception ([3addf11][85])
- **test:** drop support for 10.x ([fb18856][86])
- **test:** standardize imports ([4f23d4e][87])

## [7.5.16][88] (2021-01-23)

### Build System

- **package.json:** nicer destructured vals in docs ([3b81944][89])

## [7.5.15][90] (2021-01-23)

### Build System

- Backport/normalize across packages ([85881f7][91])

## [7.5.14][92] (2021-01-22)

### Build System

- Update debug statement syntax ([107b953][93])

## [7.5.13][94] (2021-01-21)
...
## [7.5.12][96] (2021-01-17)

### Build System

- Backport changes from gac ([172fa77][97])

## [7.5.11][98] (2021-01-12)

### Build System

- Rebuild lockfile ([fef7222][99])
- Update babel-plugin-transform-mjs-imports ([16a597d][100])

## [7.5.10][101] (2021-01-12)

### Build System

- Update -browser to -client everywhere ([597d6c5][102])

## [7.5.9][103] (2021-01-10)

### Bug Fixes

- **webpack.config.js:** better process.env support ([25db498][104])

## [7.5.8][105] (2021-01-06)

### Build System

- **webpack.config.js:** process.env shim ([3973279][106])

## [7.5.7][107] (2021-01-06)
...
## [7.5.3][115] (2021-01-05)

### Build System

- **package.json:** backported updates ([8a051d1][116])

## [7.5.2][117] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][118])

## [7.5.1][119] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][120])
- **package.json:** return browser test ([6c1c4d4][121])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][122])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][123])
- **package.json:** backports from the wild ([eda277e][124])
- **webpack.config.js:** add env-expect ([0f401ff][125])

# [7.5.0][126] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][127])

## [7.4.5][128] (2021-01-05)
...
## [7.4.4][130] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][131])

## [7.4.3][132] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][133])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][134])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][135])
- **.github/workflows/build-test-deploy.yml:** fix debug output (normalize node
  support) ([0528db6][136])

## [7.4.2][137] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][138])
- **package.json:** revert "test: peer dep install" ([4c174fe][139])
- **package.json:** test: peer dep install ([6c00005][140])

## [7.4.1][141] (2021-01-04)
...
# [7.4.0][144] (2021-01-04)

### Features

- **.github:** add codecov to externals; add flags to codecov ([e47160b][145])

# [7.3.0][146] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][147])

### Build System

- **package.json:** better lint output ([0dc7c4e][148])

### Features

- **.github:** backport env matrix hint ([c01b325][149])
- **readme.md:** add NPM7 warning ([24f0888][150])

## [7.2.3][151] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][152])

## [7.2.2][153] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][154])

## [7.2.1][155] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][156])

# [7.2.0][157] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][158])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][159])
- **workflows:** fix should-skip determination algo ([f7d1256][160])

# [7.1.0][161] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][162])
- **readme.md:** complete skip test ([67264ed][163])
- **workflows:** replace should-skip determination algo ([cd6236a][164])

# [7.0.0][165] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][166])

### BREAKING CHANGES

- **changelog.md:** **skip github/github skip options were removed**

## [6.7.3][167] (2021-01-03)

### Bug Fixes

- **.changelogrc.js:** show reverts in changelog ([ec26302][168])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][169])

## [6.7.2][170] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][171])
- _"debug(readme.md): debug debug"_ ([aff005d][172])

## [6.7.1][173] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][174])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][175])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][176])

### Build System

- **package.json:** better build-changelog ([f2e971e][177])

# [6.7.0][178] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][179])

# [6.6.0][180] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][181])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][182])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][183])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][184])
- **release.config.js:** use imported releaseRules ([2fe163c][185])

## [6.5.1][186] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][187])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][188])

# [6.5.0][189] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][190])

## [6.4.3][191] (2021-01-02)
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][193])
- **package.json:** remove deploy test script ([4fb641c][194])

## [6.4.2][195] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][196])

## [6.4.1][197] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support
  ([de7ef33][198])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][199])
- **release.config.js:** fix deploy to run at success step; add debug output
  ([b9e8cc5][200])

# [6.4.0][201] (2021-01-02)

### Features

- **package.json:** vercel deploy test ([ed73fc3][202])

## [6.3.8][203] (2021-01-02)
...
## [6.3.5][209] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][210])

## [6.3.4][211] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][212])
- Update remark linting to exit 1 on error, quiet on success ([077abce][213])
- Update sort-package-json to contrib-env-expect ([6885a34][214])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][215])

## [6.3.3][216] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][218])

## [6.3.2][219] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][220])

## [6.3.1][221] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][222])

# [6.3.0][223] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][224])

### Features

- **src:** add div function ([636c353][225])

# [6.2.0][226] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][227])
- **.husky:** remove verbose flag ([538c374][228])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][229])
- **package.json:** remove debug echo ([33a510d][230])
- **release.config.js:** fix to use gfm ([db4c284][231])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][232])

## [6.1.7][233] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][234])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][235])

## [6.1.6][236] (2020-12-30)
...
## [6.1.4][240] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][241])

## [6.1.3][242] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][243])
- **build-test-deploy.yml:** fix syntax error ([5448960][244])

## [6.1.2][245] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][246])
- **package.json:** remove high audit CI failure ([b2ea6f1][247])
- **package.json:** test high audit CI failure ([03825f0][248])

## [6.1.1][249] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][250])

# [6.1.0][251] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][252])

### Features

- **readme.md:** dummy feat ([f90dde3][253])

## [6.0.5][254] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][255])

## [6.0.4][256] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][257])

## [6.0.3][258] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][259])
- **.github:** fix cleanup ([7520e0f][260])

## [6.0.2][261] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][262])
- **release.config.js:** remove console.info ([b374296][263])

## [6.0.1][264] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][265])

# [6.0.0][266] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][267])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][268] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][270])

## [5.0.2][271] (2020-12-29)
...
## [5.0.1][273] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][274])
- **package.json:** add codecov package ([d73cac9][275])
- **package.json:** remove codecov package ([da477b7][276])

# [5.0.0][277] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][278])
...
- Update comment language ([5a2aef4][281])
...
## [3.0.1][282] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][283])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][284])

### Build System

- **package.json:** update deps ([a876517][285])

# [3.0.0][286] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][287])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][288])
- **package.json:** use @xunnamius/semantic-release ([0447d59][289])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][290])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][291])
- **package-lock.json:** fix syntax error ([4fd2952][292])
...
- Added mult function ([e537358][294])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][295])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][296])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][297])
...
## [2.3.4][298] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][299])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][300])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][301])
- Added .env.example and env-expect ([efb29c5][302])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][303])

## [2.3.3][304] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][306])

## [2.3.2][307] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][308])

## [2.3.1][309] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][310])
- **release:** fix changelogTitle bug ([0d181ea][311])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][312])

# [2.3.0][313] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][314])

### Performance Improvements

- Better faster spellchecking ([c44c310][315])

## [2.2.2][316] (2020-11-29)
...
## [2.2.1][318] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][319])

# [2.2.0][320] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][322])
- **config:** fix broken changelog.config.js structure ([bd10f44][323])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][324])
- **package.json:** install lint-staged dep and script ([f3800e4][325])
- **package.json:** install spellcheck dependencies ([9a7adb4][326])
- **spellcheck:** change "contains" to "includes" ([af76dbe][327])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][328])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][329])

### Build System

- Install @semantic-release/exec ([cc94940][330])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][331])
- **config:** fix husky pre-commit hook ([f0d0032][332])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][333])
- **config:** retire @semantic-release/changelog ([787a281][334])

### Features

- Add build-changelog to npm scripts ([8393a87][335])

## [2.1.4][336] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][337])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][338])

## [2.1.3][339] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][340])

## [2.1.2][341] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][342])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][343])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][344])

## [2.1.1][345] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][346])

# [2.1.0][347] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][348])
- **actions:** if statements now use | instead of > ([24e3739][349])
- **actions:** move comments out of multiline statements ([874f8d6][350])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][354])
- Add build commits to release rule ([3124ab0][355])

# [2.0.0][356] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][357])
- **actions:** deps caching done properly ([bbe0416][358])
- **actions:** ensure repo is always checked out first ([65e5d46][359])
- **actions:** removed signed pushes ([f621f76][360])
- **package.json:** do not guess error codes ([f5428c8][361])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][362])
...
- Added diff to take the difference ([5e40deb][365])

### Performance Improvements

- **actions:** better caching ([6da0a65][366])
- **actions:** made test-integration-chrome independent ([d489cfa][367])
- **actions:** only cache node_modules ([57775c9][368])

### Reverts

- _"debug: added debug step"_ ([1741cde][369])
- _"debug: debug cache miss"_ ([42af347][370])
...
- Version 1.0.15 ([57faa2c][371])

<!---->

- Version 1.0.7 ([5ced626][372])

- Version 1.0.0 ([df91d82][373])
...
[374]: https://conventionalcommits.org
[375]: https://semver.org
[376]:
