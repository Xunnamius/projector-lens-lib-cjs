...
The format is based on [Conventional Commits][372], and this project adheres to
[Semantic Versioning][373].

## [7.8.16][374] (2021-02-21)
...
- **setup.ts:** backport setup fix ([ee1aca2][6])

## [7.8.12][7] (2021-02-21)

### Build System

- **package.json:** chmod cli during build-dist step ([d6f8cc3][8])

## [7.8.11][9] (2021-02-21)

### Build System

- **expect-env.js:** rename from env-expect.js ([aa14ed9][10])

## [7.8.10][11] (2021-02-21)

### Bug Fixes

- **build-test-deploy.yml:** check real exit code ([4ff058e][12])

## [7.8.9][13] (2021-02-20)

### Build System

- **package-lock.json:** make consistent with package.json ([8a63ac7][14])
- **package.json:** remove extraneous module ([1012053][15])

## [7.8.8][16] (2021-02-20)

### Build System

- **deps:** bump object-path from 0.11.3 to 0.11.5 ([95c974a][17])

## [7.8.7][18] (2021-02-20)

### Bug Fixes

- Package.json & package-lock.json to reduce vulnerabilities ([41de5ce][19])

## [7.8.6][20] (2021-02-20)

### Bug Fixes

- **build-test-deploy.yml:** even more resilient error checking ([b050bba][21])

### Build System

- **deps:** bump object-path from 0.11.3 to 0.11.5 ([981229a][22])
...
- **build-test-deploy.yml:** better error handling and debug messaging for
  auto-merge job ([2dee6f6][24])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([1667e70][25])
...
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([e9e3ca1][28])
...
- **build-test-deploy.yml:** better error messages ([6d5573e][31])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([c493a8c][32])

## [7.8.2][33] (2021-02-20)

### Build System

- **deps:** bump object-path from 0.11.4 to 0.11.5 ([aaf7665][34])

## [7.8.1][35] (2021-02-20)

### Bug Fixes

- **build-test-deploy.yml:** store and use proper result ([09d35d7][36])

### Build System

- **deps:** bump object-path from 0.11.4 to 0.11.5 ([658f591][37])
- **package.json:** bump jest timeout to 1 minute ([cb59af2][38])
...
- **build-test-deploy.yml:** whitelist is again case-insensitive ([c034e86][42])

### Build System

- **build-test-deploy.yml:** also run on reopened PRs ([ece78e3][43])
- **build-test-deploy.yml:** codecov failures no longer fail the whole pipeline
  ([a111d7f][44])
- **build-test-deploy.yml:** restructure env w/ comments ([b980cbe][45])
- **build-test-deploy.yml:** update repo owner whitelist step ([b4f89cf][46])

# [7.7.0][47] (2021-02-19)

### Bug Fixes

- Account for node 12 ([4cdb325][48])
...
- **package.json:** external integration test runs w/ proper prefix
  ([5056c05][50])
- **package.json:** update deps ([4ef9c1b][51])

### Features

- **external-scripts:** reorganize externals; rename external to dummy
  ([efc916e][52])
- **test:** externalize jest helper proto-packages ([2dbfb8e][53])

## [7.6.5][54] (2021-02-15)

### Build System

- **package.json:** add private:false ([090cdfe][55])

## [7.6.4][56] (2021-02-14)

### Bug Fixes

- **webpack.config.js:** call dotenv properly ([22a8424][57])

## [7.6.3][58] (2021-02-14)

### Bug Fixes

- Incorrect package name ([bbbd58d][59])

### Build System

- **package.json:** update deps ([599b6c2][60])
...
- **package.json:** account for new ./dist organization ([99a01ea][63])

### Build System

- **test:** complete testing suite ([35da4c3][64])
- **webpack.config.js:** add externals ([7a8f54b][65])
- Move debug to deps, update dependencies ([6587184][66])
- **.eslintrc.js:** false env browser/webextensions ([71809e9][67])
- **integration-client.test.ts:** removed ([f080ad0][68])
- Normalize across repos ([2020d61][69])
- **webpack.config.js:** normalize webpack configuration across repos
  ([8a3bc81][70])
- **webpack.config.js:** remove ES6 syntax from JS file ([dd2b254][71])
...
- **babel.config.js:** add babel-plugin-transform-default-named-imports
  ([720dc20][73])
- **package.json:** update deps ([26a8371][74])
...
- **post-release-check.yml:** run executables as part of check ([31bdc0c][77])

## [7.5.18][78] (2021-01-29)

### Build System

- **build-test-deploy.yml:** drop support for webpack 4 ([e7f2bbb][79])
- **cleanup.yml:** fix bug for new package repos ([8d16630][80])

## [7.5.17][81] (2021-01-29)

### Build System

- **babel.config.js:** add plugin-rename-imports ([c59e45c][82])
- **build-test-deploy.yml:** remove externals exception ([3addf11][83])
- **test:** drop support for 10.x ([fb18856][84])
- **test:** standardize imports ([4f23d4e][85])

## [7.5.16][86] (2021-01-23)

### Build System

- **package.json:** nicer destructured vals in docs ([3b81944][87])

## [7.5.15][88] (2021-01-23)

### Build System

- Backport/normalize across packages ([85881f7][89])

## [7.5.14][90] (2021-01-22)

### Build System

- Update debug statement syntax ([107b953][91])

## [7.5.13][92] (2021-01-21)
...
## [7.5.12][94] (2021-01-17)

### Build System

- Backport changes from gac ([172fa77][95])

## [7.5.11][96] (2021-01-12)

### Build System

- Rebuild lockfile ([fef7222][97])
- Update babel-plugin-transform-mjs-imports ([16a597d][98])

## [7.5.10][99] (2021-01-12)

### Build System

- Update -browser to -client everywhere ([597d6c5][100])

## [7.5.9][101] (2021-01-10)

### Bug Fixes

- **webpack.config.js:** better process.env support ([25db498][102])

## [7.5.8][103] (2021-01-06)

### Build System

- **webpack.config.js:** process.env shim ([3973279][104])

## [7.5.7][105] (2021-01-06)
...
## [7.5.3][113] (2021-01-05)

### Build System

- **package.json:** backported updates ([8a051d1][114])

## [7.5.2][115] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][116])

## [7.5.1][117] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][118])
- **package.json:** return browser test ([6c1c4d4][119])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][120])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][121])
- **package.json:** backports from the wild ([eda277e][122])
- **webpack.config.js:** add env-expect ([0f401ff][123])

# [7.5.0][124] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][125])

## [7.4.5][126] (2021-01-05)
...
## [7.4.4][128] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][129])

## [7.4.3][130] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][131])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][132])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][133])
- **.github/workflows/build-test-deploy.yml:** fix debug output (normalize node
  support) ([0528db6][134])

## [7.4.2][135] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][136])
- **package.json:** revert "test: peer dep install" ([4c174fe][137])
- **package.json:** test: peer dep install ([6c00005][138])

## [7.4.1][139] (2021-01-04)
...
# [7.4.0][142] (2021-01-04)

### Features

- **.github:** add codecov to externals; add flags to codecov ([e47160b][143])

# [7.3.0][144] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][145])

### Build System

- **package.json:** better lint output ([0dc7c4e][146])

### Features

- **.github:** backport env matrix hint ([c01b325][147])
- **readme.md:** add NPM7 warning ([24f0888][148])

## [7.2.3][149] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][150])

## [7.2.2][151] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][152])

## [7.2.1][153] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][154])

# [7.2.0][155] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][156])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][157])
- **workflows:** fix should-skip determination algo ([f7d1256][158])

# [7.1.0][159] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][160])
- **readme.md:** complete skip test ([67264ed][161])
- **workflows:** replace should-skip determination algo ([cd6236a][162])

# [7.0.0][163] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][164])

### BREAKING CHANGES

- **changelog.md:** **skip github/github skip options were removed**

## [6.7.3][165] (2021-01-03)

### Bug Fixes

- **.changelogrc.js:** show reverts in changelog ([ec26302][166])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][167])

## [6.7.2][168] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][169])
- _"debug(readme.md): debug debug"_ ([aff005d][170])

## [6.7.1][171] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][172])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][173])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][174])

### Build System

- **package.json:** better build-changelog ([f2e971e][175])

# [6.7.0][176] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][177])

# [6.6.0][178] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][179])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][180])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][181])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][182])
- **release.config.js:** use imported releaseRules ([2fe163c][183])

## [6.5.1][184] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][185])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][186])

# [6.5.0][187] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][188])

## [6.4.3][189] (2021-01-02)
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][191])
- **package.json:** remove deploy test script ([4fb641c][192])

## [6.4.2][193] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][194])

## [6.4.1][195] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support
  ([de7ef33][196])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][197])
- **release.config.js:** fix deploy to run at success step; add debug output
  ([b9e8cc5][198])

# [6.4.0][199] (2021-01-02)

### Features

- **package.json:** vercel deploy test ([ed73fc3][200])

## [6.3.8][201] (2021-01-02)
...
## [6.3.5][207] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][208])

## [6.3.4][209] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][210])
- Update remark linting to exit 1 on error, quiet on success ([077abce][211])
- Update sort-package-json to contrib-env-expect ([6885a34][212])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][213])

## [6.3.3][214] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][216])

## [6.3.2][217] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][218])

## [6.3.1][219] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][220])

# [6.3.0][221] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][222])

### Features

- **src:** add div function ([636c353][223])

# [6.2.0][224] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][225])
- **.husky:** remove verbose flag ([538c374][226])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][227])
- **package.json:** remove debug echo ([33a510d][228])
- **release.config.js:** fix to use gfm ([db4c284][229])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][230])

## [6.1.7][231] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][232])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][233])

## [6.1.6][234] (2020-12-30)
...
## [6.1.4][238] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][239])

## [6.1.3][240] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][241])
- **build-test-deploy.yml:** fix syntax error ([5448960][242])

## [6.1.2][243] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][244])
- **package.json:** remove high audit CI failure ([b2ea6f1][245])
- **package.json:** test high audit CI failure ([03825f0][246])

## [6.1.1][247] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][248])

# [6.1.0][249] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][250])

### Features

- **readme.md:** dummy feat ([f90dde3][251])

## [6.0.5][252] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][253])

## [6.0.4][254] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][255])

## [6.0.3][256] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][257])
- **.github:** fix cleanup ([7520e0f][258])

## [6.0.2][259] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][260])
- **release.config.js:** remove console.info ([b374296][261])

## [6.0.1][262] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][263])

# [6.0.0][264] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][265])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][266] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][268])

## [5.0.2][269] (2020-12-29)
...
## [5.0.1][271] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][272])
- **package.json:** add codecov package ([d73cac9][273])
- **package.json:** remove codecov package ([da477b7][274])

# [5.0.0][275] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][276])
...
- Update comment language ([5a2aef4][279])
...
## [3.0.1][280] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][281])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][282])

### Build System

- **package.json:** update deps ([a876517][283])

# [3.0.0][284] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][285])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][286])
- **package.json:** use @xunnamius/semantic-release ([0447d59][287])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][288])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][289])
- **package-lock.json:** fix syntax error ([4fd2952][290])
...
- Added mult function ([e537358][292])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][293])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][294])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][295])
...
## [2.3.4][296] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][297])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][298])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][299])
- Added .env.example and env-expect ([efb29c5][300])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][301])

## [2.3.3][302] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][304])

## [2.3.2][305] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][306])

## [2.3.1][307] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][308])
- **release:** fix changelogTitle bug ([0d181ea][309])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][310])

# [2.3.0][311] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][312])

### Performance Improvements

- Better faster spellchecking ([c44c310][313])

## [2.2.2][314] (2020-11-29)
...
## [2.2.1][316] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][317])

# [2.2.0][318] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][320])
- **config:** fix broken changelog.config.js structure ([bd10f44][321])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][322])
- **package.json:** install lint-staged dep and script ([f3800e4][323])
- **package.json:** install spellcheck dependencies ([9a7adb4][324])
- **spellcheck:** change "contains" to "includes" ([af76dbe][325])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][326])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][327])

### Build System

- Install @semantic-release/exec ([cc94940][328])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][329])
- **config:** fix husky pre-commit hook ([f0d0032][330])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][331])
- **config:** retire @semantic-release/changelog ([787a281][332])

### Features

- Add build-changelog to npm scripts ([8393a87][333])

## [2.1.4][334] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][335])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][336])

## [2.1.3][337] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][338])

## [2.1.2][339] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][340])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][341])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][342])

## [2.1.1][343] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][344])

# [2.1.0][345] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][346])
- **actions:** if statements now use | instead of > ([24e3739][347])
- **actions:** move comments out of multiline statements ([874f8d6][348])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][352])
- Add build commits to release rule ([3124ab0][353])

# [2.0.0][354] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][355])
- **actions:** deps caching done properly ([bbe0416][356])
- **actions:** ensure repo is always checked out first ([65e5d46][357])
- **actions:** removed signed pushes ([f621f76][358])
- **package.json:** do not guess error codes ([f5428c8][359])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][360])
...
- Added diff to take the difference ([5e40deb][363])

### Performance Improvements

- **actions:** better caching ([6da0a65][364])
- **actions:** made test-integration-chrome independent ([d489cfa][365])
- **actions:** only cache node_modules ([57775c9][366])

### Reverts

- _"debug: added debug step"_ ([1741cde][367])
- _"debug: debug cache miss"_ ([42af347][368])
...
- Version 1.0.15 ([57faa2c][369])

<!---->

- Version 1.0.7 ([5ced626][370])

- Version 1.0.0 ([df91d82][371])
...
[372]: https://conventionalcommits.org
[373]: https://semver.org
[374]:
