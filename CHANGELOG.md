...
The format is based on [Conventional Commits][350], and this project adheres to
[Semantic Versioning][351].

## [7.8.6][352] (2021-02-20)

### Bug Fixes

- **build-test-deploy.yml:** even more resilient error checking ([b050bba][353])

### Build System

- **deps:** bump object-path from 0.11.3 to 0.11.5 ([12318e3][354])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([981229a][355])
...
- **build-test-deploy.yml:** better error handling and debug messaging for
  auto-merge job ([2dee6f6][2])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([1667e70][3])
...
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([e9e3ca1][6])
...
- **build-test-deploy.yml:** better error messages ([6d5573e][9])
- **deps:** bump object-path from 0.11.3 to 0.11.5 ([c493a8c][10])

## [7.8.2][11] (2021-02-20)

### Build System

- **deps:** bump object-path from 0.11.4 to 0.11.5 ([aaf7665][12])

## [7.8.1][13] (2021-02-20)

### Bug Fixes

- **build-test-deploy.yml:** store and use proper result ([09d35d7][14])

### Build System

- **deps:** bump object-path from 0.11.4 to 0.11.5 ([658f591][15])
- **package.json:** bump jest timeout to 1 minute ([cb59af2][16])
...
- **build-test-deploy.yml:** whitelist is again case-insensitive ([c034e86][20])

### Build System

- **build-test-deploy.yml:** also run on reopened PRs ([ece78e3][21])
- **build-test-deploy.yml:** codecov failures no longer fail the whole pipeline
  ([a111d7f][22])
- **build-test-deploy.yml:** restructure env w/ comments ([b980cbe][23])
- **build-test-deploy.yml:** update repo owner whitelist step ([b4f89cf][24])

# [7.7.0][25] (2021-02-19)

### Bug Fixes

- Account for node 12 ([4cdb325][26])
...
- **package.json:** external integration test runs w/ proper prefix
  ([5056c05][28])
- **package.json:** update deps ([4ef9c1b][29])

### Features

- **external-scripts:** reorganize externals; rename external to dummy
  ([efc916e][30])
- **test:** externalize jest helper proto-packages ([2dbfb8e][31])

## [7.6.5][32] (2021-02-15)

### Build System

- **package.json:** add private:false ([090cdfe][33])

## [7.6.4][34] (2021-02-14)

### Bug Fixes

- **webpack.config.js:** call dotenv properly ([22a8424][35])

## [7.6.3][36] (2021-02-14)

### Bug Fixes

- Incorrect package name ([bbbd58d][37])

### Build System

- **package.json:** update deps ([599b6c2][38])
...
- **package.json:** account for new ./dist organization ([99a01ea][41])

### Build System

- **test:** complete testing suite ([35da4c3][42])
- **webpack.config.js:** add externals ([7a8f54b][43])
- Move debug to deps, update dependencies ([6587184][44])
- **.eslintrc.js:** false env browser/webextensions ([71809e9][45])
- **integration-client.test.ts:** removed ([f080ad0][46])
- Normalize across repos ([2020d61][47])
- **webpack.config.js:** normalize webpack configuration across repos
  ([8a3bc81][48])
- **webpack.config.js:** remove ES6 syntax from JS file ([dd2b254][49])
...
- **babel.config.js:** add babel-plugin-transform-default-named-imports
  ([720dc20][51])
- **package.json:** update deps ([26a8371][52])
...
- **post-release-check.yml:** run executables as part of check ([31bdc0c][55])

## [7.5.18][56] (2021-01-29)

### Build System

- **build-test-deploy.yml:** drop support for webpack 4 ([e7f2bbb][57])
- **cleanup.yml:** fix bug for new package repos ([8d16630][58])

## [7.5.17][59] (2021-01-29)

### Build System

- **babel.config.js:** add plugin-rename-imports ([c59e45c][60])
- **build-test-deploy.yml:** remove externals exception ([3addf11][61])
- **test:** drop support for 10.x ([fb18856][62])
- **test:** standardize imports ([4f23d4e][63])

## [7.5.16][64] (2021-01-23)

### Build System

- **package.json:** nicer destructured vals in docs ([3b81944][65])

## [7.5.15][66] (2021-01-23)

### Build System

- Backport/normalize across packages ([85881f7][67])

## [7.5.14][68] (2021-01-22)

### Build System

- Update debug statement syntax ([107b953][69])

## [7.5.13][70] (2021-01-21)
...
## [7.5.12][72] (2021-01-17)

### Build System

- Backport changes from gac ([172fa77][73])

## [7.5.11][74] (2021-01-12)

### Build System

- Rebuild lockfile ([fef7222][75])
- Update babel-plugin-transform-mjs-imports ([16a597d][76])

## [7.5.10][77] (2021-01-12)

### Build System

- Update -browser to -client everywhere ([597d6c5][78])

## [7.5.9][79] (2021-01-10)

### Bug Fixes

- **webpack.config.js:** better process.env support ([25db498][80])

## [7.5.8][81] (2021-01-06)

### Build System

- **webpack.config.js:** process.env shim ([3973279][82])
...
- **package.json:** backported updates ([8a051d1][92])

## [7.5.2][93] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][94])

## [7.5.1][95] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][96])
- **package.json:** return browser test ([6c1c4d4][97])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][98])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][99])
- **package.json:** backports from the wild ([eda277e][100])
- **webpack.config.js:** add env-expect ([0f401ff][101])

# [7.5.0][102] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][103])

## [7.4.5][104] (2021-01-05)
...
## [7.4.4][106] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][107])

## [7.4.3][108] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][109])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][110])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][111])
- **.github/workflows/build-test-deploy.yml:** fix debug output (normalize node
  support) ([0528db6][112])

## [7.4.2][113] (2021-01-04)

### Build System

- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][114])
- **package.json:** revert "test: peer dep install" ([4c174fe][115])
- **package.json:** test: peer dep install ([6c00005][116])

## [7.4.1][117] (2021-01-04)
...
# [7.4.0][120] (2021-01-04)

### Features

- **.github:** add codecov to externals; add flags to codecov ([e47160b][121])

# [7.3.0][122] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][123])

### Build System

- **package.json:** better lint output ([0dc7c4e][124])

### Features

- **.github:** backport env matrix hint ([c01b325][125])
- **readme.md:** add NPM7 warning ([24f0888][126])

## [7.2.3][127] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][128])

## [7.2.2][129] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][130])

## [7.2.1][131] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][132])

# [7.2.0][133] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][134])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][135])
- **workflows:** fix should-skip determination algo ([f7d1256][136])

# [7.1.0][137] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][138])
- **readme.md:** complete skip test ([67264ed][139])
- **workflows:** replace should-skip determination algo ([cd6236a][140])

# [7.0.0][141] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][142])

### BREAKING CHANGES

- **changelog.md:** **skip github/github skip options were removed**

## [6.7.3][143] (2021-01-03)

### Bug Fixes

- **.changelogrc.js:** show reverts in changelog ([ec26302][144])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][145])

## [6.7.2][146] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][147])
- _"debug(readme.md): debug debug"_ ([aff005d][148])

## [6.7.1][149] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][150])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][151])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][152])

### Build System

- **package.json:** better build-changelog ([f2e971e][153])

# [6.7.0][154] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][155])

# [6.6.0][156] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][157])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][158])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][159])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][160])
- **release.config.js:** use imported releaseRules ([2fe163c][161])

## [6.5.1][162] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][163])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][164])

# [6.5.0][165] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][166])

## [6.4.3][167] (2021-01-02)
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][169])
- **package.json:** remove deploy test script ([4fb641c][170])

## [6.4.2][171] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][172])

## [6.4.1][173] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support
  ([de7ef33][174])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][175])
- **release.config.js:** fix deploy to run at success step; add debug output
  ([b9e8cc5][176])

# [6.4.0][177] (2021-01-02)

### Features

- **package.json:** vercel deploy test ([ed73fc3][178])

## [6.3.8][179] (2021-01-02)
...
## [6.3.5][185] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][186])

## [6.3.4][187] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][188])
- Update remark linting to exit 1 on error, quiet on success ([077abce][189])
- Update sort-package-json to contrib-env-expect ([6885a34][190])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][191])

## [6.3.3][192] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][194])

## [6.3.2][195] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][196])

## [6.3.1][197] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][198])

# [6.3.0][199] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][200])

### Features

- **src:** add div function ([636c353][201])

# [6.2.0][202] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][203])
- **.husky:** remove verbose flag ([538c374][204])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][205])
- **package.json:** remove debug echo ([33a510d][206])
- **release.config.js:** fix to use gfm ([db4c284][207])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][208])

## [6.1.7][209] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][210])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][211])

## [6.1.6][212] (2020-12-30)
...
## [6.1.4][216] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][217])

## [6.1.3][218] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][219])
- **build-test-deploy.yml:** fix syntax error ([5448960][220])

## [6.1.2][221] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][222])
- **package.json:** remove high audit CI failure ([b2ea6f1][223])
- **package.json:** test high audit CI failure ([03825f0][224])

## [6.1.1][225] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][226])

# [6.1.0][227] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][228])

### Features

- **readme.md:** dummy feat ([f90dde3][229])

## [6.0.5][230] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][231])

## [6.0.4][232] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][233])

## [6.0.3][234] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][235])
- **.github:** fix cleanup ([7520e0f][236])

## [6.0.2][237] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][238])
- **release.config.js:** remove console.info ([b374296][239])

## [6.0.1][240] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][241])

# [6.0.0][242] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][243])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][244] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][246])

## [5.0.2][247] (2020-12-29)
...
## [5.0.1][249] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][250])
- **package.json:** add codecov package ([d73cac9][251])
- **package.json:** remove codecov package ([da477b7][252])

# [5.0.0][253] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][254])
...
- Update comment language ([5a2aef4][257])
...
## [3.0.1][258] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][259])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][260])

### Build System

- **package.json:** update deps ([a876517][261])

# [3.0.0][262] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][263])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][264])
- **package.json:** use @xunnamius/semantic-release ([0447d59][265])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][266])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][267])
- **package-lock.json:** fix syntax error ([4fd2952][268])
...
- Added mult function ([e537358][270])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][271])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][272])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][273])
...
## [2.3.4][274] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][275])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][276])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][277])
- Added .env.example and env-expect ([efb29c5][278])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][279])

## [2.3.3][280] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][282])

## [2.3.2][283] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][284])

## [2.3.1][285] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][286])
- **release:** fix changelogTitle bug ([0d181ea][287])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][288])

# [2.3.0][289] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][290])

### Performance Improvements

- Better faster spellchecking ([c44c310][291])

## [2.2.2][292] (2020-11-29)
...
## [2.2.1][294] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][295])

# [2.2.0][296] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][298])
- **config:** fix broken changelog.config.js structure ([bd10f44][299])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][300])
- **package.json:** install lint-staged dep and script ([f3800e4][301])
- **package.json:** install spellcheck dependencies ([9a7adb4][302])
- **spellcheck:** change "contains" to "includes" ([af76dbe][303])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][304])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][305])

### Build System

- Install @semantic-release/exec ([cc94940][306])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][307])
- **config:** fix husky pre-commit hook ([f0d0032][308])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][309])
- **config:** retire @semantic-release/changelog ([787a281][310])

### Features

- Add build-changelog to npm scripts ([8393a87][311])

## [2.1.4][312] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][313])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][314])

## [2.1.3][315] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][316])

## [2.1.2][317] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][318])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][319])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][320])

## [2.1.1][321] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][322])

# [2.1.0][323] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][324])
- **actions:** if statements now use | instead of > ([24e3739][325])
- **actions:** move comments out of multiline statements ([874f8d6][326])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][330])
- Add build commits to release rule ([3124ab0][331])

# [2.0.0][332] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][333])
- **actions:** deps caching done properly ([bbe0416][334])
- **actions:** ensure repo is always checked out first ([65e5d46][335])
- **actions:** removed signed pushes ([f621f76][336])
- **package.json:** do not guess error codes ([f5428c8][337])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][338])
...
- Added diff to take the difference ([5e40deb][341])

### Performance Improvements

- **actions:** better caching ([6da0a65][342])
- **actions:** made test-integration-chrome independent ([d489cfa][343])
- **actions:** only cache node_modules ([57775c9][344])

### Reverts

- _"debug: added debug step"_ ([1741cde][345])
- _"debug: debug cache miss"_ ([42af347][346])
...
- Version 1.0.15 ([57faa2c][347])

<!---->

- Version 1.0.7 ([5ced626][348])

- Version 1.0.0 ([df91d82][349])

[1]: https://github.com/Xunnamius/projector-lens-lib-cjs/compare/v7.8.4...v7.8.5
[2]:
...
[4]: https://github.com/Xunnamius/projector-lens-lib-cjs/compare/v7.8.3...v7.8.4
[5]:
...
[7]: https://github.com/Xunnamius/projector-lens-lib-cjs/compare/v7.8.2...v7.8.3
[8]:
...
[350]: https://conventionalcommits.org
[351]: https://semver.org
[352]:
...
[354]:
  https://github.com/Xunnamius/projector-lens-lib-cjs/commit/12318e39b61a9a3a40fd5b3ddfff4863bc5009c4
[355]:
