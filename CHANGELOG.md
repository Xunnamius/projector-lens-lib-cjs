...
The format is based on [Conventional Commits][270], and this project adheres to
[Semantic Versioning][271].

## [7.5.9][272] (2021-01-10)

### Bug Fixes

- **webpack.config.js:** better process.env support ([25db498][273])

## [7.5.8][1] (2021-01-06)

### Build System

- **webpack.config.js:** process.env shim ([3973279][2])
...
- **package.json:** backported updates ([8a051d1][12])

## [7.5.2][13] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][14])

## [7.5.1][15] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][16])
- **package.json:** return browser test ([6c1c4d4][17])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][18])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][19])
- **package.json:** backports from the wild ([eda277e][20])
- **webpack.config.js:** add env-expect ([0f401ff][21])

# [7.5.0][22] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][23])
...
- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][27])
...
- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][29])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][30])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][31])
...
- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][34])
- **package.json:** revert "test: peer dep install" ([4c174fe][35])
- **package.json:** test: peer dep install ([6c00005][36])
...
- **.github:** add codecov to externals; add flags to codecov ([e47160b][41])

# [7.3.0][42] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][43])

### Build System

- **package.json:** better lint output ([0dc7c4e][44])

### Features

- **.github:** backport env matrix hint ([c01b325][45])
- **readme.md:** add NPM7 warning ([24f0888][46])

## [7.2.3][47] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][48])

## [7.2.2][49] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][50])

## [7.2.1][51] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][52])

# [7.2.0][53] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][54])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][55])
- **workflows:** fix should-skip determination algo ([f7d1256][56])

# [7.1.0][57] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][58])
- **readme.md:** complete skip test ([67264ed][59])
- **workflows:** replace should-skip determination algo ([cd6236a][60])

# [7.0.0][61] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][62])
...
- **.changelogrc.js:** show reverts in changelog ([ec26302][64])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][65])

## [6.7.2][66] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][67])
- _"debug(readme.md): debug debug"_ ([aff005d][68])

## [6.7.1][69] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][70])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][71])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][72])

### Build System

- **package.json:** better build-changelog ([f2e971e][73])

# [6.7.0][74] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][75])

# [6.6.0][76] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][77])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][78])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][79])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][80])
- **release.config.js:** use imported releaseRules ([2fe163c][81])

## [6.5.1][82] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][83])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][84])

# [6.5.0][85] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][86])
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][89])
- **package.json:** remove deploy test script ([4fb641c][90])

## [6.4.2][91] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][92])

## [6.4.1][93] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support ([de7ef33][94])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][95])
...
- **package.json:** vercel deploy test ([ed73fc3][98])
...
## [6.3.5][105] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][106])

## [6.3.4][107] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][108])
- Update remark linting to exit 1 on error, quiet on success ([077abce][109])
- Update sort-package-json to contrib-env-expect ([6885a34][110])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][111])

## [6.3.3][112] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][114])

## [6.3.2][115] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][116])

## [6.3.1][117] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][118])

# [6.3.0][119] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][120])

### Features

- **src:** add div function ([636c353][121])

# [6.2.0][122] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][123])
- **.husky:** remove verbose flag ([538c374][124])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][125])
- **package.json:** remove debug echo ([33a510d][126])
- **release.config.js:** fix to use gfm ([db4c284][127])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][128])

## [6.1.7][129] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][130])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][131])

## [6.1.6][132] (2020-12-30)
...
## [6.1.4][136] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][137])

## [6.1.3][138] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][139])
- **build-test-deploy.yml:** fix syntax error ([5448960][140])

## [6.1.2][141] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][142])
- **package.json:** remove high audit CI failure ([b2ea6f1][143])
- **package.json:** test high audit CI failure ([03825f0][144])

## [6.1.1][145] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][146])

# [6.1.0][147] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][148])

### Features

- **readme.md:** dummy feat ([f90dde3][149])

## [6.0.5][150] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][151])

## [6.0.4][152] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][153])

## [6.0.3][154] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][155])
- **.github:** fix cleanup ([7520e0f][156])

## [6.0.2][157] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][158])
- **release.config.js:** remove console.info ([b374296][159])

## [6.0.1][160] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][161])

# [6.0.0][162] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][163])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][164] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][166])

## [5.0.2][167] (2020-12-29)
...
## [5.0.1][169] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][170])
- **package.json:** add codecov package ([d73cac9][171])
- **package.json:** remove codecov package ([da477b7][172])

# [5.0.0][173] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][174])
...
- Update comment language ([5a2aef4][177])
...
## [3.0.1][178] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][179])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][180])

### Build System

- **package.json:** update deps ([a876517][181])

# [3.0.0][182] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][183])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][184])
- **package.json:** use @xunnamius/semantic-release ([0447d59][185])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][186])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][187])
- **package-lock.json:** fix syntax error ([4fd2952][188])
...
- Added mult function ([e537358][190])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][191])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][192])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][193])
...
## [2.3.4][194] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][195])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][196])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][197])
- Added .env.example and env-expect ([efb29c5][198])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][199])

## [2.3.3][200] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][202])

## [2.3.2][203] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][204])

## [2.3.1][205] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][206])
- **release:** fix changelogTitle bug ([0d181ea][207])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][208])

# [2.3.0][209] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][210])

### Performance Improvements

- Better faster spellchecking ([c44c310][211])

## [2.2.2][212] (2020-11-29)
...
## [2.2.1][214] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][215])

# [2.2.0][216] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][218])
- **config:** fix broken changelog.config.js structure ([bd10f44][219])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][220])
- **package.json:** install lint-staged dep and script ([f3800e4][221])
- **package.json:** install spellcheck dependencies ([9a7adb4][222])
- **spellcheck:** change "contains" to "includes" ([af76dbe][223])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][224])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][225])

### Build System

- Install @semantic-release/exec ([cc94940][226])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][227])
- **config:** fix husky pre-commit hook ([f0d0032][228])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][229])
- **config:** retire @semantic-release/changelog ([787a281][230])

### Features

- Add build-changelog to npm scripts ([8393a87][231])

## [2.1.4][232] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][233])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][234])

## [2.1.3][235] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][236])

## [2.1.2][237] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][238])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][239])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][240])

## [2.1.1][241] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][242])

# [2.1.0][243] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][244])
- **actions:** if statements now use | instead of > ([24e3739][245])
- **actions:** move comments out of multiline statements ([874f8d6][246])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][250])
- Add build commits to release rule ([3124ab0][251])

# [2.0.0][252] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][253])
- **actions:** deps caching done properly ([bbe0416][254])
- **actions:** ensure repo is always checked out first ([65e5d46][255])
- **actions:** removed signed pushes ([f621f76][256])
- **package.json:** do not guess error codes ([f5428c8][257])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][258])
...
- Added diff to take the difference ([5e40deb][261])

### Performance Improvements

- **actions:** better caching ([6da0a65][262])
- **actions:** made test-integration-chrome independent ([d489cfa][263])
- **actions:** only cache node_modules ([57775c9][264])

### Reverts

- _"debug: added debug step"_ ([1741cde][265])
- _"debug: debug cache miss"_ ([42af347][266])
...
[22]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.5...v7.5.0
[23]:
  https://github.com/Xunnamius/workflow-playground/commit/77c033ff143dff64455049b8314cd528bae4e198
[24]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.4...v7.4.5
[25]:
  https://github.com/Xunnamius/workflow-playground/commit/677b4cedff4d3e4541736e612035d909a0df6131
[26]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.3...v7.4.4
[27]:
  https://github.com/Xunnamius/workflow-playground/commit/5c8fefa330e31620fe2af848d42eb2c5ab881d02
[28]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.2...v7.4.3
[29]:
...
[33]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.1...v7.4.2
[34]:
...
[37]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.0...v7.4.1
[38]:
...
[40]: https://github.com/Xunnamius/workflow-playground/compare/v7.3.0...v7.4.0
[41]:
  https://github.com/Xunnamius/workflow-playground/commit/e47160b09b956e69f0d9eb0cab01a3440bb66645
[42]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.3...v7.3.0
[43]:
...
[47]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.2...v7.2.3
[48]:
  https://github.com/Xunnamius/workflow-playground/commit/786942001834cb5337fabf921cbc14ea4cc04d2f
[49]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.1...v7.2.2
[50]:
  https://github.com/Xunnamius/workflow-playground/commit/a8cd37812dc9e304bf813c742b2d4d54c1c9c183
[51]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.0...v7.2.1
[52]:
  https://github.com/Xunnamius/workflow-playground/commit/73edb9a864bbc4b7d5a7eb1d03ca4ce3b8e02e95
[53]: https://github.com/Xunnamius/workflow-playground/compare/v7.1.0...v7.2.0
[54]:
...
[57]: https://github.com/Xunnamius/workflow-playground/compare/v7.0.0...v7.1.0
[58]:
...
[61]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.3...v7.0.0
[62]:
  https://github.com/Xunnamius/workflow-playground/commit/5765c024e82c3e7e0c77808e3860c85fb8c8d759
[63]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.2...v6.7.3
[64]:
...
[66]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.1...v6.7.2
[67]:
...
[69]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.0...v6.7.1
[70]:
...
[74]: https://github.com/Xunnamius/workflow-playground/compare/v6.6.0...v6.7.0
[75]:
  https://github.com/Xunnamius/workflow-playground/commit/1fdcb9c6c500f88fbc2b7b6ec7f427f0a4995080
[76]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.1...v6.6.0
[77]:
...
[82]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.0...v6.5.1
[83]:
...
[85]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.3...v6.5.0
[86]:
  https://github.com/Xunnamius/workflow-playground/commit/54488d92317360c2e358bca9238e60e2daca64dd
[87]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[88]:
...
[91]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[92]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[93]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[94]:
...
[112]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[113]:
...
[115]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[116]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[117]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[118]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[119]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[120]:
...
[122]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[123]:
...
[129]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[130]:
...
[132]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[133]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[134]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[135]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[136]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[137]:
  https://github.com/Xunnamius/workflow-playground/commit/44f5cd4c3c6adeb548ba89adba8e884336f41520
[138]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[139]:
...
[141]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[142]:
...
[145]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[146]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[147]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[148]:
...
[150]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[151]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[152]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[153]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[154]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[155]:
...
[157]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[158]:
...
[160]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.0...v6.0.1
[161]:
  https://github.com/Xunnamius/workflow-playground/commit/d40192bd13d9b301e09723cdca68be60b44b5d82
[162]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.3...v6.0.0
[163]:
  https://github.com/Xunnamius/workflow-playground/commit/95a13d21dd902a490d445d3c8aee89c59b2131f1
[164]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.2...v5.0.3
[165]:
...
[167]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.1...v5.0.2
[168]:
  https://github.com/Xunnamius/workflow-playground/commit/e62c5b42ca2b43326cc9eec8db248020b2d90ec8
[169]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.0...v5.0.1
[170]:
...
[173]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[174]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[175]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[176]:
...
[178]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[179]:
...
[182]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[183]:
...
[194]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[195]:
...
[200]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[201]:
...
[203]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[204]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[205]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[206]:
...
[209]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[210]:
...
[212]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[213]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[214]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[215]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[216]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[217]:
...
[232]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[233]:
...
[235]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[236]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[237]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[238]:
...
[241]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[242]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[243]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[244]:
...
[248]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[249]:
...
[252]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[253]:
...
[270]: https://conventionalcommits.org
[271]: https://semver.org
[272]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.8...v7.5.9
[273]:
