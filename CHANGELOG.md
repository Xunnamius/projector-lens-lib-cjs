...
The format is based on [Conventional Commits][266], and this project adheres to
[Semantic Versioning][267].

## [7.5.7][268] (2021-01-06)
...
- **package.json:** backported updates ([8a051d1][8])

## [7.5.2][9] (2021-01-05)

### Build System

- **package.json:** backported updates ([2cf6e46][10])

## [7.5.1][11] (2021-01-05)

### Bug Fixes

- **env-expect.js:** use syntax for node 10 ([cb77d20][12])
- **package.json:** return browser test ([6c1c4d4][13])

### Build System

- **.github:** add INCLUDE_EXTERNALS ([c755631][14])
- **build-test-deploy.yml:** remove codecov upload for externals integration
  tests ([3fdd509][15])
- **package.json:** backports from the wild ([eda277e][16])
- **webpack.config.js:** add env-expect ([0f401ff][17])

# [7.5.0][18] (2021-01-05)

### Features

- **package-lock.json:** add unique-filename ([77c033f][19])
...
- **.github/workflows/build-test-deploy.yml:** move webpack install
  responsibility to integration ([5c8fefa][23])
...
- **.github/workflows/build-test-deploy.yml:** add debug output to npm ci
  ([09304d7][25])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([c247c7a][26])
- **.github/workflows/build-test-deploy.yml:** fix debug output ([6eb7d41][27])
...
- **.github/workflows/build-test-deploy.yml:** do not run npm install when stdin
  is empty ([2842a31][30])
- **package.json:** revert "test: peer dep install" ([4c174fe][31])
- **package.json:** test: peer dep install ([6c00005][32])
...
- **.github:** add codecov to externals; add flags to codecov ([e47160b][37])

# [7.3.0][38] (2021-01-04)

### Bug Fixes

- **env-expect.js:** simple RegExp names no longer error ([a576d0b][39])

### Build System

- **package.json:** better lint output ([0dc7c4e][40])

### Features

- **.github:** backport env matrix hint ([c01b325][41])
- **readme.md:** add NPM7 warning ([24f0888][42])

## [7.2.3][43] (2021-01-04)

### Build System

- Updates back-ported from package migration ([7869420][44])

## [7.2.2][45] (2021-01-03)

### Bug Fixes

- Add remark frontmatter support ([a8cd378][46])

## [7.2.1][47] (2021-01-03)

### Bug Fixes

- **templates:** fix strange issue template problems ([73edb9a][48])

# [7.2.0][49] (2021-01-03)

### Bug Fixes

- **changelog.md:** conclude tests _breaks champagne glass_ ([864253c][50])
- **workflows:** actually fix should-skip determination algo ([bf8c76b][51])
- **workflows:** fix should-skip determination algo ([f7d1256][52])

# [7.1.0][53] (2021-01-03)

### Bug Fixes

- **.github:** add set +e to should-skip ([27c9750][54])
- **readme.md:** complete skip test ([67264ed][55])
- **workflows:** replace should-skip determination algo ([cd6236a][56])

# [7.0.0][57] (2021-01-03)

### Features

- **changelog.md:** add skip cd/cd skip pipeline commands ([5765c02][58])
...
- **.changelogrc.js:** show reverts in changelog ([ec26302][60])

### Reverts

- _"chore(changelog.md): update pipeline usage bullets"_ ([6e9fb73][61])

## [6.7.2][62] (2021-01-03)

### Reverts

- _"chore(readme.md): debug chore"_ ([38bfb77][63])
- _"debug(readme.md): debug debug"_ ([aff005d][64])

## [6.7.1][65] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** exclude pre-releases ([c24773e][66])
- **.changelogrc.js:** fix bad type bug ([ff94fe1][67])
- **.changelogrc.js:** several writer glitches fixed ([717ffdb][68])

### Build System

- **package.json:** better build-changelog ([f2e971e][69])

# [6.7.0][70] (2021-01-02)

### Features

- **.changelogrc.js:** reintroduced selective capitalization ([1fdcb9c][71])

# [6.6.0][72] (2021-01-02)

### Bug Fixes

- **.changelogrc.js:** correct improper array access ([0cb2645][73])

### Build System

- **.changelogrc.js:** fix revision filtering during generation ([ac06b33][74])
- **.changelogrc.js:** fix spread bug ([c6a3cd6][75])

### Features

- **.changelogrc.js:** centralize release rules ([69ec71f][76])
- **release.config.js:** use imported releaseRules ([2fe163c][77])

## [6.5.1][78] (2021-01-02)

### Bug Fixes

- **release.config.js:** add title to releaseRules objects ([99c2868][79])

### Build System

- **.changelogrc.js:** add debug output to .changelogrc.js ([d47c48b][80])

# [6.5.0][81] (2021-01-02)

### Features

- **.changelogrc.js:** add debug to all javascript ([54488d9][82])
...
- **.github:** fix debug scope name (leave / alone) ([de2c7b1][85])
- **package.json:** remove deploy test script ([4fb641c][86])

## [6.4.2][87] (2021-01-02)

### Build System

- **.github:** add DEBUG support to metadata gathering steps ([6b2e238][88])

## [6.4.1][89] (2021-01-02)

### Build System

- **.github/workflows/build-test-deploy.yml:** add DEBUG support ([de7ef33][90])
- **release.config.js:** fix bracket scoping issue ([c8ef15e][91])
...
- **package.json:** vercel deploy test ([ed73fc3][94])
...
- **.github/workflows/cleanup.yml:** fix metadata gathering step ([44dd462][98])
...
## [6.3.5][101] (2021-01-01)

### Build System

- **.github:** fix hardcoded package name ([a10bac3][102])

## [6.3.4][103] (2021-01-01)

### Build System

- Move npm lint step before lint-staged in husky hook ([e8bac90][104])
- Update remark linting to exit 1 on error, quiet on success ([077abce][105])
- Update sort-package-json to contrib-env-expect ([6885a34][106])
- **pre-commit:** decentralize remark; more resilient build system
  ([ba0ef58][107])

## [6.3.3][108] (2021-01-01)
...
- **pre-commit:** move eslint (and tsc) CL linting out of lint-staged and
  directly into husky ([e38af90][110])

## [6.3.2][111] (2021-01-01)

### Build System

- **.github:** fix pre/post formatting steps ([f757db8][112])

## [6.3.1][113] (2021-01-01)

### Bug Fixes

- **test:** improve test coverage ([7f4a70a][114])

# [6.3.0][115] (2021-01-01)

### Build System

- **package.json:** simplify lint ([dda943e][116])

### Features

- **src:** add div function ([636c353][117])

# [6.2.0][118] (2021-01-01)

### Build System

- **.github/workflows/build-test-deploy.yml:** add remark and formatting steps
  ([e16cd8b][119])
- **.husky:** remove verbose flag ([538c374][120])
- **package.json:** fix lint-staged remark and prettier ([6fbd1df][121])
- **package.json:** remove debug echo ([33a510d][122])
- **release.config.js:** fix to use gfm ([db4c284][123])

### Features

- **package.json:** add remark-gfm; test lint-staged ([bcbf3f5][124])

## [6.1.7][125] (2020-12-31)

### Bug Fixes

- **README.md:** simulated external-PR fix ([8a7fc06][126])

### Reverts

- _"chore(readme.md): format husky test"_ ([9675eeb][127])

## [6.1.6][128] (2020-12-30)
...
## [6.1.4][132] (2020-12-30)

### Reverts

- _"build(build-test-deploy.yml): debug should warn"_ ([44f5cd4][133])

## [6.1.3][134] (2020-12-30)

### Build System

- **build-test-deploy.yml:** debug should warn ([55e1235][135])
- **build-test-deploy.yml:** fix syntax error ([5448960][136])

## [6.1.2][137] (2020-12-30)

### Build System

- **.github:** better snyk ignore ([5921653][138])
- **package.json:** remove high audit CI failure ([b2ea6f1][139])
- **package.json:** test high audit CI failure ([03825f0][140])

## [6.1.1][141] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([bda2d5e][142])

# [6.1.0][143] (2020-12-30)

### Bug Fixes

- **readme.md:** dummy fix ([b9d92fd][144])

### Features

- **readme.md:** dummy feat ([f90dde3][145])

## [6.0.5][146] (2020-12-30)

### Bug Fixes

- **readme.md:** add codecov badge ([4b6c84c][147])

## [6.0.4][148] (2020-12-30)

### Build System

- **.github:** more resilient cleanup routine ([85b8e12][149])

## [6.0.3][150] (2020-12-30)

### Build System

- **.github:** better cleanup caching ([02746df][151])
- **.github:** fix cleanup ([7520e0f][152])

## [6.0.2][153] (2020-12-30)

### Build System

- **cleanup.yml:** add cleanup workflow ([747a674][154])
- **release.config.js:** remove console.info ([b374296][155])

## [6.0.1][156] (2020-12-30)

### Build System

- **.github:** ensure deploy stage is using latest node and npm ([d40192b][157])

# [6.0.0][158] (2020-12-30)

### Features

- **readme.md:** fake feature ([95a13d2][159])

### BREAKING CHANGES

- **readme.md:** **fake breaking change**

## [5.0.3][160] (2020-12-29)
...
- _"chore(.gitignore): ignore coverage"_ ([4aab0bd][162])

## [5.0.2][163] (2020-12-29)
...
## [5.0.1][165] (2020-12-29)

### Build System

- **.github:** add codecov-action to test-unit job ([2ef6297][166])
- **package.json:** add codecov package ([d73cac9][167])
- **package.json:** remove codecov package ([da477b7][168])

# [5.0.0][169] (2020-12-29)

### Chore

- Fix capitalization of non-release commit types ([7391321][170])
...
- Update comment language ([5a2aef4][173])
...
## [3.0.1][174] (2020-12-28)

### Bug Fixes

- **.github:** update ci committer name and email to xunn-bot ([b151491][175])
- **package.json:** update typedoc to latest beta and fix npmbd ([783ba76][176])

### Build System

- **package.json:** update deps ([a876517][177])

# [3.0.0][178] (2020-12-07)

### Bug Fixes

- **.github/workflows:** fix syntax: "no-ci/\*\*" ([b060d3e][179])
- **config:** rename changelog.config.js to .changelogrc.js ([d5dfc50][180])
- **package.json:** use @xunnamius/semantic-release ([0447d59][181])

### Build System

- **.github/workflows:** build system now ignores branches with names that begin
  with "no-ci/" ([3a4bdff][182])
- **.github/workflows:** workflow no longer triggered on tag push,
  dependabot/snyk push ([1096e6f][183])
- **package-lock.json:** fix syntax error ([4fd2952][184])
...
- Added mult function ([e537358][186])

### Reverts

- _"chore(.github/workflows): exclude ./.git from build caching"_
  ([b75d8ac][187])
- _"debug(.github/workflows): fake change"_ ([d59bb1a][188])
- _"debug(.github/workflows): test force push protection"_ ([4cc6ee6][189])
...
## [2.3.4][190] (2020-12-03)

### Build System

- **commitlint:** add debug type to type-enum ([10c71bf][191])
- **config:** fix changelog.config.js bug when subject is undefined
  ([57e0c16][192])
- **package.json:** downgrade puppeteer and upgrade other deps ([e5d6d42][193])
- Added .env.example and env-expect ([efb29c5][194])

### Reverts

- revert "debug: switch actions ci to install" ([f9a3e23][195])

## [2.3.3][196] (2020-11-30)
...
- **release:** fix changelogTitle skip title ([1dcdcc1][198])

## [2.3.2][199] (2020-11-30)

### Build System

- **release:** fix changelogTitle spread bug ([598a396][200])

## [2.3.1][201] (2020-11-30)

### Build System

- Install @semantic-release/changelog ([022603b][202])
- **release:** fix changelogTitle bug ([0d181ea][203])
- **release:** fix SHOULD_UPDATE_CHANGELOG conditional ([ec632ad][204])

# [2.3.0][205] (2020-11-30)

### Features

- **tooling:** spellcheck now ignores camelCase et al ([d921382][206])

### Performance Improvements

- Better faster spellchecking ([c44c310][207])

## [2.2.2][208] (2020-11-29)
...
## [2.2.1][210] (2020-11-29)

### Build System

- **changelog:** changelog now includes relevant reverts ([d4ccacb][211])

# [2.2.0][212] (2020-11-29)
...
- **config:** changelog config honors skip commands, leaves reverts alone
  ([823f8b5][214])
- **config:** fix broken changelog.config.js structure ([bd10f44][215])
- **package.json:** downgrade typedoc and assoc plugins ([46db2ee][216])
- **package.json:** install lint-staged dep and script ([f3800e4][217])
- **package.json:** install spellcheck dependencies ([9a7adb4][218])
- **spellcheck:** change "contains" to "includes" ([af76dbe][219])
- **spellcheck:** fix bug where spellcheck reads from wrong message source
  ([69a25ba][220])
- **spellcheck:** spellcheck now leverages assorted knowledge ([14b86ae][221])

### Build System

- Install @semantic-release/exec ([cc94940][222])
- **config:** fix changelog.config.js operating on individual releases
  ([66adf2f][223])
- **config:** fix husky pre-commit hook ([f0d0032][224])
- **config:** generate CHANGELOG.md beautifully ([2fa4aa9][225])
- **config:** retire @semantic-release/changelog ([787a281][226])

### Features

- Add build-changelog to npm scripts ([8393a87][227])

## [2.1.4][228] (2020-11-28)

### Bug Fixes

- **actions:** ensure metadata is gathered properly ([31ece1c][229])
- **release:** remove extra newlines during changelogs generation
  ([72acb24][230])

## [2.1.3][231] (2020-11-28)

### Bug Fixes

- **release:** update how changelogs are generated ([8ce1760][232])

## [2.1.2][233] (2020-11-28)

### Bug Fixes

- **actions:** remove erroneous build-dist from lint job ([2cdd373][234])
- **actions:** remove erroneous build-dist from test-unit job ([fcb2232][235])
- **config:** fix babel.config.js with NODE_LTS ([cdf4610][236])

## [2.1.1][237] (2020-11-26)

### Bug Fixes

- **actions:** update gather-metadata with more accurate grep ([961ecef][238])

# [2.1.0][239] (2020-11-25)

### Bug Fixes

- **actions:** gather-metadata steps gather and skip properly ([97682f4][240])
- **actions:** if statements now use | instead of > ([24e3739][241])
- **actions:** move comments out of multiline statements ([874f8d6][242])
...
- **dependabot:** ensure dependabot formats GitHub Actions PRs correctly
  ([bcdbd0e][246])
- Add build commits to release rule ([3124ab0][247])

# [2.0.0][248] (2020-11-24)

### Bug Fixes

- **actions:** add install-dependencies to semantic-release needs
  ([d8cc836][249])
- **actions:** deps caching done properly ([bbe0416][250])
- **actions:** ensure repo is always checked out first ([65e5d46][251])
- **actions:** removed signed pushes ([f621f76][252])
- **package.json:** do not guess error codes ([f5428c8][253])
- **package.json:** ensure machine-friendly run-script syntax ([7af5e45][254])
...
- Added diff to take the difference ([5e40deb][257])

### Performance Improvements

- **actions:** better caching ([6da0a65][258])
- **actions:** made test-integration-chrome independent ([d489cfa][259])
- **actions:** only cache node_modules ([57775c9][260])

### Reverts

- _"debug: added debug step"_ ([1741cde][261])
- _"debug: debug cache miss"_ ([42af347][262])
...
- Version 1.0.15 ([57faa2c][263])

<!---->

- Version 1.0.7 ([5ced626][264])

- Version 1.0.0 ([df91d82][265])

[1]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.5...v7.5.6
[2]:
  https://github.com/Xunnamius/workflow-playground/commit/31f61f5dc94357a5950d2b2fe90ef9e6268e4ee4
[3]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.4...v7.5.5
[4]:
  https://github.com/Xunnamius/workflow-playground/commit/7212561b4cf094f47169b7b38e9ae4a9550e569b
[5]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.3...v7.5.4
[6]:
  https://github.com/Xunnamius/workflow-playground/commit/ed31f79e0ebe97823e2a62b9e6aa7b3e2355ff7c
[7]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.2...v7.5.3
[8]:
  https://github.com/Xunnamius/workflow-playground/commit/8a051d1222ed6df2d1c9e1f2e2eb890d763a6333
[9]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.1...v7.5.2
[10]:
  https://github.com/Xunnamius/workflow-playground/commit/2cf6e46a6fe59b8a47123f2215ba8caf7976ad87
[11]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.0...v7.5.1
[12]:
...
[18]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.5...v7.5.0
[19]:
  https://github.com/Xunnamius/workflow-playground/commit/77c033ff143dff64455049b8314cd528bae4e198
[20]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.4...v7.4.5
[21]:
  https://github.com/Xunnamius/workflow-playground/commit/677b4cedff4d3e4541736e612035d909a0df6131
[22]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.3...v7.4.4
[23]:
  https://github.com/Xunnamius/workflow-playground/commit/5c8fefa330e31620fe2af848d42eb2c5ab881d02
[24]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.2...v7.4.3
[25]:
...
[29]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.1...v7.4.2
[30]:
...
[33]: https://github.com/Xunnamius/workflow-playground/compare/v7.4.0...v7.4.1
[34]:
...
[36]: https://github.com/Xunnamius/workflow-playground/compare/v7.3.0...v7.4.0
[37]:
  https://github.com/Xunnamius/workflow-playground/commit/e47160b09b956e69f0d9eb0cab01a3440bb66645
[38]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.3...v7.3.0
[39]:
...
[43]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.2...v7.2.3
[44]:
  https://github.com/Xunnamius/workflow-playground/commit/786942001834cb5337fabf921cbc14ea4cc04d2f
[45]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.1...v7.2.2
[46]:
  https://github.com/Xunnamius/workflow-playground/commit/a8cd37812dc9e304bf813c742b2d4d54c1c9c183
[47]: https://github.com/Xunnamius/workflow-playground/compare/v7.2.0...v7.2.1
[48]:
  https://github.com/Xunnamius/workflow-playground/commit/73edb9a864bbc4b7d5a7eb1d03ca4ce3b8e02e95
[49]: https://github.com/Xunnamius/workflow-playground/compare/v7.1.0...v7.2.0
[50]:
...
[53]: https://github.com/Xunnamius/workflow-playground/compare/v7.0.0...v7.1.0
[54]:
...
[57]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.3...v7.0.0
[58]:
  https://github.com/Xunnamius/workflow-playground/commit/5765c024e82c3e7e0c77808e3860c85fb8c8d759
[59]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.2...v6.7.3
[60]:
...
[62]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.1...v6.7.2
[63]:
...
[65]: https://github.com/Xunnamius/workflow-playground/compare/v6.7.0...v6.7.1
[66]:
...
[70]: https://github.com/Xunnamius/workflow-playground/compare/v6.6.0...v6.7.0
[71]:
  https://github.com/Xunnamius/workflow-playground/commit/1fdcb9c6c500f88fbc2b7b6ec7f427f0a4995080
[72]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.1...v6.6.0
[73]:
...
[78]: https://github.com/Xunnamius/workflow-playground/compare/v6.5.0...v6.5.1
[79]:
...
[81]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.3...v6.5.0
[82]:
  https://github.com/Xunnamius/workflow-playground/commit/54488d92317360c2e358bca9238e60e2daca64dd
[83]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.2...v6.4.3
[84]:
...
[87]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.1...v6.4.2
[88]:
  https://github.com/Xunnamius/workflow-playground/commit/6b2e2383ef2b54a56a665e6b9ecef7d93e5fec2e
[89]: https://github.com/Xunnamius/workflow-playground/compare/v6.4.0...v6.4.1
[90]:
...
[108]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.2...v6.3.3
[109]:
...
[111]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.1...v6.3.2
[112]:
  https://github.com/Xunnamius/workflow-playground/commit/f757db8f0e97286abda30b825de9f803cd63c097
[113]: https://github.com/Xunnamius/workflow-playground/compare/v6.3.0...v6.3.1
[114]:
  https://github.com/Xunnamius/workflow-playground/commit/7f4a70af17528c36e80440827663251f79c9c1be
[115]: https://github.com/Xunnamius/workflow-playground/compare/v6.2.0...v6.3.0
[116]:
...
[118]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.7...v6.2.0
[119]:
...
[125]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.6...v6.1.7
[126]:
...
[128]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.5...v6.1.6
[129]:
  https://github.com/Xunnamius/workflow-playground/commit/828751d051d5cff15c5d1315fc9729d82cab985f
[130]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.4...v6.1.5
[131]:
  https://github.com/Xunnamius/workflow-playground/commit/d8ed033ead9608349f2d876c4cecebecd65dc47f
[132]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.3...v6.1.4
[133]:
  https://github.com/Xunnamius/workflow-playground/commit/44f5cd4c3c6adeb548ba89adba8e884336f41520
[134]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.2...v6.1.3
[135]:
...
[137]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.1...v6.1.2
[138]:
...
[141]: https://github.com/Xunnamius/workflow-playground/compare/v6.1.0...v6.1.1
[142]:
  https://github.com/Xunnamius/workflow-playground/commit/bda2d5ea408563874429d8ed8e30455d5e717a54
[143]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.5...v6.1.0
[144]:
...
[146]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.4...v6.0.5
[147]:
  https://github.com/Xunnamius/workflow-playground/commit/4b6c84c788c4105db8a1ddd10ecb044be31876f9
[148]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.3...v6.0.4
[149]:
  https://github.com/Xunnamius/workflow-playground/commit/85b8e12e1bce4baa22bd301da9dda21ea289fd9d
[150]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.2...v6.0.3
[151]:
...
[153]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.1...v6.0.2
[154]:
...
[156]: https://github.com/Xunnamius/workflow-playground/compare/v6.0.0...v6.0.1
[157]:
  https://github.com/Xunnamius/workflow-playground/commit/d40192bd13d9b301e09723cdca68be60b44b5d82
[158]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.3...v6.0.0
[159]:
  https://github.com/Xunnamius/workflow-playground/commit/95a13d21dd902a490d445d3c8aee89c59b2131f1
[160]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.2...v5.0.3
[161]:
...
[163]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.1...v5.0.2
[164]:
  https://github.com/Xunnamius/workflow-playground/commit/e62c5b42ca2b43326cc9eec8db248020b2d90ec8
[165]: https://github.com/Xunnamius/workflow-playground/compare/v5.0.0...v5.0.1
[166]:
...
[169]: https://github.com/Xunnamius/workflow-playground/compare/v4.0.0...v5.0.0
[170]:
  https://github.com/Xunnamius/workflow-playground/commit/7391321c8da14ed35a865a4e245db2ae3b72a606
[171]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.1...v4.0.0
[172]:
...
[174]: https://github.com/Xunnamius/workflow-playground/compare/v3.0.0...v3.0.1
[175]:
...
[178]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.4...v3.0.0
[179]:
...
[190]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.3...v2.3.4
[191]:
...
[196]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.2...v2.3.3
[197]:
...
[199]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.1...v2.3.2
[200]:
  https://github.com/Xunnamius/workflow-playground/commit/598a3966ce1d85c6dcc2945878ebd3ba2c969654
[201]: https://github.com/Xunnamius/workflow-playground/compare/v2.3.0...v2.3.1
[202]:
...
[205]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.2...v2.3.0
[206]:
...
[208]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.1...v2.2.2
[209]:
  https://github.com/Xunnamius/workflow-playground/commit/d630264d1ee046ddf943ad287b15f5308ce4c224
[210]: https://github.com/Xunnamius/workflow-playground/compare/v2.2.0...v2.2.1
[211]:
  https://github.com/Xunnamius/workflow-playground/commit/d4ccacb6533b04c4889b909ecd2bffd4c7b5fa79
[212]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.4...v2.2.0
[213]:
...
[228]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.3...v2.1.4
[229]:
...
[231]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.2...v2.1.3
[232]:
  https://github.com/Xunnamius/workflow-playground/commit/8ce176044293af0ac3b5dd2495d7d0eb580bbede
[233]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.1...v2.1.2
[234]:
...
[237]: https://github.com/Xunnamius/workflow-playground/compare/v2.1.0...v2.1.1
[238]:
  https://github.com/Xunnamius/workflow-playground/commit/961ecef3555403928cf319012ca6bd40093da66e
[239]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.1...v2.1.0
[240]:
...
[244]: https://github.com/Xunnamius/workflow-playground/compare/v2.0.0...v2.0.1
[245]:
...
[248]: https://github.com/Xunnamius/workflow-playground/compare/v1.0.15...v2.0.0
[249]:
...
[266]: https://conventionalcommits.org
[267]: https://semver.org
[268]: https://github.com/Xunnamius/workflow-playground/compare/v7.5.6...v7.5.7
[269]:
