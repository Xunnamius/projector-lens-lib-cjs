...
> or context and immediately upon push to this repository, are \[released]\[2]
> in accordance with \[this project's license]\[3].
...
- **Do** \[open an issue]\[12] and discuss your proposed changes (to prevent
  ...
  \[search]\[13] to see if there are any existing issues related to your
  concerns
- **Do** practice \[atomic committing]\[14]
- **Do not** reduce code coverage (\[codecov]\[15] checks are performed during
  CI)
...
is a description of this project's automated \[CL]\[6]/\[CI/CD]\[7] pipeline and
NPM run scripts; **this is optional reading for external collaborators.** You're
done!
...
principles, specifically leveraging \[_short-lived feature branches_]\[19]
(SLFB) and \[CL]\[6]/\[CI/CD]\[7]. Broadly speaking, this pipeline consists of
three "sub-pipelines" put together front to back:
...
- Finally, if the CI pipeline terminates successfully (and other conditions are
  met), the \[Continuous Deployment]\[23] (CD) pipeline runs. It builds,
  formats, versions, and ships to production on every commit. Production
  releases only occur on the addition of features, fixes, build system changes,
  or breaking changes.
...
- `main` is the only permanent branch, all other branches are automatically
  ...
  - The term "merged" as used here and elsewhere in this document connotes a
    \[non-ff merge]\[41] operation. Note that \[ff merge]\[41], \[rebase]\[24],
    and \[squash]\[42] operations can be used as well **except when merging
    between release branches (like `main` and `canary`); \[only non-ff merge
    operations should be used to merge between release branches]\[43]; any other
    operation (_\[including force pushing]\[25]_) risks damaging
    `semantic-release`'s version tracking metadata**!
...
This project ships with several \[NPM run scripts]\[33]. Use
...
\[]: [https\://www\.dataschool.io/how-to-contribute-on-github][1] \[2]:
[https\://help.github.com/articles/github-terms-of-service/#6-contributions-under-repository-license][2]
\[3]: LICENSE \[4]: /.github/CODE_OF_CONDUCT.md \[5]:
[https\://github.com/features/actions][3] \[6]:
[https\://github.com/Xunnamius/workflow-playground/tree/main/.husky][4] \[7]:
.github/workflows/build-test-deploy.yml \[8]:
[https\://github.com/semantic-release/semantic-release#readme][5] \[9]:
[https\://github.com/Xunnamius/workflow-playground/fork][6] \[10]:
[https\://docs.github.com/en/free-pro-team\@latest/github/creating-cloning-and-archiving-repositories/cloning-a-repository][7]
\[11]: [https\://github.com/Xunnamius/workflow-playground/compare][8] \[12]:
[https\://github.com/Xunnamius/workflow-playground/issues/new/choose][9] \[13]:
[https\://github.com/Xunnamius/workflow-playground/issues?q=][10] \[14]:
[https\://www\.codewithjason.com/atomic-commits-testing/][11] \[15]:
[https\://about.codecov.io/][12] \[16]:
[https\://www\.conventionalcommits.org/en/v1.0.0/#summary][13] \[17]:
[https\://github.com/rails/rails/pull/13771#issuecomment-32746700][14] \[18]:
[https\://trunkbaseddevelopment.com/][15] \[19]:
[https\://trunkbaseddevelopment.com/#scaled-trunk-based-development][16] \[20]:
[https\://blog.nelhage.com/post/testing-and-feedback-loops/#invest-in-regression-testing][17]
\[21]: [https\://github.com/pricing][18] \[22]:
[https\://en.wikipedia.org/wiki/Continuous_integration][19] \[23]:
[https\://en.wikipedia.org/wiki/Continuous_deployment][20] \[24]:
[https\://git-scm.com/docs/git-rebase][21] \[25]:
[https\://semantic-release.gitbook.io/semantic-release/support/troubleshooting#release-not-found-release-branch-after-git-push-force][22]
\[26]:
[https\://semantic-release.gitbook.io/semantic-release/usage/workflow-configuration#maintenance-branches][23]
\[27]: [https\://docs.npmjs.com/cli/v6/commands/npm-dist-tag#purpose][24] \[28]:
[https\://www\.npmjs.com/package/semantic-release][25] \[29]:
[https\://semantic-release.gitbook.io/semantic-release/usage/workflow-configuration#release-branches][26]
\[30]:
[https\://semantic-release.gitbook.io/semantic-release/usage/workflow-configuration#pre-release-branches][27]
\[31]: release.config.js \[32]:
[https\://docs.github.com/en/free-pro-team\@latest/actions/reference/events-that-trigger-workflows][28]
\[33]: [https\://docs.npmjs.com/cli/v6/commands/npm-run-script][29] \[34]:
[https\://docs.microsoft.com/en-us/windows/wsl/install-win10][30] \[35]:
[https\://jestjs.io/docs/en/cli.html#--coverageboolean][31] \[36]:
[https\://github.com/puppeteer/puppeteer][32] \[37]:
[https\://github.com/typicode/husky][33] \[38]:
[https\://www\.npmjs.com/package/npx][34] \[39]:
[https\://semantic-release.gitbook.io/semantic-release/usage/configuration#dryrun][35]
\[40]: [https\://docs.npmjs.com/cli/v6/commands/npm-ci][36] \[41]:
[https\://git-scm.com/docs/git-merge#Documentation/git-merge.txt---no-ff][37]
\[42]:
[https\://git-scm.com/book/en/v2/Git-Tools-Rewriting-History#\_squashing][38]
\[43]:
[https\://github.com/semantic-release/git#merging-between-semantic-release-branches][39]
...
[5]: https://github.com/semantic-release/semantic-release#readme
[6]: https://github.com/Xunnamius/workflow-playground/fork
[7]:
  https://docs.github.com/en/free-pro-team@latest/github/creating-cloning-and-archiving-repositories/cloning-a-repository
[8]: https://github.com/Xunnamius/workflow-playground/compare
[9]: https://github.com/Xunnamius/workflow-playground/issues/new/choose
[10]: https://github.com/Xunnamius/workflow-playground/issues?q=
[11]: https://www.codewithjason.com/atomic-commits-testing/
[12]: https://about.codecov.io/
[13]: https://www.conventionalcommits.org/en/v1.0.0/#summary
[14]: https://github.com/rails/rails/pull/13771#issuecomment-32746700
[15]: https://trunkbaseddevelopment.com/
[16]: https://trunkbaseddevelopment.com/#scaled-trunk-based-development
[17]:
  https://blog.nelhage.com/post/testing-and-feedback-loops/#invest-in-regression-testing
[18]: https://github.com/pricing
[19]: https://en.wikipedia.org/wiki/Continuous_integration
[20]: https://en.wikipedia.org/wiki/Continuous_deployment
[21]: https://git-scm.com/docs/git-rebase
[22]:
...
[24]: https://docs.npmjs.com/cli/v6/commands/npm-dist-tag#purpose
[25]: https://www.npmjs.com/package/semantic-release
[26]:
...
[29]: https://docs.npmjs.com/cli/v6/commands/npm-run-script
[30]: https://docs.microsoft.com/en-us/windows/wsl/install-win10
[31]: https://jestjs.io/docs/en/cli.html#--coverageboolean
[32]: https://github.com/puppeteer/puppeteer
[33]: https://github.com/typicode/husky
[34]: https://www.npmjs.com/package/npx
[35]:
  https://semantic-release.gitbook.io/semantic-release/usage/configuration#dryrun
[36]: https://docs.npmjs.com/cli/v6/commands/npm-ci
[37]: https://git-scm.com/docs/git-merge#Documentation/git-merge.txt---no-ff
[38]: https://git-scm.com/book/en/v2/Git-Tools-Rewriting-History#_squashing
[39]:
